...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  struct VideoConfig {
    ...
    // If specified will be used in order to define if
    // VideoTrackInterface::ContentHint::kText should be set for current video
    // track.
    // TODO(landrey) use just use_text_content_hint field here.
