 ...
 public:
  RtpGenericFrameDescriptorExtensionTest()
      : arbitrary_bool_(std::get<0>(GetParam())),
        use_discardability_flag_(std::get<1>(GetParam())),
  ...
  bool Parse(rtc::ArrayView<const uint8_t> data,
    ...
    return RtpGenericFrameDescriptorExtension::Parse(data, descriptor,
  ...
  size_t ValueSize(const RtpGenericFrameDescriptor& descriptor) {
    return RtpGenericFrameDescriptorExtension::ValueSize(
        descriptor, use_discardability_flag_);
  }

  bool Write(rtc::ArrayView<uint8_t> data,
             const RtpGenericFrameDescriptor& descriptor) {
    return RtpGenericFrameDescriptorExtension::Write(data, descriptor,
                                                     use_discardability_flag_);
  }
