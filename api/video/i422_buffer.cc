  ...
  switch (mode) {
    case libyuv::kRotate0:
      ...
      libyuv::CopyPlane(src_y, src_stride_y, dst_y, dst_stride_y, width,
                        height);
      libyuv::CopyPlane(src_u, src_stride_u, dst_u, dst_stride_u, width,
                        height);
      libyuv::CopyPlane(src_v, src_stride_v, dst_v, dst_stride_v, width,
                        height);
      return 0;
    case libyuv::kRotate90:
      libyuv::RotatePlane90(src_y, src_stride_y, dst_y, dst_stride_y, width,
                            height);
      libyuv::RotatePlane90(src_u, src_stride_u, dst_u, dst_stride_u, width,
                            height);
      libyuv::RotatePlane90(src_v, src_stride_v, dst_v, dst_stride_v, width,
                            height);
      return 0;
    case libyuv::kRotate270:
      libyuv::RotatePlane270(src_y, src_stride_y, dst_y, dst_stride_y, width,
                             height);
      libyuv::RotatePlane270(src_u, src_stride_u, dst_u, dst_stride_u, width,
                             height);
      libyuv::RotatePlane270(src_v, src_stride_v, dst_v, dst_stride_v, width,
                             height);
      return 0;
    case libyuv::kRotate180:
      libyuv::RotatePlane180(src_y, src_stride_y, dst_y, dst_stride_y, width,
                             height);
      libyuv::RotatePlane180(src_u, src_stride_u, dst_u, dst_stride_u, width,
                             height);
      libyuv::RotatePlane180(src_v, src_stride_v, dst_v, dst_stride_v, width,
                             height);
      return 0;
    default:
      break;
...
int I422Scale(const uint8_t* src_y,
  ...
  libyuv::ScalePlane(src_u, src_stride_u, src_width, src_height, dst_u,
                     dst_stride_u, dst_width, dst_height, filtering);
  libyuv::ScalePlane(src_v, src_stride_v, src_width, src_height, dst_v,
