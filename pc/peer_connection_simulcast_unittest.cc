...
class PeerConnectionSimulcastWithMediaFlowTests
 ...
 public:
  ...
  rtc::scoped_refptr<RtpTransceiverInterface> ConfigureSimulcastAndConnect(
    ...
    {
      SCOPED_TRACE("after create offer");
      ValidateTransceiverParameters(transceiver, init_layers);
    }
...
TEST_F(PeerConnectionSimulcastWithMediaFlowTests,
  ...
  ConfigureSimulcastAndConnect(local, remote,
