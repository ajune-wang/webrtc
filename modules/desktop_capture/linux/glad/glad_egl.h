...
#ifndef MODULES_DESKTOP_CAPTURE_LINUX_GLAD_GLAD_EGL_H_

#ifdef __egl_h_
#error EGL header already included, remove this include, \
       glad already provides it
#endif

#define MODULES_DESKTOP_CAPTURE_LINUX_GLAD_GLAD_EGL_H_
#define __egl_h_
...
#include "modules/desktop_capture/linux/glad/eglplatform.h"
...
typedef void(APIENTRY* EGLDEBUGPROCKHR)(EGLenum error,
                                        const char* command,
                                        EGLint messageType,
...
typedef EGLDisplay(APIENTRYP PFNEGLGETPLATFORMDISPLAYEXTPROC)(
    EGLenum platform,
    void* native_display,
    const EGLint* attrib_list);
...
typedef EGLSurface(APIENTRYP PFNEGLCREATEPLATFORMWINDOWSURFACEEXTPROC)(
    EGLDisplay dpy,
    EGLConfig config,
    void* native_window,
    const EGLint* attrib_list);
GLAPI PFNEGLCREATEPLATFORMWINDOWSURFACEEXTPROC
    glad_eglCreatePlatformWindowSurfaceEXT;
#define eglCreatePlatformWindowSurfaceEXT glad_eglCreatePlatformWindowSurfaceEXT
typedef EGLSurface(APIENTRYP PFNEGLCREATEPLATFORMPIXMAPSURFACEEXTPROC)(
    EGLDisplay dpy,
    EGLConfig config,
    void* native_pixmap,
    const EGLint* attrib_list);
GLAPI PFNEGLCREATEPLATFORMPIXMAPSURFACEEXTPROC
...
typedef EGLImageKHR(APIENTRYP PFNEGLCREATEIMAGEKHRPROC)(
    EGLDisplay dpy,
    EGLContext ctx,
    EGLenum target,
    EGLClientBuffer buffer,
...
typedef EGLBoolean(APIENTRYP PFNEGLDESTROYIMAGEKHRPROC)(EGLDisplay dpy,
                                                        EGLImageKHR image);
...
#endif  // MODULES_DESKTOP_CAPTURE_LINUX_GLAD_GLAD_EGL_H_
