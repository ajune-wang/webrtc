...
class LibaomAv1Encoder final : public VideoEncoder {
 ...
 private:
  ...
  void SetSvcParams(ScalableVideoController::StreamLayersConfig svc_config);
...
int LibaomAv1Encoder::InitEncode(const VideoCodec* codec_settings,
  ...
  SetSvcParams(svc_controller_->StreamConfig());

  return WEBRTC_VIDEO_CODEC_OK;
}

void LibaomAv1Encoder::SetSvcParams(
...
void LibaomAv1Encoder::SetSvcRefFrameConfig(
  ...
  // Note last_frame_idx and golden_frame_idx in section 6.8.2 of the av1 spec
