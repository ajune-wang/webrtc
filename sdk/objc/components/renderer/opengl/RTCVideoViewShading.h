...
/**
 * RTC_OBJC_TYPE(RTCVideoViewShading) provides a way for apps to customize the OpenGL(ES) shaders
 * used in rendering for the RTC_OBJC_TYPE(RTCEAGLVideoView)/RTC_OBJC_TYPE(RTCNSGLVideoView).
 */
RTC_OBJC_EXPORT
