...
()
    ...
    /**
     * The native IceCandidateInterface representation of this RTC_OBJC_TYPE(RTCIceCandidate)
     * object. This is needed to pass to the underlying C++ APIs.
     */
    @property(nonatomic, readonly) std::unique_ptr<webrtc::IceCandidateInterface> nativeCandidate;

/**
 * Initialize an RTC_OBJC_TYPE(RTCIceCandidate) from a native IceCandidateInterface. No
