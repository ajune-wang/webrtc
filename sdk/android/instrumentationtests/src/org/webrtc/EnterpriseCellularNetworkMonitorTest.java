...
public class EnterpriseCellularNetworkMonitorTest {
  ...
  @UiThreadTest
  @SmallTest
  public void testGetActiveEnterpriseNetworks() throws InterruptedException {
    ...
    boolean nonEnterprise = false;
    final NetworkChangeDetector.NetworkInformation net1 =
        createNetworkInfo(1, NetworkChangeDetector.ConnectionType.CONNECTION_WIFI, nonEnterprise);
  ...
  @UiThreadTest
  @SmallTest
  public void testGetActiveMixedNetworks() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
    ...
    final NetworkChangeDetector.NetworkInformation net3 =
        createNetworkInfo(3, NetworkChangeDetector.ConnectionType.CONNECTION_4G, nonEnterprise);
  ...
  @UiThreadTest
  @SmallTest
  public void testGetActiveNonEnterpriseNetworks() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
    ...
    final NetworkChangeDetector.NetworkInformation net2 =
        createNetworkInfo(2, NetworkChangeDetector.ConnectionType.CONNECTION_4G, nonEnterprise);
    final NetworkChangeDetector.NetworkInformation net3 =
        createNetworkInfo(3, NetworkChangeDetector.ConnectionType.CONNECTION_4G, nonEnterprise);
  ...
  @UiThreadTest
  @SmallTest
  public void testOnNetworkConnectEnterprise() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
    ...
    final NetworkChangeDetector.NetworkInformation net2 =
        createNetworkInfo(2, NetworkChangeDetector.ConnectionType.CONNECTION_4G, isEnterprise);
    final NetworkChangeDetector.NetworkInformation net3 =
        createNetworkInfo(3, NetworkChangeDetector.ConnectionType.CONNECTION_4G, isEnterprise);

    fakeDetector.observer.onNetworkConnect(net1);
    fakeDetector.observer.onNetworkConnect(net2);
    fakeDetector.observer.onNetworkConnect(net3);

    ArrayList<NetworkChangeDetector.NetworkInformation> expectList = new ArrayList<>();
    expectList.add(net1);
    expectList.add(net2);
    expectList.add(net3);
    assertEquals(expectList, observer.onNetworkConnectList);
    assertTrue(observer.onNetworkDisconnectList.isEmpty());
  }

  @Test
  @UiThreadTest
  @SmallTest
  public void testOnNetworkConnectNonEnterprise() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
  ...
  @UiThreadTest
  @SmallTest
  public void testOnNetworkConnectEnterpriseFollowedByNonEnterprise() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
  ...
  @UiThreadTest
  @SmallTest
  public void testOnNetworkConnectNonEnterpriseFollowedByEnterprise() throws InterruptedException {
    FakeDetector fakeDetector = new FakeDetector();
    TestObserver observer = new TestObserver();
    EnterpriseCellularNetworkMonitor monitor = Create(fakeDetector, observer);
    ...
    fakeDetector.observer.onNetworkConnect(net1);
    // This will be disconnected when net2 connects.
    fakeDetector.observer.onNetworkConnect(net3);
    fakeDetector.observer.onNetworkConnect(net2);

    ArrayList<NetworkChangeDetector.NetworkInformation> connectList = new ArrayList<>();
    connectList.add(net1);
    connectList.add(net3);
    connectList.add(net2);
    assertEquals(connectList, observer.onNetworkConnectList);

    ArrayList<Long> disconnectList = new ArrayList<>();
    disconnectList.add(net3.handle);
    assertEquals(disconnectList, observer.onNetworkDisconnectList);
  }
}
