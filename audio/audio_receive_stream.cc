...
namespace internal {
namespace {
voe::ChannelProxy* CreateChannelAndProxy(
...
AudioReceiveStream::AudioReceiveStream(
    ...
    const rtc::scoped_refptr<webrtc::AudioState>& audio_state,
    webrtc::RtcEventLog* event_log,
    voe::ChannelProxy* channel_proxy)
    : config_(config),
...
void AudioReceiveStream::AssociateSendStream(AudioSendStream* send_stream) {
  ...
  associate_send_stream_ = send_stream;
}
...
// Used for testing.
const AudioSendStream* AudioReceiveStream::associate_send_stream() const {
  RTC_DCHECK_RUN_ON(&worker_thread_checker_);
  return associate_send_stream_;
}
