...
class DelayManager {
 public:
  ...
  // This accessor is only intended for testing purposes.
  absl::optional<int> deceleration_target_level_offset() const {
    return deceleration_target_level_offset_;
  }
 ...
 private:
  ...
  // Constant offset to avoid big difference
  // |BufferLimits| |lower_limit| and |higher_limit| for high target levels,
  // which may cause A/V desynchronization. In Q8.
