...
public class DefaultVideoDecoderFactory implements VideoDecoderFactory {
  ...
  @Nullable
  @Override
  public VideoDecoder createDecoder(long webrtcEnvRef, VideoCodecInfo info) {
    VideoDecoder softwareDecoder = softwareVideoDecoderFactory.createDecoder(webrtcEnvRef, info);
    final VideoDecoder hardwareDecoder =
        hardwareVideoDecoderFactory.createDecoder(webrtcEnvRef, info);
    if (softwareDecoder == null && platformSoftwareVideoDecoderFactory != null) {
      softwareDecoder = platformSoftwareVideoDecoderFactory.createDecoder(webrtcEnvRef, info);
    }
