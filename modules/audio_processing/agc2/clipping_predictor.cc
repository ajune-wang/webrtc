...
// Returns an input volume that could possibly reduce `gain_error_db`, which is
// a gain error estimated when `input_volume` was applied. Returns a value in
// [`min_input_volume`, `max_input_volume`].
