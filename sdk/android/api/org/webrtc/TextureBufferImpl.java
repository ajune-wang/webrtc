...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
  ...
  public VideoFrame.Buffer cropAndScale(
    ...
    return applyTransformationMatrix(cropAndScaleMatrix, scaleWidth, scaleHeight);
  }

  /**
   * Create a new TextureBufferImpl with an applied transformation matrix and a new size. The
   * existing buffer is unchanged.
   */
  public TextureBufferImpl applyTransformationMatrix(
