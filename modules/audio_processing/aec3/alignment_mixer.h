...
class AlignmentMixer {
 public:
  AlignmentMixer(int num_channels,
                 bool downmix,
  ...
  enum class AlignmentVariant { kDownmix, kAdaptive, kFixed };
 ...
 private:
  ...
  const AlignmentVariant selection_variant_;
  std::vector<size_t> strong_block_counters_;
