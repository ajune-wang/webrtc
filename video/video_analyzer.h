...
class VideoAnalyzer : public PacketReceiver,
 ...
 private:
  ...
  rtc::CriticalSection crit_;
  const int frames_to_process_ RTC_GUARDED_BY(comparison_lock_);
  ...
  int64_t total_media_bytes_ RTC_GUARDED_BY(crit_);
  int64_t first_sending_time_ RTC_GUARDED_BY(crit_);
  int64_t last_sending_time_ RTC_GUARDED_BY(crit_);
