  ...
  switch (type) {
    ...
    case VideoFrameBuffer::Type::kI010:
      return WrapI010Buffer(
          width, height, reinterpret_cast<const uint16_t*>(y_plane), y_stride,
          reinterpret_cast<const uint16_t*>(u_plane), u_stride,
          reinterpret_cast<const uint16_t*>(v_plane), v_stride, no_longer_used);
