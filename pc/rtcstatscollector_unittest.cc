...
TEST_F(RTCStatsCollectorTest, CollectRTCCertificateStatsSingle) {
  ...
  pc_->SetRemoteCertChain(
      kTransportName, remote_certinfo->certificate->ssl_cert_chain().Copy());
...
TEST_F(RTCStatsCollectorTest, CollectRTCCertificateStatsMultiple) {
  ...
  pc_->SetRemoteCertChain(
      kAudioTransport,
      audio_remote_certinfo->certificate->ssl_cert_chain().Copy());
  ...
  pc_->SetRemoteCertChain(
      kVideoTransport,
      video_remote_certinfo->certificate->ssl_cert_chain().Copy());
