...
vars = {
  ...
  'chromium_revision': 'f6e2c3a5063c4e904023dbcb1f7ba2f0d5cc5fc0',
}
...
deps = {
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@f212a82aaaee7383a3ee8b0eb4f13dce98bf0200',
