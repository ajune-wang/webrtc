...
class DecisionLogic : public NetEqController {
 public:
  ...
  NetEq::Operations GetDecision(const NetEqController::NetEqStatus& status,
  ...
  // sync buffer.
  void ExpandDecision(NetEq::Operations operation) override;
 ...
 private:
  ...
  NetEq::Operations CngOperation(NetEq::Modes prev_mode,
  ...
  NetEq::Operations NoPacket(bool play_dtmf);

  // Returns the operation to do given that the expected packet is available.
  NetEq::Operations ExpectedPacketAvailable(NetEq::Modes prev_mode,
                                            bool play_dtmf);

  // Returns the operation to do given that the expected packet is not
  // available, but a packet further into the future is at hand.
  NetEq::Operations FuturePacketAvailable(size_t decoder_frame_length,
