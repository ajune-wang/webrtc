 ...
 * This class is thred safe and methods can be called from any thread, but the methods adaptFrame()
 * and OnFrameCaptured() needs to be called in order and refer to the same input frame, before the
