...
class RtpRtcp : public Module {
 public:
  ...
  // Scheduler sending remb on next and following sender/receiver reports.
  virtual void SetREMBData(uint32_t bitrate_bps,
                           const std::vector<uint32_t>& ssrcs) = 0;
  // Stop sending remb on next and following sender/receiver reports.
