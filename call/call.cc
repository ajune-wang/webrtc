...
class Call : public webrtc::Call,
 ...
 private:
  ...
  Call::Config config_;
  FecControllerFactoryInterface* fec_controller_factory_;
...
Call* Call::Create(const Call::Config& config) {
  return new internal::Call(config, config.fec_controller_factory,
...
Call::Call(const Call::Config& config,
    ...
    : clock_(Clock::GetRealTimeClock()),
      ...
      config_(config),
      fec_controller_factory_(fec_controller_factory),
...
webrtc::VideoSendStream* Call::CreateVideoSendStream(
    ...
    VideoEncoderConfig encoder_config,
    std::unique_ptr<FecControllerFactoryInterface> fec_controller_factory) {
  fec_controller_factory_ = fec_controller_factory.get();
