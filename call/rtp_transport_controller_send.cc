...
// Check if route has changed (enough for us to care).
bool RouteHasChanged(const rtc::NetworkRoute& old_route,
...
void RtpTransportControllerSend::OnNetworkRouteChanged(
  ...
  if (RouteHasChanged(old_route, network_route)) {
    ...
    task_queue_.PostTask([this, msg, network_route] {
      ...
      if (reset_feedback_on_route_change_) {
        // TODO(jonaso): Should transport_feedback_adapter have a real "route"
