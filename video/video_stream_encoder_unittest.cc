 ...
 public:
  ...
  class TestEncoder : public test::FakeEncoder {
   public:
    ...
    void SetApplyAlignmentToSimulcastLayers(bool b) {
      MutexLock lock(&local_mutex_);
      apply_alignment_to_simulcast_layers_ = b;
    }
   ...
   private:
    ...
    bool apply_alignment_to_simulcast_layers_ RTC_GUARDED_BY(local_mutex_) =
        false;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ResolutionAlignmentTest,
    ::testing::Combine(
        ::testing::Values(1, 2, 3, 4, 5, 6, 7, 8, 16),  // requested_alignment_
        ::testing::Values(std::vector<double>{-1.0},    // scale_factors_
                          ...
                          std::vector<double>{4.9, 1.7, 1.0},
                          std::vector<double>{10.0, 6.0, 3.0},
...
TEST_P(ResolutionAlignmentTest, SinkWantsAlignmentApplied) {
  ...
  fake_encoder_.SetApplyAlignmentToSimulcastLayers(true);
