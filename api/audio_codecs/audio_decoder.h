...
class AudioDecoder {
 public:
  ...
  // for more if fewer samples than indicated by needed_samples_per_channel were
  // produced.
  // If the implementation provides concealment samples, it is also responsible
  // for "stitching" it together the decoded audio on either side of the
  // concealment.
  ...
  virtual void GeneratePlc(size_t needed_samples_per_channel,
