...
public class PeerConnection {
  ...
  @NativeMethods
  interface Natives {
    long getNativePeerConnection(long nativePeerConnectionObserver);
    SessionDescription getLocalDescription(long nativePeerConnectionObserver);
    SessionDescription getRemoteDescription(long nativePeerConnectionObserver);
    RtcCertificatePem getCertificate(long nativePeerConnectionObserver);
    DataChannel createDataChannel(
        long nativePeerConnectionObserver, String label, DataChannel.Init init);
    void createOffer(
        long nativePeerConnectionObserver, SdpObserver observer, MediaConstraints constraints);
    void createAnswer(
        long nativePeerConnectionObserver, SdpObserver observer, MediaConstraints constraints);
    void setLocalDescriptionAutomatically(long nativePeerConnectionObserver, SdpObserver observer);
    void setLocalDescription(
        long nativePeerConnectionObserver, SdpObserver observer, SessionDescription sdp);
    void setRemoteDescription(
        long nativePeerConnectionObserver, SdpObserver observer, SessionDescription sdp);
    void restartIce(long nativePeerConnectionObserver);
    void setAudioPlayout(long nativePeerConnectionObserver, boolean playout);
    void setAudioRecording(long nativePeerConnectionObserver, boolean recording);
    boolean setBitrate(
        long nativePeerConnectionObserver, Integer min, Integer current, Integer max);
    SignalingState signalingState(long nativePeerConnectionObserver);
    IceConnectionState iceConnectionState(long nativePeerConnectionObserver);
    PeerConnectionState connectionState(long nativePeerConnectionObserver);
    IceGatheringState iceGatheringState(long nativePeerConnectionObserver);
    void close(long nativePeerConnectionObserver);
    long createPeerConnectionObserver(Observer observer);
    void freeOwnedPeerConnection(long ownedPeerConnection);
    boolean setConfiguration(long nativePeerConnectionObserver, RTCConfiguration config);
    boolean addIceCandidate(long nativePeerConnectionObserver, String sdpMid, int sdpMLineIndex,
        String iceCandidateSdp);
    void addIceCandidateWithObserver(long nativePeerConnectionObserver, String sdpMid,
        int sdpMLineIndex, String iceCandidateSdp, AddIceObserver observer);
    boolean removeIceCandidates(long nativePeerConnectionObserver, final IceCandidate[] candidates);
    boolean addLocalStream(long nativePeerConnectionObserver, long stream);
    void removeLocalStream(long nativePeerConnectionObserver, long stream);
    boolean oldGetStats(
        long nativePeerConnectionObserver, StatsObserver observer, long nativeTrack);
    void newGetStats(long nativePeerConnectionObserver, RTCStatsCollectorCallback callback);
    void newGetStatsSender(
        long nativePeerConnectionObserver, long sender, RTCStatsCollectorCallback callback);
    void newGetStatsReceiver(
        long nativePeerConnectionObserver, long receiver, RTCStatsCollectorCallback callback);
    RtpSender createSender(long nativePeerConnectionObserver, String kind, String stream_id);
    List<RtpSender> getSenders(long nativePeerConnectionObserver);
    List<RtpReceiver> getReceivers(long nativePeerConnectionObserver);
    List<RtpTransceiver> getTransceivers() long nativePeerConnectionObserver;
    RtpSender addTrack(long nativePeerConnectionObserver, long track, List<String> streamIds);
    boolean removeTrack(long nativePeerConnectionObserver, long sender);
    RtpTransceiver addTransceiverWithTrack(
        long nativePeerConnectionObserver, long track, RtpTransceiver.RtpTransceiverInit init);
    RtpTransceiver addTransceiverOfType(long nativePeerConnectionObserver,
        MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit init);
    boolean startRtcEventLog(
        long nativePeerConnectionObserver, int file_descriptor, int max_size_bytes);
    void stopRtcEventLog(long nativePeerConnectionObserver);
  }
}
