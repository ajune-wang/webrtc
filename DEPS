...
vars = {
  ...
  'chromium_revision': '759bef183623c913a786482868446481fdd7cc89',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'b2250db35d0a87adfdfbd769958368aadf5220bf',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '3e62726c0c23a7268d10234b929e1911fdf92833',
  'src/tools/gyp':
