...
TEST_F(PeerConnectionMediaTestPlanB, EmptyRemoteOfferRemovesRecvStreams) {
  ...
  caller->pc()->RemoveTrack(caller_audio_track.get());
  caller->pc()->RemoveTrack(caller_video_track.get());
...
TEST_F(PeerConnectionMediaTestPlanB, EmptyLocalAnswerRemovesSendStreams) {
  ...
  callee->pc()->RemoveTrack(callee_audio_track.get());
  callee->pc()->RemoveTrack(callee_video_track.get());
