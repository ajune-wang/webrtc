...
class AAudioPlayer final : public AAudioObserverInterface,
 ...
 private:
  ...
  // Counts number of ongoing restart attempts. Should nevere be larger than
  // one to avoid issues with more than one active restart attempt.
  mutable volatile int restart_count_ = 0;
};
