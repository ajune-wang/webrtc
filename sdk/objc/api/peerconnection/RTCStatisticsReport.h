...
/** A statistics report. Encapsulates a number of RTCStatistics objectas. */
...
/** A part of a report covering a certain */
@interface RTCStatistics : NSObject

/** Id of this subreport, e.g. "RTCMediaStreamTrack_receiver_2". */
