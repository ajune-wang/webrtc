...
TEST_F(WebRtcSdpTest, SerializeSimulcast_ComplexSerialization) {
  ...
  send_rids.push_back(RidDescription("1", RidDirection::kRidDirectionSend));
  send_rids.push_back(RidDescription("2", RidDirection::kRidDirectionSend));
  send_rids.push_back(RidDescription("3", RidDirection::kRidDirectionSend));
  send_rids.push_back(RidDescription("4", RidDirection::kRidDirectionSend));
  send_stream.set_rids(send_rids);
  StreamParams recv_stream;
  std::vector<RidDescription> recv_rids;
  recv_rids.push_back(RidDescription("6", RidDirection::kRidDirectionReceive));
  recv_rids.push_back(RidDescription("7", RidDirection::kRidDirectionReceive));
  recv_rids.push_back(RidDescription("8", RidDirection::kRidDirectionReceive));
  recv_rids.push_back(RidDescription("9", RidDirection::kRidDirectionReceive));
  recv_rids.push_back(RidDescription("10", RidDirection::kRidDirectionReceive));
  recv_rids.push_back(RidDescription("11", RidDirection::kRidDirectionReceive));
