  ...
  ApplyAdaptationStep(const Step& step,
    ...
    switch (step.type) {
      case StepType::kIncreaseResolution:
        ...
        IncreaseResolutionTo(step.target, &restrictions, &counters);
        break;
      case StepType::kDecreaseResolution:
        RTC_DCHECK(step.target);
        DecreaseResolutionTo(step.target, &restrictions, &counters);
        break;
      case StepType::kIncreaseFrameRate:
        RTC_DCHECK(step.target);
        IncreaseFrameRateTo(step.target, &restrictions, &counters);
      ...
      case StepType::kDecreaseFrameRate:
        RTC_DCHECK(step.target);
        DecreaseFrameRateTo(step.target, &restrictions, &counters);
        break;
      default:
        RTC_NOTREACHED();
    }
