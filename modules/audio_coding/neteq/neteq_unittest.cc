...
TEST_F(NetEqDecodingTest, MAYBE_TestOpusBitExactness) {
  ...
  const std::string checksum = "554ad4133934e3920f97575579a46f674683d77c";
  const std::string output_checksum = PlatformChecksum(
      checksum, "459c356a0ef245ddff381f7d82d205d426ef2002",
      "625055e5eb0e6de2c9d170b4494eadc5afab08c8", checksum, checksum);
...
TEST_F(NetEqDecodingTest, MAYBE_TestOpusDtxBitExactness) {
  ...
  const std::string checksum = "df5d1d3019bf3764829b84f4fb315721f4adde29";
  const std::string output_checksum = PlatformChecksum(
      checksum, "551df04e8f45cd99eff28503edf0cf92974898ac",
      "709a3f0f380393d3a67bace10e2265b90a6ebbeb", checksum, checksum);
