...
vars = {
  ...
  'chromium_revision': '886319301673b10fe95f65d6d60148445ba051e4',
...
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + '86a36638e19f7649e43e044763a536331fbd2255',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '465254ff7b54419ac9fed259c2361a48ba0178b6',
  'src/tools/gyp':
