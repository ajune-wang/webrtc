...
// Array of structs needed to map {KeyExchangeProtocolType, cricket::MediaType}
// to KeyExchangeProtocolMedia without using std::map in order to avoid
// -Wglobal-constructors and -Wexit-time-destructors.
static const struct {
