...
const uint32_t KFreezeDetectionMinFreezeDurationMs =
    (VideoQualityObserver::kAvgInterframeDelaysWindowSizeFrames *
         VideoQualityObserver::kMinIncreaseForFreezeMs +
     (VideoQualityObserver::kAvgInterframeDelaysWindowSizeFrames - 1) *
