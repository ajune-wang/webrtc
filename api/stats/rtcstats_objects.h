...
class RTC_EXPORT RTCIceCandidatePairStats final : public RTCStats {
 public:
  ...
  // FIXME: Our implementation of `writable` may not be spec compliant?
...
// FIXME: Remove this obsolete metric.
...
class RTC_EXPORT RTCMediaStreamTrackStats final : public RTCStats {
 public:
  ...
  // FIXME: This is obsolete and hardcoded to the value false. It serves no
  // purpose, so it should be safe to remove.
  ...
  // FIXME: Should also be implemented for video.
...
class RTC_EXPORT RTCOutboundRTPStreamStats final : public RTCRTPStreamStats {
 public:
  ...
  RTCStatsMember<std::string> content_type;
  // Only implemented for video.
  // FIXME: Implement for audio as well.
