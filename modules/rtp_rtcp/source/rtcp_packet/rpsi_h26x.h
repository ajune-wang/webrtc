 ...
 */
#ifndef MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_RPSI_H26X_H_
#define MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_RPSI_H26X_H_
...
// Reference Picuture Selection Indication(RPSI)
// for H.26x encodings. (Refer to RFC 7798 for more details).
class H26xRpsi : public Psfb {
 public:
  static constexpr uint8_t kFeedbackMessageType = 3;

  H26xRpsi();
  H26xRpsi(const H26xRpsi& pli);
  ~H26xRpsi() override;
...
#endif  // MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_RPSI_H26X_H_
