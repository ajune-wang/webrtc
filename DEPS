...
vars = {
  ...
  'chromium_revision': 'd624cabd412bd1a745583fd8685f882af50c1c58',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@b0189aa26f78927e046852322db64b8d07d4747f',
    ...
    'packages': [
      {
          ...
          'version': 'cRWtfCO6PHoqBudVeMXaaA9u3M194hNiBfZpJS5CxRQC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
