...
#ifndef TEST_DECODER_PROXY_FACTORY_H_
#define TEST_DECODER_PROXY_FACTORY_H_
...
class DecoderProxyFactory final : public VideoDecoderFactory {
 public:
  explicit DecoderProxyFactory(VideoDecoder* decoder) : decoder_(decoder) {}
...
#endif  // TEST_DECODER_PROXY_FACTORY_H_
