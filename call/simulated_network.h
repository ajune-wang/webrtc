...
namespace webrtc {
// CoDel Active queue management emulation. Loosely based on CoDel pseudocode
// from ACMQueue. CoDel keeps queuing delays low by dropping packets when delay
// is high. For each packet ready for dequeue, call DropDequeuePacket with the
