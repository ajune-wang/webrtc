...
vars = {
  ...
  'chromium_revision': 'b4d80cec121a135e16482ec35d01f9f14f3b98d6',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '7582091a2a960337a95a1d41e21753b13e2fd735',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'd76746ed1218a3a36910bf5c1598cdf6db7facd9',
  'src/tools/gyp':
