...
#ifndef WEBRTC_MODULES_CONGESTION_CONTROLLER_RTP_SEND_TIME_HISTORY_H_
#define WEBRTC_MODULES_CONGESTION_CONTROLLER_RTP_SEND_TIME_HISTORY_H_
...
#endif  // WEBRTC_MODULES_CONGESTION_CONTROLLER_RTP_SEND_TIME_HISTORY_H_
