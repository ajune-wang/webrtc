...
bool IsSameH264PacketizationMode(const SdpVideoFormat::Parameters& left,
...
bool IsSameCodecSpecific(const SdpVideoFormat& format1,
  ...
  switch (codec_type) {
    case kVideoCodecH264:
      return H264::IsSameH264Profile(format1.parameters, format2.parameters) &&
             IsSameH264PacketizationMode(format1.parameters,
                                         format2.parameters);
    case kVideoCodecVP9:
      return IsSameVP9Profile(format1.parameters, format2.parameters);
    default:
      return true;
  }
}
...
bool SdpVideoFormat::IsCodecInList(
    const std::vector<webrtc::SdpVideoFormat>& formats) const {
