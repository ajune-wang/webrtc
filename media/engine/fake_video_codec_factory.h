...
// Provides a fake video encoder instances that produces frames large enough for
// the given bitrate constraints. These frames are filled with zeros.
...
// Provides a fake video decoder instances that ignores the given bistream and
// produces frames with alternating colors.
