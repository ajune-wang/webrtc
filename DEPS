...
vars = {
  ...
  'chromium_revision': 'ba384081c75d1fe07ddcd2be91eb66ade035aeaf',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '0ba6056404ba793e0f797124b2de66b6c17e418f',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '0ec2dc8ba22e512fade678cb4ccd5ca4b81c9144',
  'src/tools/gyp':
