...
void DtlsSrtpTransport::SetDtlsTransports(
  ...
  MaybeSetupDtlsSrtpAndUpdateWritableState();
}
...
void DtlsSrtpTransport::MaybeSetupDtlsSrtpAndUpdateWritableState() {
  if (IsDtlsWritable()) {
    MaybeSetupDtlsSrtp();
  }
...
void DtlsSrtpTransport::MaybeUpdateWritableState() {
  bool writable = SrtpTransport::IsWritable(/*rtcp=*/true) &&
                  SrtpTransport::IsWritable(/*rtcp=*/false);
