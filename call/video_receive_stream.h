...
class VideoReceiveStreamInterface : public MediaReceiveStreamInterface {
 public:
  ...
  struct Stats {
    ...
    // Corruption score, indicating the probability of corruption. It's value is
    ...
    absl::optional<double> corruption_score;
    absl::optional<double> corruption_score_squared;
    // Number of frames the `corruption_score` was calculated on. This is
    // usually not the same as `frames_decoded`.
    uint32_t frames_corruption_score_calculated = 0;
