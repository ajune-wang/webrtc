...
// will be determined by maximizing PSNR.
...
// video will have the same number of frames as the size of |indicies|, and
// frame nr i in the returned video will point to frame nr indicies[i] in the
// original video.
