...
class RTC_EXPORT EncodedImage {
 public:
  ...
  absl::optional<int> SimulcastIndex() const {
    ...
    // the spatial index if the simulcast index was not set.
  ...
  // TODO(hbos): Delete this, don't deprecate the old one...
  absl::optional<int> SpatialIndex_() const { return spatial_index_; }
