...
struct OverusePredictorConfig {
  FieldTrialFlag enabled_{"Enabled"};
  FieldTrialParameter<double> capacity_dev_ratio_threshold_{"dev_thr", 0.2};
  FieldTrialParameter<double> capacity_deviation_{"cap_dev", -1};
  FieldTrialParameter<TimeDelta> delay_threshold_{"del_thr",
                                                  TimeDelta::ms(100)};
...
class OverusePredictor {
 public:
  ...
  bool PredictOveruse(absl::optional<NetworkStateEstimate> estimate);
