...
class ControlledAlarmClock {
 public:
  ...
  // An alarm clock only supports one deadline.  Calls to |ScheduleAt| with an
  // earlier deadline will reset the alarm to fire earlier.  Calls to
  // |ScheduleAt| with a later deadline are ignored.
  virtual void ScheduleAt(Timestamp deadline) = 0;
