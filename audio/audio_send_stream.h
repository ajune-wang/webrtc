...
class AudioSendStream final : public webrtc::AudioSendStream,
 ...
 public:
  ...
  void Start() override;
  void Stop() override;
  void OnAudioData(std::unique_ptr<AudioFrame> audio_frame) override;
 ...
 private:
  ...
  void SetEncoderProperties(int sample_rate_hz, size_t num_channels);
  ...
  // XXX TODO: Add locking, if necessary.
  bool sending_ = false;
