...
// Performs channel to mono for the purpose of providing a decent mono input for
// the delay estimation. This is achieved by analyzing all incoming channels and
// produce one single channel output.
