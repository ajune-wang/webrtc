  ...
  test_queue_.SendTask([this] {
    ...
    static_cast<VideoStreamEncoderInterface::EncoderSink*>(vss_impl.get())
        ->OnEncoderConfigurationChanged(
            ...
            VideoCodecMode::kRealtimeVideo, min_transmit_bitrate_bps);
    vss_impl->Stop();
  });
}
  ...
  test_queue_.SendTask([this] {
    ...
    static_cast<VideoStreamEncoderInterface::EncoderSink*>(vss_impl.get())
        ->OnEncoderConfigurationChanged(
            ...
            VideoCodecMode::kScreensharing, min_transmit_bitrate_bps);
    vss_impl->Stop();
  });
}
...
TEST_F(VideoSendStreamImplTest,
  ...
  test_queue_.SendTask([this] {
    ...
    static_cast<VideoStreamEncoderInterface::EncoderSink*>(vss_impl.get())
        ->OnEncoderConfigurationChanged(
            std::vector<VideoStream>{low_stream, high_stream},
            VideoCodecMode::kRealtimeVideo, /*min_transmit_bitrate_bps=*/0);
    vss_impl->Stop();
  });
}
