...
#ifndef WEBRTC_RTC_BASE_TIME_TIMESTAMP_EXTRAPOLATOR_H_
#define WEBRTC_RTC_BASE_TIME_TIMESTAMP_EXTRAPOLATOR_H_
...
#endif  // WEBRTC_RTC_BASE_TIME_TIMESTAMP_EXTRAPOLATOR_H_
