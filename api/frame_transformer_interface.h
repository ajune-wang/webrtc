...
class FrameTransformerInterface : public rtc::RefCountInterface {
 public:
  ...
  // |addition_data| holds data that is needed in the frame transformation
  ...
  // holds the serialized generic frame descriptor extension, needed in the
