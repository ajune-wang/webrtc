...
RTC_OBJC_EXPORT
// Camera capture that implements RTC_OBJC_TYPE(RTCVideoCapturer). Delivers frames to a
// RTC_OBJC_TYPE(RTCVideoCapturerDelegate) (usually RTC_OBJC_TYPE(RTCVideoSource)).
