...
#ifndef WEBRTC_SDK_OBJC_NATIVE_SRC_AUDIO_AUDIO_DEVICE_IOS_H_
#define WEBRTC_SDK_OBJC_NATIVE_SRC_AUDIO_AUDIO_DEVICE_IOS_H_
...
#endif  // WEBRTC_SDK_OBJC_NATIVE_SRC_AUDIO_AUDIO_DEVICE_IOS_H_
