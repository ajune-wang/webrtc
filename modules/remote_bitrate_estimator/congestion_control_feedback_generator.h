...
// after receiving a complete frame. If no packet with marker bit is received,
// feedback can be delayed up to 25ms after the first packet since the last sent
// feedback. On good networks, this means that a sender may receive feedback
// for every sent frame.
