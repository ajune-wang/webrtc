...
void StreamStatisticianImpl::UpdateCounters(const RtpPacketReceived& packet) {
  ...
  receive_counters_.last_packet_received_timestamp = now;
...
RtpReceiveStats StreamStatisticianImpl::GetStats() const {
  ...
  if (receive_counters_.last_packet_received_timestamp.IsFinite()) {
    stats.last_packet_received_timestamp_ms =
        receive_counters_.last_packet_received_timestamp.ms() +
