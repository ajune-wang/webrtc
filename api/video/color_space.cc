...
bool ColorSpace::set_chroma_siting_horizontal_from_uint8(uint8_t enum_value) {
  return set_chroma_siting_from_uint8(enum_value, &chroma_siting_horizontal_);
}

bool ColorSpace::set_chroma_siting_vertical_from_uint8(uint8_t enum_value) {
  return set_chroma_siting_from_uint8(enum_value, &chroma_siting_vertical_);
}

bool ColorSpace::set_chroma_siting_from_uint8(uint8_t enum_value,
