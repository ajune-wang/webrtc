  ...
  class MockVideoMediaSendChannel : public cricket::FakeVideoMediaSendChannel {
   public:
    MockVideoMediaSendChannel(
        ...
        : FakeVideoMediaSendChannel(engine, options, network_thread) {}
    MOCK_METHOD(void,
  ...
  class MockVideoMediaReceiveChannel
   ...
   public:
    MockVideoMediaReceiveChannel(
        ...
        const cricket::VideoOptions& options,
        TaskQueueBase* network_thread = rtc::Thread::Current())
        : FakeVideoMediaReceiveChannel(engine, options, network_thread) {}
    MOCK_METHOD(void,
...
TEST_F(VideoRtpReceiverTest,
  ...
  MockVideoMediaReceiveChannel channel2(nullptr, cricket::VideoOptions());
  ...
  Source()->GenerateKeyFrame();
  MockVideoMediaReceiveChannel channel3(nullptr, cricket::VideoOptions());
  ...
  StrictMock<MockVideoMediaReceiveChannel> channel4(nullptr,
...
TEST_F(VideoRtpReceiverTest, DisablesEnablesEncodedOutputOnChannelSwitch) {
  ...
  Source()->RemoveEncodedSink(&sink);
  StrictMock<MockVideoMediaReceiveChannel> channel3(nullptr,
                                                    cricket::VideoOptions());
  SetMediaChannel(&channel3);
