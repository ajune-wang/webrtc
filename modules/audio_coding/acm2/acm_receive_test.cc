...
bool RemapPltypeAndUseThisCodec(const char* plname,
  ...
  if (rtc::StrCaseCmp(plname, "PCMU") == 0 && plfreq == 8000) {
    ...
    *pltype = 104;
  } else if (rtc::StrCaseCmp(plname, "telephone-event") == 0 && plfreq == 8000) {
    *pltype = 106;
  } else if (rtc::StrCaseCmp(plname, "telephone-event") == 0 && plfreq == 16000) {
    *pltype = 114;
  } else if (rtc::StrCaseCmp(plname, "telephone-event") == 0 && plfreq == 32000) {
    *pltype = 115;
  } else if (rtc::StrCaseCmp(plname, "telephone-event") == 0 && plfreq == 48000) {
    *pltype = 116;
