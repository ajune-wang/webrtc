...
(Stats)
  ...
  auto collector = rtc::make_ref_counted<webrtc::StatsCollectorCallbackAdapter>(completionHandler);
...
- (void)statsForTrack:(RTC_OBJC_TYPE(RTCMediaStreamTrack) *)mediaStreamTrack
  ...
  auto observer = rtc::make_ref_counted<webrtc::StatsObserverAdapter>(completionHandler);
