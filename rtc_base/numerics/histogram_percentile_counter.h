...
#ifndef WEBRTC_RTC_BASE_NUMERICS_HISTOGRAM_PERCENTILE_COUNTER_H_
#define WEBRTC_RTC_BASE_NUMERICS_HISTOGRAM_PERCENTILE_COUNTER_H_
...
#endif  // WEBRTC_RTC_BASE_NUMERICS_HISTOGRAM_PERCENTILE_COUNTER_H_
