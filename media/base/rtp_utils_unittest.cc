...
// RTP packet with one-byte extension header of length 4 bytes.
...
// RTP packet with two byte extension header of length 4 bytes.
// Extension id = 3 and length = 3
...
// and in message |kRtpMsgWithOneByteAbsSendTimeExtension|.
