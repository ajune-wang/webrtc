...
EncodedImage JavaToNativeEncodedImage(JNIEnv* env,
                                      ...
                                      // The nanosecond timestamp is needed for
                                      // frame matching in VideoEncoderWrapper,
                                      // but there's no place for it in the C++
                                      // EncodedImage.
  ...
  *capture_time_ns = Java_EncodedImage_getCaptureTimeNs(env, j_encoded_image);
  return frame;
}
