...
TEST(SourceTrackerTest, OnFrameDeliveredRecordsSources) {
  ...
  constexpr RtpSource::Extensions extensions = {kAudioLevel, kAbsoluteCaptureTime};
...
TEST(SourceTrackerTest, OnFrameDeliveredUpdatesSources) {
  ...
  constexpr RtpSource::Extensions extensions0 = {kAudioLevel0, kAbsoluteCaptureTime0};
  constexpr RtpSource::Extensions extensions1 = {kAudioLevel1, kAbsoluteCaptureTime1};
