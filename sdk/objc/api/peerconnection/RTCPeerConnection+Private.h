...
/**
 * These objects are created by RTC_OBJC_TYPE(RTCPeerConnectionFactory) to wrap an
 * id<RTC_OBJC_TYPE(RTCPeerConnectionDelegate)> and call methods on that interface.
 */
...
/** The factory used to create this RTC_OBJC_TYPE(RTCPeerConnection) */
@property(nonatomic, readonly) RTC_OBJC_TYPE(RTCPeerConnectionFactory) *factory;
...
/** Initialize an RTC_OBJC_TYPE(RTCPeerConnection) with a configuration, constraints,
