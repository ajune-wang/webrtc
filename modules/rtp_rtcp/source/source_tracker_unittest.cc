...
class SourceTrackerRandomTest
 ...
 protected:
  SourceTrackerRandomTest()
      : ssrcs_count_(::testing::get<0>(GetParam())),
        csrcs_count_(::testing::get<1>(GetParam())),
        generator_(42) {}
...
TEST(SourceTrackerTest, OnFrameDeliveredUpdatesSources) {
  constexpr uint32_t kSsrc = 10;
  constexpr uint32_t kCsrcs0[] = {20, 21};
  constexpr uint32_t kCsrcs1[] = {22, 20};
  ...
  tracker.OnFrameDelivered(RtpPacketInfos(
      {RtpPacketInfo(kSsrc, {kCsrcs0[0], kCsrcs0[1]}, kSequenceNumber0,
  ...
  tracker.OnFrameDelivered(RtpPacketInfos(
      {RtpPacketInfo(kSsrc, {kCsrcs1[0], kCsrcs1[1]}, kSequenceNumber1,
  ...
  EXPECT_THAT(
      ...
      ElementsAre(RtpSource(timestamp_ms_1, kSsrc, RtpSourceType::SSRC,
                  ...
                  RtpSource(timestamp_ms_1, kCsrcs1[1], RtpSourceType::CSRC,
                            kAudioLevel1, kRtpTimestamp1),
                  RtpSource(timestamp_ms_1, kCsrcs1[0], RtpSourceType::CSRC,
                            kAudioLevel1, kRtpTimestamp1),
                  RtpSource(timestamp_ms_0, kCsrcs0[1], RtpSourceType::CSRC,
