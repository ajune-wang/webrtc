...
vars = {
  ...
  'chromium_revision': '957415c68e0ce6c5078dcd39dee17bf51c09532d',
...
deps = {
  ...
  'src/build':
    'https://chromium.googlesource.com/chromium/src/build@cddf832501f695059066e0b4046b79da3e8147cb',
  'src/buildtools':
    ...
    'packages': [
      {
          ...
          'version': 'LklsXbtKO7BsjK1X0YeJygpBCNUX9YLqsmIvURMrXNoC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
