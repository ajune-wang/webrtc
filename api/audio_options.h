...
struct AudioOptions {
  ...
  std::string ToString() const {
    return webrtc::AbslStrCat(
        ...
        // The adaptor config is a serialized proto buffer and therefore not
        // human readable. So we comment out the following line.
        // ToStringIfSet("audio_network_adaptor_config",
