...
namespace webrtc {
  ...
  MultiplexVideoFrameBuffer::MultiplexVideoFrameBuffer(const rtc::scoped_refptr<VideoFrameBuffer>& video_frame_buffer,
  ...
  rtc::scoped_refptr<VideoFrameBuffer> MultiplexVideoFrameBuffer::GetVideoFrameBuffer() const {
