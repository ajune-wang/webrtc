          ...
          new SurfaceTextureHelper.OnTextureFrameAvailableListener() {
            ...
            public void onTextureFrameAvailable(
              ...
              if (videoFrameEmitTrialEnabled) {
                VideoFrame.Buffer buffer = surfaceTextureHelper.createTextureBuffer(mask_texture[0],
                    VideoFrame.TextureBuffer.Type.RGB, captureFormat.width, captureFormat.height,
