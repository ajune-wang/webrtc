...
class RTC_EXPORT XdgDesktopPortalBase : public rtc::RefCountedBase {
 public:
  ...
  void CloseConnection(int32_t id = 0);
  void SetConnectionStreamingOnWeb(int32_t id = 0);

  bool IsConnectionInitialized(int32_t id = 0) const;
  bool IsConnectionStreamingOnWeb(int32_t id = 0) const;

  PipeWireBase* GetPipeWireBase(int32_t id = 0) const;
  ...
  int32_t CurrentConnectionId() const;
  void SetCurrentConnectionId(int32_t id = 0);

  ConnectionData* GetConnectionData(int32_t id = 0) const;
...
class RTC_EXPORT ConnectionData {
 public:
