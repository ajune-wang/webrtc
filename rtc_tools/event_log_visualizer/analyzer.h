...
class EventLogAnalyzer {
 public:
  // The EventLogAnalyzer keeps a reference to the ParsedRtcEventLog2 for the
  // duration of its lifetime. The ParsedRtcEventLog2 must not be destroyed or
  // modified while the EventLogAnalyzer is being used.
  explicit EventLogAnalyzer(const ParsedRtcEventLog2& log);
 ...
 private:
  ...
  const ParsedRtcEventLog2& parsed_log_;
