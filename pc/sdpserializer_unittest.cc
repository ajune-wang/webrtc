...
void ExpectEqual(const RidDescription& expected, const RidDescription& actual) {
  ...
  ExpectEqual(expected.formats, actual.formats);
...
TEST_F(RidDescriptionSdpSerializerTest, Serialize_FormatList) {
  RidDescription rid_description;
  rid_description.rid = "3";
  rid_description.direction = cricket::kRidDirectionSend;
  rid_description.formats.push_back(102);
  rid_description.formats.push_back(101);
...
TEST_F(RidDescriptionSdpSerializerTest, Serialize_FormatListSingleFormat) {
  RidDescription rid_description;
  rid_description.rid = "4";
  rid_description.direction = cricket::kRidDirectionReceive;
  rid_description.formats.push_back(100);
...
TEST_F(RidDescriptionSdpSerializerTest, Serialize_FormatAndAttributeList) {
  RidDescription rid_description;
  rid_description.rid = "6";
  rid_description.direction = cricket::kRidDirectionSend;
  rid_description.formats.push_back(103);
  rid_description.formats.push_back(104);
...
// The following string "1 send receive" looks malformed because it specifies
