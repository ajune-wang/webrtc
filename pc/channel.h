...
// BaseChannelInterface contains methods common to voice, video and data
// channels.
// TODO(amithi): Push more methods from BaseChannel to the interface as needed.
class BaseChannelInterface {
 public:
  // Gets the media type.
  ...
  // Gets a flag that indicates if this channel is enabled.
  ...
  virtual sigslot::signal1<BaseChannelInterface*>&
  SignalFirstPacketReceived() = 0;
 ...
 protected:
  virtual ~BaseChannelInterface() = default;
};
...
class BaseChannel : public BaseChannelInterface,
 ...
 public:
  ...
  // Used for latency measurements.
  sigslot::signal1<BaseChannelInterface*>& SignalFirstPacketReceived()
      override {
 ...
 private:
  ...
  sigslot::signal1<BaseChannelInterface*> signalFirstPacketReceived_;
