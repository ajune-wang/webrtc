...
class RTC_EXPORT RtpTransceiverInterface : public rtc::RefCountInterface {
 public:
  ...
  // TODO(armax): fill in the description
  ...
  // https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-direction
  virtual RTCError SetDirection(RtpTransceiverDirection new_direction) = 0;
  ...
  // TODO(armax): describe what this function does.
  // https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-stop
  virtual RTCError Stop() = 0;
  ...
  // TODO(armax): describe why this is here.
  virtual void SetPeerConnectionClosed() = 0;
