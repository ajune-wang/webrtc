...
WebRtcVideoChannel::WebRtcVideoReceiveStream::GetVideoReceiverInfo(
  ...
  if (use_standard_bytes_stats_) {
    info.bytes_rcvd = stats.rtp_stats.packet_counter.transmitted.payload_bytes;
  } else {
    info.bytes_rcvd = stats.rtp_stats.packet_counter.transmitted.TotalBytes();
  }
  info.packets_rcvd = stats.rtp_stats.packet_counter.transmitted.packets;
  ...
  info.last_packet_received_timestamp_ms =
      stats.rtp_stats.packet_counter.last_packet_received_timestamp_ms;
