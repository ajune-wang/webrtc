...
public class YuvHelper {
  ...
  public static boolean i420Scale(int srcWidth, int srcHeight, ByteBuffer srcY, int srcStrideY,
      ...
      int dstSliceHeightU, int dstStrideV, int dstSliceHeightV, FilterMode filterMode) {
    final int chromaWidth = (dstWidth + 1) / 2;
    final int chromaHeight = (dstHeight + 1) / 2;
    ...
    return nativeI420Scale(srcY, srcStrideY, srcU, srcStrideU, srcV, srcStrideV, srcWidth,
        srcHeight, dstYBuffer, dstStrideY, dstUBuffer, dstStrideU, dstVBuffer, dstStrideV, dstWidth,
        dstHeight, filterMode.value);
  }
