...
// static
int VideoStreamAdaptor::GetLowerFrameRateThan(int fps) {
  return VideoSourceRestrictor::GetLowerFrameRateThan(fps);
}

// static
int VideoStreamAdaptor::GetHigherFrameRateThan(int fps) {
  return VideoSourceRestrictor::GetHigherFrameRateThan(fps);
}

// static
int VideoStreamAdaptor::GetLowerResolutionThan(int pixel_count) {
  return VideoSourceRestrictor::GetLowerResolutionThan(pixel_count);
}

// static
int VideoStreamAdaptor::GetHigherResolutionThan(int pixel_count) {
...
VideoSourceRestrictions VideoStreamAdaptor::source_restrictions() const {
...
bool VideoStreamAdaptor::CanDecreaseResolutionTo(int target_pixels,
                                                 int min_pixels_per_frame) {
  return source_restrictor_->CanDecreaseResolutionTo(target_pixels,
                                                     min_pixels_per_frame);
}

void VideoStreamAdaptor::DecreaseResolutionTo(int target_pixels,
                                              int min_pixels_per_frame) {
  source_restrictor_->DecreaseResolutionTo(target_pixels, min_pixels_per_frame);
}

bool VideoStreamAdaptor::CanIncreaseResolutionTo(int target_pixels) {
  return source_restrictor_->CanIncreaseResolutionTo(target_pixels);
}

void VideoStreamAdaptor::IncreaseResolutionTo(int target_pixels) {
  source_restrictor_->IncreaseResolutionTo(target_pixels);
}

bool VideoStreamAdaptor::CanDecreaseFrameRateTo(int max_frame_rate) {
  return source_restrictor_->CanDecreaseFrameRateTo(max_frame_rate);
}

void VideoStreamAdaptor::DecreaseFrameRateTo(int max_frame_rate) {
  source_restrictor_->DecreaseFrameRateTo(max_frame_rate);
}

bool VideoStreamAdaptor::CanIncreaseFrameRateTo(int max_frame_rate) {
  return source_restrictor_->CanIncreaseFrameRateTo(max_frame_rate);
}

void VideoStreamAdaptor::IncreaseFrameRateTo(int max_frame_rate) {
