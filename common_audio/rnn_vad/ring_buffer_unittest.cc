...
TEST(RnnVadTest, CheckRingBufferArrayViews) {
  constexpr size_t s = 3;
  constexpr size_t n = 4;
  RingBuffer<int, 3, n> ring_buf;
...
TEST(RnnVadTest, CheckRingBufferUnsigned) {
...
TEST(RnnVadTest, CheckRingBufferSigned) {
...
TEST(RnnVadTest, CheckRingBufferFloating) {
