...
std::unique_ptr<ChannelManager> ChannelManager::Create(
  ...
  // Since we use a private constructor, we cannot use make_unique (and also
  // don't want to friend make_unique).
  return std::unique_ptr<ChannelManager>(new cricket::ChannelManager(
