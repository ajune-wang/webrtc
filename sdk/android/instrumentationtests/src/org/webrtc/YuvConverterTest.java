...
public class YuvConverterTest {
  ...
  /**
   * These tests are parameterized and this enum representing the different VideoFrame.Buffers is
    ...
    for (BufferType bufferType : BufferType.values()) {
      for (int widthAlignment : alignments) {
        for (int heightAlignment : alignments) {
          // TODO(bugs.webrtc.org/XXXXX): Investigate why these cases fail.
          if (widthAlignment < 8 || heightAlignment == 1) {
            continue;
          }
