...
class VoipCore : public VoipEngine,
 ...
 public:
  ...
  void GetInputVolumeInfo(ChannelId channel_id,
                          VolumeInfo& input_volume) override;
  void GetOutputVolumeInfo(ChannelId channel_id,
                           VolumeInfo& output_volume) override;
