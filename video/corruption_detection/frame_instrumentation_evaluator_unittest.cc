...
// TODO: bugs.webrtc.org/358039777 - Move the content of the file to where we
// want it. Also change test suite name.
...
TEST(CorruptionScoreTest, HaveNoCorruptionScoreWhenNoSampleValuesAreProvided) {
...
TEST(CorruptionScoreTest, HaveACorruptionScoreWhenSampleValuesAreProvided) {
...
TEST(CorruptionScoreTest, ApplyThresholdsWhenNonNegativeThresholdsAreProvided) {
  FrameInstrumentationData data = {
      .sequence_index = 0,
      .communicate_upper_bits = false,
      .std_dev = 0.0,
...
TEST(CorruptionScoreTest, ApplyStdDevWhenNonNegativeStdDevIsProvided) {
  FrameInstrumentationData data = {
      .sequence_index = 0,
      .communicate_upper_bits = false,
      .std_dev = 0.6,
...
TEST(CorruptionScoreTest, ApplySequenceIndexWhenProvided) {
  FrameInstrumentationData data = {
      .sequence_index = 1,
      .communicate_upper_bits = false,
      .std_dev = 0.6,
