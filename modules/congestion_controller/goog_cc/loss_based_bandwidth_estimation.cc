...
LossBasedControlConfig::LossBasedControlConfig()
    : enabled(field_trial::IsEnabled(kBweLossBasedControl)),
      ...
      increase_low_rtt("incr_low_rtt", TimeDelta::Milliseconds(200)),
      increase_high_rtt("incr_high_rtt", TimeDelta::Milliseconds(800)),
      decrease_factor("decr", 0.99),
      loss_window("loss_win", TimeDelta::Milliseconds(800)),
      loss_max_window("loss_max_win", TimeDelta::Milliseconds(800)),
      acknowledged_rate_max_window("ackrate_max_win",
                                   TimeDelta::Milliseconds(800)),
      increase_offset("incr_offset", DataRate::BitsPerSecond(1000)),
      loss_bandwidth_balance_increase("balance_incr",
                                      DataRate::KilobitsPerSecond(0.5)),
      loss_bandwidth_balance_decrease("balance_decr",
                                      DataRate::KilobitsPerSecond(4)),
      loss_bandwidth_balance_exponent("exponent", 0.5),
      allow_resets("resets", false),
      decrease_interval("decr_intvl", TimeDelta::Milliseconds(300)),
      loss_report_timeout("timeout", TimeDelta::Milliseconds(6000)) {
