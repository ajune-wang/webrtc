...
VideoStreamDecoderImpl::~VideoStreamDecoderImpl() {
  // By stopping the |frame_buffer_| no more tasks will be posted to the
  // |decode_queue_|. Now the |decode_queue_| can be destructed safely, and
  // after that the |decoder_|.
  rtc::Event event;
