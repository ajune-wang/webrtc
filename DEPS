...
vars = {
  ...
  'chromium_revision': 'c1d7ebd614d42d911836802022a050f80af8cad9',
...
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '5006fe83093db46b9a3d650d11ecebe36a046f93',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'bd632bd749d8010f02d424c36439b78512d384c2',
