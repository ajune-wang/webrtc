...
class AudioTrackSinkInterface {
 public:
  ...
  // Returns the number of channels that are processed by the sink. This can
  // be less the number_of_channels if down-mixing occur. A value of -1 means
  // an unknown number.
  virtual int NumProcessedChannels() const { return -1; }
