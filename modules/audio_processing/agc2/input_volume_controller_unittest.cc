...
TEST(InputVolumeControllerTest, UpdateInputVolumeWaitFramesEffective) {
  constexpr int kInputVolume = kInitialInputVolume;
  ...
  SpeechSamplesReader reader;
  reader.Feed(/*num_frames=*/99, /*gain_db=*/0, kHighSpeechProbability,
  ...
  reader.Feed(/*num_frames=*/1, /*gain_db=*/0, kHighSpeechProbability,
              /*speech_level=*/-42.0f, *controller_wait_0);
  reader.Feed(/*num_frames=*/1, /*gain_db=*/0, kHighSpeechProbability,
              /*speech_level=*/-42.0f, *controller_wait_100);
