...
DEPRECATED_SendSideCongestionController::
  ...
  VideoRateControlExperiments experiment_params =
      VideoRateControlExperiments::ParseFromKeyValueConfig(key_value_config);
  cwnd_experiment_parameter_ = experiment_params.GetCongestionWindowParameter();
  if (cwnd_experiment_parameter_ &&
      experiment_params.GetCongestionWindowPushbackParameter()) {
    congestion_window_pushback_controller_ =
        absl::make_unique<CongestionWindowPushbackController>(key_value_config);
  }
