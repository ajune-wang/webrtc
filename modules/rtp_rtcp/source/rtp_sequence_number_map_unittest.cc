...
class RtpSequenceNumberMapTest : public ::testing::Test {
 protected:
  ...
  Random random_;
  RtpSequenceNumberMap uut_;  // Unit under test.
};
...
TEST_F(RtpSequenceNumberMapTest, GetOnUnknownKeyReturnsNullOpt) {
...
TEST_P(RtpSequenceNumberMapTestWithParams, GetOnKnownKeyReturnsCorrectValue) {
...
TEST_F(RtpSequenceNumberMapTest,
       GetOnObsoleteKeyReturnsNullOptSingleValueObsoleted) {
...
TEST_P(RtpSequenceNumberMapTestWithBoolParams,
       GetOnObsoleteKeyReturnsNullOptMultipleEntriesObsoleted) {
