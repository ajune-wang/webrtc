...
class BasicPortAllocatorTestBase : public ::testing::Test,
 ...
 public:
  ...
  // port is bound to the "any" address. This may be different from the default
  // local address which the endpoint observes. This can occur if the route to
  // the public endpoint like 8.8.8.8 (specified as the default local address)
  // is different from the route to the STUN server (the default route).
