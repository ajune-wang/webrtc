...
absl::optional<NetEq::Operations> ActionToOperations(
  ...
  switch (*a) {
    case NetEqSimulator::Action::kAccelerate:
      return absl::make_optional(NetEq::Operations::kAccelerate);
    case NetEqSimulator::Action::kExpand:
      return absl::make_optional(NetEq::Operations::kExpand);
    case NetEqSimulator::Action::kNormal:
      return absl::make_optional(NetEq::Operations::kNormal);
    case NetEqSimulator::Action::kPreemptiveExpand:
      return absl::make_optional(NetEq::Operations::kPreemptiveExpand);
  }
}
