...
extern template class TypedParser<uint32_t>;
extern template class TypedParser<uint64_t>;
extern template class TypedParser<absl::optional<double>>;
extern template class TypedParser<absl::optional<int>>;
extern template class TypedParser<absl::optional<uint32_t>>;
extern template class TypedParser<absl::optional<uint64_t>>;
