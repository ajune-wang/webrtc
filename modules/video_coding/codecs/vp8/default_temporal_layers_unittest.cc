...
class TemporalLayersTest : public ::testing::Test {
 public:
  ...
  CodecSpecificInfoVP8* IgnoredCodecSpecificInfo() {
    vp8_info_ = absl::make_unique<CodecSpecificInfo>();
    return &vp8_info_->codecSpecific.VP8;
  }

 private:
  std::unique_ptr<CodecSpecificInfo> vp8_info_;
};
