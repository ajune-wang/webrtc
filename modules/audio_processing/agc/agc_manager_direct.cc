...
AgcManagerDirect::AgcManagerDirect(int num_capture_channels,
  ...
  RTC_DCHECK_LT(0, clipped_level_step);
  RTC_DCHECK_GE(255, clipped_level_step);
  RTC_DCHECK_LT(0.f, clipped_ratio_threshold);
  RTC_DCHECK_GT(1.f, clipped_ratio_threshold);
  RTC_DCHECK_LT(0, clipped_wait_frames);
