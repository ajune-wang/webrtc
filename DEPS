...
vars = {
  ...
  'chromium_revision': 'b6f10930c887251dddc342ee85eb26bdf4484764',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '494598394bd02e6adbb6c1134cbf82a398a97bf4',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '9063784d86af5ecd8d3ee0a2176cd192e2498f81',
  'src/tools/gyp':
