...
// If `allow_transient_supporessor_usage` is false, disables transient
// suppression (TS). When `input_volume_controller_config_override` is
// specified, switches all gain control to AGC2.
