...
using AlwaysValidFieldTrialsView =
...
void TurnPort::PrepareAddress() {
  ...
  if (!AllowedTurnPort(server_address_.address.port(), field_trials_.get())) {
...
bool TurnPort::CreateOrRefreshEntry(const rtc::SocketAddress& addr,
  ...
  if (entry == nullptr) {
    ...
    if (field_trials_->IsEnabled("WebRTC-TurnAddMultiMapping")) {
...
TurnCreatePermissionRequest::TurnCreatePermissionRequest(
  ...
  if (port_->field_trials_->IsEnabled("WebRTC-TurnAddMultiMapping")) {
