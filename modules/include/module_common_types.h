...
class AudioFrame {
 public:
  ...
  // short period of time until webrtc clients have updated.
  RTC_DEPRECATED("bugs.webrtc.org/6548") AudioFrame& operator>>=(const int rhs);
  RTC_DEPRECATED("bugs.webrtc.org/6548")
