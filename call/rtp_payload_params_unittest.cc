...
TEST(RtpPayloadParamsTest, CreatesGenericDescriptorForVp8) {
  ...
  delta_info.codecType = kVideoCodecVP8;
  delta_info.codecSpecific.VP8.temporalIdx = 1;
  RTPVideoHeader delta_header = params.GetRtpVideoHeader(
      delta_image, &delta_info, /*shared_frame_id=*/124);
