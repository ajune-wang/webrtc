...
struct NetworkEstimatorProducers {
  // NetworkEstimate::Producer* NetworkEstimateProducer;
};
...
struct NetworkControlProducers : NetworkEstimatorProducers,
                                 NetworkCommanderProducers {
