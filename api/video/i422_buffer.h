...
class RTC_EXPORT I422Buffer : public I422BufferInterface {
 public:
  ...
  // Deprecated.
  static rtc::scoped_refptr<I422Buffer> Copy(const VideoFrameBuffer& buffer) {
    return Copy(*buffer.GetI422());
  }
  ...
  // Deprecated.
  static rtc::scoped_refptr<I422Buffer> Rotate(const VideoFrameBuffer& src,
                                               VideoRotation rotation) {
    return Rotate(*src.GetI422(), rotation);
  }
