...
/**
 * Interface for drawer that is capable of rendering a video frame using OpenGL.
 */
public interface GlVideoFrameDrawer {
  /**
   * Draws the frame to the current OpenGL viewport. If VideoFrame buffer is a texture buffer, the
