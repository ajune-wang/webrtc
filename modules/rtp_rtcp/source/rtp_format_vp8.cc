...
void RtpPacketizerVp8::GeneratePackets(size_t frame_len) {
  ...
  size_t total_bytes = frame_len + limits_.last_packet_reduction_len;
  ...
  size_t remaining_data = frame_len;
  while (remaining_data > 0) {
    ...
    QueuePacket(frame_len - remaining_data, current_packet_bytes,
                /*first_packet=*/remaining_data == frame_len);
