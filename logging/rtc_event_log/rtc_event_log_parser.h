...
class ParsedRtcEventLog {
 public:
  ...
  const std::vector<LoggedGoogCcBweUpdate>& bwe_goog_cc_updates() const {
 ...
 private:
  ...
  void StoreBweGoogCcUpdate(const rtclog2::GoogCcBweUpdate& proto);
  ...
  std::vector<LoggedGoogCcBweUpdate> bwe_target_rate_updates_;
