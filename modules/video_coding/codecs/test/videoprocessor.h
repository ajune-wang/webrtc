...
class VideoProcessor {
 ...
 public:
  ...
  // When the encode callback is received, the encoded frame is buffered. After
  // encoding is finished buffered frame is sent to decoder. Quality evaluation
  // is done in the decode callback.
 ...
 private:
  ...
  void EvaluateFrameQuality(const VideoFrame& ref_frame,
  ...
  size_t num_simulcast_or_spatial_layers;
