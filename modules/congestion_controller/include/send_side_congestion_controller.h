...
class SendSideCongestionController : public CallStatsObserver,
 ...
 public:
  ...
  SendSideCongestionController(const Clock* clock,
                               RtcEventLog* event_log,
                               PacedSender* pacer,
                               NetworkControllerFactoryInterface::uptr);
  ...
  // NetworkControlObserver interface
 ...
 private:
  ...
  using RunningToken = rtc::RefCountedObject<RunningState>;
  void WaitOnTask(closure_t closure);
  ...
  rtc::scoped_refptr<RunningToken> running_token_;
  ...
  bool network_available_ RTC_GUARDED_BY(network_state_lock_) = true;
  rtc::Optional<TargetTransferRate> last_transfer_rate_
