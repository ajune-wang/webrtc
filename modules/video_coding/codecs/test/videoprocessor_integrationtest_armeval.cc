...
TEST_F(VideoProcessorIntegrationTestArmEval,
       LibvpxVp8_SingleLayer_DenoisingOff) {
...
TEST_F(VideoProcessorIntegrationTestArmEval,
       LibvpxVp9_SingleLayer_DenoisingOff) {
  config_.SetCodecSettings(
...
TEST_F(VideoProcessorIntegrationTestArmEval,
       LibvpxVp8_SingleLayer_DenoisingOn) {
  config_.SetCodecSettings(
      cricket::kVp8CodecName, 1, 1, 1, true /* denoising_on */,
      false /* frame_dropper_on */, false /* spatial_resize_on */,
      false /* resilience_on */, kWidth, kHeight);
  RunTest();
}
...
TEST_F(VideoProcessorIntegrationTestArmEval,
       LibvpxVp9_SingleLayer_DenoisingOn) {
  config_.SetCodecSettings(
      cricket::kVp9CodecName, 1, 1, 1, true /* denoising_on */,
      false /* frame_dropper_on */, false /* spatial_resize_on */,
      false /* resilience_on */, kWidth, kHeight);
  RunTest();
}
