...
EncoderStreamFactory::GetLayerResolutionFromRequestedResolution(
  ...
  webrtc::Resolution adjusted_requested_resolution = {
      .width = std::min(requested_resolution.width,
                        static_cast<int>(std::round(
                            requested_resolution.height * frame_aspect_ratio))),
      .height =
          std::min(requested_resolution.height,
                   static_cast<int>(std::round(requested_resolution.width /
                                               frame_aspect_ratio)))};
