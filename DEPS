...
vars = {
  ...
  'chromium_revision': '3e20dde5752bac74f8c419979b66017edeb07b65',
...
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + '834fd1a1bbf6a175cc63acd7ac1a951c6a64c8e1',
  'src/buildtools':
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '30217e2a64ed96dab0159a69784ccdaf75138b3a',
  'src/third_party':
