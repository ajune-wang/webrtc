...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(std::make_tuple(std::vector<double>{-1.0},
...
TEST_P(AlignmentAdjusterTest, AlignmentAppliedToAllLayers) {
  ...
  int alignment = AlignmentAdjuster::GetAlignment(info, &config);
  EXPECT_EQ(alignment, kRequestedAlignment * kAdjustedAlignment);
