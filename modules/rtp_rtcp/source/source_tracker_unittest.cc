...
class SourceTrackerTest : public TestWithParam<std::tuple<uint32_t, uint32_t>> {
 protected:
  SourceTrackerTest()
...
TEST_P(SourceTrackerTest, RandomOperations) {
...
INSTANTIATE_TEST_SUITE_P(SourceTrackerTest,
                         SourceTrackerTest,
