...
class DataChannel : public DataChannelInterface, public sigslot::has_slots<> {
 public:
  ...
  virtual absl::optional<uint16_t> maxPacketLifeTime() const {
    return config_.maxRetransmitTime;
  }
  virtual absl::optional<uint16_t> maxRetransmitsOpt() const {
...
PROXY_CONSTMETHOD0(absl::optional<uint16_t>, maxRetransmitsOpt)
PROXY_CONSTMETHOD0(absl::optional<uint16_t>, maxPacketLifeTime)
