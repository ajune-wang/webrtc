...
#define RTC_EXPORT_TEMPLATE_DECLARE(export)                                \
  RTC_EXPORT_TEMPLATE_INVOKE(DECLARE, RTC_EXPORT_TEMPLATE_STYLE(export, ), \
                             export)
#define RTC_EXPORT_TEMPLATE_DEFINE(export)                                \
  RTC_EXPORT_TEMPLATE_INVOKE(DEFINE, RTC_EXPORT_TEMPLATE_STYLE(export, ), \
                             export)
...
//     RTC_EXPORT_TEMPLATE_STYLE_3(EXPORT_TEMPLATE_STYLE_MATCH__declspec(dllimport))
...
#define RTC_EXPORT_TEMPLATE_TEST(want, export)                                 \
  static_assert(RTC_EXPORT_TEMPLATE_INVOKE(                                    \
                    TEST_##want, RTC_EXPORT_TEMPLATE_STYLE(export, ), export), \
                #export)
#define RTC_EXPORT_TEMPLATE_TEST_DEFAULT_DEFAULT(...) true
#define RTC_EXPORT_TEMPLATE_TEST_MSVC_HACK_MSVC_HACK(...) true

RTC_EXPORT_TEMPLATE_TEST(DEFAULT, );
