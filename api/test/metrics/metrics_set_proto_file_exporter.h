...
#ifndef API_TEST_METRICS_METRICS_SET_PROTO_FILE_EXPORTER_H
#define API_TEST_METRICS_METRICS_SET_PROTO_FILE_EXPORTER_H
...
#endif  // API_TEST_METRICS_METRICS_SET_PROTO_FILE_EXPORTER_H
