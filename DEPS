...
vars = {
  ...
  'chromium_revision': 'dba483cee6a5f15e2e2d73df16968ab10b38a2bf',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '65e50e91d795b97574008f8e99325af30bed9135',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '3ff866aac6d6bb0a23ac19d9cfbd3a03a855ab46',
  'src/tools/gyp':
