...
struct SocketUnderTest {
  SocketUnderTest(absl::string_view name, const DcSctpOptions& opts = {})
...
TEST(DcSctpSocketTest2, EstablishConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, EstablishConnectionWithSetupCollision) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ShuttingDownWhileEstablishingConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, EstablishSimultaneousConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, EstablishConnectionLostCookieAck) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ResendInitAndEstablishConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ResendingInitTooManyTimesAborts) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ResendCookieEchoAndEstablishConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ResendingCookieEchoTooManyTimesAborts) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, DoesntSendMorePacketsUntilCookieAckHasBeenReceived) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, ShutdownTimerExpiresTooManyTimeClosesConnection) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, EstablishConnectionWhileSendingData) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, SendMessageAfterEstablished) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, PassingHighWatermarkWillOnlyAcceptCumAckTsn) {
  SocketUnderTest a("A");
...
TEST(DcSctpSocketTest2, SetMaxMessageSize) {
  SocketUnderTest a("A");
...
TEST(DcSctpSocketTest2, HasDefaultOnBufferedAmountLowValueZero) {
  SocketUnderTest a("A");
...
TEST(DcSctpSocketTest2, InitialMetricsAreZeroed) {
  SocketUnderTest a("A");
...
TEST(DcSctpSocketTest2, RxAndTxPacketMetricsIncrease) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, SendMessagesAfterHandover) {
  SocketUnderTest a("A");
  auto z = std::make_unique<SocketUnderTest>("Z");
...
TEST(DcSctpSocketTest2, CanDetectDcsctpImplementation) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
...
TEST(DcSctpSocketTest2, BothCanDetectDcsctpImplementation) {
  SocketUnderTest a("A");
  SocketUnderTest z("Z");
