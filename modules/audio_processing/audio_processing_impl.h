...
class AudioProcessingImpl : public AudioProcessing {
 public:
  ...
  // Thread safe method that can be accessed in a multi-chreaded manner.
  void GetLinearAecOutput(rtc::ArrayView<float> linear_output) override {}
 ...
 private:
  ...
  std::vector<float> linear_output_capture_queue_buffer_
      RTC_GUARDED_BY(crit_capture_);
  std::vector<float> linear_output_getter_queue_buffer_;
