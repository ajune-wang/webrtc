  ...
  bool IsTopWindow() {
    ...
    while (true) {
      ...
      if (lastError == ERROR_SUCCESS) {
        ...
        // enumerated; retry the enumeration in this case (this should be a rare
        // race & unlikely to recur).
        RTC_LOG(LS_WARNING)
            << "Enumeration failed due to race with a window closing; retrying";
        continue;
      } else {
