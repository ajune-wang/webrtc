...
void AudioDecoderMultiChannelOpus::AppendSupportedDecoders(
  ...
  // ATM.
  {
    AudioCodecInfo surround_5_1_opus_info{48000, 6, 128000, 36000, 510000};
  ...
  {
    AudioCodecInfo surround_7_1_opus_info{48000, 8, 200000, 36000, 510000};
    ...
    SdpAudioFormat opus_format({"multiopus",
                                ...
                                {{"minptime", "10"},
                                 {"useinbandfec", "1"},
                                 {"channel_mapping", "0,6,1,2,3,5,5,7"},
                                 {"coupled_stream", "3"}}});
