...
struct AdaptationCounters {
  AdaptationCounters() : resolutions_adaptations(0), fps_adaptations(0) {}
  AdaptationCounters(int resolutions_adaptations, int fps_adaptations)
      : resolutions_adaptations(resolutions_adaptations),
