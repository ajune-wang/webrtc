...
void AudioMixerImpl::UpdateSourceCountStats() {
  ...
  if (current_source_count > max_source_count_seen_) {
    RTC_HISTOGRAM_COUNTS_100("WebRTC.Audio.AudioMixer.NewHighestSourceCount",
                             current_source_count);
    max_source_count_seen_ = current_source_count;
  }
}
}  // namespace webrtc
