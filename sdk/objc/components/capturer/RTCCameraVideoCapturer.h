 ...
 * Error passing block.
 */
typedef void (^RTC_OBJC_TYPE(RTCCameraVideoCapturerCompletionBlock))(NSError *_Nullable error);
...
- (void)startCaptureWithDevice:(AVCaptureDevice *)device
                        format:(AVCaptureDeviceFormat *)format
                           fps:(NSInteger)fps
             completionHandler:
                 (__nullable RTC_OBJC_TYPE(RTCCameraVideoCapturerCompletionBlock))completionHandler;
