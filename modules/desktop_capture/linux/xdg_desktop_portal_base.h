...
class RTC_EXPORT XdgDesktopPortalBase {
 public:
  ...
  XdgDesktopPortalBase(const XdgDesktopPortalBase& xdp) = delete;
  XdgDesktopPortalBase& operator=(const XdgDesktopPortalBase& xdp) = delete;

  static XdgDesktopPortalBase& GetInstance();
  ...
  void CloseCurrentConnectionId() { CloseConnection(absl::nullopt); }
 ...
 private:
  ...
  static XdgDesktopPortalBase* instance_;
...
class UserData {
 public:
  explicit UserData(int32_t id) { data_id_ = id; }
