...
TEST(DefaultEncodedImageIdInjector, InjectExtract) {
  DefaultEncodedImageIdInjector injector(8);
  DefaultEncodedImageIdInjector extractor(8);
  ...
  std::pair<uint16_t, EncodedImage> out =
      extractor.ExtractId(injector.InjectId(512, source));
...
TEST(DefaultEncodedImageIdInjector, Inject3Extract3) {
  ...
  EncodedImage intermediate1 = injector.InjectId(510, source1);
  EncodedImage intermediate2 = injector.InjectId(520, source2);
  EncodedImage intermediate3 = injector.InjectId(520, source3);

  std::pair<uint16_t, EncodedImage> out1 = extractor.ExtractId(intermediate1);
  std::pair<uint16_t, EncodedImage> out2 = extractor.ExtractId(intermediate2);
  std::pair<uint16_t, EncodedImage> out3 = extractor.ExtractId(intermediate3);
...
TEST(DefaultEncodedImageIdInjector, InjectExtractFromConcatenated) {
  ...
  EncodedImage intermediate1 = injector.InjectId(512, source1);
  EncodedImage intermediate2 = injector.InjectId(512, source2);
  EncodedImage intermediate3 = injector.InjectId(512, source3);
  ...
  std::pair<uint16_t, EncodedImage> out = extractor.ExtractId(concatenated);
