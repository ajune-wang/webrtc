...
using MediaType = webrtc::ParsedRtcEventLog2::MediaType;
...
void PrintSenderReport(const webrtc::ParsedRtcEventLog2& parsed_stream,
...
void PrintReceiverReport(const webrtc::ParsedRtcEventLog2& parsed_stream,
                         const webrtc::rtcp::CommonHeader& rtcp_block,
                         uint64_t log_timestamp,
                         webrtc::PacketDirection direction) {
...
void PrintXr(const webrtc::ParsedRtcEventLog2& parsed_stream,
             const webrtc::rtcp::CommonHeader& rtcp_block,
             uint64_t log_timestamp,
             webrtc::PacketDirection direction) {
...
void PrintBye(const webrtc::ParsedRtcEventLog2& parsed_stream,
              const webrtc::rtcp::CommonHeader& rtcp_block,
              uint64_t log_timestamp,
              webrtc::PacketDirection direction) {
  webrtc::rtcp::Bye bye;
...
void PrintRtpFeedback(const webrtc::ParsedRtcEventLog2& parsed_stream,
                      const webrtc::rtcp::CommonHeader& rtcp_block,
                      uint64_t log_timestamp,
                      webrtc::PacketDirection direction) {
...
void PrintPsFeedback(const webrtc::ParsedRtcEventLog2& parsed_stream,
                     const webrtc::rtcp::CommonHeader& rtcp_block,
                     uint64_t log_timestamp,
                     webrtc::PacketDirection direction) {
  switch (rtcp_block.fmt()) {
...
int main(int argc, char* argv[]) {
  ...
  webrtc::ParsedRtcEventLog2 parsed_stream;
  ...
  for (size_t i = 0; i < parsed_stream.GetNumberOfEvents(); i++) {
    ...
    switch (parsed_stream.GetEventType(i)) {
      case webrtc::ParsedRtcEventLog2::UNKNOWN_EVENT: {
        if (FLAG_unknown) {
      ...
      case webrtc::ParsedRtcEventLog2::LOG_START: {
        if (FLAG_startstop) {
      ...
      case webrtc::ParsedRtcEventLog2::LOG_END: {
        if (FLAG_startstop) {
      ...
      case webrtc::ParsedRtcEventLog2::RTP_EVENT: {
        if (FLAG_rtp) {
      ...
      case webrtc::ParsedRtcEventLog2::RTCP_EVENT: {
        if (FLAG_rtcp) {
          size_t length;
      ...
      case webrtc::ParsedRtcEventLog2::AUDIO_PLAYOUT_EVENT: {
        if (FLAG_playout) {
      ...
      case webrtc::ParsedRtcEventLog2::LOSS_BASED_BWE_UPDATE: {
        if (FLAG_bwe) {
      ...
      case webrtc::ParsedRtcEventLog2::DELAY_BASED_BWE_UPDATE: {
        if (FLAG_bwe) {
      ...
      case webrtc::ParsedRtcEventLog2::VIDEO_RECEIVER_CONFIG_EVENT: {
      ...
      case webrtc::ParsedRtcEventLog2::VIDEO_SENDER_CONFIG_EVENT: {
      ...
      case webrtc::ParsedRtcEventLog2::AUDIO_RECEIVER_CONFIG_EVENT: {
      ...
      case webrtc::ParsedRtcEventLog2::AUDIO_SENDER_CONFIG_EVENT: {
      ...
      case webrtc::ParsedRtcEventLog2::AUDIO_NETWORK_ADAPTATION_EVENT: {
        if (FLAG_ana) {
      ...
      case webrtc::ParsedRtcEventLog2::BWE_PROBE_CLUSTER_CREATED_EVENT: {
        if (FLAG_probe) {
      ...
      case webrtc::ParsedRtcEventLog2::BWE_PROBE_RESULT_EVENT: {
        if (FLAG_probe) {
      ...
      case webrtc::ParsedRtcEventLog2::ALR_STATE_EVENT: {
        if (FLAG_bwe) {
      ...
      case webrtc::ParsedRtcEventLog2::ICE_CANDIDATE_PAIR_CONFIG: {
        if (FLAG_ice) {
      ...
      case webrtc::ParsedRtcEventLog2::ICE_CANDIDATE_PAIR_EVENT: {
        if (FLAG_ice) {
