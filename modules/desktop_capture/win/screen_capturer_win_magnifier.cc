...
static LPCWTSTR kHostWindowName = L"MagnifierHost";
static LPCWTSTR kMagnifierWindowClass = L"Magnifier";
static LPCWTSTR kMagnifierWindowName = L"MagnifierWindow";
