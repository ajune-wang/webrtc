...
vars = {
  ...
  'chromium_revision': 'd36191b3c7cd522efaa31751719d2f953ca3715e',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '56c36a31ae6e4e0b51fc3840e18409bf0c7229ed',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'd7814aadfa48bfb81a509e9b0ea161c080915110',
  'src/tools/gyp':
