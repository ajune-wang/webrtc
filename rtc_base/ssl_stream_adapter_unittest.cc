...
INSTANTIATE_TEST_SUITE_P(
    ...
    Combine(
        ...
        Values(
#ifdef OPENSSL_IS_BORINGSSL
            // OpenSSL no longer provides this combination depending on the
            // "security level". Remove once BoringSSL does no longer either.
            std::make_pair(rtc::DIGEST_SHA_1, SHA_DIGEST_LENGTH),
