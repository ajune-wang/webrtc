...
@interface RTC_OBJC_TYPE(RTCCameraVideoCapturer) ()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
- (void)dealloc {
  NSAssert(
      !_willBeRunning,
      @"Session was still running in RTC_OBJC_TYPE(RTCCameraVideoCapturer) dealloc. Forgot to call stopCapture?");
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput
  ...
  RTC_OBJC_TYPE(RTCCVPixelBuffer) *rtcPixelBuffer = [[RTC_OBJC_TYPE(RTCCVPixelBuffer) alloc] initWithPixelBuffer:pixelBuffer];
  int64_t timeStampNs = CMTimeGetSeconds(CMSampleBufferGetPresentationTimeStamp(sampleBuffer)) *
      kNanosecondsPerSecond;
  RTC_OBJC_TYPE(RTCVideoFrame) *videoFrame = [[RTC_OBJC_TYPE(RTCVideoFrame) alloc] initWithBuffer:rtcPixelBuffer
                                                           rotation:_rotation
...
- (void)setupVideoDataOutput {
  ...
  NSSet<NSNumber *> *supportedPixelFormats = [RTC_OBJC_TYPE(RTCCVPixelBuffer) supportedPixelFormats];
