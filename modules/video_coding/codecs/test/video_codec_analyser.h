...
class VideoCodecAnalyser {
 public:
  // TODO(ssilkin): Get rid of this. Target rates needed to be known at frame ->
  // video stats aggregation. The target rates are known at test level which can
  // pass them to aggration functions.
