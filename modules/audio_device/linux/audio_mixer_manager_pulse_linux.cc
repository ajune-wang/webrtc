    ...
    uint16_t deviceIndex)
{
    RTC_DCHECK(thread_checker_.CalledOnValidThread());
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::OpenSpeaker(deviceIndex="
        << deviceIndex << ")";
    ...
    uint32_t volume)
{
    RTC_DCHECK(thread_checker_.CalledOnValidThread());
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::SetSpeakerVolume(volume="
        << volume << ")";
...
AudioMixerManagerLinuxPulse::SpeakerVolume(uint32_t& volume) const
{
    ...
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::SpeakerVolume() => vol="
        << volume;
...
int32_t AudioMixerManagerLinuxPulse::SetSpeakerMute(bool enable)
{
    RTC_DCHECK(thread_checker_.CalledOnValidThread());
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::SetSpeakerMute(enable="
        << enable << ")";
...
int32_t AudioMixerManagerLinuxPulse::SpeakerMute(bool& enabled) const
{
    ...
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::SpeakerMute() => enabled="
        << enabled;
...
int32_t AudioMixerManagerLinuxPulse::SetMicrophoneMute(bool enable)
{
    RTC_DCHECK(thread_checker_.CalledOnValidThread());
    RTC_LOG(LS_VERBOSE)
        << "AudioMixerManagerLinuxPulse::SetMicrophoneMute(enable="
        << enable << ")";
