...
vars = {
  ...
  'chromium_revision': '44615a0ff94d4ff1f20412d49267d878004085d4',
...
deps = {
  ...
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@b2094e8934aad946b3066329281968f21d3b544a',
  'src/third_party':
