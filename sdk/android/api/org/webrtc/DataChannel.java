...
public class DataChannel {
  ...
  public void registerObserver(Observer observer) {
    ...
    if (nativeObserver != 0) {
      DataChannelJni.get().unregisterObserver(DataChannel.this, nativeObserver);
    }
    nativeObserver = DataChannelJni.get().registerObserver(DataChannel.this, observer);
  }
  ...
  public String label() {
    checkDataChannelExists();
    return DataChannelJni.get().label(DataChannel.this);
  }

  public int id() {
    checkDataChannelExists();
    return DataChannelJni.get().id(DataChannel.this);
  }

  public State state() {
    checkDataChannelExists();
    return DataChannelJni.get().state(DataChannel.this);
  }
  ...
  public long bufferedAmount() {
    checkDataChannelExists();
    return DataChannelJni.get().bufferedAmount(DataChannel.this);
  }

  /** Close the channel. */
  public void close() {
    checkDataChannelExists();
    DataChannelJni.get().close(DataChannel.this);
  }
  ...
  public boolean send(Buffer buffer) {
    ...
    return DataChannelJni.get().send(DataChannel.this, data, buffer.binary);
  }
