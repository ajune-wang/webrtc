...
class MonoAgc {
 ...
 private:
  ...
  // Frames since the last `UpdateGain()` call. Reset to -1 at the startup and
  // initialization and to 0 at gain updates.
  int frames_since_update_gain_ = -1;
};
