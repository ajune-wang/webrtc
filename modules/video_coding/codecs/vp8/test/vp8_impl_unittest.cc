...
TEST_F(TestVp8Impl, ChecksSimulcastSettings) {
  ...
  codec_settings_.simulcastStream[0] = {kWidth, kHeight, 30,   2,
                                        4000,   3000,    2000, 80};
  ...
  codec_settings_.simulcastStream[0] = {kWidth / 2, kHeight / 2, 30,   1,
                                        4000,       3000,        2000, 80};
  codec_settings_.simulcastStream[1] = {kWidth / 2, kHeight / 2, 30,   1,
                                        4000,       3000,        2000, 80};
  ...
  EXPECT_EQ(WEBRTC_VIDEO_CODEC_ERR_SIMULCAST_PARAMETERS_NOT_SUPPORTED,
            encoder_->InitEncode(&codec_settings_, kNumCores, kMaxPayloadSize));
  // Reslutions are not scaled by 2.
  codec_settings_.simulcastStream[0] = {kWidth, kHeight, 30,   1,
                                        4000,   3000,    2000, 80};
  codec_settings_.simulcastStream[1] = {kWidth, kHeight, 30,   1,
                                        4000,   3000,    2000, 80};
  codec_settings_.simulcastStream[2] = {kWidth, kHeight, 30,   1,
                                        4000,   3000,    2000, 80};
  EXPECT_EQ(WEBRTC_VIDEO_CODEC_ERR_SIMULCAST_PARAMETERS_NOT_SUPPORTED,
  ...
  codec_settings_.simulcastStream[0] = {kWidth / 4, kHeight / 4, 30,   1,
                                        4000,       3000,        2000, 80};
  codec_settings_.simulcastStream[1] = {kWidth / 2, kHeight / 2, 30,   2,
                                        4000,       3000,        2000, 80};
  codec_settings_.simulcastStream[2] = {kWidth, kHeight, 30,   3,
                                        4000,   3000,    2000, 80};
  EXPECT_EQ(WEBRTC_VIDEO_CODEC_ERR_SIMULCAST_PARAMETERS_NOT_SUPPORTED,
            encoder_->InitEncode(&codec_settings_, kNumCores, kMaxPayloadSize));
  // Resolutions do not match codec config.
  codec_settings_.simulcastStream[0] = {
      kWidth / 4 + 1, kHeight / 4 + 1, 30, 1, 4000, 3000, 2000, 80};
  codec_settings_.simulcastStream[1] = {
      kWidth / 2 + 2, kHeight / 2 + 2, 30, 1, 4000, 3000, 2000, 80};
  codec_settings_.simulcastStream[2] = {kWidth + 4, kHeight + 4, 30,   1,
                                        4000,       3000,        2000, 80};
  EXPECT_EQ(WEBRTC_VIDEO_CODEC_ERR_SIMULCAST_PARAMETERS_NOT_SUPPORTED,
            encoder_->InitEncode(&codec_settings_, kNumCores, kMaxPayloadSize));
