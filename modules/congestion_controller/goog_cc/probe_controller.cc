...
ProbeController::ProbeController(const WebRtcKeyValueConfig* key_value_config,
    ...
    : enable_periodic_alr_probing_(false),
      in_rapid_recovery_experiment_(
          absl::StartsWith(key_value_config->Lookup(kBweRapidRecoveryExperiment), "Enabled"),
      limit_probes_with_allocateable_rate_(
          absl::StartsWith(key_value_config->Lookup(kCappedProbingFieldTrialName), "Disabled"),
