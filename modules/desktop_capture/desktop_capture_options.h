...
class RTC_EXPORT DesktopCaptureOptions {
 public:
  ...
  // request 2) Call close_request(id) in case the preview dialog was cancelled
  // or user
  //       picked a web page to be shared
  // Note: In case the current request is not finalized, we will close it for
  // safety
  //       reasons and client will need to ask the portal again
