...
class MonitorInterval {
 public:
  ...
  const std::vector<TimeDelta>& GetRttOfReceivedPackets() const;
  const std::vector<Timestamp>& GetSendTimeOfReceivedPackets() const;
  const std::vector<Timestamp>& GetSendTimeOfLostPackets() const;
