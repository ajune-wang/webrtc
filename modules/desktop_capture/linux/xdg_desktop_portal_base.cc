...
bool XdgDesktopPortalBase::IsConnectionInitialized(int32_t id) const {
...
bool XdgDesktopPortalBase::IsConnectionStreamingOnWeb(int32_t id) const {
  auto connection_data = GetConnectionData(id);
...
int32_t XdgDesktopPortalBase::CurrentConnectionId() const {
...
void XdgDesktopPortalBase::SetConnectionStreamingOnWeb(int32_t id) {
  auto connection_data = GetConnectionData(id);
