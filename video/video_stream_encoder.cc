...
class VideoStreamEncoder::SinkAdapter
    : public FrameCadenceAdapterInterface::Callback {
 public:
  explicit SinkAdapter(VideoStreamEncoder& video_stream_encoder)
...
VideoStreamEncoder::VideoStreamEncoder(
    ...
    : worker_queue_(TaskQueueBase::Current()),
      ...
      sink_callback_adapter_(std::make_unique<SinkAdapter>(*this)),
  ...
  zero_hertz_adapter_->Initialize(sink_callback_adapter_.get());
