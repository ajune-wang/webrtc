...
struct EchoCanceller3Config {
  ...
  struct Delay {
    ...
    size_t histogram_size = 250;
    int histogram_threshold = 25;
    struct MatchedFilters {
      size_t num_filters = 10;
      size_t filter_size_sub_blocks = 16;
      size_t filter_alignment_overlap_sub_blocks = 8;
      size_t down_sampling_factor = 8;
      float estimator_smoothing = 0.7f;
      float poor_excitation_render_limit = 150.f;
      float poor_excitation_render_limit_ds8 = 20.f;
      float detection_threshold = 0.1f;
    } matched_filters;
    size_t num_filters = 10;           // Deprecated.
    size_t down_sampling_factor = 8;  // Deprecated.
  } delay;
