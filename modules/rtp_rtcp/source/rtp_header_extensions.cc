...
constexpr RTPExtensionType VideoFrameTrackingId::kId;
constexpr uint8_t VideoFrameTrackingId::kValueSizeBytes;
constexpr const char VideoFrameTrackingId::kUri[];

bool VideoFrameTrackingId::Parse(rtc::ArrayView<const uint8_t> data,
...
bool VideoFrameTrackingId::Write(rtc::ArrayView<uint8_t> data,
                                 uint16_t video_frame_tracking_id) {
  RTC_DCHECK_EQ(data.size(), ValueSize(video_frame_tracking_id));
