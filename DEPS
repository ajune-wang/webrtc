...
vars = {
  ...
  'chromium_revision': '07c71f41d989e9da75e0f211dec182b545496e56',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'cdee23617e6dbef1bc593b7118cf22e1cdc8a8d8',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '2266c32a36092b13f6e636f4fb08cd47c1c66685',
  'src/tools/gyp':
