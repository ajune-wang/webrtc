...
std::unique_ptr<Call> PeerConnectionFactory::CreateCall_w(
  ...
  FieldTrialParameter<DataRate> min_bandwidth("min_bandwidth",
                                              DataRate::kbps(30));
  FieldTrialParameter<DataRate> start_bandwidth("start_bandwidth",
                                                DataRate::kbps(300));
  FieldTrialParameter<DataRate> max_bandwidth("max_bandwidth",
                                              DataRate::kbps(2000));
  ParseFieldTrial({&min_bandwidth, &start_bandwidth, &max_bandwidth},
                  field_trial::FindFullName("WebRTC-CallConfigBitrates"));
