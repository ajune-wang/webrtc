...
// |receive_frame_callback_| on the |audio_receive_thread_|.
class AudioReceiveFrameTransformerDelegate : public TransformedFrameCallback {
 public:
  ...
  AudioReceiveFrameTransformerDelegate(
      ...
      TaskQueueBase* audio_receive_thread);
  ...
  // |receive_frame_callback_| on |audio_receive_thread_|. Called from
  ...
  // |audio_receive_thread_|, by calling |receive_frame_callback_|.
 ...
 private:
  ...
  rtc::scoped_refptr<FrameTransformerInterface> frame_transformer_
      RTC_GUARDED_BY(sequence_checker_);
  TaskQueueBase* const audio_receive_thread_;
};
