...
void RtpVideoStreamReceiver::OnRtpPacket(const RtpPacketReceived& packet) {
  ...
  // Update receive statistics after OnReceivedPayloadData.
  ...
  if (!packet.recovered()) {
    ...
    rtp_receive_statistics_->IncomingPacket(
        webrtc_rtp_header.header, packet.size(),
        IsPacketRetransmitted(webrtc_rtp_header.header));
  }
