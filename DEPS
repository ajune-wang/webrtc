...
vars = {
  ...
  'chromium_revision': 'bd36318f6ad4a5121a75effce184b295614fd5f1',
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '78d89b42c293bff9ae1fec4b849a8853e25f419b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '17c822010ca22a9ae8605da333dc958d392a79b5',
