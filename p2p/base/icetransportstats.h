...
struct IceTransportStats {
  IceTransportStats();
  ~IceTransportStats();
  uint64_t last_time_ms_candidate_pairs_sorted = 0;
  size_t num_active_candidate_pairs = 0;
  size_t num_writable_candidate_pairs = 0;
  size_t num_continual_switchings_to_weak_candidate_pairs = 0;
