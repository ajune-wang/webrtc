...
std::unique_ptr<TestPeer> TestPeerFactory::CreateTestPeer(
  ...
  PeerConnectionFactoryDependencies pcf_deps = CreatePCFDependencies(
      components.get(), params.get(), video_analyzer_helper,
...
PeerConnectionFactoryDependencies TestPeerFactory::CreatePCFDependencies(
  ...
  pcf_deps.media_engine =
      CreateMediaEngine(components, params, video_analyzer_helper,
                        std::move(audio_output_file_name));
...
TestPeerFactory::CreateMediaEngine(
  ...
  std::unique_ptr<VideoEncoderFactory> video_encoder_factory =
      CreateVideoEncoderFactory(components, video_analyzer_helper);
  std::unique_ptr<VideoDecoderFactory> video_decoder_factory =
      CreateVideoDecoderFactory(components, video_analyzer_helper);
