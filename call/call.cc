...
void Call::SignalChannelNetworkState(MediaType media, NetworkState state) {
  ...
  // TODO(tommi): Fire this event from the network thread since
  // video_receive_streams_ will move to the network thread and the downstream
  // code uses mutexes rather than tq affinity.
