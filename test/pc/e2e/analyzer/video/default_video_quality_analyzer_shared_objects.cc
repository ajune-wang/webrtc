...
std::set<StatsKey> StreamsInfo::GetStatsKeys() const {
...
std::set<std::string> StreamsInfo::GetStreams() const {
...
std::set<std::string> StreamsInfo::GetStreams(
...
absl::optional<std::string> StreamsInfo::GetSender(
...
std::set<std::string> StreamsInfo::GetReceivers(
    absl::string_view stream_label) const {
