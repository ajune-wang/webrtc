...
TEST(ColorSpace, TestSettingChromaSitingHorzFromUint8) {
  ColorSpace color_space;
  EXPECT_TRUE(
      color_space.set_chroma_siting_horizontal_from_uint8(static_cast<uint8_t>(
          ColorSpace::ChromaSitingHorizontal::kLeftCollocated)));
  EXPECT_EQ(ColorSpace::ChromaSitingHorizontal::kLeftCollocated,
...
TEST(ColorSpace, TestSettingChromaSitingVertFromUint8) {
  ...
  EXPECT_TRUE(color_space.set_chroma_siting_vertical_from_uint8(
      static_cast<uint8_t>(ColorSpace::ChromaSitingVertical::kTopCollocated)));
  EXPECT_EQ(ColorSpace::ChromaSitingVertical::kTopCollocated,
