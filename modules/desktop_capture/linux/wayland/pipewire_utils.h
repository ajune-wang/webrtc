...
// this will do so. If there is other configuration needed, this will also do
// so. Note that this does not guarantee a PipeWire server is running nor does
// it establish a connection to one.
