...
const char kBweTrendlineWindowExperiment[] =
    "WebRTC-BweWindowInPacketsExperiment";

size_t ReadTrendlineFilterWindowSize() {
  std::string experiment_string =
      webrtc::field_trial::FindFullName(kBweTrendlineWindowExperiment);
  size_t window_size;
  int parsed_values =
...
DelayBasedBwe::DelayBasedBwe(RtcEventLog* event_log, const Clock* clock)
    : event_log_(event_log),
      ...
      trendline_window_size_(
          webrtc::field_trial::IsEnabled(kBweTrendlineWindowExperiment)
