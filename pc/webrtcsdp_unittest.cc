...
// serialized/deserialized appropriately. In this case that in the unsignaled
// case, every audio/video MediaContentDescription will contain a StreamParams
// object that doesn't have any ssrcs. Vice versa, this will be created upon
// deserializing an SDP with no ssrc lines.
