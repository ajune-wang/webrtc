...
void AudioProcessingSimulator::CreateAudioProcessor() {
  ...
  if (settings_.experimental_multichannel_echo_control) {
    apm_config.pipeline.experimental_multichannel_echo_control =
        *settings_.experimental_multichannel_echo_control;
  }
  if (settings_.experimental_multichannel_render_analysis) {
    apm_config.pipeline.experimental_multichannel_render_analysis =
        *settings_.experimental_multichannel_render_analysis;
  }
