...
bool PeerConnection::Initialize(
  ...
  // Following RTC_DCHECKs are added by carefully looking at the caller
  // thread and if this is incorrect there might not be failures which
  // will not be tested in unit tests in webrtc but caught
  // during the chromium roll until webrtc:186946 is fixed.
