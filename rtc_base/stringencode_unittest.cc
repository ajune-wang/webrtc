...
TEST(ToString, SanityCheck) {
  ...
  EXPECT_EQ(ToString(static_cast<short>(-123)), "-123");
  EXPECT_EQ(ToString(static_cast<unsigned short>(123)), "123");
  EXPECT_EQ(ToString(static_cast<int>(-123)), "-123");
  EXPECT_EQ(ToString(static_cast<unsigned int>(123)), "123");
  EXPECT_EQ(ToString(static_cast<long int>(-123)), "-123");
  EXPECT_EQ(ToString(static_cast<unsigned long int>(123)), "123");
  EXPECT_EQ(ToString(static_cast<long long int>(-123)), "-123");
  EXPECT_EQ(ToString(static_cast<unsigned long long int>(123)), "123");
