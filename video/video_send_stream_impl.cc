...
// Stricter pacing factor than the default 2.5 that used by default when
// send-side BWE is used. Provides a more careful bandwidth rampup with less
// risk of overshoots causing adverse effects like packet loss. Not used for
// receive side BWE, since there we lack features lack probing, which may result
// in too slow initial rampup.
