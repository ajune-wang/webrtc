...
class FakeQualityScalerQpUsageHandlerCallback
 ...
 public:
  ...
  void OnQpUsageHandled(bool clear_qp_samples) override {
    clear_qp_samples_ = clear_qp_samples;
  }

  absl::optional<bool> clear_qp_samples() const { return clear_qp_samples_; }

 private:
  absl::optional<bool> clear_qp_samples_;
};
...
class VideoStreamEncoderUnderTest : public VideoStreamEncoder {
 public:
  ...
  bool TriggerQualityScalerHighQpAndReturnIfQpSamplesShouldBeCleared() {
    ...
    EXPECT_TRUE(callback->clear_qp_samples().has_value());
    return callback->clear_qp_samples().value();
  }
