...
class RTCPSender final {
 public:
  ...
  void SetLastRtpTime(uint32_t rtp_timestamp,
      ...
      RTC_LOCKS_EXCLUDED(mutex_rtcp_sender_);
  //   // TODO(bugs.webrtc.org/6458): Remove default parameter value when all
  //   the
  //   // depending projects are updated to correctly set payload type.
  //   // TODO(bugs.webrtc.org/12873): Remove once downstream consumers migrates
  //   to
  //   // new version of SetLastRtpTime declared above.
  //   void SetLastRtpTime(uint32_t rtp_timestamp,
