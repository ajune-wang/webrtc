...
vars = {
  ...
  'chromium_revision': 'b520aae0ab2f4c3d47be1c75f5a27da9a17ab4d3',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '2b8b18eb33cd962e28e3aa6e68fa71b371d94890',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b83c774bfb6f295f1a2bee773a0efb97fc5698c9',
  'src/tools/gyp':
