...
struct BitrateProberConfig {
  ...
  FieldTrialParameter<int> min_probe_packets_sent_;
  // A minimum interval between probes to allow scheduling to be feasible.
  FieldTrialParameter<TimeDelta> min_probe_delta_;
  // The minimum probing duration.
  FieldTrialParameter<TimeDelta> min_probe_duration_;
  ...
  FieldTrialParameter<TimeDelta> max_probe_delay_;
};
