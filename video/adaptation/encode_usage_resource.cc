...
void EncodeUsageResource::AdaptUp(adaptation::VideoAdaptationReason reason) {
  RTC_DCHECK_EQ(reason, adaptation::VideoAdaptationReason::kCpu);
  OnResourceUsageStateMeasured(ResourceUsageState::kUnderuse);
}

bool EncodeUsageResource::AdaptDown(adaptation::VideoAdaptationReason reason) {
  RTC_DCHECK_EQ(reason, adaptation::VideoAdaptationReason::kCpu);
