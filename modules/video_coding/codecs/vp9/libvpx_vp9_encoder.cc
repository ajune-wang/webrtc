...
rtc::scoped_refptr<VideoFrameBuffer> LibvpxVp9Encoder::PrepareBufferForProfile0(
  ...
  absl::InlinedVector<VideoFrameBuffer::Type, kMaxPreferredPixelFormats>
      profile0_supported_formats = {VideoFrameBuffer::Type::kI420,
  ...
  if (buffer->type() != VideoFrameBuffer::Type::kNative) {
    ...
    mapped_buffer = buffer->GetMappedFrameBuffer(profile0_supported_formats);
  }
  if (!mapped_buffer ||
      absl::c_find(profile0_supported_formats, mapped_buffer->type()) ==
          profile0_supported_formats.end()) {
