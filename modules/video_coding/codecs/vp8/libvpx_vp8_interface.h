...
#ifndef MODULES_VIDEO_CODING_CODECS_VP8_LIBVPX_VP8_INTERFACE_H_
#define MODULES_VIDEO_CODING_CODECS_VP8_LIBVPX_VP8_INTERFACE_H_
...
class LibvpxVp8Interface {
 public:
  LibvpxVp8Interface() = default;
  virtual ~LibvpxVp8Interface() = default;
  ...
  // Note that several methods here have an underscore suffix, this is in order
  // to avoid the preprocessor from corrupting this file when it tries to
  // expand the macros these function names map to.
  ...
  static std::unique_ptr<LibvpxVp8Interface> CreateEncoderInterface();
};

}  // namespace webrtc

#endif  // MODULES_VIDEO_CODING_CODECS_VP8_LIBVPX_VP8_INTERFACE_H_
