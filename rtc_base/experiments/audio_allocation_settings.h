...
class AudioAllocationSettings {
 public:
  ...
  bool configure_audio_bitrate_allocation() const;
  bool enable_transport_sequence_number_extension() const;

  bool include_audio_in_feedback(int transport_sequence_number_id) const;
  bool update_audio_target_bitrate(int transport_sequence_number_id) const;
