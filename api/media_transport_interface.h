...
struct MediaTransportAllocateddBitrateLimits {
  webrtc::DataRate min_send_bitrate = DataRate::Zero();
  webrtc::DataRate max_padding_bitrate = DataRate::Zero();
  webrtc::DataRate total_bitrate = DataRate::Zero();
};
