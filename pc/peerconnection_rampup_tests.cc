...
namespace {
static const int kDefaultTestTime = 10000;
static const int kDefaultTimeout = 10000;
static const rtc::SocketAddress kDefaultLocalAddress("1.1.1.1", 0);
static const int kHighNetworkBandwidth = 1500000;
}  // namespace
...
class PeerConnectionRampUpTest : public ::testing::Test {
 public:
  ...
  // Runs the call for kDefaultTestTime, and then records the bandwidth send
  ...
  void RunTest(const std::string& test_string) {
    ...
    std::string value_description =
        "bwe_after_" + std::to_string(kDefaultTestTime / 1000) + "_seconds";
