...
class RTC_EXPORT Network {
 public:
  ...
  // return local link ones. 4) if #3 not available, use ULA ipv6 as last
  // resort. (ULA stands for unique local address, which is not route-able in
  // open internet but might be useful for a close WebRTC deployment.
