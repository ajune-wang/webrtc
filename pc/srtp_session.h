...
class SrtpSession {
 public:
  ...
  [[deprecated("Pass ZeroOnFreeBuffer")]] bool SetSend(
      int crypto_suite,
      const uint8_t* key,
      size_t len,
  ...
  bool SetSend(int crypto_suite,
               ...
               const std::vector<int>& extension_ids);
  [[deprecated("Pass ZeroOnFreeBuffer")]] bool UpdateSend(
      int crypto_suite,
      const uint8_t* key,
      size_t len,
      const std::vector<int>& extension_ids);
  ...
  [[deprecated("Pass ZeroOnFreeBuffer")]] bool SetRecv(
      int crypto_suite,
      const uint8_t* key,
      size_t len,
      const std::vector<int>& extension_ids);
  bool SetRecv(int crypto_suite,
               const rtc::ZeroOnFreeBuffer<uint8_t>& key,
               const std::vector<int>& extension_ids);
  [[deprecated("Pass ZeroOnFreeBuffer")]] bool UpdateRecv(
      int crypto_suite,
      const uint8_t* key,
      size_t len,
      const std::vector<int>& extension_ids);
