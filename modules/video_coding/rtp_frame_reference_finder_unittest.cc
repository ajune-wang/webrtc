...
TEST_F(TestRtpFrameReferenceFinder, Vp8TemporalLayers_0212_drop_tl2) {
  ...
  InsertVp8(sn, sn + 1, true, pid, 0, 55);
  // DROP -> Vp8(false, pid + 1, 2, 55, true);
  InsertVp8(sn + 2, sn + 3, false, pid + 2, 1, 55, true);
  // DROP -> Vp8(false, pid + 3, 2, 55);
  InsertVp8(sn + 4, sn + 5, false, pid + 4, 0, 56);
  // DROP -> Vp8(false, pid + 5, 2, 56);
  InsertVp8(sn + 6, sn + 7, false, pid + 6, 1, 56);
  // DROP -> Vp8(false, pid + 7, 2, 56);
  InsertVp8(sn + 8, sn + 9, false, pid + 8, 0, 57);
  // DROP -> Vp8(false, pid + 9, 2, 57, true);
  InsertVp8(sn + 10, sn + 11, false, pid + 10, 1, 57, true);
