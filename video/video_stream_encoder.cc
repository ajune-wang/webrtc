...
absl::optional<webrtc::VideoSourceRestrictions> MergeRestrictions(
    const std::vector<absl::optional<webrtc::VideoSourceRestrictions>>& list) {
  absl::optional<webrtc::VideoSourceRestrictions> return_value;
