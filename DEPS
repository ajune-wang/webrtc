...
vars = {
  ...
  'chromium_revision': 'ba75a9c365c659bfa24767f61c669fb5857d657c',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '08bd82f71bee409e147546836b6fec0885cc542b',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '207a874706216d356d7aaeeb4e8c034789402b80',
  'src/tools/gyp':
