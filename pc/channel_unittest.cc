...
class ChannelTest : public testing::Test, public sigslot::has_slots<> {
 public:
  ...
  void VerifySimulcastStreamParams(const StreamParams& expected,
    ...
    const std::vector<StreamParams>& streams = channel->GetLocalContent();
  ...
  void TestUpdateLocalStreamsWithSimulcast() {
    ...
    StreamParams stream1 = channel1_->GetLocalContent()[0];
    ...
    StreamParams stream2 = channel1_->GetLocalContent()[0];
