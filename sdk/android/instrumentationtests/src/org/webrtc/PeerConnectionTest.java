...
public class PeerConnectionTest {
  ...
  // Test that RIDs get set in the RTP sender when passed in through a TransceiverInit.
  @Test
  @SmallTest
  public void testSetRidInSimulcast() throws Exception {
    ...
    encodings.add(new Encoding("F", true, null, null, null, null, null, null));
    encodings.add(new Encoding("H", true, null, null, null, null, null, null));
