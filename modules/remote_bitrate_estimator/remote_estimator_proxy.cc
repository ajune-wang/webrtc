...
void RemoteEstimatorProxy::IncomingPacket(int64_t arrival_time_ms,
  ...
  if (network_state_estimator_ && header.extension.hasAbsoluteSendTime) {
    ...
    abs_send_timestamp_ +=
        header.extension.GetAbsoluteSendTimeDelta(previouse_abs_send_time_);
    previouse_abs_send_time_ = header.extension.absoluteSendTime;
