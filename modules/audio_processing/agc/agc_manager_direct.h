...
class MonoAgc {
 ...
 private:
  ...
  // Frames since the last `UpdateGain()` call. Reset to empty at the startup
  // and initialization and to 0 after gain updates.
  absl::optional<int> frames_since_update_gain_ = absl::nullopt;
};
