 ...
 public:
  ...
  class VideoDumpOptions {
   public:
    ...
    // with content of the stream. If true, output file with the same name as
    // video dump and suffix ".frame_ids.txt" will be cretaed. It will contain
    // assigned frame ids in the same order as original frames in the output
