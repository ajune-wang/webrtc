...
// Provides fake video encoder instances that produce frames large enough for
...
// Provides fake video decoder instances that ignore the given bistream and
// produce frames with alternating colors.
