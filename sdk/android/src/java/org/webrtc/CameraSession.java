...
interface CameraSession {
  ...
  static VideoFrame.TextureBuffer createTextureBufferWithModifiedTransformMatrix(
      VideoFrame.TextureBuffer buffer, boolean mirror, int rotation) {
    // final Matrix transformMatrix = new Matrix(buffer.getTransformMatrix());
    ...
    return buffer.applyTransformationMatrix(transformMatrix, buffer.getWidth(), buffer.getHeight());
  }
}
