...
ColorSpace::ColorSpace(PrimaryID primaries,
                       ...
                       MatrixID matrix,
                       RangeID range,
                       ChromaSitingHorizontal chroma_siting_horz,
                       ChromaSitingVertical chroma_siting_vert,
...
ColorSpace::ChromaSitingHorizontal ColorSpace::chroma_siting_horizontal()
    const {
  return chroma_siting_horizontal_;
}

ColorSpace::ChromaSitingVertical ColorSpace::chroma_siting_vertical() const {
...
bool ColorSpace::set_chroma_siting_horizontal_from_uint8(uint8_t enum_value) {
  constexpr ChromaSitingHorizontal kChromaSitingHorizontals[] = {
      ChromaSitingHorizontal::kUnspecified,
      ChromaSitingHorizontal::kLeftCollocated, ChromaSitingHorizontal::kHalf};
  constexpr uint64_t enum_bitmask = CreateEnumBitmask(kChromaSitingHorizontals);

  return SetFromUint8(enum_value, enum_bitmask, &chroma_siting_horizontal_);
}

bool ColorSpace::set_chroma_siting_vertical_from_uint8(uint8_t enum_value) {
  constexpr ChromaSitingVertical kChromaSitingVerticals[] = {
      ChromaSitingVertical::kUnspecified, ChromaSitingVertical::kTopCollocated,
      ChromaSitingVertical::kHalf};
  constexpr uint64_t enum_bitmask = CreateEnumBitmask(kChromaSitingVerticals);

  return SetFromUint8(enum_value, enum_bitmask, &chroma_siting_vertical_);
}
