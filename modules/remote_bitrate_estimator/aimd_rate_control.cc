...
static const float kDefaultBackoffFactor = 0.85;

const char kBweBackOffFactorExperiment[] = "WebRTC-BweBackOffFactorExperiment";
...
float ReadTrendlineFilterWindowSize() {
  ...
  if (parsed_values == 1) {
    RTC_CHECK_LT(backoff_factor, 1.0f) << "Must be < 1.0";
    RTC_CHECK_GT(backoff_factor, 0.0f) << "Must be < 1.0";
