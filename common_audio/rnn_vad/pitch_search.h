...
// gain. |x| is the pitch buffer, |pitch_period| is the initial estimation at 2x
// sample rate, and |last_pitch| comes from the previous frame.
...
// Search the pitch period in the pitch buffer |x|.
