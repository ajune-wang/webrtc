...
vars = {
  ...
  'chromium_revision': 'dab51277de1c26d2a315e2d722f0902e6e2eeece',
...
deps = {
  ...
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@bf2abde6946c246a63ac56be250ba07e49983ee2',
  'src/third_party':
    ...
    'packages': [
      {
          ...
          'version': 'n3LJ-ZGQJxBsfDPhuvkH7JR0njpIGbQ3sNwg2ebtzF8C',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
