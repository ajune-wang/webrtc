...
inline void StoreBigEndian8(uint8_t* data, uint8_t val) { data[0] = val; }
...
class BoundedByteWriter {
 public:
  ...
  void Store8(uint8_t value) {
    ...
    StoreBigEndian8(&data_[offset], value);
  }
  ...
  void Store16(uint16_t value) {
    ...
    StoreBigEndian16(&data_[offset], value);
  }
  ...
  void Store32(uint32_t value) {
    ...
    StoreBigEndian32(&data_[offset], value);
  }
