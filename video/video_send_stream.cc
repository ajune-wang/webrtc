...
VideoSendStreamImpl::VideoSendStreamImpl(
  ...
  if (initial_encoder_max_bitrate > 0) {
    ...
    // bitrate allocator. Previously -1 was implicitely casted to UINT32_MAX, a
    // behaviour that is not safe. Casting to 10 Mbps should be safe for
    ...
    encoder_max_bitrate_bps_ = 10000000;
  }
