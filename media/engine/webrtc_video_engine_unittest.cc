...
TEST_F(WebRtcVideoChannelTest, GetOutboundRtpSubstreams) {
  ...
  substreams[kFirstMediaStreamSsrc].frame_counts.key_frames = 9;
  ...
  substreams[kSecondMediaStreamSsrc].frame_counts.key_frames = 18;
  ...
  auto merged_substreams =
      WebRtcVideoChannel::GetOutboundRtpSubstreams(substreams);
