...
// State of the bandwidth estimate, that is equivalent to LossBasedState. The
// state can be either increasing/decreasing when network is loss limited, or
// equal to the delay based estimate.
