...
#ifndef WEBRTC_SDK_ANDROID_SRC_JNI_PC_PEERCONNECTION_H_
#define WEBRTC_SDK_ANDROID_SRC_JNI_PC_PEERCONNECTION_H_
...
#endif  // WEBRTC_SDK_ANDROID_SRC_JNI_PC_PEERCONNECTION_H_
