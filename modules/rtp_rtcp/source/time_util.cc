...
NtpTime TimeMicrosToNtp(int64_t time_us) {
  ...
  // Convert microseconds since 1900 to ntp units.

  // Convert seconds to uint32 through uint64.
  // Wrap around (will happen in 2036) is legal for ntp time.
  ...
  uint32_t ntp_fractions = DivideRoundToNearest(us_fractions * kNtpInSecond,
