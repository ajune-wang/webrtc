...
vars = {
  ...
  'chromium_revision': 'c9304d77cab8a6beaedf17801b01430f512112a6',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '7ff22c759f27f4c5f9f7d2e7c9f7b8992083fd52',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '23426fb1663add1960bc163cef8fbcf458ee5000',
  'src/tools/gyp':
