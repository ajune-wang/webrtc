...
void ParsedRtcEventLog::StoreGenericAckReceivedEvent(
  ...
  generic_acks_received_.push_back({proto.timestamp_ms(), proto.packet_number(),
  ...
  */
  for (size_t i = 0; i < number_of_deltas; i++) {
    ...
    generic_acks_received_.push_back({timestamp_ms, packet_number,
                                      acked_packet_number,
...
void ParsedRtcEventLog::StoreGenericPacketSentEvent(
  ...
  for (size_t i = 0; i < number_of_deltas; i++) {
    ...
    generic_packets_sent_.push_back({timestamp_ms, packet_number,
