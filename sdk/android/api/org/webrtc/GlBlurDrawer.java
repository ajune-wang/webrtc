...
public class GlBlurDrawer implements RendererCommon.GlDrawer {
  ...
  private final GlAveraging glAveraging = new GlAveraging();
  ...
  private void renderBlurredFrame(
    ...
    glAveraging.average(downscaledFrameBuffer);

    glRectDrawer.drawRgb(glAveraging.getTextureId(), RendererCommon.identityMatrix(),
