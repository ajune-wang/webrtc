 ...
 */
#ifndef MODULES_CONGESTION_CONTROLLER_GOCC_MEDIAN_SLOPE_ESTIMATOR_H_
#define MODULES_CONGESTION_CONTROLLER_GOCC_MEDIAN_SLOPE_ESTIMATOR_H_
...
#endif  // MODULES_CONGESTION_CONTROLLER_GOCC_MEDIAN_SLOPE_ESTIMATOR_H_
