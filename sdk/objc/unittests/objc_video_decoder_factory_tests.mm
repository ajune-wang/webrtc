...
id<RTC_OBJC_TYPE(RTCVideoDecoderFactory)> CreateDecoderFactoryReturning(int return_code) {
  ...
  RTC_OBJC_TYPE(RTCVideoCodecInfo) *supported = [[RTC_OBJC_TYPE(RTCVideoCodecInfo) alloc] initWithName:@"H264" parameters:nil];
...
std::unique_ptr<webrtc::VideoDecoder> GetObjCDecoder(id<RTC_OBJC_TYPE(RTCVideoDecoderFactory)> factory) {
