...
webrtc::VideoStream LayerWithRequestedResolution(webrtc::Resolution res) {
  webrtc::VideoStream s;
...
TEST(EncoderStreamFactory, SinglecastRequestedResolution) {
  ...
  EXPECT_EQ(GetStreamResolutions(streams), (std::vector<webrtc::Resolution>{
