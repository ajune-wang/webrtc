...
void DefaultVideoQualityAnalyzer::ReisterParticipantInCall(
...
void DefaultVideoQualityAnalyzer::StreamState::AddPeer() {
  const size_t new_head_index = frame_ids_.readers_count();
  frame_ids_.AddHead();
  frame_ids_.CopyHead(owner_, new_head_index);
}
