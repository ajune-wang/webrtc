...
class RtcpTransceiver {
 public:
  ...
  // TODO(bugs.webrtc.org/8239): Remove SendFeedback and SSRC functions and move
  // generating of the TransportFeedback message inside RtcpTransceiverImpl when
  // there is one RtcpTransceiver per rtp transport.
  uint32_t SSRC() const;
