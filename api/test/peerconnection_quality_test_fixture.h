   ...
   public:
    class Resolution {
     public:
      ...
      enum class Spec {
        // No ectra spec set. It describes regular resolution.
        kNone,
      ...
      Resolution(const VideoConfig& video_config);
    ...
    static std::optional<VideoSubscription::Resolution> GetMaxResolution(
