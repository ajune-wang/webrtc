...
class AudioDeviceIOS : public AudioDeviceGeneric,
 ...
 private:
  ...
  // Uses current `playout_parameters_` to inform the
  // audio device buffer (ADB) about our internal audio parameters.
  void UpdatePlayoutAudioDeviceBuffer();

  // Uses current `record_parameters_` to inform the
  // audio device buffer (ADB) about our internal audio parameters.
  void UpdateRecordAudioDeviceBuffer();
  ...
  void SetupPlayoutAudioBuffersForActiveAudioSession();

  void SetupRecordAudioBuffersForActiveAudioSession();
  ...
  void UpdateAudioUnit(BaseAudioUnit& audio_unit,
                       const AudioParameters& audio_params,
                       bool can_play_or_record,
