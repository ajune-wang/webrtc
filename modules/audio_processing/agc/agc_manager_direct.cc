...
void LogClippingMetrics(int clipping_ratio) {
  RTC_LOG(LS_INFO) << "Clipping ratio: " << clipping_ratio << "%";
  RTC_HISTOGRAM_COUNTS_LINEAR("WebRTC.Audio.Agc.ClippingRatio", clipping_ratio,
                              /*min=*/0, /*max=*/100, /*bucket_count=*/50);
}
