...
// b, a = signal.butter(2, 1500/16000.0, 'lowpass', analog=False) which are the
// same as b, a = signal.butter(2, 75/8000.0, 'lowpass', analog=False).
...
// b, a = signal.butter(2, 800/16000.0, 'lowpass', analog=False) which are the
// same as b, a = signal.butter(2, 400/8000.0, 'lowpass', analog=False).
