...
#ifndef API_VIDEO_CODECS_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
#define API_VIDEO_CODECS_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
...
#endif  // API_VIDEO_CODECS_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
