...
namespace {
const std::string audio_reference = "e0ddf36854059151cdb7a0c4af3d282a";
const std::string payload_reference = "b43bdf7638b2bc2a5a6f30bdc640b9ed";
// Common checksums.
...
TEST_F(AcmSenderBitExactnessNewApi, OpusFromFormat_stereo_20ms_voip) {
  ...
  ASSERT_NO_FATAL_FAILURE(SetUpTestExternalEncoder(
      AudioEncoderOpus::MakeAudioEncoder(*config, 120), 120));
  const std::string audio_checksum = "2d7e5797444f75e5bfeaffbd8c25176b";
  const std::string payload_checksum = "b38b5584cfa7b6999b2e8e996c950c88";
  Run(AcmReceiverBitExactnessOldApi::PlatformChecksum(
          audio_checksum, audio_checksum, "f1cefe107ffdced7694d7f735342adf3",
