...
// Forward declaration, so we can set this function as a friend of AudioManager.
// The actual declaration is in
// modules/audio_device/generated_audio_device_java_jni/WebRtcAudioManager_jni.h
namespace jni {
...
static void JNICALL
JNI_WebRtcAudioManager_CacheAudioParameters(JNIEnv* env,
                                            jint sample_rate,
...
class AudioManager {
 ...
 private:
  ...
  friend void JNICALL
  jni::JNI_WebRtcAudioManager_CacheAudioParameters(JNIEnv* env,
                                                   jint sample_rate,
                                                   jint output_channels,
                                                   jint input_channels,
                                                   jboolean hardware_aec,
