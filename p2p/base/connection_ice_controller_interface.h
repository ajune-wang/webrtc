...
#ifndef P2P_BASE_CONNECTION_ICE_CONTROLLER_INTERFACE_H_
#define P2P_BASE_CONNECTION_ICE_CONTROLLER_INTERFACE_H_
...
// This interface contains information for the IceController.
class ConnectionIceControllerInterface : public CandidatePairInterface {
 public:
  virtual ~ConnectionIceControllerInterface() = default;
...
#endif  // P2P_BASE_CONNECTION_ICE_CONTROLLER_INTERFACE_H_
