...
constexpr CodecBufferUsage None(int id) {
  return CodecBufferUsage(id, /*referenced=*/false, /*updated=*/false);
}
...
TEST(FrameDependenciesCalculatorTest, SingleLayer) {
  ...
  EXPECT_THAT(calculator.FromBuffersUsage(VideoFrameType::kVideoFrameKey,
                                          /*frame_id=*/1, pattern),
              IsEmpty());
...
TEST(FrameDependenciesCalculatorTest, TwoTemporalLayers) {
  ...
  //      /   /   /   /
  // T0: 1---3---5---7 ...
  CodecBufferUsage pattern[][3] = {{ReferenceAndUpdate(0), None(1), None(2)},
                                   {Reference(0), Update(1), None(2)},
                                   {ReferenceAndUpdate(0), None(1), None(2)},
                                   {Reference(0), Reference(1), None(2)}};
  FrameDependenciesCalculator calculator;
...
TEST(FrameDependenciesCalculatorTest, SimulcastWith2Layers) {
  ...
  //
  // S0: 1---3---5-  ...
  CodecBufferUsage pattern[][1] = {
      {ReferenceAndUpdate(0)},
      {ReferenceAndUpdate(1)},
  };
  FrameDependenciesCalculator calculator;
