...
TEST_F(P2PTransportChannelTest,
  ...
  EXPECT_EQ(1u, ice_transport_stats1.selected_candidate_pair_changes);
  EXPECT_EQ(3u, ice_transport_stats2.connection_infos.size());
  EXPECT_EQ(1u, ice_transport_stats2.selected_candidate_pair_changes);
...
TEST_F(P2PTransportChannelTest,
       ConnectingIncreaseSelectedCandidatePairChanges) {
  rtc::ScopedFakeClock clock;
  ConfigureEndpoints(OPEN, OPEN, kDefaultPortAllocatorFlags,
                     kDefaultPortAllocatorFlags);
  CreateChannels();
...
TEST_F(P2PTransportChannelTest,
       DisconnectedIncreaseSelectedCandidatePairChanges) {
  rtc::ScopedFakeClock clock;
  ConfigureEndpoints(OPEN, OPEN, kDefaultPortAllocatorFlags,
                     kDefaultPortAllocatorFlags);
  CreateChannels();
  ...
  EXPECT_EQ(nullptr, ep1_ch1()->selected_connection());
  ASSERT_TRUE(ep1_ch1()->GetStats(&ice_transport_stats));
...
TEST_F(P2PTransportChannelTest,
       NewSelectionIncreaseSelectedCandidatePairChanges) {
  rtc::ScopedFakeClock clock;
  ConfigureEndpoints(OPEN, OPEN, kDefaultPortAllocatorFlags,
                     kDefaultPortAllocatorFlags);
  CreateChannels();
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      ep1_ch1()->selected_connection() != selected_connection &&
          ep1_ch1()->selected_connection() != nullptr,
      kMediumTimeout, clock);
