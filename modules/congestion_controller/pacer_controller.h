...
class PacerController {
 ...
 public:
  CongestionWindow::MessageHandler CongestionWindowReceiver;
  NetworkAvailability::MessageHandler NetworkAvailabilityReceiver;
  NetworkRouteChange::MessageHandler NetworkRouteChangeReceiver;
  OutstandingData::MessageHandler OutstandingDataReceiver;
  PacerConfig::MessageHandler PacerConfigReceiver;
  ProbeClusterConfig::MessageHandler ProbeClusterConfigReceiver;
