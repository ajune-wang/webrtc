...
public class VideoFrame {
  ...
  public static VideoFrame.Buffer cropAndScaleI420A(final I420ABuffer buffer, int cropX, int cropY,
    ...
    nativeCropAndScaleI420A(buffer.getDataY(), buffer.getStrideY(), buffer.getDataU(),
  ...
  private static native void nativeCropAndScaleI420A(ByteBuffer srcY, int srcStrideY,
