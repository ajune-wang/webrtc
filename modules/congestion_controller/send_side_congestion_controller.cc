...
TargetRateConstraints ConvertContraints(int min_bitrate_bps,
                                        int max_bitrate_bps,
...
void SendSideCongestionController::SetBweBitrates(int min_bitrate_bps,
                                                  int start_bitrate_bps,
                                                  int max_bitrate_bps) {
  TargetRateConstraints msg = ConvertContraints(
...
void SendSideCongestionController::OnNetworkRouteChanged(
  ...
  msg.constraints = ConvertContraints(min_bitrate_bps, max_bitrate_bps,
