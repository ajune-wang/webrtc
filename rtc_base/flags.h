...
#define WEBRTC_DECLARE_bool(name) DECLARE_FLAG(bool, name)
#define WEBRTC_DECLARE_int(name) DECLARE_FLAG(int, name)
#define WEBRTC_DECLARE_float(name) DECLARE_FLAG(double, name)
#define WEBRTC_DECLARE_string(name) DECLARE_FLAG(const char*, name)
