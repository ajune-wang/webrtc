...
TEST_F(TestVp8Impl, DontDropKeyframes) {
  ...
  // Screensharing has the internal frame dropper off, and instead per frames
  ...
  // Reset the frame generator with large number of squares, leading lots of
  // details an high probability of overshoot.
  input_frame_generator_ = test::FrameGenerator::CreateSquareGenerator(
      codec_settings_.width, codec_settings_.height,
      test::FrameGenerator::OutputType::I420, absl::optional<int>(300));
