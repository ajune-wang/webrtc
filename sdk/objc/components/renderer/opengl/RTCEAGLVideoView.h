...
/**
 * RTC_OBJC_TYPE(RTCEAGLVideoView) is an RTC_OBJC_TYPE(RTCVideoRenderer) which renders video frames in its
...
- (instancetype)initWithFrame:(CGRect)frame
                       shader:(id<RTC_OBJC_TYPE(RTCVideoViewShading)>)shader NS_DESIGNATED_INITIALIZER;
