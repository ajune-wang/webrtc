...
MatchedFilter::MatchedFilter(ApmDataDumper* data_dumper,
                             ...
                             float smoothing_delay_not_found,
                             float smoothing_delay_found,
    ...
    : data_dumper_(data_dumper),
      ...
      smoothing_delay_not_found_(smoothing_delay_not_found),
      smoothing_delay_found_(smoothing_delay_found),
...
void MatchedFilter::Update(const DownsampledRenderBuffer& render_buffer,
                           ...
                           bool reliable_delay_found) {
  RTC_DCHECK_EQ(sub_block_size_, capture.size());
  auto& y = capture;

  const float smoothing = reliable_delay_found ? smoothing_delay_found_
                                               : smoothing_delay_not_found_;
