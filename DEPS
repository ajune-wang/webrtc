...
vars = {
  ...
  'chromium_revision': 'ce8bf10a5bef91198c0c36b653562eb97b03468b',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'd5599ea9768c393d1181c53a8af69e4273ba39b3',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'ea3426d7d9169ecc244aff7b15c7ab105aa9d46e',
  'src/tools/gyp':
