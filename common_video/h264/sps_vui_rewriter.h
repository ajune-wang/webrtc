...
class SpsVuiRewriter : private SpsParser {
 public:
  ...
  // Parses NAL units from |buffer| based on |nalu_offsets| and
  // |nalu_lengths| and rewrites VUI in SPS blocks if necessary.
  // The result is written to |output_buffer| and modified NAL unit
  // offsets and lenghts are written to |output_nalu_offsets| and
  // |output_nalu_lenghts| to account for any added data.
