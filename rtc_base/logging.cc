...
#if defined(WEBRTC_MUTEX_RACE_CHECK)
#if defined(WEBRTC_MUTEX_ABSL)
#error Please only define one of WEBRTC_MUTEX_RACE_CHECK and WEBRTC_MUTEX_ABSL.
#endif
...
#endif  // if defined(WEBRTC_MUTEX_RACE_CHECK)
...
#if defined(WEBRTC_MUTEX_RACE_CHECK)
// When WEBRTC_MUTEX_RACE_CHECK is defined, even though WebRTC objects are
