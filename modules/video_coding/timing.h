...
class VCMTiming {
 public:
  ...
  // complete before we must pass it to the decoder. The parameter
  // too_many_frames_queued is used to signal that the decode queue is full and
  // that the frame should be decoded as soon as possible.
