...
rtc::scoped_refptr<IceGatherer> P2PTransportChannel::CreateGatherer() {
  ...
  // This purposely ignores any pooled sessions.
  // If we ever need to have pooled shared gatherers, we should add
  // an IceGatherer::Start method and then call that to "pool".
