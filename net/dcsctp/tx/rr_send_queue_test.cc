...
TEST_F(RRSendQueueTest, WillSendMessagesByPrio) {
  ...
  buf_.SetStreamPriority(StreamID(1), StreamPriority(1));
  buf_.SetStreamPriority(StreamID(2), StreamPriority(2));
  buf_.SetStreamPriority(StreamID(3), StreamPriority(3));
