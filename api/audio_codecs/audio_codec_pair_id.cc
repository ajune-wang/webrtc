...
constexpr uint64_t ObfuscateId(uint64_t id) {
  ...
  return uint64_t{0x85fdb20e1294309a} + uint64_t{0xc516ef5c3746246a} * id;
}

// The first ten values. Verified against the Python function
//
//   def f(n):
//     return (0x85fdb20e1294309a + 0xc516ef5c3746246a * n) % 2**64
//
// Callers should obviously not depend on these exact values...
//
// (Ifdeffed out for the Visual C++ compiler, because it complains about the
// intentional and completely legal wraparounds in ObfuscateId.)
#ifndef _MSC_VER
static_assert(ObfuscateId(0) == uint64_t{0x85fdb20e1294309a}, "");
static_assert(ObfuscateId(1) == uint64_t{0x4b14a16a49da5504}, "");
static_assert(ObfuscateId(2) == uint64_t{0x102b90c68120796e}, "");
static_assert(ObfuscateId(3) == uint64_t{0xd5428022b8669dd8}, "");
static_assert(ObfuscateId(4) == uint64_t{0x9a596f7eefacc242}, "");
static_assert(ObfuscateId(5) == uint64_t{0x5f705edb26f2e6ac}, "");
static_assert(ObfuscateId(6) == uint64_t{0x24874e375e390b16}, "");
static_assert(ObfuscateId(7) == uint64_t{0xe99e3d93957f2f80}, "");
static_assert(ObfuscateId(8) == uint64_t{0xaeb52cefccc553ea}, "");
static_assert(ObfuscateId(9) == uint64_t{0x73cc1c4c040b7854}, "");
#endif  // _MSC_VER
