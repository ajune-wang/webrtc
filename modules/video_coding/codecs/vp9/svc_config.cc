...
const size_t kMinScreenSharingLayerBitrateKbps[] = {30, 150, 600};
const size_t kTargetScreenSharingLayerBitrateKbps[] = {100, 250, 1250};
const size_t kMaxScreenSharingLayerBitrateKbps[] = {200, 400, 1250};
