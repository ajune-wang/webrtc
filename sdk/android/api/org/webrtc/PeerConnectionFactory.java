...
public class PeerConnectionFactory {
  ...
  public VideoSource createVideoSource(VideoCapturer capturer) {
    final VideoSource videoSource = createVideoSource(capturer.isScreencast());
    final EglBase.Context eglContext =
        localEglbase == null ? null : localEglbase.getEglBaseContext();
    final SurfaceTextureHelper surfaceTextureHelper =
        SurfaceTextureHelper.create(VIDEO_CAPTURER_THREAD_NAME, eglContext);
    capturer.initialize(surfaceTextureHelper, ContextUtils.getApplicationContext(), videoSource);
    return videoSource;
  }
