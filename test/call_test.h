...
class CallTestSender {
 public:
  ...
  void CreateVideoStreamsForCalls(Call* sender_call, Call* receiver_call);
  void CreateVideoSendStreamsForCall(Call* sender_call);
  void CreateVideoReceiveStreamsForCall(Call* receiver_call);
  void CreateAudioStreamsForCalls(Call* sender_call, Call* receiver_call);
  void CreateFlexfecStreamsForCall(Call* receiver_call);
  ...
  void DestroyStreamsForCalls(Call* sender_call, Call* receiver_call);
  void DestroyVideoSendStreamsForCall(Call* sender_call);
  ...
  AudioSendStream::Config audio_send_config_ = AudioSendStream::Config(nullptr);
...
class CallTest : public ::testing::Test, public CallTestSender {
 public:
  CallTest();
  virtual ~CallTest();
 ...
 protected:
  ...
  CallTestSender* GetSender();
  CallTestSender* GetReturnSender();
