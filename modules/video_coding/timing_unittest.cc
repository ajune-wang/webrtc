...
TEST(ReceiverTiming, Tests) {
  ...
  EXPECT_EQ(jitter_delay_ms - 10, wait_time);
  ...
  // (10) to wait.
  EXPECT_EQ(kMinTotalDelayMs - kDecodeTimeMs - kRenderDelayMs, wait_time);
