...
AdaptiveDigitalGainApplier::AdaptiveDigitalGainApplier(
    ...
    : AdaptiveDigitalGainApplier(
          apm_data_dumper,
          kDigitalGainApplierAdjacentSpeechFramesThreshold) {}
...
AdaptiveDigitalGainApplier::AdaptiveDigitalGainApplier(
    ...
    : apm_data_dumper_(apm_data_dumper),
      ...
      time_to_gain_increase_allowed_(adjacent_speech_frames_threshold_),
      last_gain_db_(kInitialAdaptiveDigitalGainDb) {
  RTC_DCHECK_GE(time_to_gain_increase_allowed_, 1);
}
