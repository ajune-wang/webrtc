...
namespace rtp_transport_controller_send_internal {
...
class RtpTransportControllerSend final
 ...
 private:
  ...
  rtp_transport_controller_send_internal::PeriodicTask* pacer_queue_update_task_
      RTC_GUARDED_BY(task_queue_);
  rtp_transport_controller_send_internal::PeriodicTask* controller_task_
      RTC_GUARDED_BY(task_queue_);
