  ...
  void SetSendCodecsShouldWorkForBitrates(const char* min_bitrate_kbps,
    ...
    EXPECT_CALL(
        *fake_call_->GetMockSendTransportController(),
        SetBitrateConfig(AllOf(Field(&BitrateConstraints::min_bitrate_bps,
...
TEST_F(WebRtcVideoChannelTest, SetSendCodecsWithBitratesAndMaxSendBandwidth) {
  ...
  EXPECT_CALL(*fake_call_->GetMockSendTransportController(),
              SetBitrateConfig(
                  AllOf(Field(&BitrateConstraints::min_bitrate_bps, 100000),
                        Field(&BitrateConstraints::start_bitrate_bps, 200000),
                        Field(&BitrateConstraints::max_bitrate_bps, 400000))));
  ...
  EXPECT_CALL(*fake_call_->GetMockSendTransportController(),
              SetBitrateConfig(
                  AllOf(Field(&BitrateConstraints::min_bitrate_bps, 100000),
                        ...
                        Field(&BitrateConstraints::max_bitrate_bps, 350000))));
  ...
  EXPECT_CALL(*fake_call_->GetMockSendTransportController(),
              SetBitrateConfig(
                  AllOf(Field(&BitrateConstraints::min_bitrate_bps, 100000),
                        Field(&BitrateConstraints::start_bitrate_bps, 200000),
                        Field(&BitrateConstraints::max_bitrate_bps, 300000))));
  EXPECT_TRUE(channel_->SetSendParameters(send_parameters_));
...
TEST_F(WebRtcVideoChannelTest, SetMaxSendBandwidthShouldBeRemovable) {
  ...
  EXPECT_CALL(
      *fake_call_->GetMockSendTransportController(),
      SetBitrateConfig(Field(&BitrateConstraints::max_bitrate_bps, 300000)));
  ...
  EXPECT_CALL(
      *fake_call_->GetMockSendTransportController(),
      SetBitrateConfig(Field(&BitrateConstraints::max_bitrate_bps, -1)));
  EXPECT_TRUE(channel_->SetSendParameters(send_parameters_));
}
...
TEST_F(WebRtcVideoChannelTest, SetMaxSendBandwidthAndAddSendStream) {
  ...
  FakeVideoSendStream* stream = AddSendStream();
  EXPECT_CALL(*fake_call_->GetMockSendTransportController(),
              SetBitrateConfig(Field(&BitrateConstraints::max_bitrate_bps,
