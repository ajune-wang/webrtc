...
std::unique_ptr<EncodedFrame> CombineAndDeleteFrames(
  ...
  // Reconstructed (combined) frame will be the highest spatial layer and that's
  // why the corruption data for the highest layer should be used to calculate
  // the metric.
  //
  // TODO: bugs.webrtc.org/358039777 - Fix for LxTy scalability.
