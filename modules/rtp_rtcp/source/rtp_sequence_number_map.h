...
//
// 1. Thread-safe.
// 2. Limits number of entries.
// TODO: !!! Limit size to something below 2^15.
// 3. RTP sequence numbers wrap around relatively infrequently.
//    This class therefore only remembers the last 2^15 RTP packets, so
//    that the newest one's sequence number is still AheadOf the oldest one's.
