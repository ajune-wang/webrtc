...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  struct VideoSimulcastConfig {
    ...
    // Specified amount of simulcast streams/SVP layers, depending on which
    // encoder is used.
  ...
  struct VideoConfig {
    ...
    // If presented video will be transfered in simulcast/SVP mode depending on
