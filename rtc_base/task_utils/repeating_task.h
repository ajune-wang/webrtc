...
class RepeatingTaskHandle {
 public:
  ...
  static RepeatingTaskHandle&& Start(rtc::TaskQueue* task_queue,
    ...
    return std::move(RepeatingTaskHandle(repeating_task_ptr));
  }
  template <class Closure>
  ...
  template <class Closure>
  static RepeatingTaskHandle&& DelayStart(rtc::TaskQueue* task_queue,
                                          TimeDelta first_delay,
                                          Closure&& closure) {
    auto repeating_task = absl::make_unique<
        webrtc_repeating_task_impl::RepeatingTaskImpl<Closure>>(
  ...
  template <class Closure>
  static RepeatingTaskHandle&& DelayStart(TimeDelta first_delay,
                                          Closure&& closure) {
    return DelayStart(rtc::TaskQueue::Current(), first_delay,
