...
Channel::Channel(ProcessThread* module_process_thread,
    ...
    : event_log_proxy_(new RtcEventLogProxy()),
      ...
      associate_send_channel_(nullptr),
...
void Channel::set_associate_send_channel(Channel* channel) {
  ...
  if (report_blocks.empty()) {
    if (allow_associate_channel) {
      ...
      if (associate_send_channel_) {
        ...
        rtt = associate_send_channel_->GetRTT(false);
      }
    }
    return rtt;
  }
