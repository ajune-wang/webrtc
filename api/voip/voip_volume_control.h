...
class VoipVolumeControl {
 public:
  ...
  // Returns the microphone level.
  virtual VolumeInfo GetInputLevel(ChannelId channel_id) = 0;

  // Returns the speaker level.
  virtual VolumeInfo GetOutputLevel(ChannelId channel_id) = 0;
