...
void BaseChannel::CacheEncryptedHeaderExtensionIds(
  ...
  source == ContentSource::CS_LOCAL
      ? recv_extension_ids_.emplace(extension_ids)
      : send_extension_ids_.emplace(extension_ids);
}
...
bool BaseChannel::EncryptedHeaderExtensionIdsChanged(
  ...
  if (source == ContentSource::CS_LOCAL) {
    return !recv_extension_ids_ || (*recv_extension_ids_) != new_extension_ids;
  } else {
    return !send_extension_ids_ || (*send_extension_ids_) != new_extension_ids;
  }
}
