...
public class WebRtcAudioTrack {
  ...
  public static interface WebRtcAudioTrackErrorCallbackExtended {
    void onWebRtcAudioTrackInitError(String errorMessage);
  ...
  private static WebRtcAudioTrackErrorCallbackExtended errorCallbackExt = null;
  ...
  public static void setErrorCallback(WebRtcAudioTrackErrorCallbackExtended errorCallback) {
    Logging.d(TAG, "Set extended error callback");
    WebRtcAudioTrack.errorCallbackExt = errorCallback;
  }
  ...
  private void reportWebRtcAudioTrackInitError(String errorMessage) {
    ...
    if (errorCallbackExt != null) {
      errorCallbackExt.onWebRtcAudioTrackInitError(errorMessage);
    }
  }
  ...
  private void reportWebRtcAudioTrackStartError(
    ...
    if (errorCallbackExt != null) {
      errorCallbackExt.onWebRtcAudioTrackStartError(errorCode, errorMessage);
    }
  }
  ...
  private void reportWebRtcAudioTrackError(String errorMessage) {
    ...
    if (errorCallbackExt != null) {
      errorCallbackExt.onWebRtcAudioTrackError(errorMessage);
    }
  }
