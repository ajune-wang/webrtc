...
TEST_F(VideoQualityAnalysisTest,
  ...
  std::vector<std::string> expected_out = {
      "RESULT NormalStatsFile: Unique_frames_count= 0 score",
      "RESULT NormalStatsFile: Max_repeated= 2 ",
      "RESULT NormalStatsFile: Max_skipped= 2 ",
      "RESULT NormalStatsFile: Total_skipped= 3 ",
      "RESULT NormalStatsFile: Decode_errors_reference= 0 ",
      "RESULT NormalStatsFile: Decode_errors_test= 0 "};
...
TEST_F(VideoQualityAnalysisTest,
  ...
  std::vector<std::string> expected_out = {
      "RESULT NormalStatsFile: Unique_frames_count= 0 score",
      "RESULT NormalStatsFile: Max_repeated= 1 ",
      "RESULT NormalStatsFile: Max_skipped= 0 ",
      "RESULT NormalStatsFile: Total_skipped= 0 ",
      "RESULT NormalStatsFile: Decode_errors_reference= 0 ",
      "RESULT NormalStatsFile: Decode_errors_test= 3 "};
  VerifyLogOutput(log_filename, expected_out);
}
