...
// BuiltInEmulatedNode is a NetworkNode that expose an interface for changing
// run time behavior of the underlying simulation.
class BuiltInEmulatedNode : public EmulatedNetworkNode {
 public:
 ...
 private:
  ...
  BuiltInEmulatedNode(NetworkNodeConfig config,
                      std::unique_ptr<NetworkBehaviorInterface> behavior,
                      SimulatedNetwork* simulation);
  static std::unique_ptr<BuiltInEmulatedNode> Create(NetworkNodeConfig config);
