...
TEST_P(RtpSenderTestWithoutPacer, PacketOptionsNoRetransmission) {
  ...
  EXPECT_EQ(PacketOptions::RetransmissionStatus::kNone,
            transport_.last_options_.retransmission);
}
...
TEST_P(RtpSenderTest, OnSendPacketNotUpdatedForRetransmits) {
  ...
  rtp_sender_->TimeToSendPacket(kSsrc, kSeqNum,
                                ...
                                PacedPacketInfo());
  EXPECT_EQ(1, transport_.packets_sent());
  EXPECT_EQ(PacketOptions::RetransmissionStatus::kRetransmission,
            transport_.last_options_.retransmission);
}
...
TEST_P(RtpSenderTest, SendRedundantPayloads) {
  ...
  EXPECT_EQ(PacketOptions::RetransmissionStatus::kRtx, options.retransmission);
  ...
  EXPECT_EQ(PacketOptions::RetransmissionStatus::kNone, options.retransmission);
}
