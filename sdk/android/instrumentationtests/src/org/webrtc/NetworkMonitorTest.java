...
public class NetworkMonitorTest {
  ...
  /**
   * Tests that when stopMonitoringAll is called, all observers are cleared.
   */
  @Test
  @SmallTest
  public void testStartStopMonitoringAll() {
    NetworkMonitor networkMonitor = NetworkMonitor.getInstance();
    Context context = ContextUtils.getApplicationContext();
    networkMonitor.startMonitoring(context);
    networkMonitor.startMonitoring(context);
    assertEquals(2, networkMonitor.getNumObservers());
    assertNotNull(networkMonitor.getNetworkMonitorAutoDetect());
    networkMonitor.stopMonitoringAll();
    assertEquals(0, networkMonitor.getNumObservers());
    assertNull(networkMonitor.getNetworkMonitorAutoDetect());
