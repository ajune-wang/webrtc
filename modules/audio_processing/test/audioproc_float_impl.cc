...
ABSL_FLAG(int,
          experimental_multichannel,
          kParameterNotSpecifiedValue,
          "Activate (1) or deactivate(0) multichannel audio in APM pipeline");
ABSL_FLAG(int,
          simulated_mic_kind,
          kParameterNotSpecifiedValue,
...
SimulationSettings CreateSettings() {
  ...
  SetSettingIfFlagSet(absl::GetFlag(FLAGS_experimental_multichannel),
                      &settings.experimental_multichannel);
