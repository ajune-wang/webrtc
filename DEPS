...
vars = {
  ...
  'chromium_revision': 'c1319e8671e0348986abd01137ea412599e86931',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '6e014ae89db05b07a0d31fcb67be85afe9d1c362',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b9a0a0d4bed64220fafddd75b04ae1ab7f70fd95',
  'src/tools/gyp':
