...
class VideoReceiveStream : public webrtc::VideoReceiveStream,
 ...
 private:
  ...
  // Defined last so it's destroyed and stopped before all members.
  rtc::TaskQueue decode_queue_;

  // Defined last so it's destroyed before decode_queue_, since it can send
  // callbacks that are run on decode_queue_ while it's alive.
