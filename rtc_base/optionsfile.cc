...
bool OptionsFile::GetStringValue(const std::string& option,
  ...
  RTC_LOG(LS_VERBOSE) << "OptionsFile::GetStringValue "
                  << option;
...
bool OptionsFile::GetIntValue(const std::string& option,
                              int *out_val) const {
  RTC_LOG(LS_VERBOSE) << "OptionsFile::GetIntValue "
                  << option;
  if (!IsLegalName(option)) {
    return false;
  }
...
bool OptionsFile::SetStringValue(const std::string& option,
  ...
  RTC_LOG(LS_VERBOSE) << "OptionsFile::SetStringValue "
                  << option << ":" << value;
...
bool OptionsFile::SetIntValue(const std::string& option,
                              int value) {
  RTC_LOG(LS_VERBOSE) << "OptionsFile::SetIntValue "
                  << option << ":" << value;
  if (!IsLegalName(option)) {
    return false;
  }
