...
vars = {
  ...
  'chromium_revision': '0f5af19c90104e13179d976dce235c9a26b629c5',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'df8d7a49c7ab9609a1fdae8b857d1499af1956dc',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'c2e5fd01ccca4657c77d09f7dd1fc8698bb966b2',
  'src/tools/gyp':
