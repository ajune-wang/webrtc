...
ProbeController::ProbeController(ProbeClusterConfig::Observer* observer)
    : cluster_config_observer_(observer), enable_periodic_alr_probing_(false) {
  using This = ProbeController;
  NetworkAvailabilityReceiver.Bind(this, &This::OnNetworkAvailability);
