...
namespace webrtc {
namespace {
constexpr auto HasFrameWithIdAndRefs =
    &RtpRefFinderTestHelper::HasFrameWithIdAndRefs;
}  // namespace
...
class Frame {
 public:
  ...
  operator std::unique_ptr<RtpFrameObject>() {
    ...
    vp8_header.pictureId = *picture_id;
    vp8_header.temporalIdx = *temporal_id;
    vp8_header.tl0PicIdx = *tl0_idx;
