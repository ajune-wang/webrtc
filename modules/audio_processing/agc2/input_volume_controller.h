...
class InputVolumeController final {
 public:
  ...
  // TODO(webrtc:7494): Deprecate this method.
 ...
 private:
  ...
  // If true, the channel controlling the input volume is the one with the
  // lowest volume, othwerwise it's the one with the highest volume.
