 ...
 *  RTC_OBJC_TYPE(RTCRtpTransceiver). Use isEqual: instead of == to compare
 * RTC_OBJC_TYPE(RTCRtpTransceiver) instances. This is only available with
 ...
 *  the newly created RTC_OBJC_TYPE(RTCRtpSender). The RTC_OBJC_TYPE(RTCRtpSender) will be
