...
class VideoSinkInterface {
 public:
  ...
  // A no-op version of the old signature is provided to allow migration.
  // TODO(https://crbug.com/1157072): When upstream projects have migrated to
  // the other signature, delete this version of OnFrame().
