...
class AudioDeviceTest : public ::testing::Test {
 protected:
  ...
  AudioDeviceModuleAndroid* audio_device_impl() const {
    return static_cast<AudioDeviceModuleAndroid*>(audio_device_.get());
  }
  ...
  AudioManager* GetAudioManager(AudioDeviceModule* adm) const {
    return static_cast<AudioDeviceModuleAndroid*>(adm)
