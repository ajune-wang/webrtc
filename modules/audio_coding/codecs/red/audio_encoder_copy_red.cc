...
AudioEncoder::EncodedInfo AudioEncoderCopyRed::EncodeImpl(
  ...
  EncodedInfo info = speech_encoder_->Encode(rtp_timestamp, audio, &primary_encoded);
  ...
  if (tertiary_info_.encoded_bytes > 0 && tertiary_info_.encoded_bytes < kRedMaxPacketSize) {
  ...
  if (secondary_info_.encoded_bytes > 0 && secondary_info_.encoded_bytes < kRedMaxPacketSize) {
