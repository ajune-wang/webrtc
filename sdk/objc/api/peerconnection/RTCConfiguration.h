 ...
 *  RTC_OBJC_TYPE(RTCRtpReceiver) (an RTC_OBJC_TYPE(RTCRtpTransceiver)), either both audio or both
 * video. This will also cause RTC_OBJC_TYPE(RTCPeerConnection) to ignore all but the first a=ssrc
