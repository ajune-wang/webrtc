...
vars = {
  ...
  'chromium_revision': 'ab595088ec2dd55b76cae534c86af4769a687128',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '948b7aa1a6ceb88514234b615bb117459b22ec35',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '3952705541dfe8ef41701bf78dfa39b5a7fd1ddc',
  'src/tools/gyp':
