...
#ifndef SDK_ANDROID_SRC_JNI_STACKTRACE_STACKTRACE_H_
#define SDK_ANDROID_SRC_JNI_STACKTRACE_STACKTRACE_H_
...
#endif  // SDK_ANDROID_SRC_JNI_STACKTRACE_STACKTRACE_H_
