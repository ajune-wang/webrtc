...
class AudioDeviceIOS : public AudioDeviceGeneric,
 ...
 public:
  ...
  OSStatus OnGetPlayoutData(AudioUnitRenderActionFlags* flags,
                            ...
                            UInt32 num_frames,
                            AudioBufferList* io_data) override;
  void OnReceivedMutedSpeechActivity(AUVoiceIOSpeechActivityEvent event) override;
 ...
 private:
  ...
  // Determines whether mute speech detection should be enabled or disabled.
  bool detect_mute_speech_;
