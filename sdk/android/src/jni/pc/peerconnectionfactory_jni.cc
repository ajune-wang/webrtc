  ...
  if (video_hw_acceleration_enabled) {
    if (jencoder_factory == nullptr && jdecoder_factory == nullptr) {
      ...
      media_engine.reset(CreateMediaEngine(
          ...
          legacy_video_encoder_factory, legacy_video_decoder_factory,
      ...
      media_engine.reset(CreateMediaEngine(adm_scoped, audio_encoder_factory,
    ...
    media_engine.reset(
        CreateMediaEngine(adm, audio_encoder_factory, audio_decoder_factory,
                          nullptr, nullptr, audio_mixer, audio_processor));
  }
