...
class NullReceiver : public EmulatedNetworkReceiverInteface {
 public:
  void OnPacketReceived(EmulatedIpPacket packet) override;
};
class ActionReceiver : public EmulatedNetworkReceiverInteface {
 public:
...
class NetworkNode : public EmulatedNetworkReceiverInteface {
 public:
  ...
  static void Route(uint64_t receiver_id,
                    ...
                    EmulatedNetworkReceiverInteface* receiver);
 ...
 private:
  ...
  void SetRoute(uint64_t receiver, EmulatedNetworkReceiverInteface* node);
  ...
  std::map<uint64_t, EmulatedNetworkReceiverInteface*> routing_
      RTC_GUARDED_BY(crit_sect_);
...
class CrossTrafficSource {
 ...
 private:
  friend class Scenario;
  CrossTrafficSource(EmulatedNetworkReceiverInteface* target,
                     uint64_t receiver_id,
                     CrossTrafficConfig config);
  void Process(Timestamp at_time, TimeDelta delta);

  EmulatedNetworkReceiverInteface* const target_;
