...
class RenderReverbModel {
 public:
  ...
  // Apply the reverberation model over the render spectrum. It also returns the
  // reverberation render power spectrum in the array reverb_power_spectrum.
  void ApplyReverb(const VectorBuffer& spectrum_buffer,
                   int delay_blocks,
                   float reverb_decay,
