...
// video payload when raw_packetization_for_video_enabled is true.
TEST_P(PeerConnectionMediaTest, RawPacketizationSetInOfferAndAnswer) {
  ...
  RTCOfferAnswerOptions options;
  options.raw_packetization_for_video_enabled = true;
...
// raw_packetization_for_video_enabled is true if it was not set in the offer.
TEST_P(PeerConnectionMediaTest,
  ...
  caller_options.raw_packetization_for_video_enabled = false;
  RTCOfferAnswerOptions callee_options;
  callee_options.raw_packetization_for_video_enabled = true;
