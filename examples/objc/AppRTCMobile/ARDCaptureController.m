...
- (AVCaptureDevice *)findDeviceForPosition:(AVCaptureDevicePosition)position {
    NSArray<AVCaptureDevice *> *captureDevices = [ARDARVideoCapturer captureDevices];
...
- (AVCaptureDeviceFormat *)selectFormatForDevice:(AVCaptureDevice *)device {
    ...
    [ARDARVideoCapturer supportedFormatsForDevice:device];
    ...
    for (AVCaptureDeviceFormat *format in formats) {
        ...
        if ([depthFormats count]==0) continue;
    ...
    NSLog(@"QiangChen: Select %dx%d %d", dimension.width, dimension.height, pixelFormat);
