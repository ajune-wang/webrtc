...
//////////////////////////////////////////////////////////////////////
// OpenSSLAdapterFactory::Impl
//////////////////////////////////////////////////////////////////////
class OpenSSLAdapterFactory::Impl final {
 public:
  void SetMode(SSLMode mode);
  OpenSSLAdapter* CreateAdapter(AsyncSocket* socket);
...
void OpenSSLAdapterFactory::Impl::SetMode(SSLMode mode) {
  RTC_DCHECK(!ssl_session_cache_);
  ssl_mode_ = mode;
}

OpenSSLAdapter* OpenSSLAdapterFactory::Impl::CreateAdapter(
    AsyncSocket* socket) {
  if (ssl_session_cache_ == nullptr) {
    SSL_CTX* ssl_ctx =
...
//////////////////////////////////////////////////////////////////////
OpenSSLAdapterFactory::OpenSSLAdapterFactory() : impl_(new Impl()) {}
...
OpenSSLAdapter* OpenSSLAdapterFactory::CreateAdapter(AsyncSocket* socket) {
  return impl_->CreateAdapter(socket);
}
