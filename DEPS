...
vars = {
  ...
  'chromium_revision': 'e1b9354ff443264487bd09d8acd9bcc802abe4e4',
}
...
deps = {
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@d365fb88979ff5e5e63e6252429085d0a6c4dc15',
