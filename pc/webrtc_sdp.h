...
bool SdpDeserialize(const absl::string_view message,
...
// error - The detail error information when parsing fails.
// return - true on success, false on failure.
RTC_EXPORT bool SdpDeserializeCandidate(const absl::string_view message,
...
// error - The detail error information when parsing fails.
// return - true on success, false on failure.
RTC_EXPORT bool SdpDeserializeCandidate(const absl::string_view transport_name,
...
RTC_EXPORT bool ParseCandidate(const absl::string_view message,
                               cricket::Candidate* candidate,
                               SdpParseError* error,
                               bool is_raw);
