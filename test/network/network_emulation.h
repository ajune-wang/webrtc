...
struct EmulatedNetworkStatsImpl
    : public rtc::RefCountedObject<EmulatedNetworkStats> {
...
class EmulatedEndpointImpl : public EmulatedEndpoint {
 public:
  ...
  rtc::scoped_refptr<EmulatedNetworkStats> stats() override;
 ...
 private:
  ...
  rtc::scoped_refptr<EmulatedNetworkStatsImpl> stats_
      RTC_GUARDED_BY(task_queue_);
};
...
class EndpointsContainer {
 public:
  ...
  rtc::scoped_refptr<EmulatedNetworkStats> GetStats() const;
