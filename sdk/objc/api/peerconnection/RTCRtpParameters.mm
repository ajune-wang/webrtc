...
- (instancetype)initWithNativeParameters:
  ...
  if (self = [self init]) {
    ...
    _rtcp = [[RTC_OBJC_TYPE(RTCRtcpParameters) alloc] initWithNativeParameters:nativeParameters.rtcp];
    ...
    for (const auto &headerExtension : nativeParameters.header_extensions) {
      [headerExtensions
          addObject:[[RTC_OBJC_TYPE(RTCRtpHeaderExtension) alloc] initWithNativeParameters:headerExtension]];
    }
