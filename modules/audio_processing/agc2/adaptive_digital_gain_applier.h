...
class AdaptiveDigitalGainApplier {
 ...
 private:
  ...
  // For some combinations of noise and speech probability,
  // attenuation is not allowed. Since we may get VAD results in
  // bursts, we keep track of this varible until the next VAD results
  // come in.
