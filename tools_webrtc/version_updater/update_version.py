...
def _RemovePreviousUpdateBranch(dry_run):
...
def _CreateRollBranch(dry_run):
    logging.info('Creating roll branch: %s', UPDATE_BRANCH_NAME)
    if not dry_run:
...
def _CreateUpdateBranch(dry_run):
