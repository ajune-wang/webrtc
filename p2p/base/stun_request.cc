...
bool StunRequestManager::CheckResponse(StunMessage* msg) {
  ...
  // TODO(tommi): Workaround in case request objects were deleted during the
  // above steps:
  iter = requests_.find(msg->transaction_id());
  if (iter == requests_.end()) {
    fprintf(stderr, "[CheckResponse]: request already deleted\n");
  } else {
