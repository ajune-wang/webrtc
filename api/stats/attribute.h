...
class RTC_EXPORT Attribute : public RTCStatsMemberInterface {
 ...
 private:
  // TODO(https://crbug.com/webrtc/15164): Replace uses of RTCStatsMember with
  // absl::optional<T> and update these pointer types.
...
std::unique_ptr<RTCStatsMemberInterface> MemberToAttribute(
