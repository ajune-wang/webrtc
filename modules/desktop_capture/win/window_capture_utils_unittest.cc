...
WindowInfo CreateTestWindow(const wchar_t* window_title) {
  WindowInfo info;
  ...
  auto window_class = _T("WindowClass");
  WNDCLASSEX wcex;
  ...
  info.hwnd = ::CreateWindow(window_class, window_title, WS_OVERLAPPEDWINDOW,
