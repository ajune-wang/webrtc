...
vars = {
  ...
  'chromium_revision': 'ea859b0e795297e0d0d69283aad1e4eace1ff7a8',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'e2059814a79cb7a3e701e487f1602f84b962e8c3',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'fd79edb0877bd7ca1822cdbc30ac8586aee8253d',
  'src/tools/gyp':
