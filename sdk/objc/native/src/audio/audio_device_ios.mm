...
void AudioDeviceIOS::HandleInterruptionBegin() {
  ...
  if (audio_input_unit_ && audio_input_unit_->GetState() == BaseAudioUnit::State::kStarted) {
  ...
  if (audio_output_unit_ && audio_output_unit_->GetState() == BaseAudioUnit::State::kStarted) {
...
void AudioDeviceIOS::SetupAudioBuffersForActiveAudioSession() {
  ...
  RTC_LOG(LS_INFO) << "Recording parameters: " << record_parameters_.ToString();
...
bool AudioDeviceIOS::BeginWebRTCAudioSession() {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  LOGI() << "BeginWebRTCAudioSession";
...
bool AudioDeviceIOS::InitAudioInputUnit() {
  ...
  if (session.canPlayOrRecord) {
    audio_input_unit_->Initialize(record_parameters_.sample_rate());
  }
  return true;
}
