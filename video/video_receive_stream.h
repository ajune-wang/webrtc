...
class VideoReceiveStream : public webrtc::VideoReceiveStream,
 ...
 private:
  ...
  void ProcessKeyFrameGeneration(const video_coding::EncodedFrame& frame);
  ...
  void DispatchEncodedFrame(std::unique_ptr<video_coding::EncodedFrame> frame)
      RTC_RUN_ON(decode_queue_);
