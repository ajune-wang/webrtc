...
#ifndef WEBRTC_RTC_TOOLS_FRAME_ANALYZER_LINEAR_LEAST_SQUARES_H_
#define WEBRTC_RTC_TOOLS_FRAME_ANALYZER_LINEAR_LEAST_SQUARES_H_
...
#endif  // WEBRTC_RTC_TOOLS_FRAME_ANALYZER_LINEAR_LEAST_SQUARES_H_
