...
// DTLS1_2 will be accepted, unless the trial flag
// WebRTC-LegacyTlsProtocols/Enabled/ is passed in. Support for these
// protocol versions will be completely removed in M84.
