...
#ifndef MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_DECODER_H_
#define MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_DECODER_H_
...
class WebMVp8Decoder : public VP8Decoder {
 public:
  WebMVp8Decoder();
  ~WebMVp8Decoder() override;
...
#endif  // MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_DECODER_H_
