...
struct NetEqLifetimeStatistics {
  ...
  // expected arrival time. The expected arrival time is the difference in
  // sender timestamps between the received packet and a reference packet
  // previously received. The actual arrival time is the time measured between
  // these packets. The reference packet is chosen by keeping a finite history
  // of packets and picking the packet such that we maximize the relative packet
  // arrival delay.
