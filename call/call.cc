...
class Call final : public webrtc::Call,
 ...
 private:
  ...
  AudioReceiveStream* FindAudioStreamForSyncGroup(
      const absl::string_view sync_group) RTC_RUN_ON(worker_thread_);
  void ConfigureSync(const absl::string_view sync_group)
...
// RTC_RUN_ON(worker_thread_)
void Call::ConfigureSync(const absl::string_view sync_group) {
