...
struct Vp9ScalabilityStructure {
...
absl::optional<Vp9ScalabilityStructure> CreateVp9ScalabilityStructure(
  ...
  if (num_spatial_layers == 1 && num_temporal_layers == 1) {
    return Vp9ScalabilityStructure{
        .svc_controller = std::make_unique<ScalableVideoControllerNoLayering>(),
  ...
  return Vp9ScalabilityStructure{
      .svc_controller = std::move(scalability_structure_controller),
...
int LibvpxVp9Encoder::InitEncode(const VideoCodec* inst,
  ...
  if (scalability_mode_.has_value()) {
    ...
    if (vp9_scalability.has_value()) {
      svc_controller_ = std::move(vp9_scalability->svc_controller);
      scalability_mode_ = vp9_scalability->scalability_mode;
    }
  }
