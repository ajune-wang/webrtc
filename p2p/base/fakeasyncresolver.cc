...
void FakeAsyncResolver::Destroy(bool wait) {
  // Calling delete here causes sanitizer builds to fail because Destroy
  // will be called synchronously from Start. We have other test code manage the
  // lifetime of the fake resolver instead.
}
