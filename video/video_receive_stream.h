...
class VideoReceiveStream : public webrtc::VideoReceiveStream,
 ...
 public:
  ...
  RecordableEncodedFrameFunction ReleaseEncodedFrameBufferFunction() override;
 ...
 private:
  ...
  bool ReceivingKeyframe(int64_t timestamp_ms) const RTC_RUN_ON(decode_queue_);
  ...
  RecordableEncodedFrameFunction encoded_frame_buffer_function_
      RTC_GUARDED_BY(decode_queue_);
  // Set to true while we're requesting keyframes.
  bool keyframe_requested_due_to_encoded_output_ RTC_GUARDED_BY(decode_queue_) =
      false;
