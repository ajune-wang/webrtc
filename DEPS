...
vars = {
  ...
  'chromium_revision': '9b0f6e3cf6bcb6aa0fa1ab8e0475dca938806a50',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '3296e11b3765efd589c740271e1abbe3b786e168',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'de3b2bccf75e2e72dba151e3aae21b8dc3b3cdc1',
  'src/tools/gyp':
