...
TEST(VideoSourceRestrictions,
  ...
  EXPECT_TRUE(DidRestrictionsIncrease(kHd, kUnlimited));
  EXPECT_TRUE(DidRestrictionsIncrease(k15fps, kUnlimited));
  EXPECT_TRUE(DidRestrictionsIncrease(kHd15fps, kHd));
  EXPECT_TRUE(DidRestrictionsIncrease(kHd15fps, kUnlimited));
}
