...
class SendSideCongestionController : public CallStatsObserver,
 ...
 private:
  ...
  int64_t min_pacing_bitrate_bps_ RTC_GUARDED_BY(network_state_lock_);
  int64_t max_padding_bitrate_bps_ RTC_GUARDED_BY(network_state_lock_);
  float pacing_factor_ RTC_GUARDED_BY(network_state_lock_);
