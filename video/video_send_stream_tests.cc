   ...
   public:
    ...
    void PerformTest() override {
      ...
      task_queue_->SendTask([this, &new_route, &bitrate_config]() {
        call_->GetSendTransportController()->OnNetworkRouteChanged("transport",
                                                                   new_route);
        bitrate_config.start_bitrate_bps = kStartBitrateBps;
        call_->GetSendTransportController()->SetBitrateConfig(bitrate_config);
      });
...
TEST_F(VideoSendStreamTest, CanReconfigureToUseStartBitrateAbovePreviousMax) {
  ...
  sender_call_->GetSendTransportController()->SetBitrateConfig(bitrate_config);
  ...
  class EncoderBitrateThresholdObserver : public test::SendTest,
   ...
   private:
    ...
    void PerformTest() override {
      ...
      // call_->GetSendTransportController()->SetBitrateConfig.
