...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private Builder(Context context) {
      ...
      this.sampleRate = WebRtcAudioUtils.getSampleRate(audioManager);
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      // TODO(magjed): Hook up audio source.
      final WebRtcAudioRecord audioInput = new WebRtcAudioRecord(audioRecordErrorCallback,
          samplesReadyCallback, useHardwareAcousticEchoCanceler, useHardwareNoiseSuppressor);
      final WebRtcAudioTrack audioOutput = new WebRtcAudioTrack(context, audioTrackErrorCallback);
      final long nativeAudioDeviceModule = nativeCreateAudioDeviceModule(
          context, audioInput, audioOutput, sampleRate, useStereoInput, useStereoOutput);
