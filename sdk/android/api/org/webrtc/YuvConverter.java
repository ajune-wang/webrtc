...
class YuvConverter {
  ...
  public I420Buffer convert(TextureBuffer textureBuffer) {
    ...
    convert(buffer, width, height, stride, textureBuffer.getTextureId(), textureBuffer.getType());
    ...
    return JavaI420Buffer.wrap(
        width, height, dataY, stride, dataU, stride, dataV, stride, null /* releaseCallback */);
  }
  ...
  private void convert(ByteBuffer buf, int width, int height, int stride, int srcTextureId,
    ...
    GLES20.glBindTexture(textureType.glTarget(), srcTextureId);
    ...
    GLES20.glBindTexture(textureType.glTarget(), 0);
  }
