...
typedef std::set<PortTypeToAllocateInFakeSession>
    AllocationSequenceForFakeSesssion;
...
class FakePortAllocatorSession : public PortAllocatorSession {
 public:
  ...
  void set_allocation_sequence(
      AllocationSequenceForFakeSesssion allocation_sequence) {
 ...
 private:
  ...
  bool running_ = false;
  AllocationSequenceForFakeSesssion allocation_sequence_;
};
