...
- (nonnull RTC_OBJC_TYPE(RTCVideoEncoderCodecSupport) *)
  ...
  RTC_OBJC_TYPE(RTCVideoScalabilityMode)* mode = [[RTCVideoScalabilityMode alloc] initWithName:scalabilityMode];
  if (mode == nil) {
  ...
  if ([info.name isEqualToString:kRTCVideoCodecAv1Name]) {
    bool supported = [RTC_OBJC_TYPE(RTCVideoEncoderAV1) isScalabilityModeSupported:mode];
