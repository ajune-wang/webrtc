...
class PictureIdTest : public test::CallTest,
 ...
 public:
  ...
  void SetEncoderConfig(int num_streams);
...
void PictureIdTest::SetupEncoder(VideoEncoderFactory* encoder_factory,
  ...
  task_queue_.SendTask([this, encoder_factory, payload_name]() {
    ...
    SetEncoderConfig(/* number_of_streams */ 1);
  });
}

void PictureIdTest::SetEncoderConfig(int num_streams) {
  ...
  for (int i = 0; i < num_streams; ++i) {
    ...
    stream.scale_resolution_down_by = (1 << (num_streams - 1 - i));
  }
}
