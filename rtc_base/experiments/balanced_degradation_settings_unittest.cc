...
TEST(BalancedDegradationSettings, GetsVp8QpThresholds) {
  webrtc::test::ScopedFieldTrials field_trials(
      "WebRTC-Video-BalancedDegradationSettings/"
      "pixels:1000|2000|3000,fps:5|15|25,"
      "vp8_qp_low:30|31|32,vp8_qp_high:85|80|90/");
  BalancedDegradationSettings settings;
  EXPECT_EQ(30, settings.GetQpThresholds(kVideoCodecVP8, 1)->low);
  EXPECT_EQ(85, settings.GetQpThresholds(kVideoCodecVP8, 1)->high);
  EXPECT_EQ(85, settings.GetQpThresholds(kVideoCodecVP8, 1000)->high);
  EXPECT_EQ(80, settings.GetQpThresholds(kVideoCodecVP8, 1001)->high);
  EXPECT_EQ(80, settings.GetQpThresholds(kVideoCodecVP8, 2000)->high);
  EXPECT_EQ(90, settings.GetQpThresholds(kVideoCodecVP8, 2001)->high);
  EXPECT_EQ(90, settings.GetQpThresholds(kVideoCodecVP8, 3000)->high);
  EXPECT_EQ(90, settings.GetQpThresholds(kVideoCodecVP8, 3001)->high);
}
