...
void EchoModelSelector::Update(bool echo_saturation,
  ...
  bool recently_converged_filter = blocks_since_converged_filter_ < 30 * kNumBlocksPerSecond;
  ...
  linear_model_selected_ = linear_model_selected_ &&  filter_has_had_time_to_converge;
