...
// This Unified Plan SDP represents a SDP that signals the msid in both a=msid
// and a=ssrc msid semantics.
static const char kUnifiedPlanSdpFullStringWithSpecialMsid[] =
    ...
    "a=ice-ufrag:ufrag_video_2\r\na=ice-pwd:pwd_video_2\r\n"
    "a=mid:video_content_name_2\r\n"
    "a=msid:local_stream_1 video_track_id_2\r\n"
    "a=msid:local_stream_2 video_track_id_2\r\n"
    "a=sendrecv\r\n"
    "a=crypto:1 AES_CM_128_HMAC_SHA1_80 "
    "inline:d0RmdmcmVCspeEc3QGZiNWpVLFJhQX1cfHAwJSoj|2^20|1:32\r\n"
    ...
    "a=ssrc:5 msid:local_stream_1 video_track_id_2\r\n"
    "a=ssrc:5 mslabel:local_stream_1\r\n"
    "a=ssrc:5 label:video_track_id_2\r\n"
    // Video track 3, stream 2.
    "m=video 9 RTP/SAVPF 120\r\n"
    "c=IN IP4 0.0.0.0\r\n"
...
class WebRtcSdpTest : public testing::Test {
 public:
  ...
  void MakeUnifiedPlanDescriptionMultipleStreamIds() {
    ...
    audio_2_streams[0].set_stream_ids({kStreamId1, kStreamId2});
    ...
    video_2_streams[0].set_stream_ids({kStreamId1, kStreamId2});
