...
class DelayBasedRateController {
 ...
 private:
  ...
  FieldTrialFlag enabled_;
  FieldTrialParameter<double> no_ack_backoff_fraction_;
  FieldTrialParameter<TimeDelta> no_ack_backoff_interval_;
  FieldTrialParameter<double> ack_backoff_fraction_;
  FieldTrialParameter<double> probe_backoff_fraction_;
  FieldTrialParameter<double> initial_increase_rate_;
  FieldTrialParameter<double> increase_rate_;
  FieldTrialParameter<DataRate> first_period_increase_rate_;
  FieldTrialParameter<TimeDelta> stop_increase_after_;
  FieldTrialParameter<TimeDelta> increase_interval_;
  FieldTrialParameter<DataRate> linear_increase_threshold_;
  FieldTrialParameter<TimeDelta> reference_duration_offset_;
