...
TEST(RnnVad, CheckValidVadProbabilities) {
  ...
  constexpr size_t kInputAudioFrameSize = 2 * kAudioFrameSize;
  ...
  std::array<float, kAudioFrameSize> samples_decimated;
  ...
  const size_t num_frames = samples_reader.data_length() / kAudioFrameSize;
