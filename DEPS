...
vars = {
  ...
  'chromium_revision': '4858e319b8fdedad532443b9e23a02fdd726f8fa',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '56f2fd6d86dd4c3cf6bc37a5327201be359f62d2',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'f10ebd817b54c87c145690378503dceb396634ca',
  'src/tools/gyp':
