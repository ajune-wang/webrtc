...
// threads.
#define BYPASS_PROXY_CUSTOM_METHOD0(r, method) \
  r method() override {                        \
    TRACE_BOILERPLATE(method);                 \
    return c_->method();                       \
  }

// The 1 argument version of `BYPASS_PROXY_CUSTOM_METHOD0`.
#define BYPASS_PROXY_CUSTOM_METHOD1(r, method, t1) \
  r method(t1 a1) override {                       \
    TRACE_BOILERPLATE(method);                     \
    return c_->method(std::move(a1));              \
  }

// The 2 argument version of `BYPASS_PROXY_CUSTOM_METHOD0`.
#define BYPASS_PROXY_CUSTOM_METHOD2(r, method, t1, t2) \
  r method(t1 a1, t2 a2) override {                    \
    TRACE_BOILERPLATE(method);                         \
