...
TEST_F(QualityLimitationReasonTrackerTest, DefaultValues) {
  ...
  EXPECT_EQ(0u, durations_ms.find(QualityLimitationReason::kNone)->second);
  EXPECT_EQ(0u, durations_ms.find(QualityLimitationReason::kCpu)->second);
  EXPECT_EQ(0u, durations_ms.find(QualityLimitationReason::kBandwidth)->second);
  EXPECT_EQ(0u, durations_ms.find(QualityLimitationReason::kOther)->second);
}
