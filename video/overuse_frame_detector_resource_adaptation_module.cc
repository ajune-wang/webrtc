...
//
// This class is designed to run on a single sequence. Safety is ensured by
// instances being "RTC_GUARDED_BY".
...
void OveruseFrameDetectorResourceAdaptationModule::Initialize() {
  // Attaching sequence checker to the current sequence.
