...
struct StreamStats {
  ...
  // QP values of the received frames. In SVC or simulcast coding scenarios, the
  // receiver will only see one of the spatial layers at a time. Hence, this
  // value corresponds to the shown frames' QP values, which should ideally
  // correspond to one of the QP values in `spatial_layers_qp`.
  SamplesStatsCounter received_frame_qp;
