...
// ScaleToAccessor has been deleted, it's the only reason why the constructors
// are not default generated.
RtpEncodingParameters::RtpEncodingParameters() : requested_resolution(*this) {}
