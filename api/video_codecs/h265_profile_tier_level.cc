...
// is multiple of minimal MinCbSizeY(8 for level 1-4.1, 32 for level 5-6.2), is
...
static constexpr LevelConstraint kLevelConstraints[] = {
    ...
    {8912896, 267386880, 8416, H265Level::kLevel5},
    {8912896, 534773760, 8416, H265Level::kLevel5_1},
    {8912896, 1069547520, 8416, H265Level::kLevel5_2},
    {35651584, 1069547520, 16864, H265Level::kLevel6},
    {35651584, 2139095040, 16864, H265Level::kLevel6_1},
    {35651584, 4278190080, 16864, H265Level::kLevel6_2},
};
