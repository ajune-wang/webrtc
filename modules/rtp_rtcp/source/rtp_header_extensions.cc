...
constexpr uint8_t TransportSequenceNumber::kValueSizeBytesWithFeedbackRequest;
...
bool TransportSequenceNumberV2::Parse(
  ...
  if (!TransportSequenceNumber::Parse(data, transport_sequence_number))
    return false;
...
bool TransportSequenceNumberV2::Write(
  ...
  TransportSequenceNumber::Write(data.subview(0, kValueSizeBytes),
