...
TEST(SingleProcessEncodedImageIdInjector, InjectExtract) {
  ...
  std::pair<uint16_t, EncodedImage> out = injector.ExtractId(
      injector.InjectId(512, source, 1,
                        EncodedImageIdInjector::CodingType::ENCODER),
      2, EncodedImageIdInjector::CodingType::DECODER);
...
TEST(SingleProcessEncodedImageIdInjector, Inject3Extract3) {
  ...
  EncodedImage intermediate1 = injector.InjectId(
      510, source1, 1, EncodedImageIdInjector::CodingType::ENCODER);
  EncodedImage intermediate2 = injector.InjectId(
      520, source2, 1, EncodedImageIdInjector::CodingType::ENCODER);
  EncodedImage intermediate3 = injector.InjectId(
      520, source3, 1, EncodedImageIdInjector::CodingType::ENCODER);

  // Extract ids in different order.
  std::pair<uint16_t, EncodedImage> out3 = injector.ExtractId(
      intermediate3, 2, EncodedImageIdInjector::CodingType::DECODER);
  std::pair<uint16_t, EncodedImage> out1 = injector.ExtractId(
      intermediate1, 2, EncodedImageIdInjector::CodingType::DECODER);
  std::pair<uint16_t, EncodedImage> out2 = injector.ExtractId(
      intermediate2, 2, EncodedImageIdInjector::CodingType::DECODER);
...
TEST(SingleProcessEncodedImageIdInjector, InjectExtractFromConcatenated) {
  ...
  EncodedImage intermediate1 = injector.InjectId(
      512, source1, 1, EncodedImageIdInjector::CodingType::ENCODER);
  EncodedImage intermediate2 = injector.InjectId(
      512, source2, 1, EncodedImageIdInjector::CodingType::ENCODER);
  EncodedImage intermediate3 = injector.InjectId(
      512, source3, 1, EncodedImageIdInjector::CodingType::ENCODER);
  ...
  std::pair<uint16_t, EncodedImage> out = injector.ExtractId(
      concatenated, 2, EncodedImageIdInjector::CodingType::DECODER);
