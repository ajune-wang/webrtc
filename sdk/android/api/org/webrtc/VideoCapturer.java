...
public interface VideoCapturer {
   ...
   * capture observer. It will be called only once and before any startCapture() request. The camera
   * thread is guaranteed to be valid until dispose() is called. If the VideoCapturer wants to
   * deliver texture frames, it should do this by rendering on the SurfaceTexture in {@code
