...
// The inverted lags for the pitch interval [|kInitialPitchMinPeriod12kHz|,
// |kPitchMaxPeriod12kHz|] are in the range [0, |kNumInvertedLags|].
constexpr size_t kNumInvertedLags12kHz =
    kPitchMaxPeriod12kHz - kInitialPitchMinPeriod12kHz;
// Same as above for 24 kHz.
constexpr size_t kNumInvertedLags24kHz =
    kPitchMaxPeriod24kHz - kInitialPitchMinPeriod24kHz;
