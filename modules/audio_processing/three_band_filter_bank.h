...
constexpr int kNumNonZeroFilters = kSparsity * kNumBands - kNumZeroFilters;
...
class ThreeBandFilterBank final {
 public:
  ...
  static const int kSplitBandSize =
      ThreeBandFilterBank::kFullBandSize / kNumBands;
  ...
  void Synthesis(rtc::ArrayView<const rtc::ArrayView<float>> in,
