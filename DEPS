...
vars = {
  ...
  'chromium_revision': 'b4f0b4dcf1305706fdb04d445913a10c3a23bf6d',
...
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '082a9618e6975f915e62fd2fb292f699414f6417',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '25586bbf349b604fabd00a785ef470d75885e257',
