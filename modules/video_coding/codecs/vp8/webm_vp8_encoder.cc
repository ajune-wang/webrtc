...
#include "modules/video_coding/codecs/vp8/webm_vp8_encoder.h"
...
std::unique_ptr<VP8Encoder> VP8Encoder::Create() {
  return rtc::MakeUnique<WebMVp8Encoder>();
}

vpx_enc_frame_flags_t WebMVp8Encoder::EncodeFlags(
...
int WebMVp8Encoder::SetRateAllocation(const BitrateAllocation& bitrate,
...
const char* WebMVp8Encoder::ImplementationName() const {
  return "libvpx";
}

void WebMVp8Encoder::SetStreamState(bool send_stream, int stream_idx) {
...
void WebMVp8Encoder::SetupTemporalLayers(int num_streams,
...
int WebMVp8Encoder::InitEncode(const VideoCodec* inst,
                               int number_of_cores,
...
int WebMVp8Encoder::SetCpuSpeed(int width, int height) {
...
int WebMVp8Encoder::NumberOfThreads(int width, int height, int cpus) {
...
int WebMVp8Encoder::InitAndSetControlSettings() {
...
uint32_t WebMVp8Encoder::MaxIntraTarget(uint32_t optimalBuffersize) {
...
int WebMVp8Encoder::Encode(const VideoFrame& frame,
...
void WebMVp8Encoder::PopulateCodecSpecific(
...
int WebMVp8Encoder::GetEncodedPartitions(
...
VideoEncoder::ScalingSettings WebMVp8Encoder::GetScalingSettings() const {
...
int WebMVp8Encoder::SetChannelParameters(uint32_t packetLoss, int64_t rtt) {
  return WEBRTC_VIDEO_CODEC_OK;
}

int WebMVp8Encoder::RegisterEncodeCompleteCallback(
