...
void AudioSendStream::Start() {
  ...
  RTC_DCHECK_NE(config_.min_bitrate_bps, -1);
  RTC_DCHECK_NE(config_.max_bitrate_bps, -1);
...
void AudioSendStream::ReconfigureBitrateObserver(
  ...
  RTC_DCHECK_NE(new_config.min_bitrate_bps, -1);
  RTC_DCHECK_NE(new_config.max_bitrate_bps, -1);
  // TODO(srte): We should not add audio to allocation just because
  // audio_send_side_bwe_ is false.
