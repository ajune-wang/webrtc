...
//                                       &payload, encoded_image._length,
//                                       nullptr, _, _))
//       .Times(1)
//       .WillOnce(Return(true));
//   EXPECT_CALL(rtp_2, SendOutgoingData(_, _, _, _, _, _, _, _, _)).Times(0);
//   EXPECT_EQ(EncodedImageCallback::Result::OK,
//             payload_router.OnEncodedImage(encoded_image, &codec_info_1,
//             nullptr)
//                 .error);
...
//   EXPECT_EQ(EncodedImageCallback::Result::OK,
//             payload_router.OnEncodedImage(encoded_image, &codec_info_2,
//             nullptr)
//                 .error);
...
//   inactive. active_modules = {false, false};
//   payload_router.SetActiveModules(active_modules);
...
//   std::vector<RtpRtcp*> modules = {&rtp1, &rtp2};
//   PayloadRouter payload_router(modules, {kSsrc1, kSsrc2}, kPayloadType,
//   states); payload_router.SetActive(true);
