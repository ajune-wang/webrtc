...
class AudioProcessingImpl : public AudioProcessing {
 public:
  ...
  int recommended_stream_analog_level() override;
 ...
 private:
  ...
  // Returns a pointer to the internal AGC1 submodule: either a GainControlImpl
  // or GainControlForExperimentalAgc instance.
  GainControl* internal_agc1_pointer() const;
