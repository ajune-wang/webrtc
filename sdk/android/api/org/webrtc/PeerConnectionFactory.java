...
public class PeerConnectionFactory {
  ...
  public static class Builder {
    ...
    private @Nullable MediaTransportFactoryFactoryInterface mediaTransportFactoryFactory;
    ...
    /** Sets a MediaTransportFactoryFactoryInterface for a PeerConnectionFactory. */
    public Builder setMediaTransportFactoryFactory(
        MediaTransportFactoryFactoryInterface mediaTransportFactoryFactory) {
  ...
  private PeerConnectionFactory(Options options, @Nullable AudioDeviceModule audioDeviceModule,
      ...
      @Nullable MediaTransportFactoryFactoryInterface mediaTransportFactoryFactory) {
    ...
    nativeFactory = nativeCreatePeerConnectionFactory(ContextUtils.getApplicationContext(), options,
        ...
        mediaTransportFactoryFactory == null ? 0 : mediaTransportFactoryFactory.createNative());
    if (nativeFactory == 0) {
