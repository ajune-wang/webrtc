...
TEST(OpenSSLSessionCache, VerifyDTLSModeSetCorrectly) {
...
TEST(OpenSSLSessionCache, VerifyTLSModeSetCorrectly) {
...
TEST(OpenSSLSessionCache, VerifySSLContextSetCorrectly) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
...
TEST(OpenSSLSessionCache, VerifyInvalidLookupReturnsNullptr) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
...
TEST(OpenSSLSessionCache, VerifySimpleValidSessionLookup) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
...
TEST(OpenSSLSessionCache, VerifyAddToExistingReplacesPrevious) {
  SSL_CTX* ssl_ctx = SSL_CTX_new(DTLSv1_2_client_method());
