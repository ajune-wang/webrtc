...
PayloadRouter* RtpTransportControllerSend::CreateVideoRtpSender(
  ...
  video_rtp_senders_.push_back(absl::make_unique<PayloadRouter>(
      ...
      rtp_config, rtcp_config, send_transport, observers.rtcp_rtt_stats,
      observers.intra_frame_callback, observers.rtcp_stats, observers.rtp_stats,
      this, observers.bitrate_observer, observers.frame_count_observer,
      observers.rtcp_type_observer, observers.send_delay_observer,
      observers.send_packet_observer, event_log, &retransmission_rate_limiter_,
