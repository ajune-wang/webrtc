...
class BaseChannel
 ...
 private:
  ...
  // Cache the encrypted header extension IDs from the local/remote description
  // and use them with other crypto parameters from DtlsTransport.
  ...
  // The cached encrypted head extension IDs.
