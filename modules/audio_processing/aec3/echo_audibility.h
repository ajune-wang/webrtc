...
class EchoAudibility {
 public:
  ...
  // JVP fix this, what is the best way of returning an array?
 ...
 private:
  // Add Overhang to the capture stationarity status
  void AddOverhangCaptureStationarityStatus(size_t k);
  ...
  StationarityEstimator capture_stationarity_;
  ...
  std::array<int, kFftLengthBy2Plus1> capture_non_stationary_overhang_;
