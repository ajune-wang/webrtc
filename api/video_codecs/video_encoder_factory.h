...
class VideoEncoderFactory {
 public:
  ...
  // PeerConnectionFactory). This is due to the fact the method is not given any
  // stream identifier, nor is the EncoderSelectorInterface given any stream
  // identifiers, i.e one does which stream is being encoded with help of the
  // selector.
  //
  // So in such scenario, the `RtpSenderInterface::SetEncoderSelector` is
  // recommended.
