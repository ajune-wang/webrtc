...
vars = {
  ...
  'chromium_revision': 'fad0f0ae8508c3df9a7eed21de48065117c7a753',
...
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '6fae8321ad17eebfebf9b019464bac98b779d220',
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '812d0fb03c7b8a2fc897d4d42b3ecb4f1e81e9e4',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b50aafae3781765ab1857ccbe587742145882edb',
  'src/tools/gyp':
