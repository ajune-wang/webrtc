...
#ifndef STATS_ATTRIBUTE_H_
#define STATS_ATTRIBUTE_H_
...
class Attribute : public RTCStatsMemberInterface {
 public:
  template <typename T>
 ...
 private:
  // TODO(hbos): Replace uses of RTCStatsMember with absl::optional<T> and
  // update these pointer types.
  absl::variant<const RTCStatsMember<bool>*,
