...
class RtpSenderReceiverTest : public testing::Test,
 ...
 public:
  ...
  void CreateAudioRtpSender(
    ...
    bool set_track_successful = audio_rtp_sender_->SetTrack(audio_track_);
    RTC_DCHECK(set_track_successful);
  ...
  void CreateVideoRtpSender(bool is_screencast, uint32_t ssrc = kVideoSsrc) {
    ...
    bool set_track_successful = video_rtp_sender_->SetTrack(video_track_);
    RTC_DCHECK(set_track_successful);
