...
class TurnPortTest : public testing::Test,
 ...
 public:
  ...
  void OnTurnReadPacket(Connection* conn,
    ...
    turn_packets_.push_back(rtc::Buffer<uint8_t>(data, size));
  }
  ...
  void OnUdpReadPacket(Connection* conn,
                       ...
                       size_t size,
                       const rtc::PacketTime& packet_time) {
    udp_packets_.push_back(rtc::Buffer<uint8_t>(data, size));
  }
 ...
 protected:
  ...
  std::vector<rtc::Buffer<uint8_t>> turn_packets_;
  std::vector<rtc::Buffer<uint8_t>> udp_packets_;
