...
AudioProcessing::Config AdjustConfig(
  ...
  if (agc1_analog_enabled && gain_controller2_config_override.has_value()) {
    ...
    if (!one_and_only_one_input_volume_controller ||
      ...
      // Override some of the adaptive digital controller parameters.
      adjusted_config.gain_controller2.adaptive_digital.headroom_db =
          gain_controller2_config_override->adaptive_digital_config.headroom_db;
      adjusted_config.gain_controller2.adaptive_digital.max_gain_db =
          gain_controller2_config_override->adaptive_digital_config.max_gain_db;
