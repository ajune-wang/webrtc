...
vars = {
  ...
  'chromium_revision': '894211b483c2db4525bbb8a292dc24d35d3ac391',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'b38f76d60cc84c740bb01aa67c5a43adb936c1c6',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'edae634a9e17b26f2357674c263f0dea675fc834',
  'src/tools/gyp':
