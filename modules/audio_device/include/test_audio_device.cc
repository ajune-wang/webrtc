  ...
  TestAudioDeviceModuleImpl(
      ...
      : TestAudioDeviceModule(
            std::make_unique<TestAudioDevice>(task_queue_factory,
                                              ...
                                              speed),
            task_queue_factory),
        audio_device_ptr_(static_cast<TestAudioDevice*>(audio_device())) {}

  void WaitForRecordingEnd() { audio_device_ptr_->WaitForRecordingEnd(); }

 private:
  // Owned by super class.
  TestAudioDevice* audio_device_ptr_ = nullptr;
};
...
TestAudioDeviceModule::TestAudioDeviceModule(
    ...
    TaskQueueFactory* task_queue_factory)
    : AudioDeviceModuleImpl(AudioLayer::kDummyAudio,
