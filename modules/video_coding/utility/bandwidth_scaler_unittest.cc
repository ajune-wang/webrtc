      ...
      switch (scale_direction) {
        case kKeepScaleNormalBandwidth: {
          bandwidth_scaler_->ReportEncodeInfo(
              (min_bitrate_bps + max_bitrate_bps) / 2, 0, width, height);
          break;
        }
        case kKeepScaleAboveMaxBandwidth: {
          bandwidth_scaler_->ReportEncodeInfo(max_bitrate_bps * 1.5, 0, width,
                                              height);
          break;
        }
        case kKeepScaleUnderMinBandwidth: {
          bandwidth_scaler_->ReportEncodeInfo(min_bitrate_bps / 2, 0, width,
                                              height);
          break;
        }
      }
