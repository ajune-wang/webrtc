...
rtc::scoped_refptr<I420BufferInterface> AndroidVideoBuffer::ToI420() {
  ...
  ScopedJavaLocalRef<jclass> j_i420a_class =
      webrtc::GetClass(jni, "org/webrtc/JavaI420ABuffer");

  if (jni->IsInstanceOf(j_video_frame_buffer_.obj(), j_i420a_class.obj())) {
    Java_Buffer_retain(jni, j_video_frame_buffer_);
    return AndroidVideoI420ABuffer::Adopt(jni, width_, height_,
