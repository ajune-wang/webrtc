...
#ifndef WEBRTC_RTC_BASE_THIRD_PARTY_SIGSLOT_SIGSLOT_H_
#define WEBRTC_RTC_BASE_THIRD_PARTY_SIGSLOT_SIGSLOT_H_
...
#endif /* WEBRTC_RTC_BASE_THIRD_PARTY_SIGSLOT_SIGSLOT_H_ */
