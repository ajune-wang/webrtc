...
/** Initialize an RTC_OBJC_TYPE(RTCAudioTrack) with an id. Convenience ctor to use an audio source
 * with no constraints.
 */
...
/** Initialize a generic RTC_OBJC_TYPE(RTCVideoSource). The RTC_OBJC_TYPE(RTCVideoSource) should be
 * passed to a RTC_OBJC_TYPE(RTCVideoCapturer) implementation, e.g.
 * RTC_OBJC_TYPE(RTCCameraVideoCapturer), in order to produce frames.
 */
