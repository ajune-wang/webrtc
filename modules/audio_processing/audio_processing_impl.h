 ...
 private:
  ...
  const struct ApmConstants {
    ApmConstants(int agc_startup_min_volume,
                 ...
                 bool experimental_multi_channel_render_killswitch,
                 bool experimental_multi_channel_capture_killswitch)
        : agc_startup_min_volume(agc_startup_min_volume),
          ...
          experimental_multi_channel_render_support(
              !experimental_multi_channel_render_killswitch),
          experimental_multi_channel_capture_support(
              !experimental_multi_channel_capture_killswitch) {}
