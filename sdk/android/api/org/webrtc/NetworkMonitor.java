...
public class NetworkMonitor {
  ...
  @NativeMethods
  interface Natives {
    void notifyConnectionTypeChanged(@JCaller caller, long nativeAndroidNetworkMonitor);
    void notifyOfNetworkConnect(@JCaller caller, long nativeAndroidNetworkMonitor,
        NetworkChangeDetector.NetworkInformation networkInfo);
    void notifyOfNetworkDisconnect(
        @JCaller caller, long nativeAndroidNetworkMonitor, long networkHandle);
    void notifyOfActiveNetworkList(@JCaller caller, long nativeAndroidNetworkMonitor,
        NetworkChangeDetector.NetworkInformation[] networkInfos);
    void notifyOfNetworkPreference(long nativeAndroidNetworkMonitor, @JCaller caller,
