...
class ReconfigurationResponseParameter
 ...
 public:
  ...
  ReconfigurationResponseParameter(uint32_t response_sequence_number,
                                   Result result)
  ...
  explicit ReconfigurationResponseParameter(uint32_t response_sequence_number,
                                            Result result,
                                            uint32_t sender_next_tsn,
                                            uint32_t receiver_next_tsn)
      : response_sequence_number_(response_sequence_number),
        result_(result),
  ...
  absl::optional<uint32_t> sender_next_tsn() const { return sender_next_tsn_; }
  absl::optional<uint32_t> receiver_next_tsn() const {
    return receiver_next_tsn_;
  }
 ...
 private:
  ...
  Result result_;
  absl::optional<uint32_t> sender_next_tsn_;
  absl::optional<uint32_t> receiver_next_tsn_;
};
