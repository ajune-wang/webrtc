...
class VideoDecodeSchedulerFixture
    : public ::testing::WithParamInterface<std::string>,
      public FrameSchedulingReceiver {
 public:
  VideoDecodeSchedulerFixture()
      : field_trials_(GetParam()),
        ...
        buffer_(
            VideoBufferController::CreateFromFieldTrial(clock_,
  ...
  ~VideoDecodeSchedulerFixture() override {
    if (buffer_) {
 ...
 protected:
  ...
  std::unique_ptr<VideoBufferController> buffer_;
...
class VideoDecodeSchedulerTest : public ::testing::Test,
                                 public VideoDecodeSchedulerFixture {};

TEST_P(VideoDecodeSchedulerTest, InitialTimeoutAfterKeyframeTimeoutPeriod) {
...
TEST_P(VideoDecodeSchedulerTest, KeyFramesAreScheduled) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, DeltaFrameTimeoutAfterKeyframeExtracted) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, DependantFramesAreScheduled) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, SpatialLayersAreScheduled) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest,
...
TEST_P(VideoDecodeSchedulerTest, FramesWaitForDecoderToComplete) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, LateFrameDropped) {
  StartNextDecodeForceKeyframe();
  //   F1
  //   /
  // F0 --> F2
...
TEST_P(VideoDecodeSchedulerTest, FramesFastForwardOnSystemHalt) {
  StartNextDecodeForceKeyframe();
  //   F1
  //   /
  // F0 --> F2
...
TEST_P(VideoDecodeSchedulerTest, ForceKeyFrame) {
  StartNextDecodeForceKeyframe();
  // Initial keyframe.
  buffer_->InsertFrame(test::FakeFrameBuilder().Id(0).Time(0).AsLast().Build());
  EXPECT_THAT(WaitForFrameOrTimeout(TimeDelta::Zero()), Frame(test::WithId(0)));
...
TEST_P(VideoDecodeSchedulerTest, SlowDecoderDropsTemporalLayers) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, NewFrameInsertedWhileWaitingToReleaseFrame) {
  StartNextDecodeForceKeyframe();
  // Initial keyframe.
  buffer_->InsertFrame(WithReceiveTimeFromRtpTimestamp(
      test::FakeFrameBuilder().Id(0).Time(0).AsLast().Build()));
...
TEST_P(VideoDecodeSchedulerTest, SameFrameNotScheduledTwice) {
...
TEST_P(VideoDecodeSchedulerTest, TestStatsCallback) {
...
TEST_P(VideoDecodeSchedulerTest, FrameCompleteCalledOnceForDuplicateFrame) {
  EXPECT_CALL(stats_callback_,
              OnCompleteFrame(true, kFrameSize, VideoContentType::UNSPECIFIED))
      .Times(1);
...
TEST_P(VideoDecodeSchedulerTest, FrameCompleteCalledOnceForSingleTemporalUnit) {
  StartNextDecodeForceKeyframe();
...
TEST_P(VideoDecodeSchedulerTest, NextFrameWithOldTimestamp) {
...
INSTANTIATE_TEST_SUITE_P(
    VideoDecodeScheduler,
    VideoDecodeSchedulerTest,
    ::testing::Values("WebRTC-FrameBuffer3/arm:FrameBuffer3/",
                      "WebRTC-FrameBuffer3/arm:SyncDecoding/"));

class LowLatencyVideoDecodeSchedulerTest : public ::testing::Test,
                                           public VideoDecodeSchedulerFixture {
};

TEST_P(LowLatencyVideoDecodeSchedulerTest,
...
TEST_P(LowLatencyVideoDecodeSchedulerTest, ZeroPlayoutDelayFullQueue) {
  // Initial keyframe.
  StartNextDecodeForceKeyframe();
  timing_.set_min_playout_delay(TimeDelta::Zero());
  timing_.set_max_playout_delay(TimeDelta::Millis(10));
...
TEST_P(LowLatencyVideoDecodeSchedulerTest, MinMaxDelayZeroLowLatencyMode) {
  // Initial keyframe.
  StartNextDecodeForceKeyframe();
  timing_.set_min_playout_delay(TimeDelta::Zero());
...
INSTANTIATE_TEST_SUITE_P(
    VideoDecodeScheduler,
    LowLatencyVideoDecodeSchedulerTest,
    ::testing::Values(
