...
class RtpVideoStreamReceiver : public LossNotificationSender,
 ...
 private:
  ...
  absl::optional<VideoCodecType> current_codec_ RTC_GUARDED_BY(network_tc_);
  uint32_t last_assembled_frame_rtp_timestamp_ RTC_GUARDED_BY(network_tc_);
  ...
  bool has_received_frame_ RTC_GUARDED_BY(network_tc_);
