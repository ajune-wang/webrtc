...
gtest-parallel, while others, and all flags after '--', will be passed as
...
def ParseArgs(argv=None):
  ...
  gtest_args.insert(0, '--shard_count=%s' % gtest_total_shards)
  gtest_args.insert(0, '--shard_index=%s' % gtest_shard_index)
