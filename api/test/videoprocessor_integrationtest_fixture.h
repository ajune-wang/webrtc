...
#ifndef API_TEST_VIDEOPROCESSOR_INTEGRATIONTEST_FIXTURE_H_
#define API_TEST_VIDEOPROCESSOR_INTEGRATIONTEST_FIXTURE_H_
...
class VideoProcessorIntegrationTestFixtureInterface {
 public:
  virtual ~VideoProcessorIntegrationTestFixtureInterface() = default;

  virtual void ProcessFramesAndMaybeVerify(
...
#endif  // API_TEST_VIDEOPROCESSOR_INTEGRATIONTEST_FIXTURE_H_
