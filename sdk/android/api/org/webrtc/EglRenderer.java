...
public class EglRenderer implements VideoSink {
  ...
  private void renderFrameOnRenderThread() {
    ...
    } catch (GlUtil.GlOutOfMemory e) {
      // Catch out-of-memory issues and keep trying for consecutive frames. Hopefully the problem is
      // intermittent and resources will soon be freed up, otherwise the view will be black.
      logE("Encountered GL out-of-memory while drawing frame");
