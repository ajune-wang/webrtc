...
class RtpVideoFrameAssemblerImpl {
 public:
  using ReturnVector = RtpVideoFrameAssembler::ReturnVector;
  explicit RtpVideoFrameAssemblerImpl(
      RtpVideoFrameAssembler::PayloadFormat payload_format);
  ~RtpVideoFrameAssemblerImpl() = default;
...
RtpVideoFrameAssemblerImpl::RtpVideoFrameAssemblerImpl(
    RtpVideoFrameAssembler::PayloadFormat payload_format)
...
RtpVideoFrameAssemblerImpl::ReturnVector
RtpVideoFrameAssemblerImpl::InsertPacket(const RtpPacketReceived& rtp_packet) {
...
void RtpVideoFrameAssemblerImpl::ClearTo(int64_t frame_id) {
...
RtpVideoFrameAssemblerImpl::ReturnVector
RtpVideoFrameAssemblerImpl::AssembleFrames(
    video_coding::PacketBuffer::InsertResult insert_result) {
...
RtpVideoFrameAssemblerImpl::ReturnVector
RtpVideoFrameAssemblerImpl::FindReferences(ReturnVector frames) {
  ReturnVector res;
...
RtpVideoFrameAssemblerImpl::ReturnVector
RtpVideoFrameAssemblerImpl::UpdateWithPadding(uint16_t seq_num) {
  auto res =
...
void RtpVideoFrameAssemblerImpl::SaveFrameIdToSeqNumMapping(
    const ReturnVector& frames) {
  for (auto& frame : frames) {
    frame_id_to_seq_num_[frame->Id()] = frame->last_seq_num();
  }
}

bool RtpVideoFrameAssemblerImpl::ParseDependenciesDescriptorExtension(
...
bool RtpVideoFrameAssemblerImpl::ParseGenericDescriptorExtension(
    const RtpPacketReceived& rtp_packet,
    RTPVideoHeader& video_header) {
...
VideoRtpDepacketizer& RtpVideoFrameAssemblerImpl::GetDepacketizer() {
...
RtpVideoFrameAssembler::RtpVideoFrameAssembler(PayloadFormat payload_format)
    : impl_(std::make_unique<internal::RtpVideoFrameAssemblerImpl>(
          payload_format)) {}

RtpVideoFrameAssembler::~RtpVideoFrameAssembler() = default;

RtpVideoFrameAssembler::ReturnVector RtpVideoFrameAssembler::InsertPacket(
