...
int Resampler::Reset(const int inFreq,
                     const int outFreq,
...
int Resampler::ComputeResamplerMode(const int inFreq,
                                    const int outFreq,
                                    ResamplerMode* mode) const {
  ...
  // Scale with GCD
  int reduced_in_freq = inFreq / b;
  int reduced_out_freq = outFreq / b;
