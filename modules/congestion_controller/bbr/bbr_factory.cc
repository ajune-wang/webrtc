...
FeedbackBasedNetworkControllerInterface::uptr
BbrNetworkControllerFactory::Create(NetworkControllerObserver* observer) {
  return rtc::MakeUnique<bbr::BbrNetworkController>(observer);
}
