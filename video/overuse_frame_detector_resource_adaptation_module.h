...
class OveruseFrameDetectorResourceAdaptationModule
 ...
 private:
  ...
  friend class VideoStreamAdaptor;
  ...
  absl::optional<VideoStreamAdaptor::AdaptationTarget> GetAdaptUpTarget(
      int input_pixels,
      int input_fps,
      AdaptationObserverInterface::AdaptReason reason) const;
  absl::optional<VideoStreamAdaptor::AdaptationTarget> GetAdaptDownTarget(
      int input_pixels,
      int input_fps,
      int min_pixels_per_frame) const;
  // Applies the |target| to |source_restrictor_|.
  void ApplyAdaptationTarget(const VideoStreamAdaptor::AdaptationTarget& target,
                             int input_pixels,
                             int input_fps,
  ...
  VideoStreamEncoderObserver::AdaptationSteps GetActiveCounts(
      AdaptationObserverInterface::AdaptReason reason);
  VideoStreamAdaptor::VideoInputMode GetVideoInputMode() const;
