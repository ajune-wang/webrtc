...
vars = {
  ...
  'chromium_revision': 'bcebd637583a168fc3014a95122ab036ca14ea8b',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'cad878f6298acb6cd6cd193bdbac70b40e209ec8',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '4ec6285379f37e8342877be818f38d233bb895d7',
  'src/tools/gyp':
