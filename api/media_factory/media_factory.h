...
#ifndef API_MEDIA_FACTORY_MEDIA_FACTORY_H_
#define API_MEDIA_FACTORY_MEDIA_FACTORY_H_
...
class MediaFactory : public CallFactoryInterface {
 ...
 private:
  ...
  friend class MediaFactoryForTest;
...
#endif  // API_MEDIA_FACTORY_MEDIA_FACTORY_H_
