...
EchoCanceller3Config AdjustConfig(const EchoCanceller3Config& config) {
  ...
  if (field_trial::IsEnabled(
    ...
    adjusted_cfg.suppressor.normal_tuning.mask_lf.enr_transparent = 0.3f;
    adjusted_cfg.suppressor.normal_tuning.mask_lf.enr_suppress = 0.4f;
  }

  if (field_trial::IsEnabled(
          "WebRTC-Aec3EnforceMoreTransparentNearendSuppressorHfTuning")) {
    adjusted_cfg.suppressor.nearend_tuning.mask_lf.enr_transparent = 1.09f;
    adjusted_cfg.suppressor.nearend_tuning.mask_lf.enr_suppress = 1.1f;
  }
