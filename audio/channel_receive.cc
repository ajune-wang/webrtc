...
class ChannelReceive : public ChannelReceiveInterface {
 public:
  ...
  void set_source_tracker(SourceTracker* source_tracker) override;
...
void ChannelReceive::OnReceivedPayloadData(
  ...
  if (!Playing()) {
    ...
    if (source_tracker_) {
      RtpPacketInfo info(rtpHeader, clock_->TimeInMilliseconds());
      RtpPacketInfos::vector_type packet_info_vector = {info};
      RtpPacketInfos infos(packet_info_vector);
      source_tracker_->OnFrameDelivered(infos);
    }
...
void ChannelReceive::set_source_tracker(SourceTracker* source_tracker) {
