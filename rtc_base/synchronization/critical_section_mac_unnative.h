...
#ifndef RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_MAC_UNNATIVE_H_
#define RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_MAC_UNNATIVE_H_
...
#endif  // RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_MAC_UNNATIVE_H_
