...
vars = {
  ...
  'chromium_revision': '6df08e7d7a943ba1c9b6bc34ba8fae9754c3922f',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '7acf54d67b602cec21d80f42f697a50d255c01e2',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b18d614dba75f5e14db7aa73e68602d570861423',
  'src/tools/gyp':
