...
output histograms natively. This is because there is no C++ API for histograms.
This script is in python and can depend on Catapult's python API for histograms.
See histogram_util.py for how this is done.

This script can't be in recipes either, because we can't access the catapult
APIs from there. It needs to be here source-side.
