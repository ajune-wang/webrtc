...
// Internal use only.
#define WEBRTC_FLAG(c_type, name) \
...
#define WEBRTC_DECLARE_bool(name) WEBRTC_FLAG(bool, name)
#define WEBRTC_DECLARE_int(name) WEBRTC_FLAG(int, name)
#define WEBRTC_DECLARE_float(name) WEBRTC_FLAG(double, name)
#define WEBRTC_DECLARE_string(name) WEBRTC_FLAG(const char*, name)
