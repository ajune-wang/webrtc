...
class VideoReceiveStream2
 ...
 public:
  ...
  // The returned state is returned as const and internally const as well,
  // meaning that the values won't change throughout the object's lifetime.
  const Config::Rtp& rtp() const { return config_.rtp; }
