...
spa_pod* BuildFormat(spa_pod_builder* builder,
  ...
  spa_fraction pw_min_frame_rate = spa_fraction{0, 1};
  spa_fraction pw_max_frame_rate = spa_fraction{UINT32_MAX, 1};
  ...
  if (frame_rate) {
    ...
    spa_pod_builder_add(
        ...
        SPA_POD_CHOICE_RANGE_Fraction(&default_frame_rate, &pw_min_frame_rate,
                                      &pw_max_frame_rate),
        0);
    spa_pod_builder_add(
        builder, SPA_FORMAT_VIDEO_maxFramerate,
        SPA_POD_CHOICE_RANGE_Fraction(&default_frame_rate, &pw_min_frame_rate,
                                      &pw_max_frame_rate),
        0);
  }
