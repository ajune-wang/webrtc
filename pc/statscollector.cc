...
void StatsCollector::AddTrack(AudioTrackInterface* track) {
  CreateTrackReport<AudioTrackInterface>(track, &reports_, &track_ids_);
}

void StatsCollector::AddTrack(VideoTrackInterface* track) {
  CreateTrackReport<VideoTrackInterface>(track, &reports_, &track_ids_);
}
