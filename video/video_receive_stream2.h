...
class VideoReceiveStream2 : public webrtc::VideoReceiveStream,
 ...
 private:
  ...
  // Signal from decode queue to decoder completion callback to fill
  // pending_resolution_
  bool fill_pending_resolution_ RTC_GUARDED_BY(pending_resolution_mutex_) =
      false;
  RecordableEncodedFrame::EncodedResolution pending_resolution_
      RTC_GUARDED_BY(pending_resolution_mutex_){0, 0};
