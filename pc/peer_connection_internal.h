...
class PeerConnectionInternalMethods {
 public:
  virtual ~PeerConnectionInternalMethods() = default;
  ...
  // PeerConnection is a subclass of PeerConnectionInternalMethods.
...
class PeerConnectionInternal : public PeerConnectionInterface,
                               public PeerConnectionInternalMethods {};
