...
class RemoteEstimatorProxy {
 ...
 private:
  ...
  absl::optional<uint32_t> previous_abs_send_time_ RTC_GUARDED_BY(&lock_);
  Timestamp abs_send_timestamp_ RTC_GUARDED_BY(&lock_) = Timestamp::Zero();
  Timestamp last_arrival_time_ RTC_GUARDED_BY(&lock_) =
