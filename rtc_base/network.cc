...
uint16_t ComputeNetworkCostByType(int type, bool use_cellular_costs) {
  ...
  switch (type) {
    ...
    case rtc::ADAPTER_TYPE_CELLULAR_2G:
      return use_cellular_costs ? kNetworkCostCellular2G : kNetworkCostCellular;
    case rtc::ADAPTER_TYPE_CELLULAR_3G:
      return use_cellular_costs ? kNetworkCostCellular3G : kNetworkCostCellular;
    case rtc::ADAPTER_TYPE_CELLULAR_4G:
      return use_cellular_costs ? kNetworkCostCellular4G : kNetworkCostCellular;
    case rtc::ADAPTER_TYPE_CELLULAR_5G:
      return use_cellular_costs ? kNetworkCostCellular5G : kNetworkCostCellular;
...
Network::Network(const std::string& name,
    ...
    : name_(name),
      ...
      preference_(0),
      use_cellular_costs_(
          webrtc::field_trial::IsEnabled("WebRTC-UseCellularCosts")) {}
...
uint16_t Network::GetCost() const {
  ...
  return ComputeNetworkCostByType(type, use_cellular_costs_);
}
