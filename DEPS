...
vars = {
  ...
  'chromium_revision': 'f21132bbb78b1f1e66e82dce50978601e89da14a',
...
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + 'cde06fe6f69d031c0cfd112f6f6df209c89eaf6b',
  'src/buildtools':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '84cc80592a1b314e67e00bbcdb939abab1eeb899',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'd9a3a335a45451c314b7ad722301a7f331728647',
  'src/tools/gyp':
