 ...
 protected:
  ...
  ColorSpace CreateTestColorSpace() const {
    ...
    ColorSpace color_space(
        ...
        ColorSpace::ChromaSitingHorz::kLeftCollocated,
        ColorSpace::ChromaSitingVert::kTopCollocated, &hdr_metadata);
    return color_space;
  }
};
...
TEST_F(TestVp9Impl, EncodeDecode) {
  ...
  EXPECT_EQ(ColorSpace::ChromaSitingHorz::kUnspecified,
            color_space.chroma_siting_horz());
  EXPECT_EQ(ColorSpace::ChromaSitingVert::kUnspecified,
