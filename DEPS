...
vars = {
  ...
  'chromium_revision': 'e161fcfb31bd0cb5154fd8a3e8b111353e19c518',
  ...
  'fuchsia_version': 'version:9.20220822.4.1',
}

deps = {
  # TODO(kjellander): Move this to be Android-only.
  'src/base':
    'https://chromium.googlesource.com/chromium/src/base@e6d6aba2128f534e6b8a8a9e7bd5b3f0d0306cd9',
  'src/build':
    'https://chromium.googlesource.com/chromium/src/build@90d51f4aefdd87cd494c2e3554c38927c59b09b6',
  'src/buildtools':
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@2e4c2ecd4b4ecb97863442826a73ff5f96b4aa67',
    'condition': 'checkout_ios',
  },
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@79696daeb931373d3a054b1834fb207241c453e2',
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@6cda51c43cd046695382d1d0fe6206bd92ce4914',
 ...
 'src/third_party/jsoncpp/source':
  ...
  'src/third_party/perfetto':
    'https://android.googlesource.com/platform/external/perfetto.git@a82ecd97e644d25ac660fffe894e2b4adee3493f',
      ...
      'packages': [
          {
              ...
              'version': 'tqdAlBozEG54h6NC2UQmRoNYSoz4oMEckckPdZSOYEkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/tools':
    'https://chromium.googlesource.com/chromium/src/tools@050866da6c8bad69c82597d140593705497bcb96',
