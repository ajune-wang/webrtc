...
// Helper functions to convert VP9Profile and string.
...
// SDP key-value map. A default profile will be returned if the profile key is
// missing. Nothing will be returned if the key is present but the string is
// invalid.
rtc::Optional<VP9Profile> ParseSdpForVP9Profile(
    const SdpVideoFormat::Parameters& params);

// Returns true if the parameters have the same VP9 profile.
