...
webrtc::Clock* FakeCall::clock() const {
...
webrtc::RtcEventLog* FakeCall::event_log() const {
  RTC_DCHECK_NOTREACHED();
  return nullptr;
}

webrtc::RtcpRttStats* FakeCall::rtcp_rtt_stats() const {
  RTC_DCHECK_NOTREACHED();
  return nullptr;
}

webrtc::SendDelayStats* FakeCall::send_delay_stats() const {
  RTC_DCHECK_NOTREACHED();
  return nullptr;
}

webrtc::BitrateAllocatorInterface* FakeCall::bitrate_allocator() const {
  RTC_DCHECK_NOTREACHED();
  return nullptr;
}
