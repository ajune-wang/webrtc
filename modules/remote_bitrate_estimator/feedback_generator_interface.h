...
#ifndef MODULES_REMOTE_BITRATE_ESTIMATOR_FEEDBACK_GENERATOR_INTERFACE_H_
#define MODULES_REMOTE_BITRATE_ESTIMATOR_FEEDBACK_GENERATOR_INTERFACE_H_
...
class FeedbackGeneratorInterface {
 public:
  virtual ~FeedbackGeneratorInterface() = default;
...
#endif  // MODULES_REMOTE_BITRATE_ESTIMATOR_FEEDBACK_GENERATOR_INTERFACE_H_
