...
// TODO(henrik.lundin): When the field trial is over and the feature is default
// enabled, remove this fixture class and let the TestOpusDtxBitExactness test
// build directly on NetEqDecodingTest.
