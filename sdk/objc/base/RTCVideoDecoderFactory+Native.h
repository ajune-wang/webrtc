...
(RTCVideoDecoderFactory)<NSObject>
    ...
    // TODO: bugs.webrtc.org/15791 - make createDecoder:info: required, and delete createDecoder:
    // when implementaions are updated
    @optional
- (nullable id<RTC_OBJC_TYPE(RTCVideoDecoder)>)createDecoder:(const webrtc::Environment &)env
                                                        info:(RTC_OBJC_TYPE(RTCVideoCodecInfo) *)
                                                                 info;
