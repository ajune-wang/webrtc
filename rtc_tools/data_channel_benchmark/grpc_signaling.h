...
// Creates a server enabling clients to perform a PeerConnection
...
// Creates a client that can connect to a server and perform a
...
class GrpcSignalingClient {
 public:
  ...
  static std::unique_ptr<GrpcSignalingClient> Create(
