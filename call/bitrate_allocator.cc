...
void BitrateAllocator::AddObserver(BitrateAllocatorObserver* observer,
  ...
  if (it != bitrate_observer_configs_.end()) {
    ...
    it->has_packet_feedback = config.has_packet_feedback;
    it->content_type = config.content_type;
  } else {
    bitrate_observer_configs_.push_back(
        ObserverConfig(observer, config.min_bitrate_bps, config.max_bitrate_bps,
                       ...
                       config.has_packet_feedback, config.content_type));
  }
...
void BitrateAllocator::UpdateAllocationLimits() {
  ...
  for (const auto& config : bitrate_observer_configs_) {
    ...
    switch (config.content_type) {
      case MediaStreamAllocationConfig::MediaContentType::kAudio:
        info.has_audio = true;
        break;
      case MediaStreamAllocationConfig::MediaContentType::kVideo:
        info.has_video = true;
        break;
      case MediaStreamAllocationConfig::MediaContentType::kScreen:
        info.has_screenshare = true;
        break;
      case MediaStreamAllocationConfig::MediaContentType::kUnknown:
        break;
    }
  }
...
MediaStreamAllocationConfig::~MediaStreamAllocationConfig() = default;

MediaStreamAllocationConfig::MediaStreamAllocationConfig(
    const MediaStreamAllocationConfig&) = default;
