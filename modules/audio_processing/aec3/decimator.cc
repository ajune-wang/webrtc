...
std::vector<CascadedBiQuadFilter::BiQuadParam> kHighPassFilter = {
    {{1.f, 0.f}, {0.72712179f, 0.21296904f}, 0.7570763753338849f}};

std::vector<CascadedBiQuadFilter::BiQuadParam> kPassThroughFilter = {};
}  // namespace
