...
/** Signals RTC_OBJC_TYPE(RTCAudioSession) that a WebRTC session is about to begin and
...
/** Signals RTC_OBJC_TYPE(RTCAudioSession) that a WebRTC session is about to end and audio
