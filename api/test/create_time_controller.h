...
// Adjusts media `deps` to use clock `time_controller` provides and enables
// media support for a PeerConnectionFactory created from `deps`.
void EnableMediaWithTimeController(TimeController& time_controller,
