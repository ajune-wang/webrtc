 ...
 */
#ifndef API_TASK_QUEUE_TASK_QUEUE_H_
#define API_TASK_QUEUE_TASK_QUEUE_H_
...
class TaskQueue : public rtc::TaskQueue::Impl {
 public:
  ...
  // Returns TaskQueue executing current code or nullptr if code executed
  // not by a TaskQueue.
  // TODO(bugs.webrtc.org/10191): Until all TaskQueue implementations switch to
  // using CurrentTaskQueueSetter below, this function may return nullptr even
  // if code is executed by a TaskQueue. Keep using rtc::TaskQueue::Current()
 ...
 protected:
  ...
  // Protected becaues users of the TaskQueue should call Delete instead
  // of directly deleting the object.
...
#endif  // API_TASK_QUEUE_TASK_QUEUE_H_
