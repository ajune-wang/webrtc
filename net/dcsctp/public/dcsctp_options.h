...
struct DcSctpOptions {
  ...
  // Maximum SCTP packet size. Note that on top of this, TURN (4 bytes), DTLS
  // (37 bytes), UDP header (8 bytes), IPv6 (40 bytes). For IPv6, it's important
  // to stay under the minimum MTU (1280) as fragmentation support in IPv6 is
  // limited.
  //
  // 1280 - 4 - 37 - 8 - 40 = 1191
  size_t mtu = 1191;
