...
bool WebRtcVideoChannel::WebRtcVideoSendStream::SetRtpParameters(
  ...
  bool reconfigure_encoder = (new_parameters.encodings[0].max_bitrate_bps !=
                             ...
                             (new_parameters.encodings[0].priority !=
                              rtp_parameters_.encodings[0].priority);
...
bool WebRtcVideoChannel::WebRtcVideoSendStream::ValidateRtpParameters(
  ...
  if (rtp_parameters.encodings[0].priority <= 0) {
    RTC_LOG(LS_ERROR)
        << "Attempted to set RtpParameters priority to an invalid number.";
    return false;
  }
  return true;
}
...
WebRtcVideoChannel::WebRtcVideoSendStream::CreateVideoEncoderConfig(
  ...
  encoder_config.bitrate_priority = rtp_parameters_.encodings[0].priority;
