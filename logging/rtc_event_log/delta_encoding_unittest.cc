...
void SetFixedLengthEncoderDeltaSignednessForTesting(
    absl::optional<bool> signedness);

namespace {

enum class DeltaSignedness { kNoOverride, kForceUnsigned, kForceSigned };

void SetSignedness(DeltaSignedness signedness) {
  switch (signedness) {
    case DeltaSignedness::kNoOverride:
      SetFixedLengthEncoderDeltaSignednessForTesting(absl::nullopt);
      return;
...
class DeltaEncodingTest
 ...
 public:
  DeltaEncodingTest()
    ...
    SetSignedness(signedness_);
  }
  ~DeltaEncodingTest() override { SetSignedness(DeltaSignedness::kNoOverride); }
...
class DeltaEncodingCompressionQualityTest
 ...
 public:
  ...
  ~DeltaEncodingCompressionQualityTest() override {
    SetSignedness(DeltaSignedness::kNoOverride);
  }
...
class DeltaEncodingFuzzerLikeTest
 ...
 public:
  ...
  ~DeltaEncodingFuzzerLikeTest() override {
    SetSignedness(DeltaSignedness::kNoOverride);
  }
