...
(RTCDtmfSender)<NSObject>
    ...
    /**
     * Returns true if this RTC_OBJC_TYPE(RTCDtmfSender) is capable of sending DTMF. Otherwise
     * returns false. To be able to send DTMF, the associated RTC_OBJC_TYPE(RTCRtpSender) must be
