...
vars = {
  ...
  'chromium_revision': 'ce8331a4bd80fa759f9057cde28c36c4bff5a2eb',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@3a2de6472fbde51b0120e3b17a8f82abf523d91a',
    ...
    'packages': [
      {
          ...
          'version': 'qnC-FW-15U51kz1MkMsoKqpD3I6JSu00Ztqdm4jzKnoC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
