...
#ifndef MODULES_PACING_PACED_SENDING_CONTROLLER_H_
#define MODULES_PACING_PACED_SENDING_CONTROLLER_H_
...
class PacedSendingController {
 public:
  ...
  PacedSendingController(Clock* clock,
...
#endif  // MODULES_PACING_PACED_SENDING_CONTROLLER_H_
