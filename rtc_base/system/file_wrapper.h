...
class FileWrapper final {
 public:
  ...
  // Returns true if all data was successfully written (or buffered), otherwise
  // false. Writing buffered data can fail later, and is reported with return
  // value from Flush or Close.
