...
void ResourceAdaptationProcessor::OnResourceUnderuse(
  ...
  stream_adapter_->SetInput(
      manager_->LastInputFrameSizeOrDefault(),
      manager_->encoder_stats_observer_->GetInputFrameRate(),
...
VideoStreamEncoderResourceManager::BitrateConstraintPreventiveResource::
    BitrateConstraintPreventiveResource(
        VideoStreamEncoderResourceManager* manager)
    : manager_(manager) {}

bool VideoStreamEncoderResourceManager::BitrateConstraintPreventiveResource::
...
VideoStreamEncoderResourceManager::VideoStreamEncoderResourceManager(
  ...
  AddResource(&bitrate_constraint_resource_,
