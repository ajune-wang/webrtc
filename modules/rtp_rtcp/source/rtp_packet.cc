...
rtc::ArrayView<uint8_t> RtpPacket::AllocateRawExtension(uint8_t id,
  ...
  ExtensionInfo const* extension_entry = FindExtensionInfo(id);
  ...
  extension_entries_.emplace_back(id, extension_info_offset,
...
RtpPacket::ExtensionInfo const* RtpPacket::FindExtensionInfo(int id) const {
