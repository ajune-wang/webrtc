...
class EmulatedEndpoint : public EmulatedNetworkReceiverInterface {
 ...
 private:
  ...
  bool is_enabled_ RTC_GUARDED_BY(state_lock_);
...
class EndpointsController {
 public:
  EndpointsController(std::vector<EmulatedEndpoint*> endpoints);

  EmulatedEndpoint* GetEndpoint(const rtc::IPAddress& ip) const;
  ...
  std::vector<rtc::Network*> GetEnabledNetworks() const;
