...
class RTC_EXPORT RTCCertificateStats final : public RTCStats {
 public:
  ...
  RTCCertificateStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCCodecStats final : public RTCStats {
 public:
  ...
  RTCCodecStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCDataChannelStats final : public RTCStats {
 public:
  ...
  RTCDataChannelStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCIceCandidatePairStats final : public RTCStats {
 public:
  ...
  RTCIceCandidatePairStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCLocalIceCandidateStats final : public RTCIceCandidateStats {
 public:
  ...
  RTCLocalIceCandidateStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCRemoteIceCandidateStats final
 ...
 public:
  static const char kType[];
  RTCRemoteIceCandidateStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT DEPRECATED_RTCMediaStreamStats final : public RTCStats {
 public:
  ...
  DEPRECATED_RTCMediaStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCPeerConnectionStats final : public RTCStats {
 public:
  ...
  RTCPeerConnectionStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCRTPStreamStats : public RTCStats {
 ...
 protected:
  RTCRTPStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCReceivedRtpStreamStats : public RTCRTPStreamStats {
 ...
 protected:
  RTCReceivedRtpStreamStats(const std::string&& id, Timestamp timestamp);
...
class RTC_EXPORT RTCSentRtpStreamStats : public RTCRTPStreamStats {
 ...
 protected:
  RTCSentRtpStreamStats(const std::string&& id, Timestamp timestamp);
...
class RTC_EXPORT RTCInboundRTPStreamStats final
 ...
 public:
  ...
  RTCInboundRTPStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCOutboundRTPStreamStats final : public RTCRTPStreamStats {
 public:
  ...
  RTCOutboundRTPStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCRemoteInboundRtpStreamStats final
 ...
 public:
  ...
  RTCRemoteInboundRtpStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCRemoteOutboundRtpStreamStats final
 ...
 public:
  ...
  RTCRemoteOutboundRtpStreamStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCMediaSourceStats : public RTCStats {
 ...
 protected:
  RTCMediaSourceStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCAudioSourceStats final : public RTCMediaSourceStats {
 public:
  ...
  RTCAudioSourceStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCVideoSourceStats final : public RTCMediaSourceStats {
 public:
  ...
  RTCVideoSourceStats(const std::string& id, Timestamp timestamp);
...
class RTC_EXPORT RTCTransportStats final : public RTCStats {
 public:
  ...
  RTCTransportStats(const std::string& id, Timestamp timestamp);
