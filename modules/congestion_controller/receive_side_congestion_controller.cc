...
void ReceiveSideCongestionController::OnReceivedPacket(
  ...
  if (send_rfc8888_congestion_feedback_) {
    ...
    // TODO: Utilize RFC 8888 feedback, which provides comprehensive details
    // similar to transport-cc. To ensure a smooth transition, we will continue
    // using transport sequence number feedback temporarily. Once validation is
    // complete, we will fully transition to using RFC 8888 feedback
    // exclusively.
