...
()
    ...
    /**
     * The AudioSourceInterface object passed to this RTC_OBJC_TYPE(RTCAudioSource) during
     * construction.
     */
    @property(nonatomic,
              readonly) rtc::scoped_refptr<webrtc::AudioSourceInterface> nativeAudioSource;

/** Initialize an RTC_OBJC_TYPE(RTCAudioSource) from a native AudioSourceInterface. */
