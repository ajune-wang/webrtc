...
ModuleRtpRtcpImpl2::GetSenderReportStats() const {
  ...
  if (rtcp_receiver_.NTP(&stats.last_remote_timestamp_secs,
                         &stats.last_remote_timestamp_frac,
                         &stats.last_arrival_timestamp_secs,
                         &stats.last_arrival_timestamp_frac,
