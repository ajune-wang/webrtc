...
constexpr int kAbsoluteSendTimeExtensionId = 2;
constexpr int kTransportSequenceNumberExtensionId = 3;
constexpr int kVideoTimingExtensionId = 4;
constexpr int kGenericDescriptorId00 = 5;
constexpr int kGenericDescriptorId01 = 6;
constexpr int kFrameMarkingExtensionId = 7;
constexpr int kVideoRotationExtensionId = 8;
