...
class RTC_EXPORT RateStatistics {
 public:
  ...
  RateStatistics(size_t max_window_size_ms, float scale);
  ...
  bool SetWindowSize(size_t window_size_ms, int64_t now_ms);
 ...
 private:
  ...
  const size_t max_window_size_ms_;
  size_t current_window_size_ms_;
};
}  // namespace webrtc
