...
vars = {
  ...
  'chromium_revision': '3770ccf1732eab5ea8009c9ce8abcd298ec5bab3',
...
deps = {
 ...
 'src/third_party/jsoncpp/source':
  ...
  'src/tools':
    'https://chromium.googlesource.com/chromium/src/tools@416e229de9f2dd4f36bbbbf7e1cbc17956bb5edc',
    ...
    'packages': [
      {
          ...
          'version': '0CqydaX3OhFguCwIjK-u9zW_gf-VQF_blvhiJx-R9aEC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
