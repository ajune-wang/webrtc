...
#ifndef WEBRTC_RTC_BASE_NUMERICS_MOVING_MEDIAN_FILTER_H_
#define WEBRTC_RTC_BASE_NUMERICS_MOVING_MEDIAN_FILTER_H_
...
#endif  // WEBRTC_RTC_BASE_NUMERICS_MOVING_MEDIAN_FILTER_H_
