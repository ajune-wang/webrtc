...
class BbrNetworkController : public NetworkControllerInterface {
 public:
  ...
  explicit BbrNetworkController(NetworkControlObserver* observers);
  ~BbrNetworkController() override;
  units::TimeDelta GetProcessInterval() override;
  void ConnectHandlers(NetworkInformationProducer*) override;
 ...
 private:
  ...
  BbrRoundTripCount num_startup_rtts() const { return num_startup_rtts_; }
  ...
  // appropriate.
  void MaybeExitStartupOrDrain(units::Timestamp now,
                               units::DataSize bytes_in_flight);
  // Decides whether to enter or exit PROBE_RTT.
  void MaybeEnterOrExitProbeRtt(units::Timestamp now,
                                units::DataSize bytes_in_flight,
                                bool is_round_start,
  ...
  void CalculateRecoveryWindow(units::DataSize bytes_acked,
                               ...
                               units::DataSize bytes_in_flight);
  NetworkControlObserver* observers_;
  RttStats rtt_stats_;
  ...
  units::DataSize prior_in_flight_;
  ...
  BbrRoundTripCount num_startup_rtts_;
