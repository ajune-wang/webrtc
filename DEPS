...
vars = {
  ...
  'chromium_revision': 'b13ef46e0efe3e53b8cab1030c99286c54dd61c8',
...
deps = {
  ...
  'src/base':
    'https://chromium.googlesource.com/chromium/src/base@4174b8ace3813fec82a43b0cec280392ab7d780e',
  'src/build':
  ...
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@302a0b3915c52b3dc854af8723056cfb27f2d398',
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@634e6f2507505bc0659fd3dfa0778ca8cd6af3ca',
    ...
    'packages': [
      {
          ...
          'version': 'KdruTbK8p7HRbdLrsXQ5kHhrxcspATyPjHGPBHy_rFEC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
