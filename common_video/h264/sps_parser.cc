...
absl::optional<SpsParser::SpsState> SpsParser::ParseSpsUpToVui(
  ...
  // formats.
  uint8_t profile_idc = bit_reader.ReadUInt8();
  ...
  if (profile_idc == 100 || profile_idc == 110 || profile_idc == 122 ||
    ...
    if (chroma_format_idc == 3) {
      ...
      sps->separate_colour_plane_flag = bit_reader.Read(1);
    }
    ...
    uint32_t seq_scaling_matrix_present_flag = bit_reader.Read(1);
    if (seq_scaling_matrix_present_flag) {
      ...
      for (int i = 0; i < scaling_list_count; ++i) {
        ...
        uint32_t seq_scaling_list_present_flags = bit_reader.Read(1);
  ...
  if (sps->pic_order_cnt_type == 0) {
    ...
    sps->delta_pic_order_always_zero_flag = bit_reader.Read(1);
  ...
  sps->frame_mbs_only_flag = bit_reader.Read(1);
  ...
  frame_cropping_flag = bit_reader.Read(1);
  ...
  sps->vui_params_present = bit_reader.Read(1);
