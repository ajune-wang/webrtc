...
// Instance a reader for the 48 kHz PCM samples (chunks size: |frame_length|).
std::pair<std::unique_ptr<BinaryFileReader<int16_t, float>>, const size_t>
CreatePcmSamplesReader(const size_t frame_length);
// Instance a reader for the pre-processed PCM samples.
std::pair<std::unique_ptr<BinaryFileReader<float>>, const size_t>
CreatePreprocessedSamplesReader();
// TODO(alessiob): Remove when RnnVadTest.SequenceBufferBitExactness is removed.
// Instance a reader for the list of first and last values in the analysis
// buffer.
std::pair<std::unique_ptr<BinaryFileReader<float>>, const size_t>
CreateAnalysisBufFirstLastReader();
