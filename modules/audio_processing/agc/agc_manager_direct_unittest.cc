...
// (Over)writes the sample values in `audio_buffer` by writing a value that
// corresponds to clipping for a fraction of samples that corresponds to
// `clipped_ratio` and by writing `samples_value` for the remaining fraction.
