...
class RTCStatsCollector : public virtual rtc::RefCountInterface,
 ...
 private:
  ...
  // all partial reports are merged this is the result of a reqeust.
  ...
  // into |partial_report_| on the signaling thread and then nulled. This can
  // happen at AddPartialResults_s() or WaitForPendingRequest(). Thread-safety
  // is ensured by using |network_report_event_|.
