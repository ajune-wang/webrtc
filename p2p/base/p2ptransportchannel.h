...
class P2PTransportChannel : public IceTransportInternal {
 ...
 private:
  ...
  // remote candidate is always zeros, and the pair of ids then represents
  // groups divided by the local networks. See the comments in the
  // implementation for the pruning logic.
