...
void JNI_Logging_EnableLogToDebugOutput(JNIEnv* env, jint nativeSeverity) {
...
void JNI_Logging_Log(JNIEnv* env,
  ...
  std::string message = JavaToStdString(env, j_message);
  std::string tag = JavaToStdString(env, j_tag);
