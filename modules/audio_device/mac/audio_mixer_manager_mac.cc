...
int32_t AudioMixerManagerMac::OpenSpeaker(AudioDeviceID deviceID) {
  ...
  if (AudioObjectHasProperty(_outputDeviceID, &propertyAddress)) {
    ...
    // getpid() is apparently "always successful"
      ...
      RTC_DLOG(LS_WARNING) << "Another process (pid = "
...
int32_t AudioMixerManagerMac::OpenMicrophone(AudioDeviceID deviceID) {
  ...
  // getpid() is apparently "always successful"
    ...
    RTC_DLOG(LS_WARNING) << "Another process (pid = " << static_cast<int>(hogPid)
...
int32_t AudioMixerManagerMac::SetSpeakerVolume(uint32_t volume) {
  ...
  if (_outputDeviceID == kAudioObjectUnknown) {
    RTC_DLOG(LS_WARNING) << "device ID has not been set";
    return -1;
  }
  ...
  if (!success) {
    RTC_DLOG(LS_WARNING) << "Unable to set a volume on any output channel";
    return -1;
  }
...
int32_t AudioMixerManagerMac::SpeakerVolume(uint32_t& volume) const {
  ...
  if (hasProperty) {
    ...
    if (channels == 0) {
      RTC_DLOG(LS_WARNING) << "Unable to get a volume on any channel";
      return -1;
    }
...
int32_t AudioMixerManagerMac::SpeakerVolumeIsAvailable(bool& available) {
  ...
  for (UInt32 i = 1; i <= _noOutputChannels; i++) {
    ...
    if (err != noErr || !isSettable) {
      available = false;
      RTC_DLOG(LS_WARNING) << "Volume cannot be set for output channel " << i
                          << ", err=" << err;
      return -1;
    }
  }
...
int32_t AudioMixerManagerMac::SpeakerMuteIsAvailable(bool& available) {
  ...
  for (UInt32 i = 1; i <= _noOutputChannels; i++) {
    ...
    if (err != noErr || !isSettable) {
      available = false;
      RTC_DLOG(LS_WARNING) << "Mute cannot be set for output channel " << i
                          << ", err=" << err;
      return -1;
    }
  }
...
int32_t AudioMixerManagerMac::SetSpeakerMute(bool enable) {
  ...
  if (!success) {
    RTC_DLOG(LS_WARNING) << "Unable to set mute on any input channel";
    return -1;
  }
...
int32_t AudioMixerManagerMac::SpeakerMute(bool& enabled) const {
  ...
  if (hasProperty) {
    ...
    if (channels == 0) {
      RTC_DLOG(LS_WARNING) << "Unable to get mute for any channel";
      return -1;
    }
...
int32_t AudioMixerManagerMac::MicrophoneVolumeIsAvailable(bool& available) {
  ...
  for (UInt32 i = 1; i <= _noInputChannels; i++) {
    ...
    if (err != noErr || !isSettable) {
      available = false;
      RTC_DLOG(LS_WARNING) << "Volume cannot be set for input channel " << i
                          << ", err=" << err;
      return -1;
    }
  }
...
int32_t AudioMixerManagerMac::SetMicrophoneVolume(uint32_t volume) {
  ...
  if (!success) {
    RTC_DLOG(LS_WARNING) << "Unable to set a level on any input channel";
    return -1;
  }
...
int32_t AudioMixerManagerMac::MicrophoneVolume(uint32_t& volume) const {
  ...
  if (hasProperty) {
    ...
    if (channels == 0) {
      RTC_DLOG(LS_WARNING) << "Unable to get a level on any channel";
      return -1;
    }
