...
public class NetworkMonitorTest {
  ...
  public void testConnectivityManagerDelegatePreferentiallyReadsFromCache() {
    ...
    // Normally set from FieldTrials.
    delegate.getAllNetworksFromCache_ = true;
  ...
  public void testConnectivityManagerParsesFieldTrials() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      assertFalse(delegate.getAllNetworksFromCache_);
      assertFalse(delegate.requestVPN_);
      assertFalse(delegate.includeOtherUidNetworks_);
    }
  }
