...
int MultiplexEncoderAdapter::Encode(
  ...
  MultiplexVideoFrameBuffer* multiplex_video_frame_buffer = nullptr;
  if (supports_augmented_data_) {
    multiplex_video_frame_buffer = static_cast<MultiplexVideoFrameBuffer *>(input_image.video_frame_buffer().get());
