...
#ifndef WEBRTC_API_VIDEO_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
#define WEBRTC_API_VIDEO_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
...
#endif  // WEBRTC_API_VIDEO_VIDEO_BITRATE_ALLOCATOR_FACTORY_H_
