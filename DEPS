...
vars = {
  ...
  'chromium_revision': 'bce4b673a25c23d9d48859fd295fa47efc920803',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'c5d85cfdb7b9ad7a32d6d4dbb184297b4b558665',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '89bcb1ce9cbe4f36cf3e2219cdf490998a3243c0',
  'src/tools/gyp':
