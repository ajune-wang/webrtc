...
// `AgcManagerDirectTestHelper::CallAgcSequence()` instead. Calls
// `AnalyzePreProcess()` on `manager` `num_calls` times. `peak_ratio` is a value
// in [0, 1] which determines the amplitude of the samples (1 maps to full
