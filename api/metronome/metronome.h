...
// The API must be used from the worker thread, and scheduled callbacks will be
// executed on the worker thread. There are no features for cancellation. When
// that's needed, use e.g. ScopedTaskSafety from the client.
//
