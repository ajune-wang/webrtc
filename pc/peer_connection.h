...
class PeerConnection : public PeerConnectionInternal,
 ...
 public:
  ...
  const FieldTrialsView& trials() override { return *trials_; }
 ...
 private:
  ...
  // This is field trials specified (in order of preference)
  // a) Specified in PeerConnectionDependencies (owned).
  // b) Borrowed from ConnectionContext (e.g PeerConnectionFactoryDependencies>
