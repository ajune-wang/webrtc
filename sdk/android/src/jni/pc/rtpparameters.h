...
#ifndef WEBRTC_SDK_ANDROID_SRC_JNI_PC_RTPPARAMETERS_H_
#define WEBRTC_SDK_ANDROID_SRC_JNI_PC_RTPPARAMETERS_H_
...
#endif  // WEBRTC_SDK_ANDROID_SRC_JNI_PC_RTPPARAMETERS_H_
