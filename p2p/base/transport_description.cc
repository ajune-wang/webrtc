...
static bool IsIceChar(char c) {
  return absl::ascii_isalnum(c) || c == '+' || c == '/';
}

static RTCErrorOr<std::string> ParseIceUfrag(absl::string_view raw_ufrag) {
...
static RTCErrorOr<std::string> ParseIcePwd(absl::string_view raw_pwd) {
