...
VideoFrame::UpdateRect VideoFrame::UpdateRect::Union(const UpdateRect& other) {
  UpdateRect res;
  res.offset_x = std::min(offset_x, other.offset_x);
  res.offset_y = std::min(offset_y, other.offset_y);
  res.width =
      std::max(width + offset_x, other.width + other.offset_x) - res.offset_x;
  res.height =
      std::max(height + offset_y, other.height + other.offset_y) - res.offset_y;
  return res;
}
