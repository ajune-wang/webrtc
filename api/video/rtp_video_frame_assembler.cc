...
RtpVideoFrameAssembler::ReturnVector RtpVideoFrameAssembler::AssembleFrames(
...
RtpVideoFrameAssembler::ReturnVector RtpVideoFrameAssembler::FindReferences(
    ReturnVector frames) {
  ReturnVector res;
...
RtpVideoFrameAssembler::ReturnVector RtpVideoFrameAssembler::UpdateWithPadding(
    uint16_t seq_num) {
  auto res =
