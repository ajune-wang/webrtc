...
class QualityLimitationReasonTracker {
 public:
  // The caller is responsible for making sure |clock| outlives the tracker. The
  // current reason defaults to QualityLimitationReason::kNone.
 ...
 private:
  ...
  // The total amount of time spent in each reason at the the of
