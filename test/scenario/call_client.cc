...
CallClient::CallClient(
    ...
    : time_controller_(time_controller),
      ...
      network_controller_factory_(time_controller->GetTaskQueueFactory(),
  ...
  SendTask(ToQueuedTask([this, config] {
...
void CallClient::SendTask(std::unique_ptr<QueuedTask> task) {
  time_controller_->SendTask(task_queue_.Get(), std::move(task));
}
