...
class WebRtcSessionTest
 ...
 protected:
  ...
  void SetLocalDescriptionWithoutError(SessionDescriptionInterface* desc) {
    ASSERT_TRUE(session_->SetLocalDescription(
        std::unique_ptr<SessionDescriptionInterface>(desc), nullptr));
  ...
  void SetRemoteDescriptionWithoutError(SessionDescriptionInterface* desc) {
    ASSERT_TRUE(session_->SetRemoteDescription(
        std::unique_ptr<SessionDescriptionInterface>(desc), nullptr));
  }
  void SetRemoteDescriptionExpectError(const std::string& action,
                                       ...
                                       SessionDescriptionInterface* desc) {
    std::string error;
    EXPECT_FALSE(session_->SetRemoteDescription(
        std::unique_ptr<SessionDescriptionInterface>(desc), &error));
