...
public class CryptoOptionsTest {
  ...
  public void testBuilderDefaultsAreFalse() {
    ...
    assertThat(cryptoOptions.getSrtp().getEnableGcmCryptoSuites()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableAes128Sha1_32CryptoCipher()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableEncryptedRtpHeaderExtensions()).isEqualTo(false);
    assertThat(cryptoOptions.getSFrame().getRequireFrameEncryption()).isEqualTo(false);
  }
  ...
  public void testBuilderCorrectlyInitializingGcmCrypto() {
    ...
    assertThat(cryptoOptions.getSrtp().getEnableGcmCryptoSuites()).isEqualTo(true);
    assertThat(cryptoOptions.getSrtp().getEnableAes128Sha1_32CryptoCipher()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableEncryptedRtpHeaderExtensions()).isEqualTo(false);
    assertThat(cryptoOptions.getSFrame().getRequireFrameEncryption()).isEqualTo(false);
  }
  ...
  public void testBuilderCorrectlyInitializingAes128Sha1_32CryptoCipher() {
    ...
    assertThat(cryptoOptions.getSrtp().getEnableGcmCryptoSuites()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableAes128Sha1_32CryptoCipher()).isEqualTo(true);
    assertThat(cryptoOptions.getSrtp().getEnableEncryptedRtpHeaderExtensions()).isEqualTo(false);
    assertThat(cryptoOptions.getSFrame().getRequireFrameEncryption()).isEqualTo(false);
  }
  ...
  public void testBuilderCorrectlyInitializingEncryptedRtpHeaderExtensions() {
    ...
    assertThat(cryptoOptions.getSrtp().getEnableGcmCryptoSuites()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableAes128Sha1_32CryptoCipher()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableEncryptedRtpHeaderExtensions()).isEqualTo(true);
    assertThat(cryptoOptions.getSFrame().getRequireFrameEncryption()).isEqualTo(false);
  }
  ...
  public void testBuilderCorrectlyInitializingRequireFrameEncryption() {
    ...
    assertThat(cryptoOptions.getSrtp().getEnableAes128Sha1_32CryptoCipher()).isEqualTo(false);
    assertThat(cryptoOptions.getSrtp().getEnableEncryptedRtpHeaderExtensions()).isEqualTo(false);
    assertThat(cryptoOptions.getSFrame().getRequireFrameEncryption()).isEqualTo(true);
  }
}
