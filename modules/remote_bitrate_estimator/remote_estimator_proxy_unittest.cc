...
TEST_F(RemoteEstimatorProxyTest, EmptyPacketArrivalTimeMap) {
...
TEST_F(RemoteEstimatorProxyTest, InsertFirstItemIntoMap) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, InsertWithGaps) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, InsertWithinBuffer) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, GrowBufferAndRemoveOld) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, GrowBufferAndRemoveOldTrimsBeginning) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, SequenceNumberJumpsDeletesAll) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, ExpandBeforeBeginning) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, ExpandingBeforeBeginningKeepsReceived) {
  PacketArrivalTimeMap map;

  map.AddPacket(42, 10);
  map.AddPacket(42 - 2 * PacketArrivalTimeMap::kMaxNumberOfPackets, 13);

  EXPECT_EQ(map.begin_sequence_number(), 42);
  EXPECT_EQ(map.end_sequence_number(), 43);
}

TEST_F(RemoteEstimatorProxyTest, EraseToRemovesElements) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, EraseInEmptyMap) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, EraseIsTolerantToWrongArguments) {
  PacketArrivalTimeMap map;
...
TEST_F(RemoteEstimatorProxyTest, EraseAllRemembersBeginningSeqNbr) {
  PacketArrivalTimeMap map;
