...
class FrameBuffer {
 public:
  ...
  // encoded, so when extracting a temporal unit it is therefor possible for
  // multiple frames to be returned. The number of frames in a temporal unit is
  // typically small (< 4), so four frames should basically always be enough.
