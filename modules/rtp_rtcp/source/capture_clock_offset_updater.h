...
class CaptureClockOffsetUpdater {
 public:
  ...
  // Convert a signed Q32.32-formatted fixed-point to a TimeDelta. This can be
  // used to convert the output from AdjustEstimatedCaptureClockOffset() to a
  // TimeDelta.
  static absl::optional<TimeDelta> ConvertToTimeDela(
      absl::optional<int64_t> input_q32x32);
