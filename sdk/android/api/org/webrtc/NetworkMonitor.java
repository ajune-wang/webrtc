...
public class NetworkMonitor {
  ...
  /**
   * Create NetworkMonitorAutoDetect to bring up mobile networks and monitor the network state
   * changes. This requires the embedding app have the platform ACCESS_NETWORK_STATE and
   * CHANGE_NETWORK_STATE permission.
   */
  @CalledByNative
