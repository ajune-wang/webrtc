...
class ChannelTest : public testing::Test, public sigslot::has_slots<> {
 public:
  ...
  void SendCustomRtp1(uint32_t ssrc, int sequence_number, int pl_type = -1) {
    rtc::Buffer<uint8_t> data = CreateRtpData(ssrc, sequence_number, pl_type);
  ...
  void SendCustomRtcp1(uint32_t ssrc) {
    rtc::Buffer<uint8_t> data = CreateRtcpData(ssrc);
  ...
  rtc::Buffer<uint8_t> CreateRtpData(uint32_t ssrc,
                                     int sequence_number,
                                     int pl_type) {
    rtc::Buffer<uint8_t> data(rtp_packet_.data(), rtp_packet_.size());
  ...
  rtc::Buffer<uint8_t> CreateRtcpData(uint32_t ssrc) {
    rtc::Buffer<uint8_t> data(rtcp_packet_.data(), rtcp_packet_.size());
 ...
 protected:
  ...
  rtc::Buffer<uint8_t> rtp_packet_;
  rtc::Buffer<uint8_t> rtcp_packet_;
