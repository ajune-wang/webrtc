...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  struct VideoConfig {
    ...
    // encoder will use an internal minimum value. Please note that if this is
    // value is set to a value that is higher than the bandwidth of the link,
    // the encoder will generate more data than the link can handle regardless
    // of the bandwidth estimation.
