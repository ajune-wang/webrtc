...
// constexpr float kLengthInSeconds = 100;
...
int main(int argc, char* argv[]) {
  ...
  rtc::scoped_refptr<webrtc::AudioMixer> mixer(webrtc::AudioMixerImpl::Create(
