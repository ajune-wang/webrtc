...
double CorruptionClassifier::CalculateCorruptionProbablility(
    rtc::ArrayView<const webrtc::FilteredSample> filtered_original_samples,
    rtc::ArrayView<const webrtc::FilteredSample> filtered_compressed_samples,
    int luma_threshold,
