...
TEST(RtpVideoSenderTest, DoesNotRetrasmitAckedPackets) {
  ...
  // lost.
  PacketFeedbackObserver::FeedbackInfo received_packet_feedback;
  ...
  PacketFeedbackObserver::FeedbackInfo lost_packet_feedback;
...
TEST(RtpVideoSenderTest, EarlyRetransmits) {
  ...
  PacketFeedbackObserver::FeedbackInfo first_packet_feedback;
  ...
  PacketFeedbackObserver::FeedbackInfo second_packet_feedback;
