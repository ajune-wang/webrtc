...
template <typename T>
void CopyElements(const T* src_data,
                  uint8_t src_size,
                  T* dst_data,
                  uint8_t* dst_size) {
...
template <typename T>
void DestroyElements(T* data, uint8_t size) {
...
// eficient, and makes BoundedInlineVector trivially copyable.
