...
namespace {
std::unique_ptr<webrtc::AudioProcessingImpl> CreateAudioProcessing() {
  webrtc::Config config;
  std::unique_ptr<webrtc::AudioProcessingImpl> apm;
  apm.reset(new rtc::RefCountedObject<webrtc::AudioProcessingImpl>(config));
  RTC_DCHECK(apm);
  return apm;
}
