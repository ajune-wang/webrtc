...
void Connection::Prune() {
  if (!pruned_ || active()) {
    ...
    LogCandidatePairConfig(webrtc::IceCandidatePairConfigType::kPruned);
  }
}
...
const webrtc::IceCandidatePairDescription& Connection::ToLogDescription() {
  ...
  log_description_->remote_relay_protocol =
      GetProtocolByString(remote.relay_protocol());
  log_description_->candidate_pair_address_family =
