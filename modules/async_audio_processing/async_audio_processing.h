 ...
 public:
  ...
  class Factory : public rtc::RefCountInterface {
   public:
    ...
    ~Factory();
    ABSL_DEPRECATED(
        "Use Factory(std::unique_ptr<AudioFrameProcessor>, TaskQueueFactory&) "
        "instead")
  ...
  ABSL_DEPRECATED(
      "Use AsyncAudioProcessing(std::unique_ptr<AudioFrameProcessor>, "
      "TaskQueueFactory&, AudioFrameProcessor::OnAudioFrameCallback) instead")
  AsyncAudioProcessing(
