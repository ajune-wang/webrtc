...
TEST(CodecTest, TestAV1CodecMatches) {
  ...
  VideoCodec c_profile0(96, cricket::kAv1CodecName);
  c_profile0.params[webrtc::kAV1FmtpProfile] = kProfile0;
  VideoCodec c_profile1(98, cricket::kAv1CodecName);
  c_profile1.params[webrtc::kAV1FmtpProfile] = kProfile1;
  VideoCodec c_profile2(99, cricket::kAv1CodecName);
...

  {
    ...
    VideoCodec c_profile1_eq(97, cricket::kAv1CodecName);
