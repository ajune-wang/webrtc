...
vars = {
  ...
  'chromium_revision': '61db434bdc95f638a2bd7766e112cd4ffd367324',
}
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@053ea0cbc0b6f494c4882c9cf7e17347adac20e7',
