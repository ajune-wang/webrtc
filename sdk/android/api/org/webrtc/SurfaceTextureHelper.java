...
public class SurfaceTextureHelper {
  ...
  private SurfaceTextureHelper(EglBase.Context sharedContext, Handler handler) {
    ...
    surfaceTexture = new SurfaceTexture(oesTextureId) {
      ...
      public void setDefaultBufferSize(int width, int height) {
        ...
        // We can catch buffer size changes coming through setDefaultBufferSize(). Camera1 and the
        // HW decoder use some other internal method of setting the texture size and needs to be
        // reported explicitly.
  ...
  /**
   * Use this function to explicitly report the texture size when setDefaultBufferSize() is not
   * used. This is the case for at least Camera1 and the MediaCodec decoder.
   */
