...
TEST_F(JsepTransportControllerTest, RollbackRestoresPreviousTransportMapping) {
  ...
  // Store the old transport pointer verify that the offer actually changed
  // transports.
...
TEST_F(JsepTransportControllerTest, RollbackAndAddToDifferentBundleGroup) {
  ...
  // Apply an offer that adds kMid2Audio to the first BUNDLE group.,
  ...
  // Apply an offer that adds kMid2Audio to the second BUNDLE group.,
