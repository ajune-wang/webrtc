...
class VoipVolumeControl {
 public:
  ...
  virtual void GetInputVolumeInfo(ChannelId channel_id,
                                  VolumeInfo& input_volume) = 0;

  // Gets the speaker volume info.
  virtual void GetOutputVolumeInfo(ChannelId channel_id,
                                   VolumeInfo& output_volume) = 0;
