...
constexpr uint8_t kSBit = 0x80;
constexpr uint8_t kEBit = 0x40;

TEST(VideoRtpDepacketizerH265Test, SingleNalu) {
  uint8_t packet[3] = {0x26, 0x02,
                       0xFF};  // F=0, Type=19 (kIdrWRadl), LayerId=0, TID=2.
...
TEST(VideoRtpDepacketizerH265Test, ApKey) {
  uint8_t packet[] = {
      ...
      // vps
      0, 0x17, 0x40, 0x02, 0x1c, 0x01, 0xff, 0xff, 0x04, 0x08, 0x00, 0x00, 0x03,
      0x00, 0x9d, 0x08, 0x00, 0x00, 0x03, 0x00, 0x00, 0x78, 0x95, 0x98, 0x09,
      // sps
      0, 0x27, 0x42, 0x02, 0x01, 0x04, 0x08, 0x00, 0x00, 0x03, 0x00, 0x9d, 0x08,
      0x00, 0x00, 0x03, 0x00, 0x00, 0x5d, 0xb0, 0x02, 0x80, 0x80, 0x2d, 0x16,
      0x59, 0x59, 0xa4, 0x93, 0x2b, 0x80, 0x40, 0x00, 0x00, 0x03, 0x00, 0x40,
      0x00, 0x00, 0x07, 0x82,
      // pps
      0, 0x32, 0x44, 0x02, 0xa4, 0x04, 0x55, 0xa2, 0x6d, 0xce, 0xc0, 0xc3, 0xed,
      0x0b, 0xac, 0xbc, 0x00, 0xc4, 0x44, 0x2e, 0xf7, 0x55, 0xfd, 0x05, 0x86,
      0x92, 0x19, 0xdf, 0x58, 0xec, 0x38, 0x36, 0xb7, 0x7c, 0x00, 0x15, 0x33,
      0x78, 0x03, 0x67, 0x26, 0x0f, 0x7b, 0x30, 0x1c, 0xd7, 0xd4, 0x3a, 0xec,
      0xad, 0xef, 0x73,
      // Idr
      0, 0xa, 0x26, 0x02, 0xaf, 0x08, 0x4a, 0x31, 0x11, 0x15, 0xe5, 0xc0};
  uint8_t expected_packet[] = {
      0x00, 0x00, 0x00, 0x01,
      // vps
      ...
      // sps
      0x00, 0x00, 0x00, 0x01, 0x42, 0x02, 0x01, 0x04, 0x08, 0x00, 0x00, 0x03,
      0x00, 0x9d, 0x08, 0x00, 0x00, 0x03, 0x00, 0x00, 0x5d, 0xb0, 0x02, 0x80,
      0x80, 0x2d, 0x16, 0x59, 0x59, 0xa4, 0x93, 0x2b, 0x80, 0x40, 0x00, 0x00,
      0x03, 0x00, 0x40, 0x00, 0x00, 0x07, 0x82,
      // pps
      0x00, 0x00, 0x00, 0x01, 0x44, 0x02, 0xa4, 0x04, 0x55, 0xa2, 0x6d, 0xce,
      0xc0, 0xc3, 0xed, 0x0b, 0xac, 0xbc, 0x00, 0xc4, 0x44, 0x2e, 0xf7, 0x55,
      0xfd, 0x05, 0x86, 0x92, 0x19, 0xdf, 0x58, 0xec, 0x38, 0x36, 0xb7, 0x7c,
      0x00, 0x15, 0x33, 0x78, 0x03, 0x67, 0x26, 0x0f, 0x7b, 0x30, 0x1c, 0xd7,
      0xd4, 0x3a, 0xec, 0xad, 0xef, 0x73,
      // Idr
      0x00, 0x00, 0x00, 0x01, 0x26, 0x02, 0xaf, 0x08, 0x4a, 0x31, 0x11, 0x15,
      0xe5, 0xc0};
  // clang-format on
  rtc::CopyOnWriteBuffer rtp_payload(packet);
...
TEST(VideoRtpDepacketizerH265Test, ApNaluSpsWithResolution) {
  ...
  uint8_t expected_packet[] = {
      0x00, 0x00, 0x00, 0x01, 0x40, 0x02,  // vps
      0x1c, 0x01, 0xff, 0xff, 0x04, 0x08, 0x00, 0x00, 0x03, 0x00, 0x9d,
      0x08, 0x00, 0x00, 0x03, 0x00, 0x00, 0x78, 0x95, 0x98, 0x09, 0x00,
      0x00, 0x00, 0x01, 0x42, 0x02,  // sps
      0x01, 0x04, 0x08, 0x00, 0x00, 0x03, 0x00, 0x9d, 0x08, 0x00, 0x00,
      0x03, 0x00, 0x00, 0x5d, 0xb0, 0x02, 0x80, 0x80, 0x2d, 0x16, 0x59,
      0x59, 0xa4, 0x93, 0x2b, 0x80, 0x40, 0x00, 0x00, 0x03, 0x00, 0x40,
      0x00, 0x00, 0x07, 0x82, 0x00, 0x00, 0x00, 0x01, 0x44, 0x02,  // pps
      0xa4, 0x04, 0x55, 0xa2, 0x6d, 0xce, 0xc0, 0xc3, 0xed, 0x0b, 0xac,
      0xbc, 0x00, 0xc4, 0x44, 0x2e, 0xf7, 0x55, 0xfd, 0x05, 0x86, 0x92,
      0x19, 0xdf, 0x58, 0xec, 0x38, 0x36, 0xb7, 0x7c, 0x00, 0x15, 0x33,
      0x78, 0x03, 0x67, 0x26, 0x0f, 0x7b, 0x30, 0x1c, 0xd7, 0xd4, 0x3a,
      0xec, 0xad, 0xef, 0x73, 0x00, 0x00, 0x00, 0x01, 0x26, 0x02,  // kIdrWRadl
      0xaf, 0x08, 0x4a, 0x31, 0x11, 0x15, 0xe5, 0xc0};
  rtc::CopyOnWriteBuffer rtp_payload(packet);
...
TEST(VideoRtpDepacketizerH265Test, Fu) {
  ...
  uint8_t packet1[] = {
      ...
      kSBit | H265::kIdrWRadl,  // FU header.
  ...
  uint8_t packet3[] = {
      0x62, 0x02,               // F=0, Type=49 (kH265Fu).
      kEBit | H265::kIdrWRadl,  // FU header.
      0x03                      // Payload.
  };
