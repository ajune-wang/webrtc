...
TEST(DefaultVideoQualityAnalyzerTest,
  ...
  EXPECT_EQ(global_stream_conters.received, 30);
  EXPECT_EQ(global_stream_conters.decoded, 30);
  EXPECT_EQ(global_stream_conters.rendered, 30);
  FrameCounters alice_bob_stream_conters =
      analyzer.GetPerStreamCounters().at(StatsKey("alice_video", "bob"));
  ...
  FrameCounters alice_david_stream_conters =
      analyzer.GetPerStreamCounters().at(StatsKey("alice_video", "david"));
  EXPECT_EQ(alice_david_stream_conters.captured, 12);
  EXPECT_EQ(alice_david_stream_conters.pre_encoded, 12);
  EXPECT_EQ(alice_david_stream_conters.encoded, 12);
  EXPECT_EQ(alice_david_stream_conters.received, 10);
  EXPECT_EQ(alice_david_stream_conters.decoded, 10);
  EXPECT_EQ(alice_david_stream_conters.rendered, 10);
}
