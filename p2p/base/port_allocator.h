...
class RTC_EXPORT PortAllocatorSession {
 public:
  ...
  virtual ~PortAllocatorSession() = 0;
  ...
  webrtc::CallbackList<PortAllocatorSession*, PortInterface*> SignalPortReady;
  ...
  // ready(pairable).
  webrtc::CallbackList<PortAllocatorSession*,
                       const std::vector<PortInterface*>&>
      SignalPortsPruned;
  webrtc::CallbackList<PortAllocatorSession*, const std::vector<Candidate>&>
      SignalCandidatesReady;
  webrtc::CallbackList<PortAllocatorSession*, const IceCandidateErrorEvent&>
      SignalCandidateError;
  // Candidates should be signaled to be removed when the port that generated
  // the candidates is removed.
  webrtc::CallbackList<PortAllocatorSession*, const std::vector<Candidate>&>
      SignalCandidatesRemoved;
  webrtc::CallbackList<PortAllocatorSession*> SignalCandidatesAllocationDone;

  webrtc::CallbackList<PortAllocatorSession*, IceRegatheringReason>
      SignalIceRegathering;

  virtual uint32_t generation();
  virtual void set_generation(uint32_t generation);
  webrtc::CallbackList<PortAllocatorSession*> SignalDestroyed;
...
class RTC_EXPORT PortAllocator {
 public:
  ...
  webrtc::CallbackList<uint32_t /* prev_filter */, uint32_t /* cur_filter */>
