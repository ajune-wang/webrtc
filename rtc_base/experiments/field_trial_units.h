...
extern template class FieldTrialParameter<rtc::Optional<DataRate>>;
extern template class FieldTrialParameter<rtc::Optional<DataSize>>;
extern template class FieldTrialParameter<rtc::Optional<TimeDelta>>;
}  // namespace webrtc
