...
FrameComparison ValidateFrameComparison(FrameComparison comparison) {
  ...
  switch (comparison.type) {
    case FrameComparisonType::kRegular:
      ...
      RTC_DCHECK(comparison.frame_stats.encoded_frame_type ==
                     VideoFrameType::kVideoFrameKey ||
                 comparison.frame_stats.encoded_frame_type ==
                     VideoFrameType::kVideoFrameDelta)
          << "Regular comparison should have key or delta frame";
      RTC_DCHECK(comparison.frame_stats.pre_decoded_frame_type ==
                     VideoFrameType::kVideoFrameKey ||
                 comparison.frame_stats.pre_decoded_frame_type ==
                     VideoFrameType::kVideoFrameDelta)
          << "Regular comparison should have key or delta frame";
      RTC_DCHECK_GT(comparison.frame_stats.pre_decoded_image_size, 0)
          << "Regular comparison should have non-zero pre_decoded_image_size";
      break;
