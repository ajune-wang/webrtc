...
rtc::scoped_refptr<QualityScalerResource> QualityScalerResource::Create(
  ...
  return new rtc::RefCountedObject<QualityScalerResource>(qp_thresholds);
}

QualityScalerResource::QualityScalerResource(
    VideoEncoder::QpThresholds qp_thresholds)
    : VideoStreamEncoderResource("QualityScalerResource"),
      quality_scaler_(this, std::move(qp_thresholds)) {}

QualityScalerResource::~QualityScalerResource() = default;
