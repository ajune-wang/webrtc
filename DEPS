...
vars = {
  ...
  'chromium_revision': 'fdc875b654b6e7932271024cf59c714ecc428f4c',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '1a6a6985a4e58523c0306f1194cabcd581c71d87',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'e97b2d142130f56c2922ce594afa674110d27fa3',
  'src/tools/gyp':
