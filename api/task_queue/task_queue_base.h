...
class TaskQueueBase {
 public:
  ...
  // will be deleted. The deletion of tasks and deallocation of the TaskQueue
  // may happen asynchronously after the Delete returns or it may happen
  // synchronously while the TaskQueue is deleted. This may vary from one
  // implementation to the next so assumptions about lifetimes of pending tasks
  // should not be made.
