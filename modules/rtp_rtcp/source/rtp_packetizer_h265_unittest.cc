...
rtc::Buffer GenerateNalUnit(nal_unit_header header, size_t size) {
  RTC_CHECK_GT(size, 0);
...
TEST(RtpPacketizerH265Test, SingleNaluTwoPackets) {
  ...
  rtc::Buffer nalus[] = {
      GenerateNalUnit(
          {.nal_unit_type = 20, .nuh_layer_id = 32, .nuh_temporal_id_plus1 = 2},
...
TEST(RtpPacketizerH265Test, ApRespectsLayerIdAndTemporalId) {
  ...
  rtc::Buffer nalus[] = {
      GenerateNalUnit(
          {.nal_unit_type = 20, .nuh_layer_id = 2, .nuh_temporal_id_plus1 = 6},
          /*size=*/3),
      GenerateNalUnit(
          {.nal_unit_type = 20, .nuh_layer_id = 0, .nuh_temporal_id_plus1 = 1},
          /*size=*/3),
      GenerateNalUnit(
          {.nal_unit_type = 20, .nuh_layer_id = 32, .nuh_temporal_id_plus1 = 2},
          /*size=*/0x123)};
...
std::vector<int> TestFu(size_t frame_payload_size,
  ...
  rtc::Buffer nalu[] = {GenerateNalUnit(
      {.nal_unit_type = 20, .nuh_layer_id = 32, .nuh_temporal_id_plus1 = 2},
...
TEST_P(RtpPacketizerH265ParametrizedTest, MixedApFu) {
  ...
  for (size_t index = 0; index < params.nalus.size(); index++) {
    nalus.push_back(GenerateNalUnit(
        {.nal_unit_type = 20, .nuh_layer_id = 32, .nuh_temporal_id_plus1 = 2},
        params.nalus[index]));
  }
  rtc::Buffer frame = CreateFrame(nalus);
