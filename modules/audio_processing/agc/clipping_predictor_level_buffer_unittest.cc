...
TEST(ClippingPredictorLevelBufferTest, ProcessingIncompleteBufferSuccessfull) {
...
TEST(ClippingPredictorLevelBufferTest, FirstProcessingSuccessfull) {
...
TEST(ClippingPredictorLevelBufferTest, RepeatedProcessingSuccessfull) {
...
TEST(ClippingPredictorLevelBufferTest, NoMetricsForNearlyEmptyBuffer) {
  const int num_values = 4;
  ClippingPredictorLevelBuffer buffer(kBufferLength);
  PopulateBuffer(num_values, buffer);
...
TEST(ClippingPredictorLevelBufferTest, NoMetricsForEmptyBuffer) {
