...
#ifdef RTC_DISABLE_CHECK_MSG2
#define RTC_CHECK_MSG_DISABLED 1
#else
#define RTC_CHECK_MSG_DISABLED 0
#endif
...
#define RTC_CHECK(condition)                                           \
  while (!(condition))                                                 \
  true ? rtc::webrtc_checks_impl::FatalLogCall<false>(                 \
...
#define RTC_CHECK_OP(name, op, val1, val2)                                \
  ...
  true ? rtc::webrtc_checks_impl::FatalLogCall<true>(                     \
             __FILE__, __LINE__,                                          \
             RTC_CHECK_EVAL_MESSAGE(#val1 " " #op " " #val2)) &           \
