...
AgcManagerDirect::AgcManagerDirect(GainControl* gctrl,
  ...
  static_cast<GainControlImpl*>(gctrl_)->SetDigitalAdaptiveAgc(
      static_cast<AdaptiveModeLevelEstimatorAgcInterface*>(agc_.get())->GetAgc());
}
...
void AgcManagerDirect::UpdateGain() {
  ...
  int raw_compression =
      rtc::SafeClamp(rms_error, kMinCompressionGain, max_compression_gain_); // SafeClamp(25, 2, 12) = 12.
