...
The main call to use is called [TaskQueuePacedSender]. It uses a task queue to
manage thread safety and schedule delayed tasks, but delegates most of the work
to the the `PacingController` class.
If needed, it's possible to develop a custom pacer with different scheduling
