...
TEST(SingleProcessEncodedImageIdInjector, InjectExtract) {
  ...
  std::pair<uint16_t, EncodedImage> out =
      injector.ExtractId(injector.InjectId(512, source));
...
TEST(SingleProcessEncodedImageIdInjector, Inject3Extract3) {
  ...
  std::pair<uint16_t, EncodedImage> out1 = injector.ExtractId(intermediate1);
  std::pair<uint16_t, EncodedImage> out2 = injector.ExtractId(intermediate2);
  std::pair<uint16_t, EncodedImage> out3 = injector.ExtractId(intermediate3);
...
TEST(SingleProcessEncodedImageIdInjector, InjectExtractFromConcatenated) {
  ...
  std::pair<uint16_t, EncodedImage> out = injector.ExtractId(concatenated);
