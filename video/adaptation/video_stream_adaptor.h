...
#ifndef VIDEO_ADAPTATION_VIDEO_STREAM_ADAPTOR_H_
#define VIDEO_ADAPTATION_VIDEO_STREAM_ADAPTOR_H_
...
class VideoStreamAdaptor {
 public:
  ...
  // or as GetNextRestrictionsUp() and ApplyRestrictions(). See follow-up CL:
  // https://webrtc-review.googlesource.com/c/src/+/169842.
...
#endif  // VIDEO_ADAPTATION_VIDEO_STREAM_ADAPTOR_H_
