...
#ifndef MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_ENCODER_H_
#define MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_ENCODER_H_
...
class WebMVp8Encoder : public VP8Encoder {
 public:
  WebMVp8Encoder();
  ~WebMVp8Encoder() override;
...
#endif  // MODULES_VIDEO_CODING_CODECS_VP8_WEBM_VP8_ENCODER_H_
