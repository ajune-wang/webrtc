...
public class PeerConnectionClient {
  ...
  private void createPeerConnectionInternal() {
    ...
    // answer to render the video.
    setRemoteVideoRenderers();
  ...
  private void setRemoteVideoRenderers() {
    for (RtpTransceiver transceiver : peerConnection.getTransceivers()) {
      if (transceiver.mediaType().equals(MediaType.MEDIA_TYPE_VIDEO)) {
        // Found the video transceiver. Set its receiving side video renderer.
        remoteVideoTrack = new VideoTrack(transceiver.receiver().track().nativeTrack);
        remoteVideoTrack.setEnabled(renderVideo);
