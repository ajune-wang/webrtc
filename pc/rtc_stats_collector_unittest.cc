...
class RTCStatsCollectorTest : public ::testing::Test {
 public:
  ...
  ExampleStatsGraph SetupExampleStatsGraphForSelectorTests() {
    ...
    video_media_info.receivers[0].last_sender_report_timestamp =
        Timestamp::Millis(kRemoteOutboundStatsTimestampMs);
    video_media_info.receivers[0].last_sender_report_remote_timestamp =
        Timestamp::Millis(kRemoteOutboundStatsRemoteTimestampMs);
  ...
  ExampleStatsGraph SetupExampleStatsVoiceGraph(
    ...
    if (add_remote_outbound_stats) {
      ...
      media_info.receivers[0].last_sender_report_timestamp =
          Timestamp::Millis(kRemoteOutboundStatsTimestampMs);
      media_info.receivers[0].last_sender_report_remote_timestamp =
          Timestamp::Millis(kRemoteOutboundStatsRemoteTimestampMs);
