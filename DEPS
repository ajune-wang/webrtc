...
vars = {
  ...
  'chromium_revision': '5ead20cf0c678a052f88fd6a799d9d62d73da462',
...
deps = {
  ...
  'src/build':
    Var('chromium_git') + '/chromium/src/build' + '@' + '91eef3ce70a551649169a599e70ab995254a6ba2',
  'src/buildtools':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '5a10156acc8f3cf69f0a610092d5d964dee2a894',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'e6730befb8ae1633a6d75e0c1a8a920e85d3400b',
  'src/tools/gyp':
