...
#include "openssl/asn1.h"              // for asn1_string_st, BN_to_ASN1_INT...
#include "openssl/base.h"              // for X509, ASN1_TIME, BIO, ASN1_INT...
#include "openssl/digest.h"            // for EVP_MD_size, EVP_sha256
#include "openssl/nid.h"               // for NID_commonName, NID_dsaWithSHA1
#include "openssl/x509.h"              // for X509_free, X509_NAME_free, X50...
