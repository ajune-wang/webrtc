...
#ifndef RTC_BASE_METRONOME_METRONOME_H_
#define RTC_BASE_METRONOME_METRONOME_H_
 ...
 public:
  class RTC_EXPORT TickListener {
   public:
    ...
    // |OnTick| is run on the |OnTickTaskQueue| each time the metronome ticks.
  ...
  // |listener.OnTick| will be invoked on each metronome tick. A listener may
  // only be added once to the metronome.
  ...
  // within a listener's own |OnTick| method.
...
#endif  // RTC_BASE_METRONOME_METRONOME_H_
