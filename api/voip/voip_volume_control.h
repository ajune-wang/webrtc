...
class VoipVolumeControl {
 public:
  ...
  // Returns the microphone volume info.
  virtual VolumeInfo GetInputVolumeInfo(ChannelId channel_id) = 0;

  // Returns the speaker volume info.
  virtual VolumeInfo GetOutputVolumeInfo(ChannelId channel_id) = 0;
