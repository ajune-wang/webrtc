...
int main(int argc, char* argv[]) {
  ...
  webrtc::ParsedRtcEventLog2::UnconfiguredHeaderExtensions header_extensions =
      webrtc::ParsedRtcEventLog2::UnconfiguredHeaderExtensions::kDontParse;
  if (FLAG_parse_unconfigured_header_extensions) {
    header_extensions = webrtc::ParsedRtcEventLog2::
        UnconfiguredHeaderExtensions::kAttemptWebrtcDefaultConfig;
  }
  webrtc::ParsedRtcEventLog2 parsed_log(header_extensions);
