...
class RtcEventLogImpl final : public RtcEventLog {
 ...
 private:
  ...
  // `normal_log_task_queue_` should be `task_queue_.get()` if the logging is
  // started. Otherwise, it equals to nullptr. All log tasks except config
  // events should use this when posted.
