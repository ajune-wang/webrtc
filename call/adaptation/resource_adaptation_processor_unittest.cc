...
class ResourceAdaptationProcessorTest : public ::testing::Test {
 public:
  ...
  void SetUp() override {
    rtc::Event adaptation_queue_event;
    resource_adaptation_queue_.PostTask([this, &adaptation_queue_event] {
      ...
      adaptation_queue_event.Set();
    });
    adaptation_queue_event.Wait(kDefaultTimeout);
  }
  ...
  void TearDown() override {
    ...
    resource_adaptation_queue_.PostTask([this, &adaptation_queue_event] {
      ...
      // The processor must be destroyed on the processor queue.
      processor_.reset();
      adaptation_queue_event.Set();
    });
    adaptation_queue_event.Wait(kDefaultTimeout);
