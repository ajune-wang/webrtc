...
void OverrideQualityScalingSettings(const VideoCodec& codec,
  ...
  if (encoder_info->scaling_settings.thresholds.has_value() &&
    ...
    RTC_LOG(LS_WARNING)
        << "Scaling settings are present but quality adaptation is disabled. "
           "Remove scaling settings.";
...
void VideoStreamEncoder::SetSource(
  ...
  encoder_queue_.PostTask([this, degradation_preference] {
    ...
    if (encoder_) {
      ...
      OverrideQualityScalingSettings(send_codec_, &encoder_info);
...
void VideoStreamEncoder::ReconfigureEncoder() {
  ...
  OverrideQualityScalingSettings(send_codec_, &info);
