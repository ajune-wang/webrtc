 ...
 protected:
  ...
  void CreateInstance(
    ...
    if (use_mock_neteq_controller_) {
      ...
      controller_config.neteq_facade = std::make_unique<NetEqFacadeImpl>(
          packet_buffer_, buffer_level_filter_, decoder_database_,
          deps.stats.get());
  ...
  // Expectations for delay manager.
  {
    ...
    EXPECT_CALL(
        *mock_neteq_controller_,
        LastDecodedWasCngOrDtmf(/*last_cng_or_dtmf*/ false,
