...
FakeNetworkSocket::FakeNetworkSocket(EndpointProvider* endpoint_provider)
    : endpoint_provider_(endpoint_provider), state_(CS_CLOSED), error_(0) {}
...
int FakeNetworkSocket::RecvFrom(void* pv,
  ...
  EmulatedIpPacket packet = std::move(packet_queue_.front());
