...
class PacedSender : public Pacer {
 public:
  ...
  void SetOutstandingData(int64_t outstanding_bytes);
  ...
  // Set the bitrate to compare with for the alr-detector
 ...
 private:
  ...
  int64_t congestion_window_bytes_ RTC_GUARDED_BY(critsect_) = 0;
  ...
  // pacer process thread. In SendSideCongestionController is running on a task
