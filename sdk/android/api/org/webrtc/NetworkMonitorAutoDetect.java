...
public class NetworkMonitorAutoDetect extends BroadcastReceiver {
  ...
  static class ConnectivityManagerDelegate {
    ...
    NetworkState getNetworkState(Network network) {
      ...
      // When |network| is a VPN and |networkInfo| is of type TYPE_VPN, we return the NetworkState
      // of the active network that supports this VPN via getActiveNetworkInfo().
      if (networkInfo.getType() == ConnectivityManager.TYPE_VPN) {
    ...
    private @Nullable NetworkInformation networkToInfo(Network network) {
      ...
      ConnectionType connectionType = getConnectionType(networkState.isConnected(),
      ...
      // unknown.
      ConnectionType underlyingConnectionTypeForVpn = getConnectionType(networkState.isConnected(),
  ...
  public NetworkMonitorAutoDetect(Observer observer, Context context) {
    ...
    connectionType = getConnectionType(networkState.isConnected(), networkState.getNetworkType(),
        networkState.getNetworkSubType());
  ...
  private String getWifiSSID(NetworkState networkState) {
    if (getConnectionType(networkState.isConnected(), networkState.getNetworkType(),
            networkState.getNetworkSubType())
  ...
  private void connectionTypeChanged(NetworkState networkState) {
    ConnectionType newConnectionType = getConnectionType(networkState.isConnected(),
        networkState.getNetworkType(), networkState.getNetworkSubType());
