...
vars = {
  ...
  'chromium_revision': '5220c2b37a2c5cd524d0addd612d63053ef2ba63',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@2b0e2c6fc90402608fcf8238f14fa7b802b893fd',
    ...
    'packages': [
      {
          ...
          'version': 'g18iQN1uRKfaFL7-3aprmbmhyaPfY9VxK3udS1Uf2IcC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
