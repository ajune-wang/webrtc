...
std::unique_ptr<Call> PeerConnectionFactory::CreateCall_w(
  ...
  call_config.task_queue_factory = GetTaskQueueFactory();
...
TaskQueueFactory* PeerConnectionFactory::GetTaskQueueFactory() {
  return task_queue_factory_ ? task_queue_factory_.get()
