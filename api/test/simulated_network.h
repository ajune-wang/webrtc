...
class NetworkBehaviorInterface {
 public:
  ...
  // Not all the packets in the returned std::vector are actually delivered, in
  // order to know the state of each packet it is necessary to check the
  ...
  // the updated estimate of delivery.
...
class SimulatedNetworkInterface : public NetworkBehaviorInterface {
 public:
  ...
  // flowing and the will restart flowing at `until_us`).
