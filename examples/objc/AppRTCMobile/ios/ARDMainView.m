...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    _startRegularCallButton.backgroundColor
        = [UIColor colorWithRed:0.3 green:0.6 blue:0.3 alpha:1.0];
    ...
    _startLoopbackCallButton.backgroundColor =
        [UIColor colorWithRed:0.3 green:0.3 blue:0.6 alpha:1.0];
    ...
    _audioLoopButton.backgroundColor =
        [UIColor colorWithRed:0.6 green:0.3 blue:0.3 alpha:1.0];
