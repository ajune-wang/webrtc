...
class AudioTrackSinkInterface {
 public:
  ...
  // Version 3. Pass audio data as a bound-checked span.
  virtual void OnData(std::span<const uint8_t> audio_data,
                      int bits_per_sample,
                      int sample_rate,
                      size_t number_of_channels,
                      size_t number_of_frames,
    ...
    // TODO(bugs.webrtc.org/10739): Deprecate the old OnData and make this one
    // pure virtual.
    return OnData(audio_data.data(), bits_per_sample, sample_rate,
