...
#ifndef RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_POSIX_H_
#define RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_POSIX_H_
...
#endif  // RTC_BASE_SYNCHRONIZATION_CRITICAL_SECTION_POSIX_H_
