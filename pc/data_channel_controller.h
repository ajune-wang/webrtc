...
class DataChannelController : public DataChannelProviderInterface,
 ...
 public:
  ...
  // label -> DataChannel
  std::map<std::string, rtc::scoped_refptr<DataChannel>>* rtp_data_channels() {
  ...
  std::vector<rtc::scoped_refptr<DataChannel>>* sctp_data_channels_to_free() {
    return &sctp_data_channels_to_free_;
  }
