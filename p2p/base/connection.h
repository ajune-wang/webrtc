...
class Connection : public CandidatePairInterface,
 ...
 public:
  ...
  void SendPingResponse(const StunMessage* request);
 ...
 private:
  ...
  // it configured vai field trial, remote peer support it (signaled
  // in STUN_BINDING) and if last STUN BINDING is identical to the one
