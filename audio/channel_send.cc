...
class ChannelSend : public ChannelSendInterface,
 ...
 private:
  ...
  // members are destroyed, in particular `encoder_queue_checker_` should be
  // valid while a task on the `encoder_queue_` might run.
...
ChannelSend::ChannelSend(
    ...
    : ssrc_(ssrc),
      ...
      encoder_queue_checker_(SequenceChecker::kDetached),
