...
vars = {
  ...
  'chromium_revision': '0733ccc6b5edd43214843a5c81a7b77f8e702e30',
...
deps = {
  ...
  'src/build':
    'https://chromium.googlesource.com/chromium/src/build@6025acd439ca7cde73ad6f93977d9806565a6c2f',
  'src/buildtools':
    ...
    'packages': [
      {
          ...
          'version': 'JpOPElqGLc1lStgXj_5O-GfE89J6aQYL3EXuN_E-gLIC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
