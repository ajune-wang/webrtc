...
vars = {
  ...
  'chromium_revision': '82875786730504c91154dca8bcc974d514d8f2f6',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '4ac1a50c8bf7cd9365cd045d582041199efa2555',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '278f3d31e584da859ed2dbcfec9cb3f6ecff6816',
  'src/tools/gyp':
