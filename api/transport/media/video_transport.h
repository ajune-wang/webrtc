...
class MediaTransportVideoSinkInterface {
 public:
  ...
  // Called when new encoded video frame is received. Deprecated.
  ...
  // TODO(nisse): Rename, maybe OnEncodedFrame?
  virtual void OnData(MediaTransportEncodedVideoFrame frame) {}
};
...
class MediaTransportKeyFrameRequestCallback {
 public:
  ...
  // Deprecated. Delete, and make above method abstract, when all
  // implementations have migrated to MediaTransportVideoSender.
