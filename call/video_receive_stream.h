...
class VideoReceiveStream {
 public:
  ...
  // Class for handling moving in/out encoded frame dispatch state.
  class EncodedFrameDispatchState {
   public:
    EncodedFrameDispatchState() : keyframe_generation_requested(false) {}
    explicit EncodedFrameDispatchState(RecordableEncodedFrameFunction callback)
        : callback(std::move(callback)), keyframe_generation_requested(false) {}
    RecordableEncodedFrameFunction callback;
    bool keyframe_generation_requested;
  };
  ...
  // Sets and returns encoded frame state. The old state is moved out
  ...
  virtual EncodedFrameDispatchState SetEncodedFrameDispatchState(
