...
class Call {
 public:
  ...
  // This is used to access the transport controller instance owned by Call. The
  // send transport controller is currently owned by Call for leagacy reasons.
  // (for instance  variants of call tests are built on this assumtion) It is
  // desirable to move ownership of send transport controller out of Call. In
  // which case this member function should be removed.
