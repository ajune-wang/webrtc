...
void ResidualEchoEstimator::Estimate(
  ...
  if (aec_state.LinearEchoEstimate()) {
    ...
    NonLinearEstimate(aec_state.SufficientFilterUpdates(),
                      aec_state.SaturatedEcho(),
                      config_.param.ep_strength.bounded_erl,
...
void ResidualEchoEstimator::NonLinearEstimate(
  ...
  if (saturated_echo) {
    ...
    // Before the filter has been able to converge, use conservative gains.
