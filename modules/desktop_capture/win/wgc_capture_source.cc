...
// Light-weight version of IsCapturable(). Avoids calling IsCapturable() which
// allocates/deallocates a new COM object for each call. Will return false
// when a window has been minimized.
