...
#ifndef WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_VIDEO_RENDERER_H_
#define WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_VIDEO_RENDERER_H_
...
#endif  // WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_VIDEO_RENDERER_H_
