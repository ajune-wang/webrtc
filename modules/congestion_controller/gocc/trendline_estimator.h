 ...
 */
#ifndef MODULES_CONGESTION_CONTROLLER_GOCC_TRENDLINE_ESTIMATOR_H_
#define MODULES_CONGESTION_CONTROLLER_GOCC_TRENDLINE_ESTIMATOR_H_
...
#endif  // MODULES_CONGESTION_CONTROLLER_GOCC_TRENDLINE_ESTIMATOR_H_
