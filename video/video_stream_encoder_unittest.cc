 ...
 public:
  ...
  void ResetEncoder(
      ...
      VideoStreamEncoderSettings::BitrateAllocationCallbackType
          allocation_report_settings = VideoStreamEncoderSettings::
...
TEST_F(VideoStreamEncoderTest, ReportsVideoBitrateAllocation) {
  ...
  // Check that encoder has been updated too, not just the allocation.
  ...
  EXPECT_EQ(sink_.number_of_bitrate_allocations(), 2);
