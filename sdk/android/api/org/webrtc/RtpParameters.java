...
public class RtpParameters {
  ...
  public static class Encoding {
    ...
    Encoding(String rid, boolean active, double bitratePriority, double networkPriority,
