...
void P2PTransportChannel::AddConnection(Connection* connection) {
  ...
  // Signal for ICE logging.
  connection->SignalConnectivityCheckStatus.connect(
      this, &P2PTransportChannel::OnCandidatePairStatusUpdate);

  had_connection_ = true;

  OnCandidatePairStatusUpdate(connection,
                              webrtc::IceCandidatePairStatus::kAdded);
}
...
void P2PTransportChannel::SwitchSelectedConnection(Connection* conn) {
  ...
  OnCandidatePairStatusUpdate(conn, webrtc::IceCandidatePairStatus::kSelected);
...
void P2PTransportChannel::OnCandidatePairStatusUpdate(
    Connection* conn,
    webrtc::IceCandidatePairStatus status) {
  ice_event_log_.LogCandidatePairStatus(conn->ToDescriptionString(), status);
}
