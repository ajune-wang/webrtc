...
TEST_F(RTCStatsCollectorTest, CollectRTCOutboundRtpStreamStats_Video) {
  ...
  video_media_info.senders[0].psnr_sum_y = std::nullopt;
  video_media_info.senders[0].psnr_sum_u = std::nullopt;
  video_media_info.senders[0].psnr_sum_v = std::nullopt;
  ...
  // `expected_video.content_type` should be undefined.
  // `expected_video.qp_sum` should be undefined.
  // `expected_video.psnr_sum_y` should be undefined.
  // `expected_video.psnr_sum_u` should be undefined.
  // `expected_video.psnr_sum_v` should be undefined.
  ...
  expected_video.qp_sum = 9;
  video_media_info.senders[0].psnr_sum_y = 29;
  video_media_info.senders[0].psnr_sum_u = 30;
  video_media_info.senders[0].psnr_sum_v = 31;
  expected_video.psnr_sum_y = 29;
  expected_video.psnr_sum_u = 30;
  expected_video.psnr_sum_v = 31;
