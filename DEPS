...
vars = {
  ...
  'chromium_revision': 'dca6bd9172dbf71b6a00cd9ada2c49682ac84c15',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '2a5e8ccd8c3f392cdef26ec9e0c159a1ca141a78',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'ac6fa74ba300ec765ea97716b8eabc8f9b7a99c4',
  'src/tools/gyp':
