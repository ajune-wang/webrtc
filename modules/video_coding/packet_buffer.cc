...
bool PacketBuffer::PotentialNewFrame(uint16_t seq_num) const {
  size_t index = seq_num % size_;
  std::cout << "=========== PNF index  :::::::::::" << index << std::endl;
  int prev_index = index > 0 ? index - 1 : size_ - 1;
  std::cout << "=========== PNF prev_index  :::::::::::" << prev_index << std::endl;

  if (!sequence_buffer_[index].used)
    return false;
  std::cout << "=========== PNF used  :::::::::::" << std::endl;
  if (sequence_buffer_[index].seq_num != seq_num)
    return false;
  std::cout << "=========== PNF seq_num  :::::::::::" << std::endl;
  if (sequence_buffer_[index].frame_created)
    return false;
  std::cout << "=========== PNF frame_created  :::::::::::" << std::endl;
  if (sequence_buffer_[index].frame_begin)
    return true;
  std::cout << "=========== PNF frame_begin  :::::::::::" << std::endl;
  if (!sequence_buffer_[prev_index].used)
    return false;
  std::cout << "=========== PNF prev used  :::::::::::" << std::endl;
  if (sequence_buffer_[prev_index].frame_created)
    return false;
  std::cout << "=========== PNF prev frame_created  :::::::::::" << std::endl;
  std::cout << "===========  sequence_buffer_[prev_index].seq_num :::::::::::" << sequence_buffer_[prev_index].seq_num << std::endl;
  std::cout << "===========  sequence_buffer_[index].seq_num :::::::::::" << sequence_buffer_[index].seq_num << std::endl;
  std::cout << "===========  sequence_buffer_[index].seq_num - 1 :::::::::::" << sequence_buffer_[index].seq_num - 1 << std::endl;
  std::cout << "===========  static_cast :::::::::::" << static_cast<uint16_t>(sequence_buffer_[index].seq_num - 1) << std::endl;
  std::cout << "===========  cmp :::::::::::" <<  (sequence_buffer_[prev_index].seq_num !=
      static_cast<uint16_t>(sequence_buffer_[index].seq_num - 1)) << std::endl;
  if (sequence_buffer_[prev_index].seq_num !=
      static_cast<uint16_t>(sequence_buffer_[index].seq_num - 1)) {
    return false;
  }
  std::cout << "=========== PNF prev seq_num  :::::::::::" << std::endl;
