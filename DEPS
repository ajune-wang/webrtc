...
vars = {
  ...
  'chromium_revision': 'c6ce337052bcad7bdb0bc2eefe291461ec284352',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '5bb7f1057328f71a01819794a89cbbd1a6eb50cb',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'cffbe491005d9727a1c0bb6a1073503a752ab621',
  'src/tools/gyp':
