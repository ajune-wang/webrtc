...
EchoCanceller3Config AdjustConfig(const EchoCanceller3Config& config) {
  ...
  if (EnableDominantNearendTuning()) {
    adjusted_cfg.suppressor.dominant_nearend_detection.enr_threshold = 7;
    adjusted_cfg.suppressor.dominant_nearend_detection.snr_threshold = 60;
    adjusted_cfg.suppressor.dominant_nearend_detection.hold_duration = 6;
    adjusted_cfg.suppressor.dominant_nearend_detection.trigger_threshold = 10;
    adjusted_cfg.suppressor.nearend_tuning.mask_hf.enr_transparent = 0.27f;
    adjusted_cfg.suppressor.nearend_tuning.mask_hf.enr_suppress = 0.3f;
    adjusted_cfg.suppressor.nearend_tuning.mask_hf.emr_transparent = 0.5f;
    adjusted_cfg.suppressor.nearend_tuning.mask_lf.enr_transparent = 0.4f;
    adjusted_cfg.suppressor.nearend_tuning.mask_lf.enr_suppress = 0.5f;
    adjusted_cfg.suppressor.nearend_tuning.mask_lf.emr_transparent = 0.5f;
    adjusted_cfg.suppressor.nearend_tuning.max_dec_factor_lf = 0.4f;
    adjusted_cfg.suppressor.nearend_tuning.max_inc_factor = 4.f;
  }
