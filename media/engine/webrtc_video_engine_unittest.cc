...
// Test that FlexFEC is supported only as a receive video codec.
// FlexFEC as a sender video codec is currently invalid.
TEST_F(WebRtcVideoEngineTest, Flexfec03SupportedAsReceiveCodecOnly) {
  encoder_factory_->AddSupportedVideoCodecType("VP8");
