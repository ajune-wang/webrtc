...
class GlGenericDrawer implements RendererCommon.GlDrawer {
  ...
  static String createFragmentShaderString(String genericFragmentSource, ShaderType shaderType) {
    ...
    if (shaderType == ShaderType.YUV) {
      ...
      stringBuilder.append("  mat4 yuv_to_rgb_mat = mat4(\n");
      stringBuilder.append("    1.16487, 1.16373, 1.16645, 0.,\n");
      stringBuilder.append("    0.000343849, -0.392669, 2.021, 0.,\n");
      stringBuilder.append("    1.59905, -0.814729, 0.00113166, 0.,\n");
      stringBuilder.append("    -0.875925, 0.533048, -1.08822, 1.);\n");
      stringBuilder.append("  vec4 yuv = vec4(\n");
      stringBuilder.append("    texture2D(y_tex, p).r,\n");
      stringBuilder.append("    texture2D(u_tex, p).r,\n");
      stringBuilder.append("    texture2D(v_tex, p).r, 1.);\n");
      stringBuilder.append("  return yuv_to_rgb_mat * yuv;\n");
