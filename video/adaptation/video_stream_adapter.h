...
struct VideoStreamInputState {
  VideoStreamInputState(int frame_size_pixels,
...
class VideoStreamAdapter {
 public:
  ...
  void SetInput(VideoStreamInputState input, int min_pixels_per_frame);
  // TODO(hbos): Remove this and update tests:
