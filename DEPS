...
vars = {
  ...
  'chromium_revision': 'ceced7f18e9f29019fa6cf8f8218d05dcbc0bc86',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@93e4867a2f1827203099317068c6de3c44991b9d',
    ...
    'packages': [
      {
          ...
          'version': 's-yk3QWNJaMZb48LAvscwd60PQUiXOxxQArM6QRSi4cC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
