...
vars = {
  ...
  'chromium_revision': 'fbc016f8498abf4d05e725bb439f5f37d1b5ddd7',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'a9d312b768d024fec4796ffcef2316736f245f6c',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '7d87e4f35449b6c3e52bfddf87ea470d9a2d6218',
  'src/tools/gyp':
