...
*   Video
    ...
    *   Generated video
    *   Video from specified file
    *   Video from any instance of *`webrtc::test::FrameGeneratorInterface`*
    *   Dumping of captured/rendered video into file
    *   Screen sharing
    *   Vp8 simulcast from caller side
    *   Vp9 CVS from caller side
