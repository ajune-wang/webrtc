...
#ifndef MODULES_DESKTOP_CAPTURE_LINUX_WAYLAND_TEST_SUPPORT_FAKE_SCREENCAST_STREAM_H_
#define MODULES_DESKTOP_CAPTURE_LINUX_WAYLAND_TEST_SUPPORT_FAKE_SCREENCAST_STREAM_H_
...
class FakeScreenCastStream {
 public:
  ...
  explicit FakeScreenCastStream(StreamNotifier* notifier);
...
#endif  // MODULES_DESKTOP_CAPTURE_LINUX_WAYLAND_TEST_SUPPORT_FAKE_SCREENCAST_STREAM_H_
