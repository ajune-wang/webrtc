...
class ConnectionInterface : public CandidatePairInterface {
 public:
  ...
  virtual PortInterface* PortForTest() = 0;
  virtual const PortInterface* PortForTest() const = 0;
 ...
 protected:
  ...
  virtual PortInterface* port() = 0;
  virtual const PortInterface* port() const = 0;
