...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
  ...
  public static VideoFrame.Buffer cropAndScaleI420(final I420Buffer buffer, int cropX, int cropY,
    ...
    JavaI420BufferJni.get().cropAndScaleI420(buffer.getDataY(), buffer.getStrideY(),
        buffer.getDataU(), buffer.getStrideU(), buffer.getDataV(), buffer.getStrideV(), cropX,
        cropY, cropWidth, cropHeight, newBuffer.getDataY(), newBuffer.getStrideY(),
  ...
  @NativeMethods
  interface Natives {
    void cropAndScaleI420(ByteBuffer srcY, int srcStrideY, ByteBuffer srcU, int srcStrideU,
        ByteBuffer srcV, int srcStrideV, int cropX, int cropY, int cropWidth, int cropHeight,
        ByteBuffer dstY, int dstStrideY, ByteBuffer dstU, int dstStrideU, ByteBuffer dstV,
        int dstStrideV, int scaleWidth, int scaleHeight);
  }
}
