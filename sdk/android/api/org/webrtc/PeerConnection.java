...
public class PeerConnection {
  ...
  public SessionDescription getLocalDescription() {
    return PeerConnectionJni.get().getLocalDescription(nativePeerConnection);
  }

  public SessionDescription getRemoteDescription() {
    return PeerConnectionJni.get().getRemoteDescription(nativePeerConnection);
  }

  public RtcCertificatePem getCertificate() {
    return PeerConnectionJni.get().getCertificate(nativePeerConnection);
  }

  public DataChannel createDataChannel(String label, DataChannel.Init init) {
    return PeerConnectionJni.get().createDataChannel(nativePeerConnection, label, init);
  }

  public void createOffer(SdpObserver observer, MediaConstraints constraints) {
    PeerConnectionJni.get().createOffer(nativePeerConnection, observer, constraints);
  }

  public void createAnswer(SdpObserver observer, MediaConstraints constraints) {
    PeerConnectionJni.get().createAnswer(nativePeerConnection, observer, constraints);
  }

  public void setLocalDescription(SdpObserver observer) {
    PeerConnectionJni.get().setLocalDescriptionAutomatically(nativePeerConnection, observer);
  }

  public void setLocalDescription(SdpObserver observer, SessionDescription sdp) {
    PeerConnectionJni.get().setLocalDescription(nativePeerConnection, observer, sdp);
  }

  public void setRemoteDescription(SdpObserver observer, SessionDescription sdp) {
    PeerConnectionJni.get().setRemoteDescription(nativePeerConnection, observer, sdp);
  }
  ...
  public void restartIce() {
    PeerConnectionJni.get().restartIce(nativePeerConnection);
  }
  ...
  public void setAudioPlayout(boolean playout) {
    PeerConnectionJni.get().setAudioPlayout(nativePeerConnection, playout);
  }
  ...
  public void setAudioRecording(boolean recording) {
    PeerConnectionJni.get().setAudioRecording(nativePeerConnection, recording);
  }

  public boolean setConfiguration(RTCConfiguration config) {
    return PeerConnectionJni.get().setConfiguration(nativePeerConnection, config);
  }

  public boolean addIceCandidate(IceCandidate candidate) {
    return PeerConnectionJni.get().addIceCandidate(
        nativePeerConnection, candidate.sdpMid, candidate.sdpMLineIndex, candidate.sdp);
  }

  public void addIceCandidate(IceCandidate candidate, AddIceObserver observer) {
    PeerConnectionJni.get().addIceCandidateWithObserver(
        nativePeerConnection, candidate.sdpMid, candidate.sdpMLineIndex, candidate.sdp, observer);
  }

  public boolean removeIceCandidates(final IceCandidate[] candidates) {
    return PeerConnectionJni.get().removeIceCandidates(nativePeerConnection, candidates);
  }
  ...
  public boolean addStream(MediaStream stream) {
    boolean ret =
        PeerConnectionJni.get().addLocalStream(nativePeerConnection, stream.getNativeMediaStream());
    if (!ret) {
      return false;
    }
  ...
  public void removeStream(MediaStream stream) {
    PeerConnectionJni.get().removeLocalStream(nativePeerConnection, stream.getNativeMediaStream());
  ...
  public RtpSender createSender(String kind, String stream_id) {
    RtpSender newSender =
        PeerConnectionJni.get().createSender(nativePeerConnection, kind, stream_id);
    if (newSender != null) {
  ...
  public List<RtpSender> getSenders() {
    ...
    senders = PeerConnectionJni.get().getSenders(nativePeerConnection);
  ...
  public List<RtpReceiver> getReceivers() {
    ...
    receivers = PeerConnectionJni.get().getReceivers(nativePeerConnection);
  ...
  public List<RtpTransceiver> getTransceivers() {
    ...
    transceivers = PeerConnectionJni.get().getTransceivers(nativePeerConnection);
  ...
  public RtpSender addTrack(MediaStreamTrack track, List<String> streamIds) {
    ...
    RtpSender newSender = PeerConnectionJni.get().addTrack(
        nativePeerConnection, track.getNativeMediaStreamTrack(), streamIds);
    if (newSender == null) {
  ...
  public boolean removeTrack(RtpSender sender) {
    ...
    return PeerConnectionJni.get().removeTrack(nativePeerConnection, sender.getNativeRtpSender());
  }
  ...
  public RtpTransceiver addTransceiver(
    ...
    RtpTransceiver newTransceiver = PeerConnectionJni.get().addTransceiverWithTrack(
        nativePeerConnection, track.getNativeMediaStreamTrack(), init);
  ...
  public RtpTransceiver addTransceiver(
    ...
    RtpTransceiver newTransceiver =
        PeerConnectionJni.get().addTransceiverOfType(nativePeerConnection, mediaType, init);
    if (newTransceiver == null) {
      throw new IllegalStateException("C++ addTransceiver failed.");
    }
    transceivers.add(newTransceiver);
  ...
  public boolean getStats(StatsObserver observer, @Nullable MediaStreamTrack track) {
    return PeerConnectionJni.get().oldGetStats(
        nativePeerConnection, observer, (track == null) ? 0 : track.getNativeMediaStreamTrack());
  }
  ...
  public void getStats(RTCStatsCollectorCallback callback) {
    PeerConnectionJni.get().newGetStats(nativePeerConnection, callback);
  }
  ...
  public void getStats(RtpSender sender, RTCStatsCollectorCallback callback) {
    PeerConnectionJni.get().newGetStatsSender(
        nativePeerConnection, sender.getNativeRtpSender(), callback);
  }
  ...
  public void getStats(RtpReceiver receiver, RTCStatsCollectorCallback callback) {
    PeerConnectionJni.get().newGetStatsReceiver(
        nativePeerConnection, receiver.getNativeRtpReceiver(), callback);
  }
  ...
  public boolean setBitrate(Integer min, Integer current, Integer max) {
    return PeerConnectionJni.get().setBitrate(nativePeerConnection, min, current, max);
  }
  ...
  public boolean startRtcEventLog(int file_descriptor, int max_size_bytes) {
    return PeerConnectionJni.get().startRtcEventLog(
  ...
  public void stopRtcEventLog() {
    PeerConnectionJni.get().stopRtcEventLog(nativePeerConnection);
  }

  // TODO(fischman): add support for DTMF-related methods once that API
  // stabilizes.
  public SignalingState signalingState() {
    return PeerConnectionJni.get().signalingState(nativePeerConnection);
  }

  public IceConnectionState iceConnectionState() {
    return PeerConnectionJni.get().iceConnectionState(nativePeerConnection);
  }

  public PeerConnectionState connectionState() {
    return PeerConnectionJni.get().connectionState(nativePeerConnection);
  }

  public IceGatheringState iceGatheringState() {
    return PeerConnectionJni.get().iceGatheringState(nativePeerConnection);
  }

  public void close() {
    PeerConnectionJni.get().close(nativePeerConnection);
  }
  ...
  public void dispose() {
    ...
    for (MediaStream stream : localStreams) {
      PeerConnectionJni.get().removeLocalStream(
          nativePeerConnection, stream.getNativeMediaStream());
      stream.dispose();
    }
    localStreams.clear();
    for (RtpSender sender : senders) {
  ...
  public long getNativePeerConnection() {
    return PeerConnectionJni.get().getNativePeerConnection(nativePeerConnection);
  }

  @CalledByNative
  long getNativeOwnedPeerConnection(nativePeerConnection) {
  ...
  @NativeMethods
  interface Natives {
    long getNativePeerConnection(long nativePeerConnectionObserverJni);
    SessionDescription getLocalDescription(long nativePeerConnectionObserverJni);
    SessionDescription getRemoteDescription(long nativePeerConnectionObserverJni);
    RtcCertificatePem getCertificate(long nativePeerConnectionObserverJni);
    DataChannel createDataChannel(
        long nativePeerConnectionObserverJni, String label, DataChannel.Init init);
    void createOffer(
        long nativePeerConnectionObserverJni, SdpObserver observer, MediaConstraints constraints);
    void createAnswer(
        long nativePeerConnectionObserverJni, SdpObserver observer, MediaConstraints constraints);
    void setLocalDescriptionAutomatically(
        long nativePeerConnectionObserverJni, SdpObserver observer);
    void setLocalDescription(
        long nativePeerConnectionObserverJni, SdpObserver observer, SessionDescription sdp);
    void setRemoteDescription(
        long nativePeerConnectionObserverJni, SdpObserver observer, SessionDescription sdp);
    void restartIce(long nativePeerConnectionObserverJni);
    void setAudioPlayout(long nativePeerConnectionObserverJni, boolean playout);
    void setAudioRecording(long nativePeerConnectionObserverJni, boolean recording);
    boolean setBitrate(
        long nativePeerConnectionObserverJni, Integer min, Integer current, Integer max);
    SignalingState signalingState(long nativePeerConnectionObserverJni);
    IceConnectionState iceConnectionState(long nativePeerConnectionObserverJni);
    PeerConnectionState connectionState(long nativePeerConnectionObserverJni);
    IceGatheringState iceGatheringState(long nativePeerConnectionObserverJni);
    void close(long nativePeerConnectionObserverJni);
    long createPeerConnectionObserver(Observer observer);
    void freeOwnedPeerConnection(long ownedPeerConnection);
    boolean setConfiguration(long nativePeerConnectionObserverJni, RTCConfiguration config);
    boolean addIceCandidate(long nativePeerConnectionObserverJni, String sdpMid, int sdpMLineIndex,
        String iceCandidateSdp);
    void addIceCandidateWithObserver(long nativePeerConnectionObserverJni, String sdpMid,
        int sdpMLineIndex, String iceCandidateSdp, AddIceObserver observer);
    boolean removeIceCandidates(
        long nativePeerConnectionObserverJni, final IceCandidate[] candidates);
    boolean addLocalStream(long nativePeerConnectionObserverJni, long stream);
    void removeLocalStream(long nativePeerConnectionObserverJni, long stream);
    boolean oldGetStats(
        long nativePeerConnectionObserverJni, StatsObserver observer, long nativeTrack);
    void newGetStats(long nativePeerConnectionObserverJni, RTCStatsCollectorCallback callback);
    void newGetStatsSender(
        long nativePeerConnectionObserverJni, long sender, RTCStatsCollectorCallback callback);
    void newGetStatsReceiver(
        long nativePeerConnectionObserverJni, long receiver, RTCStatsCollectorCallback callback);
    RtpSender createSender(long nativePeerConnectionObserverJni, String kind, String stream_id);
    List<RtpSender> getSenders(long nativePeerConnectionObserverJni);
    List<RtpReceiver> getReceivers(long nativePeerConnectionObserverJni);
    List<RtpTransceiver> getTransceivers() long nativePeerConnectionObserverJni;
    RtpSender addTrack(long nativePeerConnectionObserverJni, long track, List<String> streamIds);
    boolean removeTrack(long nativePeerConnectionObserverJni, long sender);
    RtpTransceiver addTransceiverWithTrack(
        long nativePeerConnectionObserverJni, long track, RtpTransceiver.RtpTransceiverInit init);
    RtpTransceiver addTransceiverOfType(long nativePeerConnectionObserverJni,
        MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit init);
    boolean startRtcEventLog(
        long nativePeerConnectionObserverJni, int file_descriptor, int max_size_bytes);
    void stopRtcEventLog(long nativePeerConnectionObserverJni);
  }
}
