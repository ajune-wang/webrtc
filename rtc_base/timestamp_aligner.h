...
class RTC_EXPORT TimestampAligner {
 ...
 public:
  ...
  // allow TimestampAligner to translate capturer time into system clock with
  // earlier observations. It won't guarantee monotonicity.
 ...
 private:
  ...
  // Memorize the offset between |prev_translated_time_us_| and the
  // corresponding capturer time.
