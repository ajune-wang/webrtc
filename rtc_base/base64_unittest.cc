...
TEST(Base64, EncodeDecodeBattery) {
  RTC_DLOG(LS_VERBOSE) << "Testing base-64";
  ...
  for (i = 0; i < sizeof(base64_tests) / sizeof(base64_tests[0]); ++i) {
    ...
    RTC_DLOG(LS_VERBOSE) << "B64: " << base64_tests[i].cyphertext;
...
TEST(Base64, LargeSample) {
  RTC_DLOG(LS_VERBOSE) << "Testing specific base64 file";
