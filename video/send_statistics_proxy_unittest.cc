 ...
 protected:
  ...
  void ExpectEqual(VideoSendStream::Stats one, VideoSendStream::Stats other) {
    ...
    for (std::map<uint32_t, VideoSendStream::StreamStats>::const_iterator it =
      ...
      const RTCPReportBlock& a_rtcp_stats = a.report_block_data->report_block();
      const RTCPReportBlock& b_rtcp_stats = b.report_block_data->report_block();
