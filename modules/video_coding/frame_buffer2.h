...
class FrameBuffer {
 ...
 private:
  ...
  // Maximum number of frames in the pre-decode queue to allow pacing. If the
  // queue grows beyond the max limit, pacing will be disabled and frames will
  // be pushed to the decoder as soon as possible.
  FieldTrialParameter<unsigned> max_queue_size_limit_pacing_delay_;
};
