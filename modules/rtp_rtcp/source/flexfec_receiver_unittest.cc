...
TEST_F(FlexfecReceiverTest, FailsOnUnknownMediaSsrc) {
  ...
  // Corrupt the SSRC.
  media_packet->data.Data()[8] = 0;
  media_packet->data.Data()[9] = 1;
  media_packet->data.Data()[10] = 2;
  media_packet->data.Data()[11] = 3;
...
TEST_F(FlexfecReceiverTest, FailsOnUnknownFecSsrc) {
  ...
  auto fec_packet = packet_generator_.BuildFlexfecPacket(*fec_packets.front());
  // Corrupt the SSRC.
  fec_packet->data.Data()[8] = 4;
  fec_packet->data.Data()[9] = 5;
  fec_packet->data.Data()[10] = 6;
  fec_packet->data.Data()[11] = 7;
