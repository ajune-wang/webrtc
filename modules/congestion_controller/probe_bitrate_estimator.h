...
class ProbeBitrateEstimator {
 public:
  ...
  // Probe results are reported only after |timeout_ms| have passed after
  // receiving them.
  rtc::Optional<int> FetchAndResetLastEstimatedBitrateBps(int64_t timeout_ms);
 ...
 private:
  ...
  int64_t last_estimate_update_ms_;
