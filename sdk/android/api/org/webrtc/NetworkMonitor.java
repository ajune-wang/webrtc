...
public class NetworkMonitor {
  ...
  /**
   * Adds an observer for any connection type changes. Deprecated, use addObserver variant instead.
   */
  @Deprecated
  ...
  /**
   * Removes an observer for any connection type changes. Deprecated, use removeObserver instead.
   */
  @Deprecated
