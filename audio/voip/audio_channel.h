...
class AudioChannel : public rtc::RefCountInterface {
 public:
  ...
  // See comments on the methods used from AudioEgressand and AudioIngress.
  // Conversion to double is following DoubleAudioLevelFromIntAudioLevel method
  // in rtc_stats_collector.cc to be consistent.
