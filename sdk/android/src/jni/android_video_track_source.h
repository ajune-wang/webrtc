...
// called from any thread, but the methods AdaptFrame() and OnFrameCaptured()
// needs to be called in order and refer to the same input frame, before the
// next call to AdaptFrame().
