...
vars = {
  ...
  'chromium_revision': 'deddea3fd0769aae2dd9a4cae78195f271ab8e09',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'ba3e1e348db839e64bdf06bb170cdd9c1ec6347b',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'd38c598aab5e1967744679c3cb2a32eee404fe45',
  'src/tools/gyp':
