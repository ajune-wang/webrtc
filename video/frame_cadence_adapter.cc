...
void ZeroHertzAdapterMode::ProcessRepeatedFrameOnDelayedCadence(
  ...
  // TODO(crbug.com/1255737): Wire in a QP convergent signal here and adjust the
  // delay on QP convergence to some lowest rate being a compromise between RTP
  // receiver keyframe-requesting timeout (3s) and some worst case RTT.
