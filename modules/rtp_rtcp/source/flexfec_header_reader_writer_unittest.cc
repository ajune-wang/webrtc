...
TEST(FlexfecHeaderReaderTest, ReadsHeaderWithMultipleStreamsMultipleMasks) {
  ...
  constexpr uint8_t kFlexfecPacketMask1[] = {kBit0 | 0x29, 0x91};
  constexpr uint8_t kUlpfecPacketMask1[] = {0x53, 0x22};
  constexpr uint8_t kFlexfecPacketMask2[] = {kBit1 | 0x32, 0xA1,  //
                                             kBit0 | 0x02, 0x11, 0x00, 0x21};
  constexpr uint8_t kUlpfecPacketMask2[] = {0x65, 0x42,  //
                                            0x08, 0x44, 0x00, 0x84};
  constexpr uint8_t kFlexfecPacketMask3[] = {kBit1 | 0x48, 0x81,              //
  ...
  constexpr uint8_t kUlpfecPacketMask3[] = {0x91, 0x02,              //
                                            ...
                                            0x04, 0x44, 0x44, 0x44,
                                            0x44, 0x44, 0x44, 0x44};
  constexpr uint8_t kFlexfecPacketMask4[] = {kBit1 | 0x32, 0x84,  //
                                             kBit0 | 0x05, 0x23, 0x00, 0x55};
