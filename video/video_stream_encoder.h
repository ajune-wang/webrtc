 ...
 private:
  ...
  class AdaptCounter final {
   public:
    ...
    EncoderStatsObserver::AdaptCounts Counts(int reason) const;
  ...
  EncoderStatsObserver::AdaptCounts GetActiveCounts(AdaptReason reason)
  ...
  EncoderStatsObserver* const encoder_stats_observer_;
