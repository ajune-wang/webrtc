...
TEST_P(DualStreamsTest, ModeratelyRestricted) {
  ...
  dual_streams.video[first_stream] = {true,   1850,    1110,  5,     50000,
                           200000, 2000000, false, "VP8", 2,
                           1,      400000,  false, false, ""};
  dual_streams.screenshare[first_stream] = {true, false, 10};

  dual_streams.video[1-first_stream] = {true,    352,     288,   30,    30000,
                           2000000, 2000000, false, "VP8", 1,
                           0,       0,       false, false, "foreman_cif"};
