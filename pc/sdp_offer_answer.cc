...
RTCError SdpOfferAnswerHandler::ApplyLocalDescription(
  ...
  RTC_DCHECK_RUN_ON(signaling_thread());
  RTC_DCHECK(desc);
  RTC_LOG(LS_ERROR) << "*************** ApplyLocalDescription [begin]";
  ...
  RTC_LOG(LS_ERROR) << "*************** ApplyLocalDescription [end]";
  return RTCError::OK();
}
...
RTCError SdpOfferAnswerHandler::ApplyRemoteDescription(
  ...
  RTC_DCHECK_RUN_ON(signaling_thread());
  RTC_DCHECK(desc);
  RTC_LOG(LS_ERROR) << "*************** ApplyRemoteDescription [begin]";
  ...
  RTC_LOG(LS_ERROR) << "*************** ApplyRemoteDescription [end]";
...
void SdpOfferAnswerHandler::DoSetLocalDescription(
  ...
  RTC_LOG_THREAD_BLOCK_COUNT();
  RTC_LOG(LS_ERROR) << "***************** DoSetLocalDescription [begin]";
  ...
  RTC_LOG(LS_ERROR) << "***************** DoSetLocalDescription [end]";
}
...
RTCError SdpOfferAnswerHandler::UpdateSessionState(
  ...
  RTC_DCHECK_RUN_ON(signaling_thread());
  RTC_LOG(LS_ERROR) << "**************** UpdateSessionState [begin]";
  ...
  if (type == SdpType::kOffer) {
    ...
    RTC_LOG(LS_ERROR) << "**************** DiscardStableStates";
  ...
  if (!error.ok()) {
    RTC_LOG(LS_ERROR) << "**************** PushdownMediaDescription failed";
    return error;
  }

  RTC_LOG(LS_ERROR) << "**************** UpdateSessionState [end]";
...
bool SdpOfferAnswerHandler::CreateDataChannel(const std::string& mid) {
  RTC_DCHECK_RUN_ON(signaling_thread());
  RTC_LOG(LS_ERROR) << "*********** CreateDataChannel [begin]";
  ...
  RTC_LOG(LS_ERROR) << "*********** CreateDataChannel [end]";
  return true;
}
