...
// Contains mapping between set of string names and unique size_t values
// (indexes). Once the name is added to the collection it is guaranteed:
...
class NamesCollection {
 public:
  ...
  absl::optional<size_t> RemoveIfPresented(absl::string_view name);
