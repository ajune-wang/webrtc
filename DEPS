...
vars = {
  ...
  'chromium_revision': 'bc90b25b19fd3d125a6712f5cf86266f9d9372ee',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'ae35272d20abeb72466f7065d8abc2457b6ab401',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '0160ce68927b2a525ce52a1eada92417f577f963',
