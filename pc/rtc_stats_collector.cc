...
CreateOutboundRTPStreamStatsFromVideoSenderInfo(
  ...
  if (video_sender_info.psnr_sum_u.has_value()) {
    outbound_video->psnr_sum_u = *video_sender_info.psnr_sum_u;
  }
  if (video_sender_info.psnr_sum_v.has_value()) {
    outbound_video->psnr_sum_v = *video_sender_info.psnr_sum_v;
  }
  if (video_sender_info.psnr_measurements.has_value()) {
