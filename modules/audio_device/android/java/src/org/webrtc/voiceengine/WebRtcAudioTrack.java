...
public class WebRtcAudioTrack {
  ...
  private boolean startPlayout() {
    ...
    // Prime the data path prior to calling AudioTrack.play() to reduce the
    // risk of a track in underrun state at play().
    primeAudioTrackWithSilence();
  ...
  // Prime the audio track with zeros to reduce the risk of underrun at start.
  private void primeAudioTrackWithSilence() {
    byteBuffer.clear();
    byteBuffer.put(emptyBytes);
    byteBuffer.position(0);
