...
class NativeAndroidVideoTrackSource {
   ...
   */
  @Nullable
  public VideoSource.FrameAdaptationParameters adaptFrame(VideoFrame frame) {
  ...
  @CalledByNative
  static VideoSource.FrameAdaptationParameters createFrameAdaptationParameters(int cropX, int cropY,
      int cropWidth, int cropHeight, int scaleWidth, int scaleHeight, long timestampNs,
      boolean drop) {
    return new VideoSource.FrameAdaptationParameters(
  ...
  @Nullable
  private static native VideoSource.FrameAdaptationParameters nativeAdaptFrame(
