...
#ifndef MODULES_PORTAL_SCREEN_CAPTURE_PORTAL_INTERFACE_H_
#define MODULES_PORTAL_SCREEN_CAPTURE_PORTAL_INTERFACE_H_
...
class ScreenCapturePortalInterface {
 public:
  ...
  // Properties that are common for both ScreenCast and RemoteDesktop

  // Description with details about the request
  // Example: www.videomeeting is requesting access to your screen
...
#endif  // MODULES_PORTAL_SCREEN_CAPTURE_PORTAL_INTERFACE_H_
