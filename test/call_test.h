...
class CallTest : public ::testing::Test {
 ...
 private:
  ...
  rtc::scoped_refptr<webrtc::TestAudioDeviceModule> fake_send_audio_device_;
  rtc::scoped_refptr<webrtc::TestAudioDeviceModule> fake_recv_audio_device_;
};
...
class BaseTest : public RtpRtcpObserver {
 public:
  ...
  virtual std::unique_ptr<webrtc::TestAudioDeviceModule::Capturer>
  CreateCapturer();
  virtual std::unique_ptr<webrtc::TestAudioDeviceModule::Renderer>
  CreateRenderer();
