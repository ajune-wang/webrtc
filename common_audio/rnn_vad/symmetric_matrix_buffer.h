...
#ifndef COMMON_AUDIO_RNN_VAD_SYMMETRIC_MATRIX_BUFFER_H_
#define COMMON_AUDIO_RNN_VAD_SYMMETRIC_MATRIX_BUFFER_H_
...
// This data structure is meant to be used to buffer the results of pair-wise
// comparisons between items stored in a ring buffer. Every time that the oldest
// item is replaced in the ring buffer, the new one is compared to the remaining
// items in the ring buffer. The results of such comparisons need to be buffered
// and automatically removed when one of the two corresponding items that have
// been compared is removed from the ring buffer. It is assumed that the
// comparison is symmetric and that comparing an item with itself is not needed.
...
#endif  // COMMON_AUDIO_RNN_VAD_SYMMETRIC_MATRIX_BUFFER_H_
