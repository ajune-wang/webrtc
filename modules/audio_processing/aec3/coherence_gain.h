...
class CoherenceGain {
 public:
  ...
  void ComputeGain(rtc::ArrayView<const float> x,
 ...
 private:
  ...
  void UpdateCoherenceSpectra(const FftData& E, const FftData& X, const FftData& Y);
  ...
  void FormWindowedFft(rtc::ArrayView<const float> v,
