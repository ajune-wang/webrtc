...
VideoCodecTestFixtureImpl::TestConfig::TestConfig() = default;

void VideoCodecTestFixtureImpl::TestConfig::SetCodecSettings(
...
size_t VideoCodecTestFixtureImpl::TestConfig::NumberOfCores() const {
  return use_single_core ? 1 : CpuInfo::DetectNumberOfCores();
}

size_t VideoCodecTestFixtureImpl::TestConfig::NumberOfTemporalLayers() const {
...
size_t VideoCodecTestFixtureImpl::TestConfig::NumberOfSpatialLayers() const {
...
size_t VideoCodecTestFixtureImpl::TestConfig::NumberOfSimulcastStreams() const {
  return codec_settings.numberOfSimulcastStreams;
}

std::vector<FrameType> VideoCodecTestFixtureImpl::TestConfig::FrameTypeForFrame(
...
std::string VideoCodecTestFixtureImpl::TestConfig::ToString() const {
...
SdpVideoFormat VideoCodecTestFixtureImpl::TestConfig::ToSdpVideoFormat() const {
...
std::string VideoCodecTestFixtureImpl::TestConfig::CodecName() const {
...
std::string VideoCodecTestFixtureImpl::TestConfig::FilenameWithParams() const {
...
bool VideoCodecTestFixtureImpl::TestConfig::IsAsyncCodec() const {
