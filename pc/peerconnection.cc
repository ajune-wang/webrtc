...
PeerConnection::~PeerConnection() {
  ...
  // It would be too late to call Close() now. See bugs.webrtc.com/9847
  // State can be kNew when initialization failed.
  RTC_CHECK(connection_state_ == PeerConnectionState::kNew ||
