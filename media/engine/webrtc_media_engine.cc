...
std::unique_ptr<MediaEngineInterface> CreateMediaEngine(
  ...
  RTC_DCHECK(dependencies.audio_encoder_factory);
  RTC_DCHECK(dependencies.audio_decoder_factory);
  RTC_DCHECK(dependencies.audio_processing);
  RTC_DCHECK(dependencies.task_queue_factory);
...
#ifdef HAVE_WEBRTC_VIDEO
  RTC_DCHECK(dependencies.video_encoder_factory);
  RTC_DCHECK(dependencies.video_decoder_factory);
