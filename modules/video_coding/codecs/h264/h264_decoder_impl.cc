...
H264DecoderImpl::H264DecoderImpl()
    : pool_(true),
      ...
      enable_8bit_hdr_fix_(
          !field_trial::IsEnabled("WebRTC-Disable8bitH264HdrFix")) {}
