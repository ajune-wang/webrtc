...
class RtpSeqNumOnlyRefFinder {
 public:
  ...
  absl::InlinedVector<std::unique_ptr<RtpFrameObject>, 3> ManageFrame(
      std::unique_ptr<RtpFrameObject> frame);
  absl::InlinedVector<std::unique_ptr<RtpFrameObject>, 3> PaddingReceived(
      uint16_t seq_num);
 ...
 private:
  ...
  void RetryStashedFrames(
      absl::InlinedVector<std::unique_ptr<RtpFrameObject>, 3>& res);
