...
class MockFrameTransformer : public FrameTransformerInterface {
 public:
  ...
  MOCK_METHOD(void, UnregisterTransformedFrameCallback, ());
};

TEST(RtpVideoReceiverFrameTransformerDelegateTest,
...
TEST(RtpVideoReceiverFrameTransformerDelegateTest, TransformFrame) {
  TestRtpVideoStreamReceiver receiver;
  rtc::scoped_refptr<MockFrameTransformer> frame_transformer(
      new rtc::RefCountedObject<MockFrameTransformer>());
  rtc::scoped_refptr<RtpVideoReceiverFrameTransformerDelegate> delegate(
