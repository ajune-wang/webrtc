...
/*const AudioDecodingCallStats kAudioDecodeStats =
...
/*        .Times(1);*/
/*    EXPECT_CALL(*channel_receive_,
 * SetAssociatedSendChannel(nullptr)).Times(1);*/
...
/*    EXPECT_CALL(*channel_receive_,
 * GetCurrentEstimatedPlayoutNtpTimestampMs(_))*/
...
/*    EXPECT_EQ(*/
/*        kCallStats.jitterSamples / (kReceiveCodec.second.clockrate_hz /
 * 1000),*/
/*        stats.jitter_ms);*/
/*    EXPECT_EQ(kNetworkStats.currentBufferSize, stats.jitter_buffer_ms);*/
/*    EXPECT_EQ(kNetworkStats.preferredBufferSize,*/
/*              stats.jitter_buffer_preferred_ms);*/
/*    EXPECT_EQ(static_cast<uint32_t>(kJitterBufferDelay +
 * kPlayoutBufferDelay),*/
/*              stats.delay_estimate_ms);*/
/*    EXPECT_EQ(static_cast<int32_t>(kSpeechOutputLevel), stats.audio_level);*/
/*    EXPECT_EQ(kTotalOutputEnergy, stats.total_output_energy);*/
/*    EXPECT_EQ(kNetworkStats.totalSamplesReceived,
...
/*    EXPECT_EQ(Q14ToFloat(kNetworkStats.currentExpandRate),
 * stats.expand_rate);*/
...
/*    EXPECT_EQ(kAudioDecodeStats.calls_to_neteq,
 * stats.decoding_calls_to_neteq);*/
/*    EXPECT_EQ(kAudioDecodeStats.decoded_normal, stats.decoding_normal);*/
/*    EXPECT_EQ(kAudioDecodeStats.decoded_neteq_plc, stats.decoding_plc);*/
/*    EXPECT_EQ(kAudioDecodeStats.decoded_codec_plc,
 * stats.decoding_codec_plc);*/
...
/*    EXPECT_EQ(kPlayoutNtpTimestampMs,
...
/*    // TODO(tommi, nisse): This applies new extensions to the internal
 * config,*/
/*    // but there's nothing that actually verifies that the changes take
 * effect.*/
/*    // In fact Call manages the extensions separately in
 * Call::ReceiveRtpConfig*/
/*    // and changing this config value (there seem to be a few copies),
 * doesn't*/
/*    // affect that logic.*/
...
/*    // actually change what frame_decryptor is used.
