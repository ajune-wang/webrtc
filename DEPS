...
vars = {
  ...
  'chromium_revision': 'f478c331c5b2a59b68912e458301f12fb279be3b',
}
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@fe541f41403569b9a31d3ba4da3b0a94e5d42986',
