...
class RTCStatsCollector : public virtual rtc::RefCountInterface,
 ...
 private:
  struct RequestInfo {
    // If a selector argument was used, |sender_selector| or |receiver_selector|
    // is set accordingly (setting both is invalid). Otherwise both are null.
    RequestInfo(rtc::scoped_refptr<RTCStatsCollectorCallback> callback,
