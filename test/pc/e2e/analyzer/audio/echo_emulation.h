...
#ifndef TEST_PC_E2E_ANALYZER_AUDIO_ECHO_EMULATION_H_
#define TEST_PC_E2E_ANALYZER_AUDIO_ECHO_EMULATION_H_
...
class EchoEmulatingCapturer : public TestAudioDeviceModule::Capturer {
 ...
 private:
  ...
  std::deque<std::vector<int16_t>> renderer_output_ RTC_GUARDED_BY(lock_);
};
...
#endif  // TEST_PC_E2E_ANALYZER_AUDIO_ECHO_EMULATION_H_
