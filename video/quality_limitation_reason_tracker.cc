...
QualityLimitationReasonTracker::QualityLimitationReasonTracker(Clock* clock)
    : clock_(clock),
      ...
      durations_ms_() {
  durations_ms_.insert(std::make_pair(QualityLimitationReason::kNone, 0u));
  durations_ms_.insert(std::make_pair(QualityLimitationReason::kCpu, 0u));
  durations_ms_.insert(std::make_pair(QualityLimitationReason::kBandwidth, 0u));
  durations_ms_.insert(std::make_pair(QualityLimitationReason::kOther, 0u));
}
