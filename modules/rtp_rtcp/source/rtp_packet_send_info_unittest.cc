...
TEST(RtpPacketSendInfo, FromConvertFec) {
...
TEST(RtpPacketSendInfo, kRetransmission) {
...
TEST(RtpPacketSendInfo, FromConvertsTransportSequenceNumbers) {
  RtpHeaderExtensionMap extension_manager;
  RtpPacketToSend packet(&extension_manager);
  packet.set_packet_type(RtpPacketMediaType::kAudio);

  EXPECT_EQ(RtpPacketSendInfo::From(/*transport_sequence_number=*/7, packet,
                                    PacedPacketInfo())
