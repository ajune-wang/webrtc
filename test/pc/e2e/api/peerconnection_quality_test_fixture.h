...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  // Add activity that will be executed after |target_time_since_start| after
  // call will be set up (after offer/answer exchange, ICE gathering will be
  // done and ICE candidates will passed to remote side). |func| param is
  ...
  // after |initial_delay_since_start| after call will be set up (after all
  // participants will be connected). |func| param is amount of time spent
  // from the call set up.
