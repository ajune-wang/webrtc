...
CreateRemoteOutboundAudioStreamStats(
  ...
  auto stats = std::make_unique<RTCRemoteOutboundRtpStreamStats>(
      ...
      /*timestamp_us=*/voice_receiver_info.last_sender_report_timestamp->ms());
...
CreateRemoteOutboundVideoStreamStats(
  ...
  auto stats = std::make_unique<RTCRemoteOutboundRtpStreamStats>(
      ...
      /*timestamp_us=*/video_receiver_info.last_sender_report_timestamp->ms());
  ...
  stats->remote_timestamp = static_cast<double>(
      video_receiver_info.last_sender_report_remote_timestamp->us());
