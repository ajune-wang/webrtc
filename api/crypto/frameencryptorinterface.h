...
#ifndef WEBRTC_API_CRYPTO_FRAMEENCRYPTORINTERFACE_H_
#define WEBRTC_API_CRYPTO_FRAMEENCRYPTORINTERFACE_H_
...
#endif  // WEBRTC_API_CRYPTO_FRAMEENCRYPTORINTERFACE_H_
