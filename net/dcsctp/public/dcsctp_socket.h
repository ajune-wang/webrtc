...
// Tracked metrics, which is the return value of GetMetrics. All metrics will
// have zero (0) as their initial value.
struct Metrics {
  // Transmission stats and metrics.

  // Number of packets sent.
  size_t tx_packets_count;

  // Number of messages requested to be sent.
  size_t tx_messages_count;
  ...
  size_t unack_data_count;

  // Receive stats and metrics.

  // Number of packets received.
  size_t rx_packets_count;

  // Number of messages received.
  size_t rx_messages_count;

  // The peer’s last announced receiver window size, corresponding to sstat_rwnd
  // defined in RFC6458.
  uint32_t peer_rwnd_bytes;
};
