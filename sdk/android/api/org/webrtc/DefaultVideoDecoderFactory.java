...
public class DefaultVideoDecoderFactory implements VideoDecoderFactory {
  ...
  public DefaultVideoDecoderFactory(EglBase.Context eglContext) {
    this.hardwareVideoDecoderFactory = new HardwareVideoDecoderFactory(eglContext, false);
    this.softwareVideoDecoderFactory = new SoftwareVideoDecoderFactory();
  }

  @Override
  public VideoDecoder createDecoder(String codecType) {
    VideoDecoder decoder = this.hardwareVideoDecoderFactory.createDecoder(codecType);
    if (decoder != null) {
      return decoder;
    }
