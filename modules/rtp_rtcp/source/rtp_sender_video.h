...
class RTPSenderVideo : public RTPVideoFrameSenderInterface {
 public:
  ...
  bool SendVideo(int payload_type,
    ...
    SendVideo(payload_type, codec_type, rtp_timestamp, capture_time, payload,
              encoder_output_size, video_header, expected_retransmission_time,
              csrcs, /*externally_encded=*/false);
  }
