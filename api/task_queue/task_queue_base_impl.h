...
#ifndef API_TASK_QUEUE_TASK_QUEUE_BASE_IMPL_H_
#define API_TASK_QUEUE_TASK_QUEUE_BASE_IMPL_H_
...
class rtc::TaskQueue::Impl : public rtc::RefCountedBase {
 public:
  ~Impl() override;
...
#endif  // API_TASK_QUEUE_TASK_QUEUE_BASE_IMPL_H_
