...
class MockCpuOveruseObserver : public AdaptationObserverInterface {
 public:
  ...
  MOCK_METHOD1(AdaptUp, void(adaptation::VideoAdaptationReason));
  MOCK_METHOD1(AdaptDown, bool(adaptation::VideoAdaptationReason));
};
...
class CpuOveruseObserverImpl : public AdaptationObserverInterface {
 public:
  ...
  bool AdaptDown(adaptation::VideoAdaptationReason) override {
    ++overuse_;
    return true;
  }
  void AdaptUp(adaptation::VideoAdaptationReason) override { ++normaluse_; }
...
class OveruseFrameDetectorTest : public ::testing::Test,
 ...
 protected:
  ...
  static const auto reason_ = adaptation::VideoAdaptationReason::kCpu;
};
