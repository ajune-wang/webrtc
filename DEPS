...
vars = {
  ...
  'chromium_revision': '4c9e1d6dda390a3098071eab7d4282f30e462256',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'be4b092e0fbf5b2e18ecbda919c886208dfc6082',
}
deps = {
  # TODO(kjellander): Move this to be Android-only once the libevent dependency
  # in base/third_party/libevent is solved.
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + 'ded52d598bb0f4590a401bc1aec623b483f91f2d',
  'src/build':
