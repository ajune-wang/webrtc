...
void ChainDiffCalculator::Reset(int num_chains, std::bitset<32> chains) {
...
absl::InlinedVector<int, 4> ChainDiffCalculator::From(int64_t frame_id,
                                                      std::bitset<32> chains) {
