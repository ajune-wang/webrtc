...
TEST_F(WebRtcVoiceEngineTestFake, AddRecvStreamFail) {
  EXPECT_TRUE(SetupChannel());
  // voe_.set_fail_create_channel(true);   TODO:
...
TEST_F(WebRtcVoiceEngineTestFake, AddRecvStream) {
  EXPECT_TRUE(SetupRecvStream());
  // int channel_num = voe_.GetLastChannel();   TODO:
  EXPECT_TRUE(AddRecvStream(1));
...
// TODO:  EXPECT_EQ(3, voe_.GetNumChannels());  // default channel + 2 added
  delete channel_;
  channel_ = NULL;
// TODO:  EXPECT_EQ(0, voe_.GetNumChannels());
}
