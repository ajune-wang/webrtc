...
public class MediaStream {
  ...
  public boolean addTrack(AudioTrack track) {
    if (addNativeAudioTrack(nativeStream, track.nativeTrack)) {
  ...
  public boolean addTrack(VideoTrack track) {
    if (addNativeVideoTrack(nativeStream, track.nativeTrack)) {
  ...
  @CalledByNative
  void addAudioTrack(long nativeTrack) {
    audioTracks.add(new AudioTrack(nativeTrack));
  }

  @CalledByNative
  void addVideoTrack(long nativeTrack) {
  ...
  @CalledByNative
  static MediaStream[] createArray(int size) {
  ...
  private static native boolean addNativeAudioTrack(long nativeStream, long nativeAudioTrack);

  private static native boolean addNativeVideoTrack(long nativeStream, long nativeVideoTrack);
