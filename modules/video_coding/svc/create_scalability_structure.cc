...
constexpr NamedStructureFactory kFactories[] = {
    {ScalabilityMode::L1T1, Create<ScalableVideoControllerNoLayering>,
     kConfigL1T1},
    {ScalabilityMode::L1T2, Create<ScalabilityStructureL1T2>, kConfigL1T2},
    {ScalabilityMode::L1T3, Create<ScalabilityStructureL1T3>, kConfigL1T3},
    {ScalabilityMode::L2T1, Create<ScalabilityStructureL2T1>, kConfigL2T1},
    {ScalabilityMode::L2T1h, CreateH<ScalabilityStructureL2T1>, kConfigL2T1h},
    {ScalabilityMode::L2T1_KEY, Create<ScalabilityStructureL2T1Key>,
     kConfigL2T1},
    {ScalabilityMode::L2T2, Create<ScalabilityStructureL2T2>, kConfigL2T2},
    {ScalabilityMode::L2T2_KEY, Create<ScalabilityStructureL2T2Key>,
     kConfigL2T2},
    {ScalabilityMode::L2T2_KEY_SHIFT, Create<ScalabilityStructureL2T2KeyShift>,
     kConfigL2T2},
    {ScalabilityMode::L2T3_KEY, Create<ScalabilityStructureL2T3Key>,
     kConfigL2T3},
    {ScalabilityMode::L3T1, Create<ScalabilityStructureL3T1>, kConfigL3T1},
    {ScalabilityMode::L3T3, Create<ScalabilityStructureL3T3>, kConfigL3T3},
    {ScalabilityMode::L3T3_KEY, Create<ScalabilityStructureL3T3Key>,
     kConfigL3T3},
    {ScalabilityMode::S2T1, Create<ScalabilityStructureS2T1>, kConfigS2T1},
    {ScalabilityMode::S3T3, Create<ScalabilityStructureS3T3>, kConfigS3T3},
};
