...
class FilterAnalyzer {
 public:
  ...
  // Returns whether the any filter has been found consistent in the sense that
  // it does notchange much over time.
  bool AnyFilterConsistent() const { return any_filter_consistent_; }

  // Returns the maximum of the estimated filter gains.
  float MaxFilterGain() const { return max_echo_path_gain_; }
