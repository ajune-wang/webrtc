    ...
    for (int y = 0; y < HEIGHT; ++y) {
      for (int x = 0; x < WIDTH; ++x) {
        ...
        final float expectedRed =
            saturatedConvert(1.16487f * y_luma + 1.59905f * v_chroma - 0.875925f);
        final float expectedGreen = saturatedConvert(
            1.16373f * y_luma - 0.392669f * u_chroma - 0.814729f * v_chroma + 0.533048f);
        final float expectedBlue =
            saturatedConvert(1.16645f * y_luma + 2.021f * u_chroma - 1.08822f);
