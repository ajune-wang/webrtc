...
bool VP9EncoderImpl::SetSvcRates(
  ...
  // If the first active layer changed, key-frame will be issued
  ...
  const bool disabled_layers = new_layers != current_layers &&
                               !lower_layers_enabled && !higher_layers_enabled;
