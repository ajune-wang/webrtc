 ...
 * to this interface will be adapted and passed to the RTC_OBJC_TYPE(RTCVideoRenderer) supplied
...
/** Initialize an RTCVideoRendererAdapter with an RTC_OBJC_TYPE(RTCVideoRenderer). */
