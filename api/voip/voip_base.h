...
class VoipBase {
 public:
  ...
  // yet. Returns false if a send codec has not been set or initialization has
  ...
  // Returns false if receive codecs have not been set or initialization has
  // failed on selected speaker device. API is subject to expand to reflect
  // error condition to application later.
