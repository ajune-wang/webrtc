...
TEST_F(VideoChannelSingleThreadTest, TestSetLocalOfferWithPacketization) {
  cricket::VideoCodec kVp8Codec(97, "VP8");
  cricket::VideoCodec kVp9Codec(98, "VP9");
  kVp9Codec.packetization = cricket::kPacketizationParamRaw;
  cricket::VideoContentDescription video;
  ...
  EXPECT_TRUE(media_channel1_->recv_codecs()[1].Matches(kVp9Codec));
...
TEST_F(VideoChannelSingleThreadTest, TestSetRemoteOfferWithPacketization) {
  ...
  EXPECT_TRUE(media_channel1_->send_codecs()[1].Matches(kVp9Codec));
...
TEST_F(VideoChannelSingleThreadTest, TestSetLocalAnswerWithoutPacketization) {
  cricket::VideoCodec kLocalCodec(98, "VP8");
  cricket::VideoCodec kRemoteCodec(99, "VP8");
  kRemoteCodec.packetization = cricket::kPacketizationParamRaw;
