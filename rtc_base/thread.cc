...
Thread::ScopedCountBlockingCalls::ScopedCountBlockingCalls(
    ...
    : thread_(Thread::Current()),
      ...
      base_would_be_blocking_call_count_(
          thread_->GetWouldBeBlockingCallCount()),
      result_callback_(std::move(callback)) {}

Thread::ScopedCountBlockingCalls::~ScopedCountBlockingCalls() {
  result_callback_(GetBlockingCallCount(), GetWouldBeBlockingCallCount());
}
...
uint32_t Thread::ScopedCountBlockingCalls::GetWouldBeBlockingCallCount() const {
  return thread_->GetWouldBeBlockingCallCount() -
         base_would_be_blocking_call_count_;
}

uint32_t Thread::ScopedCountBlockingCalls::GetTotalBlockedCallCount() const {
  return GetBlockingCallCount() + GetWouldBeBlockingCallCount();
}
#endif
...
uint32_t Thread::GetWouldBeBlockingCallCount() const {
  RTC_DCHECK_RUN_ON(this);
  return would_be_blocking_call_count_;
}
#endif
