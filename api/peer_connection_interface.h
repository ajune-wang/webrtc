...
class RTC_EXPORT PeerConnectionInterface : public webrtc::RefCountInterface {
 public:
  ...
  struct RTC_EXPORT RTCConfiguration {
    ...
    bool stats_timestamp_with_enviroment_clock() const {
      return media_config.stats_timestamp_with_enviroment_clock;
    }
    void set_stats_timestamp_with_enviroment_clock(bool enable) {
      media_config.stats_timestamp_with_enviroment_clock = enable;
    }
