...
void AudioProcessingImpl::set_stream_analog_level(int level) {
  ...
  data_dumper_->DumpRaw("gain_control_stream_analog_level", 1, &level);
...
void AudioProcessingImpl::UpdateRecommendedStreamAnalogLevelLocked() {
  ...
  data_dumper_->DumpRaw("gain_control_recommended_analog_level", 1,
                        &last_recommended_analog_level_);
}
...
void AudioProcessingImpl::RecordAudioProcessingState() {
  ...
  audio_proc_state.recommended_analog_level = last_recommended_analog_level_;
