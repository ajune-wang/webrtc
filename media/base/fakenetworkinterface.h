...
class FakeNetworkInterface : public MediaChannel::NetworkInterface,
 ...
 public:
  ...
  void SetRtcpReceiver(webrtc::RtcpPacketReceiver* rtcp_receiver) {
  ...
  virtual void OnMessage(rtc::Message* msg) {
    ...
    if (dest_) {
      if (msg->message_id == ST_RTP) {
        ...
        rtcp_receiver_->DeliverRtcpPacket(msg_data->data(), rtc::TimeMicros());
      }
    }
    delete msg_data;
  }
 ...
 private:
  ...
  rtc::Thread* thread_;
  MediaChannel* dest_;
  webrtc::RtcpPacketReceiver* rtcp_receiver_;
  bool conf_;
