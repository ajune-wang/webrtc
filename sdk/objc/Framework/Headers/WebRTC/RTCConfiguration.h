 ...
 *  will also cause RTCPeerConnection to reject offers/answers with multiple m=
 ...
 *  RTCRtpReceiver (an RTCRtpTransceiver), either both audio or both video.
 *  Plan B style offers or answers will be rejected in calls to
