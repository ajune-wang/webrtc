...
constexpr uint32_t kFlexFecSsrc = 123458;
...
TEST_F(PacketSequencerTest, IgnoresFlexFec) {
  RtpPacketToSend packet =
      CreatePacket(RtpPacketMediaType::kForwardErrorCorrection, kFlexFecSsrc);
...
TEST_F(PacketSequencerTest, AllowsPaddingAtAnyTimeIfSoConfigured) {
  PacketSequencer packet_sequencer(
      kMediaSsrc, kRtxSsrc, kFlexFecSsrc,
