...
TwoWayCommunication::TwoWayCommunication(int testMode)
    : _acmA(AudioCodingModule::Create(CreateBuiltinAudioDecoderFactory())),
      _acmRefA(AudioCodingModule::Create(CreateBuiltinAudioDecoderFactory())),
      _testMode(testMode) {
...
void TwoWayCommunication::ChooseCodec(uint8_t* codecID_A,
                                      uint8_t* codecID_B) {
  std::unique_ptr<AudioCodingModule> tmpACM(
      AudioCodingModule::Create(CreateBuiltinAudioDecoderFactory()));
