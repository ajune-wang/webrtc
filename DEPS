...
vars = {
  ...
  'chromium_revision': 'e1dc029e8c436183121edb49d3636ef75ba9fb52',
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '1b4007165563cf3f1afb0e46c8fe0f0037985c1c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '2da41d3f742f015cfab5f12115992ecc56208716',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b6abfced0c72bca053c91236117651eca715f533',
  'src/tools/gyp':
