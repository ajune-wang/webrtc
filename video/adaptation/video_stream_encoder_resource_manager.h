...
class VideoStreamEncoderResourceManager
 ...
 public:
  ...
  void ConfigureBandWidthScaler(const VideoEncoder::EncoderInfo& encoder_info);
 ...
 private:
  ...
  void UpdateBandwidthScalerSettings(bool allow_bandwidth_start_check);
  ...
  const rtc::scoped_refptr<BandwidthScalerResource> bandwidth_scaler_resource_;
