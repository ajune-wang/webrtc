...
TEST_F(TestVp8Impl, TestLowStreamActive) {
  TestVp8Simulcast::TestLowStreamActive();
}

TEST_F(TestVp8Impl, TestLowStreamInactiveOnlyKeyFrames) {
  TestVp8Simulcast::TestLowStreamInactiveOnlyKeyFrames();
}
