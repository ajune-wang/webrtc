...
public class SurfaceTextureHelper {
   ...
   *
   * @deprecated Call setTextureSize() and use a VideoSink as listener instead.
   */
  @Deprecated
  ...
  /**
   * There is unfortunately no way for this class to know the texture size, so this information has
   * to be reported from the outside.
   */
