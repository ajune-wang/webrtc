...
static inline void getCubeVertexData(int cropX, int cropY,
                       int cropWidth, int cropHeight,
                       size_t frameWidth, size_t frameHeight,
                       RTCVideoRotation rotation, float *buffer) {
...
- (BOOL)setupTexturesForFrame:(nonnull RTCVideoFrame *)frame {
  ...
  if (pixelBuffer.cropX != _oldCropX || pixelBuffer.cropY != _oldCropY ||
      ...
      frameWidth != _oldFrameWidth ||
      frameHeight != _oldFrameHeight) {

    getCubeVertexData(pixelBuffer.cropX, pixelBuffer.cropY,
                      pixelBuffer.cropWidth, pixelBuffer.cropHeight,
                      frameWidth, frameHeight,
                      rotation, (float*) _vertexBuffer.contents);
