...
const double kNetworkPriorityVeryLow = 0.5;
const double kNetworkPriorityLow = 1.0;
const double kNetworkPriorityMedium = 2.0;
const double kNetworkPriorityHigh = 4.0;
