...
bool StreamSynchronization::ComputeDelays(int relative_delay_ms,
  ...
  NLOG(LS_VERBOSE, "Audio delay: ", current_audio_delay_ms,
       " current diff: ", relative_delay_ms, " for stream ", audio_stream_id_);
  ...
  NLOG(LS_VERBOSE, "Sync video delay ", new_video_delay_ms,
       " for video stream ", video_stream_id_, " and audio delay ",
