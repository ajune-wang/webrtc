...
TEST(H264ProfileLevelId, TestGenerateProfileLevelIdForAnswerEmpty) {
  SdpVideoFormat::Parameters answer_params = H264ProfileLevelIdForAnswer(
...
TEST(H264ProfileLevelId,
  ...
  SdpVideoFormat::Parameters answer_params = H264ProfileLevelIdForAnswer(
      low_level /* local_supported */, high_level /* remote_offered */);
  EXPECT_EQ("42e015", answer_params["profile-level-id"]);

  SdpVideoFormat::Parameters answer_params2 = H264ProfileLevelIdForAnswer(
      high_level /* local_supported */, low_level /* remote_offered */);
...
TEST(H264ProfileLevelId,
  ...
  SdpVideoFormat::Parameters answer_params =
      H264ProfileLevelIdForAnswer(local_params, remote_params);
