...
vars = {
  ...
  'chromium_revision': '0b451d9cbf727ed07aab2960c4b794425f9a7ec8',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@a8b2f5b65d5a2916da66eb6ba8cb8b525d13d79e',
    ...
    'packages': [
      {
          ...
          'version': 'TCvAAn2fKuqhajyY4SQN8CI3iDvA1qRp4xJhNm5b9AEC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
