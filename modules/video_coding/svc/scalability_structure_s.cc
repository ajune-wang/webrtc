 ...
 */
#include "modules/video_coding/svc/scalability_structure_s.h"
...
constexpr int ScalabilityStructureS::kMaxNumSpatialLayers;
constexpr int ScalabilityStructureS::kMaxNumTemporalLayers;

ScalabilityStructureS::~ScalabilityStructureS() = default;

ScalabilityStructureS::ScalabilityStructureS(int num_spatial_layers,
...
ScalabilityStructureS::StreamConfig() const {
...
bool ScalabilityStructureS::TemporalLayerIsActive(int tid) const {
...
ScalabilityStructureS::Dti(int sid, int tid, const LayerFrameConfig& config) {
...
ScalabilityStructureS::FramePattern ScalabilityStructureS::NextPattern() const {
...
ScalabilityStructureS::NextFrameConfig(bool restart) {
...
GenericFrameInfo ScalabilityStructureS::OnEncodeDone(
...
void ScalabilityStructureS::OnRatesUpdated(
