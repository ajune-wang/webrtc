...
TEST_F(SrtpSessionTest, ProtectUnprotectWrapAroundRocMismatch) {
  ...
  // Note: If libsrtp is modified to attempt to decrypt with ROC=1 for this case,
  // this test will fail and needs to be modified accordingly.
  // See https://issues.webrtc.org/353565743 for details.
