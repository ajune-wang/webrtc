...
void P2PTransportChannel::AddConnection(Connection* connection) {
  ...
  OnCandidatePairEvent(connection, webrtc::IceCandidatePairEventType::kAdded);
}
...
void P2PTransportChannel::SwitchSelectedConnection(Connection* conn) {
  ...
  OnCandidatePairEvent(conn, webrtc::IceCandidatePairEventType::kSelected);
...
void P2PTransportChannel::OnCandidatePairEvent(
    Connection* conn,
