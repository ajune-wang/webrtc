...
void P2PTransportChannel::PruneConnectionsByInterfaceIdPair() {
  ...
  // distinct paths over which we can switch. If |best_connection| is not
  // connected, we may be reconnecting a TCP connection and should not prune
  // connections with this pair of interface ids. See the big comment in
