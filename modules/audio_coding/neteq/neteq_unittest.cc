...
TEST_F(NetEqDecodingTest, MAYBE_TestOpusBitExactness) {
  ...
  const std::string maybe_sse =
      ...
      "TestOpusBitExactness_maybe_sse";
  ...
  const std::string network_stats_checksum =
      PlatformChecksum("439a3d0c9b5115e6d4f8387f64ed2d57cae29b0a",
                       "TestOpusBitExactness_network_stats_checksum_2",
                       "TestOpusBitExactness_network_stats_checksum_3",
...
TEST_F(NetEqDecodingTest, MAYBE_TestOpusDtxBitExactness) {
  ...
  const std::string maybe_sse =
      ...
      "TestOpusDtxBitExactness_maybe_sse";
  const std::string output_checksum = PlatformChecksum(
