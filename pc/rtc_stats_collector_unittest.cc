...
TEST_F(RTCStatsCollectorTest, CollectRTCOutboundRtpStreamStats_Video) {
  ...
  // `expected_video.psnr_measurements_y` should be undefined.
  ...
  expected_video.qp_sum = 9;
  video_media_info.senders[0].psnr_sum_y = 30;
  expected_video.psnr_sum_y = 30;
  expected_video.psnr_measurements_y = 1;
