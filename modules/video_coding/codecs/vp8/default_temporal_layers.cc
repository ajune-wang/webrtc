...
FrameDependencyStructure DefaultTemporalLayers::GetTemplateStructure(
  ...
  switch (num_layers) {
    ...
    case 2: {
      template_structure.templates = {
          T(0).Dtis("SS"),
          T(0).Dtis("SS").Fdiffs({2}),
          T(0).Dtis("SR").Fdiffs({2}),
          T(1).Dtis("-S").Fdiffs({1}),
          T(1).Dtis("-D").Fdiffs({1, 2}),
      };
      return template_structure;
    }
    case 3: {
      if (field_trial::IsEnabled("WebRTC-UseShortVP8TL3Pattern")) {
        template_structure.templates = {
            T(0).Dtis("SSS"),
            T(0).Dtis("SSS").Fdiffs({4}),
            T(1).Dtis("-DR").Fdiffs({2}),
            T(2).Dtis("--S").Fdiffs({1}),
            T(2).Dtis("--D").Fdiffs({1, 2}),
        };
      } else {
        template_structure.templates = {
            T(0).Dtis("SSS"),
            T(0).Dtis("SSS").Fdiffs({4}),
            T(0).Dtis("SRR").Fdiffs({4}),
            T(1).Dtis("-SS").Fdiffs({2}),
            T(1).Dtis("-DS").Fdiffs({2, 4}),
            T(2).Dtis("--D").Fdiffs({1}),
            T(2).Dtis("--D").Fdiffs({1, 3}),
        };
      }
      return template_structure;
    }
    case 4: {
      template_structure.templates = {
          T(0).Dtis("SSSS"),
          T(0).Dtis("SSSS").Fdiffs({8}),
          T(1).Dtis("-SRR").Fdiffs({4}),
          T(1).Dtis("-SRR").Fdiffs({4, 8}),
          T(2).Dtis("--SR").Fdiffs({2}),
          T(2).Dtis("--SR").Fdiffs({2, 4}),
          T(3).Dtis("---D").Fdiffs({1}),
          T(3).Dtis("---D").Fdiffs({1, 3}),
      };
      return template_structure;
    }
    default:
