...
class SdpOfferAnswerHandler : public SdpStateInfoInterface,
 ...
 public:
  ...
  // Implementation of SdpStateInfoInterface
  ...
  const JsepTransportController* transport_controller() const override;
  bool IceRestartPending(const std::string& content_name) const override;

  // Non-const version of transport_controller()
