...
bool ReassemblyQueue::IsConsistent() const {
  // There shouldn't be TSNs in `delivered_tsns_` that are adjacent to
  // `last_assembled_tsn_watermark_`, as that should instead move
  // `last_assembled_tsn_watermark_` until there is a gap.
