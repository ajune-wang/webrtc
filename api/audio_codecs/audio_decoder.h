...
class AudioDecoder {
 public:
  ...
  // requested_samples_per_channel, or nothing at all. If the implementation is
  // not willing to produce concealment audio, it must leave the buffer
  // unmodified. This is a signal to the caller to conceal the loss with other
  // means. If the implementation provides concealment samples, it is also
  // responsible for "stitching" it together with the decoded audio on either
  // side of the concealment.
