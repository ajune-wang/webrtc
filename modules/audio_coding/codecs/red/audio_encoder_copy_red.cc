...
AudioEncoderCopyRed::AudioEncoderCopyRed(Config&& config)
  ...
  auto numberOfRedundantEncodings = GetMaxRedundancyFromFieldTrial();
  for (size_t i = 0; i < numberOfRedundantEncodings; i++) {
...
void AudioEncoderCopyRed::Reset() {
  ...
  auto numberOfRedundantEncodings = redundant_encodings_.size();
