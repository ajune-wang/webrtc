...
// responsible.
constexpr size_t kInitialPitchMinPeriod24kHz = 3 * kPitchMinPeriod24kHz;
static_assert(kPitchMinPeriod24kHz < kInitialPitchMinPeriod24kHz, "");
static_assert(kInitialPitchMinPeriod24kHz < kPitchMaxPeriod24kHz, "");
...
constexpr size_t kInitialPitchMinPeriod12kHz = kInitialPitchMinPeriod24kHz / 2;
