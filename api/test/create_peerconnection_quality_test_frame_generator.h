...
// Validates that ScreeanShare frame generator can be created based on the screen_share_config.
...
// FrameGeneratorInterface::OutputType::I420. video_config specifies frame weight and height.
