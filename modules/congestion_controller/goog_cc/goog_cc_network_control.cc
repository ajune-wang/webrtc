...
NetworkControlUpdate GoogCcNetworkController::OnProcessInterval(
  ...
  if (rate_control_settings_.UseCongestionWindow() &&
    ...
    UpdateCongestionWindowSize(msg.at_time);
  }
  MaybeTriggerOnNetworkChanged(&update, msg.at_time);
  return update;
}
...
void GoogCcNetworkController::UpdateCongestionWindowSize(Timestamp at_time) {
  ...
  if (use_downlink_delay_for_congestion_window_ &&
    ...
    time_window += at_time - last_packet_received_time_;
  }
...
NetworkControlUpdate GoogCcNetworkController::OnTransportPacketsFeedback(
  ...
  if (rate_control_settings_.UseCongestionWindow() &&
    ...
    UpdateCongestionWindowSize(report.feedback_time);
  }
