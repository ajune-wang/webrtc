 ...
 public:
  SctpActor(absl::string_view name,
      ...
      : log_prefix_(std::string(name) + ": "),
        ...
        sctp_socket_(name, *this, nullptr, DcSctpOptions()) {
  ...
  TimeMs TimeMillis() override { return TimeMs(clock_.TimeNanos() / 100000); }
...
TEST_F(DcSctpSocketNetworkTest, CanSendLargeMessageOverSocketServer) {
  ...
  SIMULATED_WAIT(false, 120'000, clock_);
