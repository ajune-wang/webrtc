...
VideoStreamEncoder::VideoStreamEncoder(
    ...
    rtc::scoped_refptr<
        webrtc::VideoEncoderFactory::RefCountedEncoderSelectorInterface>
        encoder_selector)
    : field_trials_(field_trials),
      ...
      encoder_selector_from_constructor_(std::move(encoder_selector)),
      ...
      encoder_selector_(encoder_selector_from_constructor_
                            ? encoder_selector_from_constructor_.get()
