...
void ParsedRtcEventLog::StoreGenericAckReceivedEvent(
  ...
  absl::optional<int64_t> base_receive_timestamp_ms;
  if (proto.has_receive_timestamp_ms()) {
    base_receive_timestamp_ms = proto.receive_timestamp_ms();
  }
  generic_acks_received_.push_back(
      {proto.timestamp_ms() * 1000, proto.packet_number(),
       proto.acked_packet_number(), base_receive_timestamp_ms});
