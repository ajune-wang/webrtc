...
class RtpPayloadParamsGenericCodecDependencyDescriptorTest
    : public ::testing::Test {
 protected:
  RtpPayloadParamsGenericCodecDependencyDescriptorTest()
      : field_trials_("WebRTC-GenericCodecDependencyDescriptor/Enabled/") {}

  test::ExplicitKeyValueConfig field_trials_;
  RtpPayloadState state_;
};

TEST_F(RtpPayloadParamsGenericCodecDependencyDescriptorTest, NoScalability) {
  RtpPayloadParams params(/*ssrc=*/123, &state_, field_trials_);
