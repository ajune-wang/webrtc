...
class P2PTransportChannelTestBase : public ::testing::Test,
 ...
 protected:
  ...
  static bool CheckConnection(P2PTransportChannel* ch1,
  ...
  static bool CheckConnected(P2PTransportChannel* ch1,
                             ...
                             SocketAddress from,
                             SocketAddress to) {
    return CheckConnected(ch1, ch2) && CheckConnection(ch1, ch2, from, to);
  }
...
TEST_F(P2PTransportChannelTest, TestTcpConnectionsFromActiveToPassive) {
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), kPublicAddrs[0], kPublicAddrs[1]),
      kShortTimeout, clock);
...
TEST_F(P2PTransportChannelTest, TestIPv6Connections) {
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), kIPv6PublicAddrs[0],
                     kIPv6PublicAddrs[1]),
      kShortTimeout, clock);
...
TEST_F(P2PTransportChannelMultihomedTest, TestFailoverControllingSide) {
  ...
  // when we are not receiving.
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), kAlternateAddrs[0], kPublicAddrs[1]),
      kMediumTimeout, clock);
...
TEST_F(P2PTransportChannelMultihomedTest, TestFailoverWithManyConnections) {
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), wifiIpv6[0], wifiIpv6[1]),
      kMediumTimeout, clock);
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), cellularIpv6[0], wifiIpv6[1]),
      kMediumTimeout, clock);
...
TEST_F(P2PTransportChannelMultihomedTest, TestRemoteFailover) {
  ...
  EXPECT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), wifi[0], wifi[1]), kDefaultTimeout,
      clock);
...
TEST_F(P2PTransportChannelMultihomedTest, TestPreferWifiToWifiConnection) {
  ...
  // Need to wait to make sure the connections on both networks are writable.
  EXPECT_TRUE_WAIT(CheckConnected(ep1_ch1(), ep2_ch1(), wifi[0], wifi[1]),
                   1000);
  DestroyChannels();
}
...
TEST_F(P2PTransportChannelMultihomedTest, TestPreferWifiOverCellularNetwork) {
  ...
  EXPECT_TRUE_WAIT_MARGIN(
      CheckConnected(ep1_ch1(), ep2_ch1(), cellular[0], wifi[1]), 1000, 1000);
  DestroyChannels();
}
...
TEST_F(P2PTransportChannelMultihomedTest,
  ...
  ASSERT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), kPublicAddrs[0], kAlternateAddrs[1]),
      kMediumTimeout, clock);
  ...
  ASSERT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), kPublicAddrs[0], kAlternateAddrs[0]),
      kMediumTimeout, clock);
...
TEST_F(P2PTransportChannelMultihomedTest, TestRestoreBackupConnection) {
  ...
  CreateChannels(config, config);
  ASSERT_TRUE_SIMULATED_WAIT(
      CheckConnected(ep1_ch1(), ep2_ch1(), wifi[0], wifi[1]), kMediumTimeout,
      clock);
...
TEST_F(P2PTransportChannelTest,
  ...
  RTC_LOG(LS_INFO) << "-- KESO KESO KESO -- Blocking traffic";
  ...
  RTC_LOG(LS_INFO) << "-- KESO KESO KESO -- Blocking traffic - done";
