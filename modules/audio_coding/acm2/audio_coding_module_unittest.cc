...
namespace {
const std::string audio_checksum = "6a76fe2ffba057c06eb63239b3c47abe";
...
TEST_F(AcmSenderBitExactnessNewApi, OpusFromFormat_stereo_20ms_voip) {
  ...
  ASSERT_NO_FATAL_FAILURE(SetUpTestExternalEncoder(
      AudioEncoderOpus::MakeAudioEncoder(*config, 120), 120));
  const std::string audio_checksum = "058c03ca2c9bb5c0066d4c15ce50d772";
  const std::string payload_checksum = "f270ec7be7a5ed60c203c2317c4e1011";
  Run(audio_checksum, payload_checksum,
      /*expected_packets=*/50,
      /*expected_channels=*/test::AcmReceiveTestOldApi::kStereoOutput);
}
#endif
