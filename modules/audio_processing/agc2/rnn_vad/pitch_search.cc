...
using pitch_search_internal::CheckLowerPitchPeriodsAndComputePitchGain;
using pitch_search_internal::ComputePitchAutoCorrelation;
using pitch_search_internal::Decimate2x;
using pitch_search_internal::FindBestPitchPeriods;
using pitch_search_internal::kNumInvertedLags12kHz;
using pitch_search_internal::RefinePitchPeriod48kHz;
...
PitchInfo PitchSearch(rtc::ArrayView<const float, kBufSize24kHz> pitch_buf,
  ...
  const size_t pitch_inv_lag_48kHz = RefinePitchPeriod48kHz(
      pitch_buf,
