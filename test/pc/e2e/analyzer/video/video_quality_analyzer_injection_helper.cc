...
class VideoWriterListener : public VideoFrameListener {
 public:
...
class AnalyzingFrameGenerator : public test::FrameGenerator {
 public:
 ...
 private:
  ...
  std::vector<std::unique_ptr<VideoFrameListener>> listeners_;
};
