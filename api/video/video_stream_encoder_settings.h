...
struct VideoStreamEncoderSettings {
  explicit VideoStreamEncoderSettings(
      const VideoEncoder::Capabilities& video_encoder_capabilities)
      : video_encoder_capabilities(video_encoder_capabilities) {}
  ...
  // side to use.
  VideoEncoder::Capabilities video_encoder_capabilities;
};
