...
class AndroidCallClient::CreateOfferObserver
    : public webrtc::CreateSessionDescriptionObserver {
 public:
  explicit CreateOfferObserver(AndroidCallClient* client);
...
class AndroidCallClient::SetRemoteSessionDescriptionObserver
    : public webrtc::SetRemoteDescriptionObserverInterface {
 public:
  void OnSetRemoteDescriptionComplete(webrtc::RTCError error) override;
};

class AndroidCallClient::SetLocalSessionDescriptionObserver
...
AndroidCallClient::AndroidCallClient()
    : pc_observer_(rtc::MakeUnique<PCObserver>(this)),
