...
vars = {
  ...
  'chromium_revision': 'd5de0d47ebb81556e6c77b9f1b63685fd3271055',
...
deps = {
  ...
  'src/base':
    'https://chromium.googlesource.com/chromium/src/base@ea6d02a47633a49db93fbc9b647eaad928540c2d',
  'src/build':
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@a6f31dab3f501a40134b8782c96146119d1c93c0',
    'condition': 'checkout_ios',
  },
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@9cdf775e096d547767e95322844b9cad8fe209e7',
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@a6362c81ce9e756fc03b69a19033ef49cfe6e268',
 ...
 'src/third_party/jsoncpp/source':
      ...
      'packages': [
          {
              ...
              'version': '-7sUKr80Td680zmg3U9qrcmqyjC_DQsavcOqRXRY_BMC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/tools':
    'https://chromium.googlesource.com/chromium/src/tools@5b1d3f07339abde71d0bc55a0d37685002b2ccdf',
    ...
    'packages': [
      {
          ...
          'version': 'Az0661QhG5Cpfft2oBSAmdixodnucJQS7_m8Is-kJ6IC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
