...
class MediaEngineFactoryForTest : public MediaEngineFactoryInterface {
 public:
  explicit MediaEngineFactoryForTest(MediaEngineFactoryParamsForTest params)
 ...
 private:
  ...
  const std::unique_ptr<MediaEngineFactoryInterface> prod_factory_ =
      CreateMediaEngineFactory();
  MediaEngineFactoryParamsForTest test_params_;
};
...
std::unique_ptr<MediaEngineFactoryInterface> CreateMediaEngineFactoryForTest(
    MediaEngineFactoryParamsForTest params) {
  return std::make_unique<MediaEngineFactoryForTest>(std::move(params));
}
