...
void AssertHasFrame(FrameStorage& storage, uint16_t frame_id) {
...
class FrameStorageTest : public testing::Test {
 protected:
  FrameStorageTest()
...
TEST_F(FrameStorageTest, CanGetAllAddedFrames) {
  ...
  FrameStorage storage(TimeDelta::Seconds(1), GetClock());
...
TEST_F(FrameStorageTest, CanGetLeftAddedFramesAfterRemove) {
  VideoFrame frame1 = Create2x2Frame(/*frame_id=*/1);
  VideoFrame frame2 = Create2x2Frame(/*frame_id=*/2);
  VideoFrame frame3 = Create2x2Frame(/*frame_id=*/3);
  VideoFrame frame4 = Create2x2Frame(/*frame_id=*/4);
...
TEST_F(FrameStorageTest, AutoCleanupRemovesOnlyOldFrames) {
  VideoFrame frame1 = Create2x2Frame(/*frame_id=*/1);
  VideoFrame frame2 = Create2x2Frame(/*frame_id=*/2);
  VideoFrame frame3 = Create2x2Frame(/*frame_id=*/3);
  VideoFrame frame4 = Create2x2Frame(/*frame_id=*/4);
...
TEST_F(FrameStorageTest, AllFramesAutoCleaned) {
  VideoFrame frame1 = Create2x2Frame(/*frame_id=*/1);
  VideoFrame frame2 = Create2x2Frame(/*frame_id=*/2);
  VideoFrame frame3 = Create2x2Frame(/*frame_id=*/3);
