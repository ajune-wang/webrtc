...
void PeerConnection::TransceiverStableState::set_m_section(
...
void PeerConnection::TransceiverStableState::set_remote_stream_ids(
    ...
    for (const auto& transceiver : transceivers_) {
      ...
      if (RtpTransceiverDirectionHasRecv(local_direction)) {
        ...
        transceiver_stable_states_by_transceivers_[transceiver]
            .set_remote_stream_ids(transceiver->receiver()->stream_ids());
...
PeerConnection::AssociateTransceiver(cricket::ContentSource source,
  ...
  if (type == SdpType::kOffer) {
    ...
    if (state_changes) {
      transceiver_stable_states_by_transceivers_[transceiver].set_m_section(
