...
GoogCcNetworkController::GoogCcNetworkController(
    ...
    : event_log_(event_log),
      ...
      probe_controller_(
          new ProbeController(observer_,
                              ...
                              config.constraints.max_data_rate.bps(),
  ...
  UpdateBitrateConstraints(config.constraints, config.starting_rate);
...
void GoogCcNetworkController::OnNetworkRouteChange(NetworkRouteChange msg) {
  ...
  if (msg.starting_rate.IsFinite())
    start_bitrate_bps = msg.starting_rate.bps();
  ...
  probe_controller_.reset(
      new ProbeController(observer_, msg.at_time.ms(), max_bitrate_bps,
                          start_bitrate_bps, enable_alr_probing_));
...
void GoogCcNetworkController::UpdateBitrateConstraints(
  ...
  if (starting_rate.IsFinite())
    start_bitrate_bps = starting_rate.bps();
