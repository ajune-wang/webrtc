...
enum PeerConnectionAddressFamilyCounter {
  ...
  kPeerConnectionAddressFamilyCounter_Max = kBestConnections_IPv6
};
...
enum PeerConnectionMetricsName {
  ...
  kPeerConnectionMetricsName_Max = kLocalCandidates_IPv6
};
...
enum IceCandidatePairType {
  ...
  kIceCandidatePairMax = kIceCandidatePairHostPublicHostName
};
...
enum KeyExchangeProtocolType {
  ...
  kEnumCounterKeyProtocolMax = kEnumCounterKeyProtocolSdes
};
...
enum KeyExchangeProtocolMedia {
  ...
  kEnumCounterKeyProtocolMediaTypeMax = kEnumCounterKeyProtocolMediaTypeSdesData
};
...
enum SdpSemanticRequested {
  ...
  kSdpSemanticRequestMax = kSdpSemanticRequestUnifiedPlan
};
...
enum SdpSemanticNegotiated {
  ...
  kSdpSemanticNegotiatedMax = kSdpSemanticNegotiatedMixed
};
...
enum SdpFormatReceived {
  ...
  kSdpFormatReceivedMax = kSdpFormatReceivedComplexUnifiedPlan
};
...
enum AddIceCandidateResult {
  ...
  kAddIceCandidateMax = kAddIceCandidateFailNotUsable
};
...
enum SimulcastApiVersion {
  ...
  kSimulcastApiVersionMax = kSimulcastApiVersionSpecCompliant,
};
