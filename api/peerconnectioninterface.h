...
class PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  // called before a SetLocal/RemoteDescription is called, and it may only be
  // called once. Once enabled, the MediaTransportInterface will be used to
  // send media, as opposed to the default RTP stack.
