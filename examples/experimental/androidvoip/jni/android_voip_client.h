...
// VoipBase related operations with socket_thread_, this is to comply
// with consistent thread usage requirement with ProcessThread used
// within VoipEngine. AndroidVoipClient is meant to be used by Java
// through JNI.
class AndroidVoipClient : public webrtc::Transport,
 ...
 public:
  ...
  // Sets two remote addresses. Please refer to SetLocalAddress above.
