...
ModuleRtpRtcpImpl2::ModuleRtpRtcpImpl2(const Configuration& configuration)
  ...
  // Schedule a task to regularly update the RTT. This gets either the send- or
  // receive-side RTT from RtcpReceiver. This is needed even if rtt_stats_ is
  // not set, because the receive-side RTT needs to be propagated to
  // ModuleRtpRtcpImpl2.
