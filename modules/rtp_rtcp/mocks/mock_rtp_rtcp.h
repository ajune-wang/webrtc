...
class MockRtpRtcp : public RtpRtcp {
 public:
  ...
  MOCK_METHOD(void, SetSSRC, (uint32_t ssrc), (override));
  ...
  MOCK_METHOD(int32_t, SetCSRCStatus, (bool include), (override));
  ...
  MOCK_METHOD(void, SetRtxSsrc, (uint32_t), (override));
  ...
  MOCK_METHOD(void,
              ...
              (RtcpIntraFrameObserver*, RtcpBandwidthObserver*),
              (override));
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(RtcpStatisticsCallback*,
              GetRtcpStatisticsCallback,
              (),
              (override));
  MOCK_METHOD(void,
              RegisterRtcpCnameCallback,
              (RtcpCnameCallback*),
              (override));
  MOCK_METHOD(void,
  ...
  MOCK_METHOD(void,
              ...
              (override));
  MOCK_METHOD(void, SetTargetSendBitrate, (uint32_t bitrate_bps), (override));
  MOCK_METHOD(int32_t,
