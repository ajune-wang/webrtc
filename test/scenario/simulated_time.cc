...
// via return_node_,
void SimulatedFeedback::DeliverPacket(EmulatedIpPacket packet) {
...
void SimulatedTimeClient::DeliverPacket(EmulatedIpPacket packet) {
...
void SimulatedTimeClient::PacerProcess(Timestamp at_time) {
  ...
  for (auto to_send : sender_.PaceAndPullSendPackets(at_time)) {
    sender_.send_node_->DeliverPacket(EmulatedIpPacket(
