...
class RTC_EXPORT IceTransportInternal : public rtc::PacketTransportInternal {
 public:
  ...
  // If MaybeStartGathering() is called after this, it will be a no-op
  // unless the ICE username and fragment are changed use SetIceParameters,
  // in which case an ICE restart will be triggered.
