...
class PeerConnectionE2EQualityTestFixture {
 public:
  ...
  struct VideoConfig {
    ...
    // Count of temporal layers for video stream.
    //
    // This value will be set into each RtpEncodingParameters of RtpParameters
    // of corresponding RtpSenderInterface for this video stream.
