...
class GainController2 {
 public:
  ...
  // Performs the pre-processing. Returns true if a gain different from that of
  // the last call has been used - i.e., echo path gain change.
  ...
  // Process() is called.
  bool PreProcess(AudioBuffer* audio);
