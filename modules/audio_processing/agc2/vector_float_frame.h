...
class VectorFloatFrame {
 public:
  VectorFloatFrame(int num_channels,
                   ...
                   float start_value);
  const AudioFrameView<float>& float_frame() { return float_frame_; }
  AudioFrameView<const float> float_frame() const { return float_frame_; }
 ...
 private:
  ...
  AudioFrameView<float> float_frame_;
};
