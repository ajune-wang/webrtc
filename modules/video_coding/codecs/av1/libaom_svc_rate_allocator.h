...
#ifndef MODULES_VIDEO_CODING_CODECS_AV1_LIBAOM_SVC_RATE_ALLOCATOR_H_
#define MODULES_VIDEO_CODING_CODECS_AV1_LIBAOM_SVC_RATE_ALLOCATOR_H_
...
class LibaomSvcRateAllocator : public VideoBitrateAllocator {
 public:
  explicit LibaomSvcRateAllocator(const VideoCodec& codec);
...
#endif  // MODULES_VIDEO_CODING_CODECS_AV1_LIBAOM_SVC_RATE_ALLOCATOR_H_
