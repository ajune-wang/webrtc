...
vars = {
  ...
  'chromium_revision': '3896403e9f711cd788ef11f2480ed720e4e18c6a',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': 'b761b7b3dd9105dc081cd4913cc1242585b363d4',
}
deps = {
  ...
  'src/third_party/winsdk_samples': {
    'url': Var('webrtc_git') + '/deps/third_party/winsdk_samples_v71' + '@' + 'ed878e0d9b7cf49cb1be80299e1956d476365aaa',
