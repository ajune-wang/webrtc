...
// used via UMA. For this reason entries should not be reordered, but new values
// can be added in between entries that are numerically separate.
...
constexpr uint32_t kDesktopCapturerIdMax = kScreenCapturerWinDirectx;
}  // namespace DesktopCapturerId
