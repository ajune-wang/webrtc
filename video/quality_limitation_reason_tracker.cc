...
QualityLimitationReasonTracker::QualityLimitationReasonTracker(Clock* clock)
    : clock_(clock),
      ...
      durations_ms_({std::make_pair(QualityLimitationReason::kNone, 0u),
                     std::make_pair(QualityLimitationReason::kCpu, 0u),
                     std::make_pair(QualityLimitationReason::kBandwidth, 0u),
                     std::make_pair(QualityLimitationReason::kOther, 0u)}) {}
