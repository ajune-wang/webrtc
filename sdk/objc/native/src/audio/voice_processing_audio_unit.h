...
class VoiceProcessingAudioUnitObserver {
 public:
  ...
  // Callback function called when a user speaking during muted is detected by system.
  virtual void OnReceivedMutedSpeechActivity(AUVoiceIOSpeechActivityEvent event) = 0;
