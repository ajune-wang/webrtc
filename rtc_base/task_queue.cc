...
TaskQueue::~TaskQueue() {
  // TODO(danilchap): change impl_ to webrtc::TaskQueue* when dependenent
  ...
  static_cast<webrtc::TaskQueue*>(impl_.get())->Delete();
...
TaskQueue* TaskQueue::Current() {
  webrtc::TaskQueue* impl = webrtc::TaskQueue::Current();
  if (impl == nullptr) {
    return nullptr;
  }
