...
class MockTestCodedVideoSource : public TestCodedVideoSource {
 public:
  MOCK_METHOD(absl::optional<EncodedImage>, Pull, (), (override));
};

class MockTestRawVideoSource : public TestRawVideoSource {
 public:
  MOCK_METHOD(absl::optional<VideoFrame>, Get, (size_t frame_num), (override));
  MOCK_METHOD(absl::optional<VideoFrame>, Pull, (), (override));
};
...
INSTANTIATE_TEST_SUITE_P(All, PaceEncodeTest, Bool());
...
INSTANTIATE_TEST_SUITE_P(All, PaceDecodeTest, Bool());
