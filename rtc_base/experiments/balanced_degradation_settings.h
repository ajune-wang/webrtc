...
class BalancedDegradationSettings {
 public:
  ...
  struct Config {
    ...
    int kbps = 0;  // Min bitrate needed to adapt up.
    int kbps_res = 0;  // Min bitrate needed to adapt up to this resolution.
  ...
  // Checks if resolution can be increased based on |pixels| and |bitrate_bps|.
