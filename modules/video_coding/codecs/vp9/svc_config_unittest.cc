...
TEST(SvcConfig, NumSpatialLayersWithScalability) {
  VideoCodec codec;
...
TEST(SvcConfig, NumSpatialLayersReducedWithScalabilityMode) {
  VideoCodec codec;
  codec.codecType = kVideoCodecVP9;
  codec.width = 480;
  codec.height = 270;
...
TEST(SvcConfig, NumSpatialLayersReducedWithScalabilityModePortrait) {
  VideoCodec codec;
  codec.codecType = kVideoCodecVP9;
  codec.width = 270;
  codec.height = 480;
...
TEST(SvcConfig, NumSpatialLayersReducedWithScalabilityModeResolutionRatio1_5) {
  VideoCodec codec;
  codec.codecType = kVideoCodecVP9;
  codec.width = 320;
  codec.height = 180;
...
TEST(SvcConfig, BitrateThresholdsWithScalability) {
  VideoCodec codec;
  codec.codecType = kVideoCodecVP9;
  codec.width = 960;
  codec.height = 540;
