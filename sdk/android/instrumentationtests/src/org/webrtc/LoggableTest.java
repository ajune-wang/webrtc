...
public class LoggableTest {
  ...
  private static class TestLoggable implements Loggable {
  ...
  private final TestLoggable testLoggable = new TestLoggable();
  ...
  public void testLoggableSetWithoutError() throws InterruptedException {
    PeerConnectionFactory.initialize(PeerConnectionFactory.InitializationOptions
                                         ...
                                         .setInjectableLogger(testLoggable, Severity.LS_INFO)
  ...
  public void testMessageIsLoggedCorrectly() throws InterruptedException {
    ...
    Logging.d(TAG, msg);
    assertTrue(testLoggable.isMessageReceived(msg, Severity.LS_INFO, TAG));
  }
  ...
  public void testLowSeverityIsFiltered() throws InterruptedException {
    ...
    PeerConnectionFactory.initialize(PeerConnectionFactory.InitializationOptions
                                         .builder(InstrumentationRegistry.getTargetContext())
                                         .setInjectableLogger(testLoggable, Severity.LS_WARNING)
                                         .createInitializationOptions());
    String msg = "Message that should NOT be logged";
    Logging.d(TAG, msg);
    assertFalse(testLoggable.isMessageReceived(msg));
  }
  ...
  public void testNativeMessageIsLoggedCorrectly() throws InterruptedException {
    ...
    assertTrue(testLoggable.isMessageReceived(msg, Severity.LS_INFO, NATIVE_FILENAME_TAG));
  }
