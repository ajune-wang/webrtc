...
aggr_hdr_z = ProtoField.new("Aggregation header Z bit", "av1.aggr.z", ftypes.BOOLEAN,
...
aggr_hdr_y = ProtoField.new("Aggregation header Y bit", "av1.aggr.y", ftypes.BOOLEAN,
    {"Last OBU continues in next packet", "Last OBU ends in this packet"}, 8, 0x40,
    "True if the last OBU continues in the next packet")
aggr_hdr_w = ProtoField.new("Aggregation header W field", "av1.aggr.w", ftypes.UINT8,
    {
...
aggr_hdr_n = ProtoField.new("Aggregation header N bit", "av1.aggr.n", ftypes.BOOLEAN, nil, 8, 0x08,
    "True if this is the first packet of a codec video sequence")
aggr_hdr_f = ProtoField.new("Aggregation header F bits", "av1.aggr.f", ftypes.BOOLEAN, nil, 8, 0x07,
    "Forbidden bits")
av1.fields = {
