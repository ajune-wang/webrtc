...
// or decoders), it will store |coding_entity_id| in the set for each met
// cosing entity and if the new one arrives, it will extend its buffers pool,
// adding 256 more buffers. During initialization injector will preallocate
// buffers for 2 coding entites, so 512 buffers with initial size 2KB.
// If in some point of time bigger buffer will be required, it will be also
// extended.
