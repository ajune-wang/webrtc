...
CallReceiveStatistics ChannelReceive::GetRTCPStatistics() const {
  ...
  absl::optional<RtpRtcpInterface::RemoteSenderStats> rtcp_sr_stats =
      rtp_rtcp_->GetRemoteSenderStats();
  if (rtcp_sr_stats.has_value()) {
    ...
    stats.round_trip_time = rtcp_sr_stats->round_trip_time;
    stats.round_trip_time_measurements =
        rtcp_sr_stats->round_trip_time_measurements;
    stats.total_round_trip_time = rtcp_sr_stats->total_round_trip_time;
  }
