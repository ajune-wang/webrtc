...
import org.webrtc.VideoFrameBufferTestNativeUtils;
...
public class VideoFrameBufferTest {
  ...
  private static VideoFrame.Buffer createBufferWithType(
    ...
    switch (bufferType) {
      case I420_JAVA:
        ...
        assertEquals(
            VideoFrameBufferType.I420, VideoFrameBufferTestNativeUtils.nativeGetBufferType(buffer));
        return buffer;
      case I420_NATIVE:
        buffer = VideoFrameBufferTestNativeUtils.nativeGetNativeI420Buffer(i420Buffer);
        assertEquals(VideoFrameBufferType.I420, buffer.getBufferType());
        assertEquals(
            VideoFrameBufferType.I420, VideoFrameBufferTestNativeUtils.nativeGetBufferType(buffer));
        return buffer;
      case RGB_TEXTURE:
        ...
        assertEquals(VideoFrameBufferType.NATIVE,
            VideoFrameBufferTestNativeUtils.nativeGetBufferType(buffer));
        return buffer;
      case OES_TEXTURE:
  ...
  public void testToI420() {
    ...
    assertEquals(VideoFrameBufferType.I420,
        VideoFrameBufferTestNativeUtils.nativeGetBufferType(outputI420Buffer));
