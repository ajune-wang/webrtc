...
class RtpTransceiver final
 ...
 public:
  ...
  cricket::BaseChannelInterface* channel() const { return channel_; }
  ...
  void SetChannel(cricket::BaseChannelInterface* channel);
 ...
 private:
  void OnFirstPacketReceived(cricket::BaseChannelInterface* channel);
  ...
  cricket::BaseChannelInterface* channel_ = nullptr;
};
