...
int32_t AudioMixerManagerLinuxALSA::CloseSpeaker() {
  ...
  if (_outputMixerHandle != NULL) {
    RTC_DLOG(LS_VERBOSE) << "Closing playout mixer";
    LATE(snd_mixer_free)(_outputMixerHandle);
    if (errVal < 0) {
      RTC_DLOG(LS_ERROR) << "Error freeing playout mixer: "
                        << LATE(snd_strerror)(errVal);
    }
    errVal = LATE(snd_mixer_detach)(_outputMixerHandle, _outputMixerStr);
    if (errVal < 0) {
      RTC_DLOG(LS_ERROR) << "Error detaching playout mixer: "
                        << LATE(snd_strerror)(errVal);
    }
    errVal = LATE(snd_mixer_close)(_outputMixerHandle);
    if (errVal < 0) {
      RTC_DLOG(LS_ERROR) << "Error snd_mixer_close(handleMixer) errVal="
                        << errVal;
    }
    _outputMixerHandle = NULL;
    _outputMixerElement = NULL;
...
int32_t AudioMixerManagerLinuxALSA::CloseMicrophone() {
  ...
  if (_inputMixerHandle != NULL) {
    RTC_DLOG(LS_VERBOSE) << "Closing record mixer";

    LATE(snd_mixer_free)(_inputMixerHandle);
    if (errVal < 0) {
      RTC_DLOG(LS_ERROR) << "Error freeing record mixer: "
                        << LATE(snd_strerror)(errVal);
    }
    RTC_DLOG(LS_VERBOSE) << "Closing record mixer 2";

    errVal = LATE(snd_mixer_detach)(_inputMixerHandle, _inputMixerStr);
    if (errVal < 0) {
      RTC_DLOG(LS_ERROR) << "Error detaching record mixer: "
                        << LATE(snd_strerror)(errVal);
    }
    RTC_DLOG(LS_VERBOSE) << "Closing record mixer 3";
    ...
    RTC_DLOG(LS_VERBOSE) << "Closing record mixer 4";
    _inputMixerHandle = NULL;
    _inputMixerElement = NULL;
  }
  memset(_inputMixerStr, 0, kAdmMaxDeviceNameSize);
...
int32_t AudioMixerManagerLinuxALSA::OpenSpeaker(char* deviceName) {
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::OpenSpeaker(name="
                      << deviceName << ")";
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_open(&_outputMixerHandle, 0) - error";
    return -1;
  }
  ...
  RTC_DLOG(LS_VERBOSE) << "snd_mixer_attach(_outputMixerHandle, " << controlName
                      << ")";

  errVal = LATE(snd_mixer_attach)(_outputMixerHandle, controlName);
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_attach(_outputMixerHandle, " << controlName
  ...
  if (_outputMixerHandle != NULL) {
    RTC_DLOG(LS_VERBOSE) << "the output mixer device is now open ("
                        << _outputMixerHandle << ")";
  }
...
int32_t AudioMixerManagerLinuxALSA::OpenMicrophone(char* deviceName) {
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::OpenMicrophone(name="
                      << deviceName << ")";
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_open(&_inputMixerHandle, 0) - error";
    return -1;
  }
  ...
  RTC_DLOG(LS_VERBOSE) << "snd_mixer_attach(_inputMixerHandle, " << controlName
                      << ")";

  errVal = LATE(snd_mixer_attach)(_inputMixerHandle, controlName);
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_attach(_inputMixerHandle, " << controlName
                      << ") error: " << LATE(snd_strerror)(errVal);
  ...
  if (_inputMixerHandle != NULL) {
    RTC_DLOG(LS_VERBOSE) << "the input mixer device is now open ("
                        << _inputMixerHandle << ")";
  }
...
int32_t AudioMixerManagerLinuxALSA::SetSpeakerVolume(uint32_t volume) {
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::SetSpeakerVolume(volume="
                      << volume << ")";

  rtc::CritScope lock(&_critSect);

  if (_outputMixerElement == NULL) {
    RTC_DLOG(LS_WARNING) << "no avaliable output mixer element exists";
    return -1;
  }
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error changing master volume: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::SpeakerVolume(uint32_t& volume) const {
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error getting outputvolume: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::SpeakerVolume() => vol="
                      << vol;
...
int32_t AudioMixerManagerLinuxALSA::MaxSpeakerVolume(
  ...
  if (_outputMixerElement == NULL) {
    RTC_DLOG(LS_WARNING) << "no avilable output mixer element exists";
    return -1;
  }
  ...
  RTC_DLOG(LS_VERBOSE) << "Playout hardware volume range, min: " << minVol
                      << ", max: " << maxVol;

  if (maxVol <= minVol) {
    RTC_DLOG(LS_ERROR) << "Error getting get_playback_volume_range: "
                      << LATE(snd_strerror)(errVal);
  }
...
/*
 ...
 {
 RTC_DLOG(LS_WARNING) << "Error getting playback volume range: "
                 << snd_strerror(errVal);
 }
 ...
 if (errVal != 0)
 {
 RTC_DLOG(LS_ERROR) << "Error setting playback volume range: "
               << snd_strerror(errVal);
 return -1;
 }
...
int32_t AudioMixerManagerLinuxALSA::SetSpeakerMute(bool enable) {
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::SetSpeakerMute(enable="
                      << enable << ")";
  ...
  if (!available) {
    RTC_DLOG(LS_WARNING) << "it is not possible to mute the speaker";
    return -1;
  }
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error setting playback switch: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::SpeakerMute(bool& enabled) const {
  if (_outputMixerElement == NULL) {
    RTC_DLOG(LS_WARNING) << "no avaliable output mixer exists";
    return -1;
  }
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error getting playback switch: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::MicrophoneMuteIsAvailable(bool& available) {
  if (_inputMixerElement == NULL) {
    RTC_DLOG(LS_WARNING) << "no avaliable input mixer element exists";
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::SetMicrophoneMute(bool enable) {
  RTC_DLOG(LS_VERBOSE) << "AudioMixerManagerLinuxALSA::SetMicrophoneMute(enable="
                      << enable << ")";
  ...
  if (!available) {
    RTC_DLOG(LS_WARNING) << "it is not possible to mute the microphone";
    return -1;
  }
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error setting capture switch: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::MicrophoneMute(bool& enabled) const {
  if (_inputMixerElement == NULL) {
    RTC_DLOG(LS_WARNING) << "no avaliable input mixer exists";
    return -1;
  }
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error getting capture switch: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
int32_t AudioMixerManagerLinuxALSA::SetMicrophoneVolume(uint32_t volume) {
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error changing microphone volume: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
...
/*
 ...
 if ((maxVol <= minVol) || (errVal != 0))
 {
 RTC_DLOG(LS_WARNING) << "Error getting capture volume range: "
                 << snd_strerror(errVal);
 }
 ...
 maxVol); RTC_DLOG(LS_VERBOSE) << "Capture hardware volume range, min: " <<
 minVol
                 << ", max: " << maxVol;
 if (errVal != 0)
 {
 RTC_DLOG(LS_ERROR) << "Error setting capture volume range: "
               << snd_strerror(errVal);
 return -1;
 }
 ...
 _inputMixerElement, minVol, maxVol);
 RTC_DLOG(LS_VERBOSE) << "Capture hardware volume range, min: " << minVol
                 << ", max: " << maxVol;
 if (errVal != 0)
 {
 RTC_DLOG(LS_ERROR) << "Error setting capture volume range: "
...
int32_t AudioMixerManagerLinuxALSA::MicrophoneVolume(uint32_t& volume) const {
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "Error getting inputvolume: "
                      << LATE(snd_strerror)(errVal);
    return -1;
  }
  RTC_DLOG(LS_VERBOSE)
...
int32_t AudioMixerManagerLinuxALSA::MaxMicrophoneVolume(
  ...
  if (!LATE(snd_mixer_selem_has_capture_volume)(_inputMixerElement)) {
    RTC_DLOG(LS_ERROR) << "No microphone volume available";
    return -1;
  }
  ...
  RTC_DLOG(LS_VERBOSE) << "Microphone hardware volume range, min: " << minVol
                      << ", max: " << maxVol;
  if (maxVol <= minVol) {
    RTC_DLOG(LS_ERROR) << "Error getting microphone volume range: "
                      << LATE(snd_strerror)(errVal);
  }
...
int32_t AudioMixerManagerLinuxALSA::LoadMicMixerElement() const {
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_load(_inputMixerHandle), error: "
                      << LATE(snd_strerror)(errVal);
    _inputMixerHandle = NULL;
    return -1;
  }
  ...
  for (elem = LATE(snd_mixer_first_elem)(_inputMixerHandle); elem;
    ...
    if (LATE(snd_mixer_selem_is_active)(elem)) {
      ...
      if (strcmp(selemName, "Capture") == 0)  // "Capture", "Mic"
      {
        ...
        RTC_DLOG(LS_VERBOSE) << "Capture element set";
      } else if (strcmp(selemName, "Mic") == 0) {
        micElem = elem;
        RTC_DLOG(LS_VERBOSE) << "Mic element found";
      }
    }
  ...
  if (_inputMixerElement == NULL) {
    ...
    if (micElem != NULL) {
      ...
      RTC_DLOG(LS_VERBOSE) << "Using Mic as capture volume.";
    } else {
      _inputMixerElement = NULL;
      RTC_DLOG(LS_ERROR) << "Could not find capture volume on the mixer.";
...
int32_t AudioMixerManagerLinuxALSA::LoadSpeakerMixerElement() const {
  ...
  if (errVal < 0) {
    RTC_DLOG(LS_ERROR) << "snd_mixer_load(_outputMixerHandle), error: "
                      << LATE(snd_strerror)(errVal);
    _outputMixerHandle = NULL;
    return -1;
  }
  ...
  for (elem = LATE(snd_mixer_first_elem)(_outputMixerHandle); elem;
    ...
    if (LATE(snd_mixer_selem_is_active)(elem)) {
      selemName = LATE(snd_mixer_selem_get_name)(elem);
      RTC_DLOG(LS_VERBOSE) << "snd_mixer_selem_get_name " << mixerIdx << ": "
                          << selemName << " =" << elem;

      // "Master", "PCM", "Wave", "Master Mono", "PC Speaker", "PCM", "Wave"
      if (strcmp(selemName, "PCM") == 0) {
        _outputMixerElement = elem;
        RTC_DLOG(LS_VERBOSE) << "PCM element set";
      } else if (strcmp(selemName, "Master") == 0) {
        masterElem = elem;
        RTC_DLOG(LS_VERBOSE) << "Master element found";
      } else if (strcmp(selemName, "Speaker") == 0) {
        speakerElem = elem;
        RTC_DLOG(LS_VERBOSE) << "Speaker element found";
      }
    }
  ...
  if (_outputMixerElement == NULL) {
    if (masterElem != NULL) {
      ...
      RTC_DLOG(LS_VERBOSE) << "Using Master as output volume.";
    } else if (speakerElem != NULL) {
      _outputMixerElement = speakerElem;
      RTC_DLOG(LS_VERBOSE) << "Using Speaker as output volume.";
    } else {
      _outputMixerElement = NULL;
      RTC_DLOG(LS_ERROR) << "Could not find output volume in the mixer.";
      return -1;
    }
  }
