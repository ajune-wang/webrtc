...
void ZeroHertzAdapterMode::ProcessRepeatedFrameOnDelayedCadence(
  ...
  // Adjust timestamps of the frame of the repeat, accounting for the delay
  // in scheduling this method.
  // No need to update the RTP timestamp as the VideoStreamEncoder overwrites it
  // based on it's NTP timestamp source.
