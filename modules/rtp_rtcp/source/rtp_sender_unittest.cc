...
class MockFlexfecSender : public FlexfecSender {
 public:
  explicit MockFlexfecSender(Clock* clock)
      : FlexfecSender(0,
                      kFlexFecSsrc,
                      kSsrc,
                      "",
                      ...
                      nullptr,
                      clock) {}
  uint32_t Ssrc() const override { return kFlexFecSsrc; }
};
 ...
 protected:
  RtpSenderTest()
      : fake_clock_(kStartTime),
        ...
        mock_flexfec_sender_(&fake_clock_),
        rtp_sender_(),
        transport_(),
        kMarkerBit(true),
  ...
  void SetUpRtpSender(bool pacer, bool populate_network2) {
    ...
    config.media_send_ssrc_ = kSsrc;
    config.rtx_send_ssrc_ = kRtxSsrc;
    config.flexfec_sender = &mock_flexfec_sender_;
  ...
  MockFlexfecSender mock_flexfec_sender_;
