...
#include "audio/utility/audio_frame_operations.h"  // for AudioFrameOperations
#include "call/audio_send_stream.h"                // for AudioSendStream
#include "rtc_base/checks.h"                       // for FatalLogCall, RTC_...
