...
TEST(MatchedFilter, ZeroWindowSize) {
  ApmDataDumper data_dumper(0);
  EchoCanceller3Config::Delay::MatchedFilters config;
  EXPECT_DEATH(MatchedFilter(&data_dumper, DetectOptimization(), config, 16),
               "");
}
...
TEST(MatchedFilter, NullDataDumper) {
  EchoCanceller3Config::Delay::MatchedFilters config;
  EXPECT_DEATH(MatchedFilter(nullptr, DetectOptimization(), config, 16), "");
}
...
TEST(MatchedFilter, DISABLED_BlockSizeMultipleOf4) {
  ApmDataDumper data_dumper(0);
  EchoCanceller3Config::Delay::MatchedFilters config;
  EXPECT_DEATH(MatchedFilter(&data_dumper, DetectOptimization(), config, 15),
               "");
}
...
TEST(MatchedFilter, DISABLED_SubBlockSizeAddsUpToBlockSize) {
  ApmDataDumper data_dumper(0);
  EchoCanceller3Config::Delay::MatchedFilters config;
  EXPECT_DEATH(MatchedFilter(&data_dumper, DetectOptimization(), config, 12),
               "");
}
