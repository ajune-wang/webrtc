 ...
 */
#ifndef MODULES_RTP_RTCP_SOURCE_RTP_FRAME_DESCRIPTOR_H_
#define MODULES_RTP_RTCP_SOURCE_RTP_FRAME_DESCRIPTOR_H_
...
class RtpFrameDescriptor {
 public:
  ...
  // Size of subframe in packets excluding first packet.
  size_t SizeOfSubframe() const;
  void SetSizeOfSubframe(size_t size);
...
#endif  // MODULES_RTP_RTCP_SOURCE_RTP_FRAME_DESCRIPTOR_H_
