...
size_t NetEqFacadeImpl::NumPacketsInBuffer() const {
  return packet_buffer_->NumPacketsInBuffer();
}

void NetEqFacadeImpl::UpdateBufferLevelFilter(size_t buffer_size_samples,
...
int NetEqFacadeImpl::GetFilteredBufferLevel() const {
  return buffer_level_filter_->filtered_current_level();
}

void NetEqFacadeImpl::ReportRelativePacketArrivalDelay(size_t delay_ms) {
