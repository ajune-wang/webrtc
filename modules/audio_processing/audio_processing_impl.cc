...
// TransientSuppressor::VadMode
// AudioProcessingImpl::GetTransientSuppressorVadMode(
//     const AudioProcessing::Config& config,
//     const
//     absl::optional<AudioProcessingImpl::GainController2ExperimentParams>&
//         params) {
...
//       (config.gain_controller2.input_volume_controller.enabled ||
//        config.gain_controller2.adaptive_digital.enabled) &&
//       params.has_value() && params->agc2_config.has_value()) {
//     // When TS is enabled and the experiment parameters succeed to fully
//     switch
//     // the gain control to AGC2, use the RNN VAD to control TS.
//     return TransientSuppressor::VadMode::kRnnVad;
//   }
//   // If TS is disabled, the returned value does not matter. If enabled, use
//   the
//   // default VAD.
