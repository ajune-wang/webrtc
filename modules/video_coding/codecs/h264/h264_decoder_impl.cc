...
int32_t H264DecoderImpl::Decode(const EncodedImage& input_image,
  ...
  int64_t frame_timestamp = input_image.ntp_time_ms_ * 1000;  // ms -> μs
  av_context_->reordered_opaque = frame_timestamp;
  ...
  // the input one.
  RTC_DCHECK_EQ(av_frame_->reordered_opaque, frame_timestamp);
