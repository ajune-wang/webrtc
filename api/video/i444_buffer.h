...
class RTC_EXPORT I444Buffer : public I444BufferInterface {
 public:
  ...
  // Deprecated.
  static rtc::scoped_refptr<I444Buffer> Copy(const VideoFrameBuffer& buffer) {
    return Copy(*buffer.GetI444());
  }
  ...
  // Deprecated.
  static rtc::scoped_refptr<I444Buffer> Rotate(const VideoFrameBuffer& src,
                                               VideoRotation rotation) {
    return Rotate(*src.GetI444(), rotation);
  }

  // Sets the buffer to all black.
  static void SetBlack(I444Buffer* buffer);

  rtc::scoped_refptr<I420BufferInterface> ToI420() final {
    return rtc::scoped_refptr<I420BufferInterface>(nullptr);
  }
