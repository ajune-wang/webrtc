...
class RTC_EXPORT VideoDecoder {
 public:
  ...
  // Prepares decoder to handle incoming encoded frames.
  // Can be called multiple times.
  // Returns 0 or positive number on success, or negative error code on failure.
  // TODO(bugs.webrtc.org/13045): Make pure virtual when implemented by all
  // derived classes.
  virtual int Configure(const Settings& settings);
