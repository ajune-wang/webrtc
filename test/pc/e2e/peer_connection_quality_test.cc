...
void PeerConnectionE2EQualityTest::Run(RunParams run_params) {
  ...
  if (!peer_configurations_[0]->params()->name) {
    peer_configurations_[0]->params()->name = "alice";
  }
  if (!peer_configurations_[1]->params()->name) {
    peer_configurations_[1]->params()->name = "bob";
  }
