...
VideoStreamEncoderResourceManager::VideoStreamEncoderResourceManager(
  ...
  MapResourceToReason(&prevent_adapt_up_in_balanced_resource_,
                      AdaptationObserverInterface::AdaptReason::kQuality);
  MapResourceToReason(&encode_usage_resource_,
...
VideoStreamEncoderResourceManager::GetReasonFromResource(
...
VideoStreamEncoderResourceManager::GetActiveCounts(
    AdaptationObserverInterface::AdaptReason reason) {
  // TODO(https://crbug.com/webrtc/11392) Ideally this should be moved out of
