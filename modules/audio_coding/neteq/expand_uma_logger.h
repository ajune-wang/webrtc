...
// This class is used to periodically log values to a UMA histogram. The callser
...
class ExpandUmaLogger {
 public:
  ...
  // In this call, value should be an incremental sample coutner. The sample
