...
vars = {
  ...
  'chromium_revision': '1a8474b5ec86323acb99ab49eb0f52da21c55acb',
...
deps = {
  ...
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@c2bc89a0053460370596c30701f027983760397c',
  'src/third_party':
