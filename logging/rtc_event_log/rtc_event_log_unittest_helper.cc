...
void RtcEventLogTestHelper::VerifyPlayoutEvent(
  ...
  // Check consistency of the parser.
  ParsedRtcEventLog::AudioPlayoutEvent parsed_event =
      parsed_log.GetAudioPlayout(index);
...
void RtcEventLogTestHelper::VerifyBweLossEvent(
  ...
  EXPECT_EQ(bitrate, bwe_update.new_bitrate);
...
void RtcEventLogTestHelper::VerifyAudioNetworkAdaptation(
  ...
  ParsedRtcEventLog::AudioNetworkAdaptationEvent parsed_event =
