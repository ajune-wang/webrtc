...
TEST(RtpDepacketizerAv1Test, ParseAggregationHeaderContinuationFlagAsNotBOF) {
...
TEST(RtpDepacketizerAv1Test, ParseAggregationHeaderNoContinuationFlagAsBOF) {
...
TEST(RtpDepacketizerAv1Test, ParseAggregationHeaderWillContinueFlagAsNotEOF) {
...
TEST(RtpDepacketizerAv1Test, ParseAggregationHeaderNoWillContinueFlagAsEOF) {
...
TEST(RtpDepacketizerAv1Test, ParseTreatsStartOfFrameAsDeltaFrame) {
