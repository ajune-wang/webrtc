...
// Returns true if the parameters have the same H265 profile/tier or neither
// contains an H265 profile/tier, otherwise false. This is used for SDP
// negotiation where for generating level we honor
RTC_EXPORT bool H265IsSameProfileTier(const CodecParameterMap& params1,
                                      const CodecParameterMap& params2);
