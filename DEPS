...
vars = {
  ...
  'chromium_revision': 'a13aa24b2f33e9042d574bbd4e57e3049c64ec84',
...
deps = {
  ...
  'src/ios': {
    'url': Var('chromium_git') + '/chromium/src/ios' + '@' + '02366ed4caffa1a624a0aca791c36fb56dfe2210',
    'condition': 'checkout_ios',
  },
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '208dc7a33d4dbf9c8fb53a31c339f7c2dacf73ed',
  'src/third_party':
