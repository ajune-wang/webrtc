...
public class CryptoOptions {
  ...
  public class Srtp {
     ...
     */
    public boolean enableGcmCryptoSuites = false;
    /**
     ...
     */
    public boolean enableAes128Sha1_32CryptoCipher = false;
    /**
     * If set to true, encrypted RTP header extensions as defined in RFC 6904
     * will be negotiated. They will only be used if both peers support them.
     */
    public boolean enableEncryptedRtpHeaderExtensions = false;
  ...
  public class SFrame {
     ...
     */
    public boolean requireFrameEncryption = false;
  ...
  public Srtp srtp = new Srtp();
  public SFrame sframe = new SFrame();
