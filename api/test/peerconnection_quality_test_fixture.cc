...
class PeerConnectionE2EQualityTestFixture::PeerParamsPreprocessor::
...
PeerConnectionE2EQualityTestFixture::PeerParamsPreprocessor::
    PeerParamsPreprocessor()
    : peer_names_provider_(
          std::make_unique<DefaultNamesProvider>("peer_", kDefaultNames)) {}
PeerConnectionE2EQualityTestFixture::PeerParamsPreprocessor::
    ~PeerParamsPreprocessor() = default;

void PeerConnectionE2EQualityTestFixture::PeerParamsPreprocessor::
    SetDefaultValuesForMissingParams(PeerConfigurer& peer) {
...
void PeerConnectionE2EQualityTestFixture::PeerParamsPreprocessor::
    ValidateParams(const PeerConfigurer& peer) {
