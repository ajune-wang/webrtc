...
bool BaseChannel::HandlesPayloadType(int packet_type) const {
  auto it = demux_criteria_.payload_types.find(packet_type);
  return it != demux_criteria_.payload_types.end();
}
...
void BaseChannel::UnregisterRtpDemuxerSink() {
  rtp_demuxer_.RemoveSink(this);
}

void BaseChannel::RegisterRtpDemuxerSink() {
