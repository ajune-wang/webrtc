...
TEST(ReConfigChunkTest, FromCapture) {
  ...
  */
  ...
  EXPECT_THAT(req.stream_ids(), ElementsAre(6));
}

TEST(ReConfigChunkTest, SerializeAndDeserialize) {
  Parameters::Builder params_builder =
      Parameters::Builder().Add(OutgoingSSNResetRequestParameter(
          /*request_sequence_number=*/123, /*response_sequence_number=*/456,
          /*sender_last_assigned_tsn=*/789, /*stream_ids=*/{42, 43}));
  ...
  EXPECT_THAT(req.stream_ids(), ElementsAre(42, 43));
