...
TEST(RtpUtilTest, ParseRtpPayloadId) {
  constexpr uint8_t kMinimalisticRtpPacket[] = {0x80, 97,   0,    0,  //
                                                0,    0,    0,    0,  //
                                                0x12, 0x34, 0x56, 0x78};
  EXPECT_EQ(ParseRtpPayloadId(kMinimalisticRtpPacket), 97);

  constexpr uint8_t kMinimalisticRtpPacketWithMarker[] = {
      0x80, 0x80 | 97, 0,    0,  //
      0,    0,         0,    0,  //
      0x12, 0x34,      0x56, 0x78};
  EXPECT_EQ(ParseRtpPayloadId(kMinimalisticRtpPacketWithMarker), 97);
}
