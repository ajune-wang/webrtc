...
#ifndef WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_FRAME_BUFFER_H_
#define WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_FRAME_BUFFER_H_
...
#endif  // WEBRTC_SDK_OBJC_NATIVE_SRC_OBJC_FRAME_BUFFER_H_
