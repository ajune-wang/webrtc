...
TEST(DenormalDisabler, DoNotZeroDenormalsIfDisabled) {
  ...
  ASSERT_TRUE(DivisionIsDenormal(kSmallest, denormal_divisor))
...
TEST(DenormalDisabler, RestoreDenormalsEnabled) {
  ...
  {
    DenormalDisabler denormal_disabler(/*enabled=*/true);
    ASSERT_FALSE(DivisionIsDenormal(kSmallest, denormal_divisor));
  }
  EXPECT_TRUE(DivisionIsDenormal(kSmallest, denormal_divisor));
}
...
TEST(DenormalDisabler, ZeroDenormalsNested) {
  ...
  EXPECT_FALSE(DivisionIsDenormal(kSmallest, denormal_divisor));
}
