...
vars = {
  ...
  'chromium_revision': '474f9a86e04c665e2c827eb681681a65a53ed5d1',
...
deps = {
  ...
  'src/base':
    'https://chromium.googlesource.com/chromium/src/base@47a3c85e77ea6d03a1cd2e9ee3334c7e4db3c502',
  'src/build':
    'https://chromium.googlesource.com/chromium/src/build@007a74bf79d5c749f6c217f743999ffdcea4cbec',
  'src/buildtools':
  ...
  'src/ios': {
    'url': 'https://chromium.googlesource.com/chromium/src/ios@3a95550781672fa9b7bc24005fec2ac81b805665',
    'condition': 'checkout_ios',
  },
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@ae9b3c92193e676bf44ab1e50bcd30638c5b986b',
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@c66d351c7ad12e598bbba4dcd9e893f2af6f277f',

  'src/buildtools/linux64': {
    'packages': [
      {
        'package': 'gn/gn/linux-${{arch}}',
        'version': 'git_revision:e11af6727dd38fdd0e8cbbab2e207c369522ac7a',
      }
    ],
    'dep_type': 'cipd',
  ...
  'src/third_party/libc++abi/src':
    'https://chromium.googlesource.com/external/github.com/llvm/llvm-project/libcxxabi.git@5f2c9767ceaeb8a21e4004890bf2c6b08faa8687',
  'src/third_party/libunwind/src':
    'https://chromium.googlesource.com/external/github.com/llvm/llvm-project/libunwind.git@a16d528d2574381332f73f385f7590c3aa60f74b',
  ...
  'src/third_party/catapult':
    'https://chromium.googlesource.com/catapult.git@a4c29ee6fa7bd290a7d848664dd2666527a8e300',
  ...
  'src/third_party/freetype/src':
    'https://chromium.googlesource.com/chromium/src/third_party/freetype2.git@7ff43d3e9f981991048a459303e431bf0c617a36',
  ...
  'src/third_party/googletest/src':
    'https://chromium.googlesource.com/external/github.com/google/googletest.git@a7f443b80b105f940225332ed3c31f2790092f47',
  'src/third_party/icu': {
 ...
 'src/third_party/jsoncpp/source':
  ...
  'src/third_party/dav1d/libdav1d':
    'https://chromium.googlesource.com/external/github.com/videolan/dav1d.git@315bfac0ce49df422c717754b93f1ebb8f3a7cc7',
  'src/third_party/libaom/source/libaom':
    'https://aomedia.googlesource.com/aom.git@4e1a5d4d08a216d71ecee10c25736abb2ffc2cdc',
  ...
  'src/third_party/perfetto':
    'https://android.googlesource.com/platform/external/perfetto.git@bdd33a29d702d9b2efb2b1c3dea51e61052667dc',
  ...
  'src/third_party/libvpx/source/libvpx':
    'https://chromium.googlesource.com/webm/libvpx.git@25540b3c127f522aae382c79872d9ee03f7307f3',
  ...
  'src/third_party/re2/src':
    'https://chromium.googlesource.com/external/github.com/google/re2.git@8e87559194f84d8a880fcd8a8984174df006fb43',
  ...
  'src/tools':
    'https://chromium.googlesource.com/chromium/src/tools@4fa9036a240e7592cad6ffef4958faa2a6148f04',
    ...
    'packages': [
      {
          ...
          'version': 'bKby92PXHFHhKylwjT-INWPIOSRajUiysMYreQsT0zIC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
      ...
      'packages': [
        {
          ...
          'version': 'git_revision:3c691526411b6ba25a7582ad8aff1f5a8848b7be',
        },
        {
