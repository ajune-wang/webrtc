...
TEST(MessageDigestTest, TestSha2Hmac) {
  ...
  EXPECT_EQ(
      ...
      ComputeHmac(DIGEST_SHA_384, key, input));
  EXPECT_EQ(
      "87aa7cdea5ef619d4ff0b4241a1d6cb0"
      "2379f4e2ce4ec2787ad0b30545e17cde"
      "daa833b7d6b8a702038b274eaea3f4e4"
      "be9d914eeb61f1702e696c203a126854",
      ComputeHmac(DIGEST_SHA_512, key, input));
  ...
  // SHA-384
  EXPECT_EQ(static_cast<size_t>(SHA384_DIGEST_LENGTH),
            ComputeHmac(DIGEST_SHA_384, key.c_str(), key.size(), input.c_str(),
                        input.size(), output, SHA384_DIGEST_LENGTH));
  EXPECT_EQ(
      "afd03944d84895626b0825f4ab46907f"
      "15f9dadbe4101ec682aa034c7cebc59c"
      "faea9ea9076ede7f4af152e8b2fa9cb6",
      hex_encode(absl::string_view(output, SHA384_DIGEST_LENGTH)));

  EXPECT_EQ(0U,
            ComputeHmac(DIGEST_SHA_384, key.c_str(), key.size(), input.c_str(),
                        input.size(), output, SHA384_DIGEST_LENGTH - 1));

  // SHA-512
  EXPECT_EQ(static_cast<size_t>(SHA512_DIGEST_LENGTH),
            ComputeHmac(DIGEST_SHA_512, key.c_str(), key.size(), input.c_str(),
                        input.size(), output, SHA512_DIGEST_LENGTH));
  EXPECT_EQ(
      "87aa7cdea5ef619d4ff0b4241a1d6cb0"
      "2379f4e2ce4ec2787ad0b30545e17cde"
      "daa833b7d6b8a702038b274eaea3f4e4"
      "be9d914eeb61f1702e696c203a126854",
      hex_encode(absl::string_view(output, SHA512_DIGEST_LENGTH)));
  EXPECT_EQ(0U,
            ComputeHmac(DIGEST_SHA_512, key.c_str(), key.size(), input.c_str(),
                        input.size(), output, SHA512_DIGEST_LENGTH - 1));
}
