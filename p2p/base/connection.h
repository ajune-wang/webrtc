...
#include "p2p/base/connection_info_interface.h"
...
class Connection : public ConnectionInfoInterface,
 ...
 public:
  ...
  // Gets the |ConnectionStats| stats, where |best_connection| has not been
