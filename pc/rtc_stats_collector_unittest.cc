...
TEST_F(RTCStatsCollectorTest, CollectRTCInboundRTPStreamStats_Video) {
  ...
  video_media_info.receivers[0].retransmitted_packets_rcvd = 17;
  video_media_info.receivers[0].retransmitted_bytes_rcvd = absl::nullopt;
  ...
  // `expected_video.retransmitted_bytes_received` should be undefined.
