...
void VideoStreamEncoder::OnConstraintsChanged(
  ...
  const bool enabled_by_constraints = constraints.min_fps.value_or(-1) == 0 &&
                                      constraints.max_fps.value_or(-1) > 0;
  zero_hertz_adapter_->SetEnabledByConstraints(enabled_by_constraints);
