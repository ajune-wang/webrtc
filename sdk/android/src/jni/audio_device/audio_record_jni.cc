...
// #include "sdk/android/generated_audio_jni/jni/WebRtcAudioEffects_jni.h"
...
AudioRecordJni::AudioRecordJni(const AudioParameters& audio_parameters)
    : AudioRecordJni(
          audio_parameters,
          0,  // TODO(magjed)
...
AudioRecordJni::AudioRecordJni(const AudioParameters& audio_parameters,
    ...
    : j_audio_record_(AttachCurrentThreadIfNeeded(), j_audio_record),
  ...
  Java_WebRtcAudioRecord_setNativeAudioRecord(AttachCurrentThreadIfNeeded(),
                                              j_audio_record_,
