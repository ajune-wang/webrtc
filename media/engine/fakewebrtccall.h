...
#include "call/test/mock_rtp_send_transport_controller.h"
...
class FakeCall final : public webrtc::Call, public webrtc::PacketReceiver {
 public:
  ...
  webrtc::MockRtpSendTransportController* GetMockSendTransportController() {
    return &send_transport_controller_;
  }
 ...
 private:
  ...
  webrtc::RtpSendTransportControllerInterface* GetSendTransportController()
      override {
    return &send_transport_controller_;
  }
  ...
  testing::NiceMock<webrtc::MockRtpSendTransportController>
      send_transport_controller_;
