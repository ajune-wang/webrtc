...
class ApmDataDumper {
 public:
  ...
  // Default dump set.
  static constexpr size_t kDefaultDumpSet = 1;

  // Specifies what dump set to use. All dump commands with a different dump set
  // than the one specified will be discarded. If not specificed, the
  // `kDefaultDumpSet` will be used.
