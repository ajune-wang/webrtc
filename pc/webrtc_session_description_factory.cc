...
WebRtcSessionDescriptionFactory::WebRtcSessionDescriptionFactory(
  ...
  if (!dtls_enabled) {
    RTC_DLOG(LS_VERBOSE) << "DTLS-SRTP disabled.";
    return;
  }
  ...
  if (certificate) {
    ...
    RTC_DLOG(LS_VERBOSE) << "DTLS-SRTP enabled; has certificate parameter.";
    ...
    case MSG_USE_CONSTRUCTOR_CERTIFICATE: {
      rtc::ScopedRefMessageData<rtc::RTCCertificate>* param =
          static_cast<rtc::ScopedRefMessageData<rtc::RTCCertificate>*>(
              msg->pdata);
      RTC_DLOG(LS_INFO) << "Using certificate supplied to the constructor.";
...
void WebRtcSessionDescriptionFactory::PostCreateSessionDescriptionFailed(
  ...
  RTC_DLOG(LS_ERROR) << "Create SDP failed: " << error;
}
...
void WebRtcSessionDescriptionFactory::OnCertificateRequestFailed() {
  ...
  RTC_DLOG(LS_ERROR) << "Asynchronous certificate generation request failed.";
...
void WebRtcSessionDescriptionFactory::SetCertificate(
  ...
  RTC_DLOG(LS_VERBOSE) << "Setting new certificate.";
