...
vars = {
  ...
  'chromium_revision': 'b73563e62bbb7b311f8801f0d382d1d748432b41',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '2a2b8673df79fb9cc188a02504e699a01a101ed5',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '347ba5638c515962c2264f27709d748d753ac06b',
  'src/tools/gyp':
