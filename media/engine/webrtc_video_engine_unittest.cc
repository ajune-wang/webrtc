...
TEST_F(WebRtcVideoChannelTest,
  ...
  cricket::VideoMediaInfo info;
  ASSERT_TRUE(channel_->GetStats(&info));
  // TODO(https://crbug.com/webrtc/9547): Populate individual outbound-rtp stats
  // objects for each simulcast stream, instead of accumulating all keyframes
  // encoded over all simulcast streams in the same outbound-rtp stats object.
