...
// supported and should take preceedence even though not listed among locally
// supported extensions.
TEST_F(MediaSessionDescriptionFactoryTest,
       TestOfferAnswerWithTransportSequenceNumberInOffer) {
  TestTransportSequenceNumberNegotiation(
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01),   // Locally.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01),   // Offered.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01));  // Expected anser.
}
TEST_F(MediaSessionDescriptionFactoryTest,
       TestOfferAnswerWithTransportSequenceNumber01And02InOffer) {
  TestTransportSequenceNumberNegotiation(
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01),       // Locally.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01And02),  // Offered.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber02));  // Expected anser.
}
TEST_F(MediaSessionDescriptionFactoryTest,
       TestOfferAnswerWithTransportSequenceNumber02InOffer) {
  TestTransportSequenceNumberNegotiation(
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber01),   // Locally.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber02),   // Offered.
      MAKE_VECTOR(kRtpExtensionTransportSequenceNumber02));  // Expected anser.
}
