...
double FramePairCorruptionScorer::CalculateScore(
  ...
  scoped_refptr<I420Buffer> raw_i420_buffer =
      GetAsI420Buffer(raw_frame.ToI420());
  scoped_refptr<I420Buffer> compressed_i420_buffer =
      GetAsI420Buffer(compressed_frame.ToI420());
