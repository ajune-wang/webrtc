...
#include "modules/audio_processing/optionally_built_submodule_creation.h"
...
void AudioProcessingImpl::OverrideSubmoduleCreationForTesting(
  ...
  capture_.submodule_creation_overrides = overrides;
}
  ...
  if (config_.transient_suppression.enabled) {
    ...
    if (!submodules_.transient_suppressor) {
      submodules_.transient_suppressor =
          CreateTransientSuppressor(capture_.submodule_creation_overrides);
    }
    if (submodules_.transient_suppressor) {
