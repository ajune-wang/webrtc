...
void VideoReceiveStream2::Start() {
  ...
  for (const Decoder& decoder : config_.decoders) {
    ...
    // TODO(tommi): Move outside of loop?
    ...
    // TODO(tommi): Is this necessary per decoder?
    ...
    // TODO(tommi): AddReceiveCodec() needs to be called on the network thread.
    // Rather than call this here in a loop
