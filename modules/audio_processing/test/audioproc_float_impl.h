...
// via the `argv` argument. The output file can optionally be specified via the
// `argv` argument. Any audio_processing object specified in the input is used
// for the simulation. Note that when the audio_processing object is specified
// all functionality that relies on using the internal builder is deactivated,
