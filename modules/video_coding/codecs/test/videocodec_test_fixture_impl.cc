...
bool RunEncodeInRealTime(const VideoCodecTestFixtureImpl::TestConfig& config) {
...
std::string FilenameWithParams(
    const VideoCodecTestFixtureImpl::TestConfig& config) {
...
VideoCodecTestStatsImpl VideoCodecTestFixtureImpl::GetStats() {
  return stats_;
}
