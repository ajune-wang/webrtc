...
RtpUtility::Payload* RTPSenderVideo::CreateVideoPayload(
  ...
  if (rtc::ascicmp(payload_name, "VP8")) {
    video_type = kRtpVideoVp8;
  } else if (rtc::ascicmp(payload_name, "VP9")) {
    video_type = kRtpVideoVp9;
  } else if (rtc::ascicmp(payload_name, "H264")) {
    video_type = kRtpVideoH264;
  } else if (rtc::ascicmp(payload_name, "I420")) {
    video_type = kRtpVideoGeneric;
  } else if (rtc::ascicmp(payload_name, "stereo")) {
