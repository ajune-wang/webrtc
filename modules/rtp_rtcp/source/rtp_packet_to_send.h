...
class RtpPacketToSend : public RtpPacket {
 public:
  ...
  // Indicates if packet is using RED encapsulation.
  ...
  // Indicates if packets should be protected by FEC.
  void set_fec_protection(bool protect_packet) {
    fec_protection_ = protect_packet;
  }
  bool fec_protection() const { return fec_protection_; }
