...
NSString *const kRTCFileVideoCapturerErrorDomain = @"org.webrtc.RTC_OBJC_TYPE(RTCFileVideoCapturer)";
...
- (void)publishSampleBuffer:(CMSampleBufferRef)sampleBuffer {
  ...
  dispatch_source_set_event_handler(timer, ^{
    ...
    RTC_OBJC_TYPE(RTCVideoFrame) *videoFrame =
        [[RTC_OBJC_TYPE(RTCVideoFrame) alloc] initWithBuffer:rtcPixelBuffer rotation:0 timeStampNs:timeStampNs];
    CFRelease(sampleBuffer);
