...
vars = {
  ...
  'chromium_revision': 'a09615be2b58d4b1a0fe1f4c6eabb782ea640b3d',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '568288456edd3e001622f67ef78646fcdad7c927',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '347e813e810f537a32323e8827942e2e01cd51d5',
  'src/tools/gyp':
