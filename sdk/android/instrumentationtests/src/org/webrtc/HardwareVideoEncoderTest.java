...
public class HardwareVideoEncoderTest {
  ...
  public void testInitialize() {
    ...
    final VideoEncoder.Settings invalidResolutionSettings =
        new VideoEncoder.Settings(SETTINGS.numberOfCores /* core */, SETTINGS.width / 4 /* width */,
            SETTINGS.height / 4 /* height */, SETTINGS.startBitrate /* kbps */,
            SETTINGS.maxFramerate, SETTINGS.numberOfSimulcastStreams /* numberOfSimulcastStreams */,
            SETTINGS.automaticResizeOn /* automaticResizeOn */,
            SETTINGS.capabilities /* capabilities= */);
    encoder = createEncoder();
    assertEquals(VideoCodecStatus.ERR_SIZE, encoder.initEncode(invalidResolutionSettings, null));
    assertEquals(VideoCodecStatus.OK, encoder.release());
  }
