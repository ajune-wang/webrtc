#ifndef NET_DCSCTP_RX_RX_ACK_BUFFER_H_
#define NET_DCSCTP_RX_RX_ACK_BUFFER_H_
...
class DataTracker {
 public:
  ...
  void Observe(TSN tsn, AnyDataChunk::ImmediateAckFlag immediate_ack);
 ...
 private:
  ...
  std::set<UnwrappedTSN> gaps_;
  std::set<UnwrappedTSN> duplicates_;
};
}  // namespace dcsctp

#endif  // NET_DCSCTP_RX_RX_ACK_BUFFER_H_
