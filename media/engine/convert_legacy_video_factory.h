...
#ifndef WEBRTC_MEDIA_ENGINE_CONVERT_LEGACY_VIDEO_FACTORY_H_
#define WEBRTC_MEDIA_ENGINE_CONVERT_LEGACY_VIDEO_FACTORY_H_
...
#endif  // WEBRTC_MEDIA_ENGINE_CONVERT_LEGACY_VIDEO_FACTORY_H_
