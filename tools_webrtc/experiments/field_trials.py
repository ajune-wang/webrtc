...
def registry_header(field_trials: Set[FieldTrial] = None) -> str:
  ...
  >>> print(registry_header({FieldTrial('Duplicate'), FieldTrial('Duplicate')}))
  // This file is automatically generated. Do not edit.
  <BLANKLINE>
  #ifndef GEN_FIELD_TRIALS_REGISTRY_H_
  #define GEN_FIELD_TRIALS_REGISTRY_H_
  <BLANKLINE>
  ...
  <BLANKLINE>
  #endif  // GEN_FIELD_TRIALS_REGISTRY_H_
  <BLANKLINE>
  """
  if not field_trials:
    field_trials = REGISTERED_FIELD_TRIALS
  registered_keys = [f.key for f in field_trials]
  test_keys = ['TestKey-A', 'TestKey-B', 'TestKey-C']
  keys = '\n'.join(f'    "{k}",'
                   for k in sorted([*registered_keys, *test_keys]))
