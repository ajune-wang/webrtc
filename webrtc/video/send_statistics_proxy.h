...
class SendStatisticsProxy : public CpuOveruseMetricsObserver,
 ...
 private:
  ...
  rtc::RateTracker media_byte_rate_tracker_ GUARDED_BY(crit_);
  rtc::RateTracker encoded_frame_rate_tracker_ GUARDED_BY(crit_);
  ...
  struct UmaSamplesContainer {
    ...
    void RemoveOld(int64_t now_ms, EncodedFrameMap* encoded_frames);
