...
#define TRACE_EVENT_COPY_INSTANT1(category, name, arg1_name, arg1_val) RTC_NOOP()
#define TRACE_EVENT_COPY_INSTANT2(category, name, arg1_name, arg1_val, \
        arg2_name, arg2_val) RTC_NOOP()
...
// The purpose of this struct is to swallow macro arguments that might
// be the sole use of a function. If the argument is completely removed
// then the code will fail to compile with -Wunused-functions. This avoids that.
struct RtcTraveEventNoopStream {};

inline RtcTraveEventNoopStream&
operator<< (RtcTraveEventNoopStream& s, const char* c) {
  return s;
}
inline RtcTraveEventNoopStream&
operator<< (RtcTraveEventNoopStream& s, const int c) {
  return s;
}
...
#define TRACE_EVENT_ASYNC_STEP1(category, name, id, step, \
    ...
    while (0) { \
      [&](){ \
        RtcTraveEventNoopStream noop; \
        noop << category << name << id << step << arg1_name << arg1_val; \
      }(); \
    }
...
#define TRACE_EVENT_ASYNC_END1(category, name, id, arg1_name, arg1_val) RTC_NOOP()
#define TRACE_EVENT_ASYNC_END2(category, name, id, arg1_name, arg1_val, \
        arg2_name, arg2_val) RTC_NOOP()
...
#define TRACE_EVENT_FLOW_END1(category, name, id, arg1_name, arg1_val) RTC_NOOP()
#define TRACE_EVENT_FLOW_END2(category, name, id, arg1_name, arg1_val, \
        arg2_name, arg2_val) RTC_NOOP()
