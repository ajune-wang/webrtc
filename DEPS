...
vars = {
  ...
  'chromium_revision': 'c256b85606bf30beee3e7a00fac38ed7739d9f11',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '749dd925e1f766fbe5750a73c0ecb452531107a6',
}
deps = {
  ...
  'src/testing':
    Var('chromium_git') + '/chromium/src/testing' + '@' + '3f1d2cc6a4167b953de75a0a4d51b482ec47e20b',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'fb1223de5cea59f12bdff883d36a066505c24f2c',
  'src/tools/gyp':
