...
TEST(SourceTrackerTest, OnFrameDeliveredRecordsSources) {
  ...
  RtpSource::Extensions extensions = {kAudioLevel, kAbsoluteCaptureTime};
...
TEST(SourceTrackerTest, OnFrameDeliveredUpdatesSources) {
  ...
  RtpSource::Extensions extensions0 = {kAudioLevel0, kAbsoluteCaptureTime0};
  RtpSource::Extensions extensions1 = {kAudioLevel1, kAbsoluteCaptureTime1};
