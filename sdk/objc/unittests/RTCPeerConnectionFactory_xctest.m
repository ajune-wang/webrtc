...
- (void)testDataChannelLifetime {
  @autoreleasepool {
    ...
    RTC_OBJC_TYPE(RTCMediaConstraints) *constraints =
        [[RTC_OBJC_TYPE(RTCMediaConstraints) alloc] initWithMandatoryConstraints:@{} optionalConstraints:nil];
    RTC_OBJC_TYPE(RTCDataChannelConfiguration) *dataChannelConfig = [[RTC_OBJC_TYPE(RTCDataChannelConfiguration) alloc] init];
...
- (void)testRTCRtpTransceiverLifetime {
  @autoreleasepool {
    ...
    RTC_OBJC_TYPE(RTCMediaConstraints) *contraints =
        [[RTC_OBJC_TYPE(RTCMediaConstraints) alloc] initWithMandatoryConstraints:@{} optionalConstraints:nil];
    RTC_OBJC_TYPE(RTCRtpTransceiverInit) *init = [[RTC_OBJC_TYPE(RTCRtpTransceiverInit) alloc] init];
