...
TEST_F(RTCStatsCollectorTest, CachedStatsReports) {
  ...
  fake_clock_.AdvanceTime(TimeDelta::Milliseconds(51));
...
TEST_P(RTCStatsCollectorTestWithParamKind,
  ...
  // to match.
  fake_clock_.SetTime(Timestamp::Microseconds(kReportBlockTimestampUtcUs));
...
TEST_P(RTCStatsCollectorTestWithParamKind,
  ...
  fake_clock_.AdvanceTime(TimeDelta::Microseconds(1234));
