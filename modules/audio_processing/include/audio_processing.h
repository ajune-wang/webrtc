...
// Enables refined linear filter adaptation in the non-mobile echo canceller.
...
// on reported system delays. This configuration does not apply to the mobile
// AEC mode. It can be set in the constructor or using
 ...
 public:
  ...
  struct Config {
    ...
    struct EchoCanceller {
      bool enabled = false;
      // The acoustic echo control for mobile (AECM) is a low complexity robust
      // option intended for use on mobile devices.
