...
class RtpBitrateConfigurator {
 public:
  ...
  // Apply a cap for relayed calls; absl::nullopt to clear existing cap.
  absl::optional<BitrateConstraints> UpdateWithRelayCap(
 ...
 private:
  ...
  absl::optional<DataRate> max_bitrate_over_relay_;
