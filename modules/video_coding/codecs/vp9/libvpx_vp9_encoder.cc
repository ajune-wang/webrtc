...
rtc::scoped_refptr<VideoFrameBuffer> LibvpxVp9Encoder::PrepareBufferForProfile0(
  ...
  if (!mapped_buffer ||
    ...
    return PrepareBufferForProfile0(i420_frame);
  }
  ...
  switch (mapped_buffer->type()) {
    ...
    case VideoFrameBuffer::Type::kI420A: {
      ...
      // On some I420 implementations (e.g. AugmentedVideoFrameBuffer),
      // GetI420() returns null even in cases where its type() is kI420. Such
      // implementations need to either implement the interfaces of its
      // announced type or report kNative instead. Until this is fixed, we have
      // to call ToI420() instead of GetI420() here.
