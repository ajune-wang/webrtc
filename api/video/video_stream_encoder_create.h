...
#ifndef WEBRTC_API_VIDEO_VIDEO_STREAM_ENCODER_CREATE_H_
#define WEBRTC_API_VIDEO_VIDEO_STREAM_ENCODER_CREATE_H_
...
#endif  // WEBRTC_API_VIDEO_VIDEO_STREAM_ENCODER_CREATE_H_
