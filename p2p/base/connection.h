...
class Connection : public ConnectionInterface,
 ...
 public:
  ...
  PortInterface* PortForTest() override { return port_; }
  const PortInterface* PortForTest() const override { return port_; }
 ...
 protected:
  ...
  Connection(PortInterface* port, size_t index, const Candidate& candidate);
  ...
  PortInterface* port() override { return port_; }
  const PortInterface* port() const override { return port_; }
...
class ProxyConnection : public Connection {
 public:
  ProxyConnection(PortInterface* port, size_t index, const Candidate& remote_candidate);
