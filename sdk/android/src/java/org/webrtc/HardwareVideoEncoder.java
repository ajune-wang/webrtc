...
class HardwareVideoEncoder implements VideoEncoder {
  ...
  private VideoCodecStatus initEncodeInternal() {
    ...
    try {
      ...
      format.setFloat(MediaFormat.KEY_FRAME_RATE, bitrateAdjuster.getAdjustedFramerateFps());
  ...
  @Override
  public VideoCodecStatus setRates(RateControlParameters rateControlParameters) {
    encodeThreadChecker.checkIsOnValidThread();
    bitrateAdjuster.setTargets(
        rateControlParameters.bitrate.getSum(), rateControlParameters.framerateFps);
    return VideoCodecStatus.OK;
  }
