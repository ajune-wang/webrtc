...
class SdpOfferAnswerTestAudioFirst : public SdpOfferAnswerTest,
                                     public testing::WithParamInterface<bool> {
 public:
  SdpOfferAnswerTestAudioFirst() : SdpOfferAnswerTest() {}
};

TEST_P(SdpOfferAnswerTestAudioFirst,
...
INSTANTIATE_TEST_SUITE_P(SdpOfferAnswerTestAudioFirst,
                         SdpOfferAnswerTestAudioFirst,
