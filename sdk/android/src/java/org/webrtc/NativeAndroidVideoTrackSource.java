...
class NativeAndroidVideoTrackSource {
  ...
  /**
   * Set the state for the native MediaSourceInterface. Maps the boolean to the either
   ...
   * the requested fps.
   */
  public void adaptOutputFormat(@Nullable VideoSource.AspectRatio targetLandscapeAspectRatio,
      @Nullable Integer maxLandscapePixelCount,
      @Nullable VideoSource.AspectRatio targetPortraitAspectRatio,
      @Nullable Integer maxPortraitPixelCount, @Nullable Integer maxFps) {
    nativeAdaptOutputFormat(nativeAndroidVideoTrackSource,
        targetLandscapeAspectRatio == null ? 0 : targetLandscapeAspectRatio.width,
        targetLandscapeAspectRatio == null ? 0 : targetLandscapeAspectRatio.height,
        maxLandscapePixelCount,
        targetPortraitAspectRatio == null ? 0 : targetPortraitAspectRatio.width,
        targetPortraitAspectRatio == null ? 0 : targetPortraitAspectRatio.height,
        maxPortraitPixelCount, maxFps);
  }
