...
vars = {
  ...
  'chromium_revision': 'fdada01a75db65126449561b8b7b62adb902efe8',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '80cded60df97b309d5285f88a4e7d1074686c101',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '7e8e2499ae95bcce8e50aeb4106b280e0281ef57',
  'src/tools/gyp':
