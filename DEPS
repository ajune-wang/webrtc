...
vars = {
  ...
  'chromium_revision': '5712cb881b2a480a02f3ee1e6f74f9b5dc6dc21b',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '873794e1a2bd3eb6990252b7fcb2774370ebe11d',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '5e297279f939fb378a4f9bfa5e4098ac912d129d',
  'src/tools/gyp':
