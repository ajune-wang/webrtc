  ...
  if (config_change_counter_ > 0) {
    if (--config_change_counter_ > 0) {
      ...
      current_config_.leakage_converged =
          one_minus_change_factory * target_config_.leakage_converged +
          change_factor * last_config_.leakage_converged;
      current_config_.leakage_diverged =
          one_minus_change_factory * target_config_.leakage_diverged +
          change_factor * last_config_.leakage_diverged;
      current_config_.error_floor =
          one_minus_change_factory * target_config_.error_floor +
