...
class OpusTest
    : public TestWithParam<::testing::tuple<int, int, bool, int, int>> {
 protected:
  OpusTest();
  ...
  const int decoder_sample_rate_hz_;
};
...
OpusTest::OpusTest()
    : opus_encoder_(NULL),
      ...
      decoder_sample_rate_hz_(::testing::get<4>(GetParam())) {}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    OpusTest,
    ::testing::ValuesIn({
        // Non-multistream: Try all combinations.
        std::make_tuple(1, 0, false, 16000, 16000),
        std::make_tuple(1, 1, false, 16000, 16000),
        std::make_tuple(2, 0, false, 16000, 16000),
        std::make_tuple(2, 1, false, 16000, 16000),
        std::make_tuple(1, 0, false, 48000, 16000),
        std::make_tuple(1, 1, false, 48000, 16000),
        std::make_tuple(2, 0, false, 48000, 16000),
        std::make_tuple(2, 1, false, 48000, 16000),
        std::make_tuple(1, 0, false, 16000, 48000),
        std::make_tuple(1, 1, false, 16000, 48000),
        std::make_tuple(2, 0, false, 16000, 48000),
        std::make_tuple(2, 1, false, 16000, 48000),
        std::make_tuple(1, 0, false, 48000, 48000),
        std::make_tuple(1, 1, false, 48000, 48000),
        std::make_tuple(2, 0, false, 48000, 48000),
        std::make_tuple(2, 1, false, 48000, 48000),

        // Multistream: Some representative cases (only 48 kHz for now).
        std::make_tuple(1, 0, true, 48000, 48000),
