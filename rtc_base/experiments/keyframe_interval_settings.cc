...
KeyframeIntervalSettings::KeyframeIntervalSettings(
    ...
    : min_keyframe_request_interval_ms_("min_keyframe_request_interval_ms"),
      max_wait_for_keyframe_ms_("max_wait_for_keyframe_ms"),
      max_wait_for_frame_ms_("max_wait_for_frame_ms") {
  ParseFieldTrial({&min_keyframe_request_interval_ms_,
                   &max_wait_for_keyframe_ms_, &max_wait_for_frame_ms_},
...
absl::optional<int> KeyframeIntervalSettings::MinKeyFrameRequestIntervalMs()
    const {
  return min_keyframe_request_interval_ms_.GetOptional();
}
