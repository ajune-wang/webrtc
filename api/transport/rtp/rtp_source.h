...
class RtpSource {
 public:
  ...
  // TODO(webrtc:10739): Remove this constructor once all clients migrate to
  // the version with absolute capture time.
  ...
  RtpSource(int64_t timestamp_ms,
      ...
      : timestamp_ms_(timestamp_ms),
        ...
        audio_level_(extensions.audio_level),
        absolute_capture_time_(extensions.absolute_capture_time),
