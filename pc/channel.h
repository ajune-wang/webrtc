...
class BaseChannel : public ChannelInterface,
 ...
 protected:
  ...
  virtual void UpdateMediaSendRecvState_w(bool enabled) RTC_RUN_ON(worker_thread()) = 0;
 ...
 private:
  ...
  // network thread.
  webrtc::RtpTransceiverDirection local_content_direction_ RTC_GUARDED_BY(worker_thread()) =
      webrtc::RtpTransceiverDirection::kInactive;
  webrtc::RtpTransceiverDirection remote_content_direction_ RTC_GUARDED_BY(worker_thread()) =
      webrtc::RtpTransceiverDirection::kInactive;
...
class VoiceChannel : public BaseChannel {
 ...
 private:
  ...
  void UpdateMediaSendRecvState_w(bool enabled) override;
