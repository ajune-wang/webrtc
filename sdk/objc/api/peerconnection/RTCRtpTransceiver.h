...
/** The RTC_OBJC_TYPE(RTCRtpTransceiver) maps to the RTC_OBJC_TYPE(RTCRtpTransceiver) defined by the WebRTC
 *  specification. A transceiver represents a combination of an RTC_OBJC_TYPE(RTCRtpSender)
 ...
 */
RTC_OBJC_EXPORT
@protocol RTC_OBJC_TYPE(RTCRtpTransceiver) <NSObject>
