...
class RtpObjectManager : public RtpSenderBase::SetStreamsObserver,
 ...
 public:
  RtpObjectManager(std::function<bool()> is_unified_plan,
  ...
  // Returns the list of senders currently associated with a transceiver
