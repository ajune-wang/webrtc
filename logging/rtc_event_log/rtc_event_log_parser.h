...
class ParsedRtcEventLog {
 ...
 private:
  ...
  std::vector<LoggedGenericPacketReceived> generic_packets_received;
  std::vector<LoggedGenericPacketSent> generic_packets_sent;
  std::vector<LoggedGenericAckReceived> generic_acks_received;
