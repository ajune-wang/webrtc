...
#ifndef WEBRTC_SDK_ANDROID_SRC_JNI_PC_STATSOBSERVER_H_
#define WEBRTC_SDK_ANDROID_SRC_JNI_PC_STATSOBSERVER_H_
...
#endif  // WEBRTC_SDK_ANDROID_SRC_JNI_PC_STATSOBSERVER_H_
