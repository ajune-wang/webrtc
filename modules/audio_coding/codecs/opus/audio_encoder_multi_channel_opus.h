...
#ifndef MODULES_AUDIO_CODING_CODECS_OPUS_AUDIO_ENCODER_MULTI_CHANNEL_OPUS_H_
#define MODULES_AUDIO_CODING_CODECS_OPUS_AUDIO_ENCODER_MULTI_CHANNEL_OPUS_H_
...
class AudioEncoderMultiChannelOpusImpl final : public AudioEncoder {
 public:
  ...
  // Do we need both c-tors?
  // Yes, but one of them can be private.

  // AudioEncoderMultiChannelOpusImpl(int payload_type, const SdpAudioFormat&
  // format);
  AudioEncoderMultiChannelOpusImpl(const AudioEncoderOpusConfig& config,
                                   int payload_type);
  ...
  // Not supported. Check if I need to override them...
 ...
 private:
  ...
  // const float min_packet_loss_rate_;
  // const std::unique_ptr<NewPacketLossRateOptimizer>
  // new_packet_loss_optimizer_;
...
#endif  // MODULES_AUDIO_CODING_CODECS_OPUS_AUDIO_ENCODER_MULTI_CHANNEL_OPUS_H_
