...
class ResourceAdaptationProcessor : public ResourceAdaptationProcessorInterface,
 ...
 private:
  // Poo poo :(
  bool HasInsufficientInput() const;
...
class VideoStreamEncoderResourceManager
 ...
 public:
  ...
  const Resource& ResourceWithQuality(
 ...
 private:
  ...
  class BitrateConstraintPreventiveResource : public Resource {
   public:
    BitrateConstraintPreventiveResource(
        VideoStreamEncoderResourceManager* manager);

    std::string name() const override {
      return "BitrateConstraintPreventiveResource";
    }

    bool CanApplyAdaptation(const VideoSourceRestrictions& restrictions_before,
                            const VideoSourceRestrictions& restrictions_after,
                            const Resource* reason_resource) const override;

   private:
    VideoStreamEncoderResourceManager* manager_;
  } bitrate_constraint_resource_;
