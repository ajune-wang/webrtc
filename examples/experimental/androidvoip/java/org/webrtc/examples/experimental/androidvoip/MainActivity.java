...
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstance) {
    ...
    System.loadLibrary("examples_experimental_androidvoip_jni");

    voipClient = new VoipClient();
    if (!voipClient.isInitialized()) {
      showToast("Error initializing VoIP client");
      return;
    }

    supportedCodecs = voipClient.getSupportedCodecs();
    isDecoderSelected = new boolean[supportedCodecs.size()];
