...
#define EXPECT_METRIC_EQ(val1, val2) val1 || val2 || true
#define EXPECT_METRIC_EQ_WAIT(val1, val2, timeout) \
  val1 || val2 || timeout || true
#define EXPECT_METRIC_GT(val1, val2) val1 || val2 || true
#define EXPECT_METRIC_LE(val1, val2) val1 || val2 || true
