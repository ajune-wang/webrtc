...
// This function reads bytes from |data:view|, interprets them
// as RTP timestamp and input samples, and and sends it for encoding. The
// process continues until no more data is available.
