...
vars = {
  ...
  'chromium_revision': 'd717ddc6ccbabee51b559d0cceaa9f39d2bf78ee',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '498d31f7080fa1e6a505d3ce15171a00fd3e0159',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '749e8656f45a134d163fc524c063b5a2b3a989fe',
  'src/tools/gyp':
