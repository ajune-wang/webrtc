...
// This class represents all color information that can be specified according
// to H264. See T-REC-H.264 E.2.1, "VUI parameters semantics", available from
// https://www.itu.int/rec/T-REC-H.264.
//
// Regarding WebRTC's other supported codecs:
...
class ColorSpace {
 public:
  enum class PrimaryID : uint8_t {
    // The indices are equal to the values specified in T-REC-H.264 Table E-3.
    kInvalid = 0,
    kBT709 = 1,
    kUNSPECIFIED = 2,
    kBT470M = 4,
  ...
  enum class TransferID : uint8_t {
    // The indices are equal to the values specified in T-REC-H.264 Table E-4.
    kInvalid = 0,
    kBT709 = 1,
    kUNSPECIFIED = 2,
    kGAMMA22 = 4,
  ...
  enum class MatrixID : uint8_t {
    // The indices are equal to the values specified in T-REC-H.264 Table E-5.
    kRGB = 0,
    kBT709 = 1,
    kUNSPECIFIED = 2,
    kFCC = 4,
