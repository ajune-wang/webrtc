...
class AecState {
 public:
  ...
  // Returns the refined delay estimate based on the linear filter.
  rtc::Optional<int> RefinedDelay() const { return refined_delay_; }
