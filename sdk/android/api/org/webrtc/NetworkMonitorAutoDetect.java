...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
  ...
  static class ConnectivityManagerDelegate {
    ...
    /** field trials */
    @VisibleForTesting() private final boolean getAllNetworksFromCache;
    @VisibleForTesting() private final boolean requestVPN;
    @VisibleForTesting() private final boolean includeOtherUidNetworks;
    ...
    NetworkRequest createNetworkRequest() {
      ...
      if ((Build.VERSION.SDK_INT >= 31) && includeOtherUidNetworks) {
