...
// Generate suggested higher and lower frame rates and resolutions. These are
// used in "maintain-resolution" and "maintain-framerate". The "balanced"
// degradation preference also makes use of BalancedDegradationPreference when
// generating suggestions. The VideoSourceRestrictor decidedes whether or not a
// proposed adaptation is valid.
