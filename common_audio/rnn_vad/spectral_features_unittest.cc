...
using rnn_vad::kFftLenght20ms48kHz;
using rnn_vad::kFftNumCoeffs20ms48kHz;
...
using rnn_vad::kSampleRate48kHz;
...
TEST(RnnVadTest, DISABLED_ComputeSpectralCoeffcientsWithinTolerance) {
  ...
  SequenceBuffer<float, kBufSize24kHz, kFrameSize10ms24kHz> seq_buf;
