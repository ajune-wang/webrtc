...
TEST(MutexTest, ProtectsSharedResource_Mutex_RawMutexLocker) {
...
TEST(MutexTest, ProtectsSharedResource_Mutex_RawMutexTryLocker) {
  std::vector<std::unique_ptr<Thread>> threads;
...
TEST(MutexTest, ProtectsSharedResource_GlobalMutex_RawMutexLocker) {
  std::vector<std::unique_ptr<Thread>> threads;
