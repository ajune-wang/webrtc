...
TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_EmptyList) {
  ...
  EXPECT_TRUE(ValidateRtpExtensions(extensions, absl::nullopt));
}
...
TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_OutOfRangeId_Low) {
  ...
  EXPECT_FALSE(ValidateRtpExtensions(extensions, absl::nullopt));
}
...
TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_EmptyToEmpty) {
  std::vector<RtpExtension> extensions;
  EXPECT_TRUE(ValidateRtpExtensions(extensions, extensions));
}

TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_NoChange) {
  std::vector<RtpExtension> extensions = MakeUniqueExtensions();
  EXPECT_TRUE(ValidateRtpExtensions(extensions, extensions));
}

TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_ChangeIdNotUrl) {
...
TEST(WebRtcMediaEngineTest, ValidateRtpExtensions_ChangeIdForUrl) {
  std::vector<RtpExtension> old_extensions = MakeUniqueExtensions();
  std::vector<RtpExtension> new_extensions = old_extensions;
