...
RTCCertificateStats::RTCCertificateStats(const std::string& id,
                                         Timestamp timestamp)
    : RTCCertificateStats(std::string(id), timestamp) {}
...
RTCCodecStats::RTCCodecStats(const std::string& id, Timestamp timestamp)
    : RTCCodecStats(std::string(id), timestamp) {}
...
RTCDataChannelStats::RTCDataChannelStats(const std::string& id,
                                         Timestamp timestamp)
    : RTCDataChannelStats(std::string(id), timestamp) {}
...
RTCIceCandidatePairStats::RTCIceCandidatePairStats(const std::string& id,
                                                   Timestamp timestamp)
    : RTCIceCandidatePairStats(std::string(id), timestamp) {}
...
RTCIceCandidateStats::RTCIceCandidateStats(const std::string& id,
                                           Timestamp timestamp,
                                           bool is_remote)
    : RTCIceCandidateStats(std::string(id), timestamp, is_remote) {}
...
RTCLocalIceCandidateStats::RTCLocalIceCandidateStats(const std::string& id,
                                                     Timestamp timestamp)
    : RTCIceCandidateStats(id, timestamp, false) {}
...
RTCRemoteIceCandidateStats::RTCRemoteIceCandidateStats(const std::string& id,
                                                       Timestamp timestamp)
    : RTCIceCandidateStats(id, timestamp, true) {}
...
DEPRECATED_RTCMediaStreamStats::DEPRECATED_RTCMediaStreamStats(
    const std::string& id,
    Timestamp timestamp)
    : DEPRECATED_RTCMediaStreamStats(std::string(id), timestamp) {}
...
DEPRECATED_RTCMediaStreamTrackStats::DEPRECATED_RTCMediaStreamTrackStats(
    ...
    Timestamp timestamp,
    const char* kind)
    : DEPRECATED_RTCMediaStreamTrackStats(std::string(id), timestamp, kind) {}
...
RTCRTPStreamStats::RTCRTPStreamStats(const std::string& id, Timestamp timestamp)
    : RTCRTPStreamStats(std::string(id), timestamp) {}
...
RTCReceivedRtpStreamStats::RTCReceivedRtpStreamStats(const std::string&& id,
                                                     Timestamp timestamp)
    : RTCReceivedRtpStreamStats(std::string(id), timestamp) {}
...
RTCSentRtpStreamStats::RTCSentRtpStreamStats(const std::string&& id,
                                             Timestamp timestamp)
    : RTCSentRtpStreamStats(std::string(id), timestamp) {}
...
RTCInboundRTPStreamStats::RTCInboundRTPStreamStats(const std::string& id,
                                                   Timestamp timestamp)
    : RTCInboundRTPStreamStats(std::string(id), timestamp) {}
...
RTCOutboundRTPStreamStats::RTCOutboundRTPStreamStats(const std::string& id,
                                                     Timestamp timestamp)
    : RTCOutboundRTPStreamStats(std::string(id), timestamp) {}
...
RTCRemoteInboundRtpStreamStats::RTCRemoteInboundRtpStreamStats(
    const std::string& id,
    Timestamp timestamp)
    : RTCRemoteInboundRtpStreamStats(std::string(id), timestamp) {}
...
RTCRemoteOutboundRtpStreamStats::RTCRemoteOutboundRtpStreamStats(
    const std::string& id,
    Timestamp timestamp)
    : RTCRemoteOutboundRtpStreamStats(std::string(id), timestamp) {}
...
RTCMediaSourceStats::RTCMediaSourceStats(const std::string& id,
                                         Timestamp timestamp)
    : RTCMediaSourceStats(std::string(id), timestamp) {}
...
RTCAudioSourceStats::RTCAudioSourceStats(const std::string& id,
                                         Timestamp timestamp)
    : RTCAudioSourceStats(std::string(id), timestamp) {}
...
RTCVideoSourceStats::RTCVideoSourceStats(const std::string& id,
                                         Timestamp timestamp)
    : RTCVideoSourceStats(std::string(id), timestamp) {}
...
RTCTransportStats::RTCTransportStats(const std::string& id, Timestamp timestamp)
    : RTCTransportStats(std::string(id), timestamp) {}
