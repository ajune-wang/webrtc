...
int AudioProcessingImpl::ProcessCaptureStreamLocked() {
  ...
  // Optionally temporarily set the output to zero after the stream has been
  // unmuted (capture output is again used). The purpose of this is to avoid
  // clicks in the audio when the processing again is reactivated after
  // unmuting.
