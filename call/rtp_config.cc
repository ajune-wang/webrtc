...
std::string NackConfig::ToString() const {
  return rtc::SlowStrCat("{rtp_history_ms: ", rtp_history_ms, "}");
}

std::string UlpfecConfig::ToString() const {
  return rtc::SlowStrCat("{ulpfec_payload_type: ", ulpfec_payload_type,
                         ", red_payload_type: ", red_payload_type,
                         ", red_rtx_payload_type: ", red_rtx_payload_type, "}");
}
