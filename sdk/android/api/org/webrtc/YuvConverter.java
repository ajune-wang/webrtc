...
public class YuvConverter {
  ...
  public I420Buffer convert(TextureBuffer textureBuffer) {
    ...
    final int frameWidth = textureBuffer.getWidth();
    final int frameHeight = textureBuffer.getHeight();

    // We need a stride that is divisible by 8, see comment below for details about layout.
    ...
    VideoFrameDrawer.drawTexture(drawer, textureBuffer, renderMatrix, frameWidth, frameHeight,
        /*viewportX*/ 0, /*viewportY*/ 0, /*viewportWidth*/ textureBuffer.getWidth(),
        /*viewportHeight*/ frameHeight);

    // Draw U.
    shaderCallbacks.setPlaneU();
    VideoFrameDrawer.drawTexture(drawer, textureBuffer, renderMatrix, frameWidth, frameHeight,
        /*viewportX*/ 0, /*viewportY*/ frameHeight, /*viewportWidth*/ textureBuffer.getWidth() / 2,
        /*viewportHeight*/ uvHeight);

    // Draw V.
    shaderCallbacks.setPlaneV();
    VideoFrameDrawer.drawTexture(drawer, textureBuffer, renderMatrix, frameWidth, frameHeight,
        /*viewportX*/ textureBuffer.getWidth() / 2, /*viewportY*/ frameHeight,
        /*viewportWidth*/ textureBuffer.getWidth() / 2,
        /*viewportHeight*/ uvHeight);
