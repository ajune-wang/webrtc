...
@interface RTC_OBJC_TYPE(RTCEAGLVideoView) () <GLKViewDelegate>
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder shader:(id<RTC_OBJC_TYPE(RTCVideoViewShading)>)shader {
