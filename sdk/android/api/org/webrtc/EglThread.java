...
public class EglThread implements RenderSynchronizer.Listener {
  ...
  public interface ReleaseMonitor {
    ...
    public interface RenderUpdate {
        ...
        /**
         * Called by EglThread when the rendering window is open. `runsInline` is true when the
         * update is executed directly while the client schedules the update.
         */
    ...
    public static EglThread create(
            ...
            final int[] configAttributes) {
        return create(
                releaseMonitor, sharedContext, configAttributes, /* renderSynchronizer= */ null);
  }
