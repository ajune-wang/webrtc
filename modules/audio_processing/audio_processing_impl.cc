...
int AudioProcessingImpl::ProcessCaptureStreamLocked() {
  ...
  if (capture_.applied_input_volume != kUnspecifiedInputVolume) {
  ...
  if (capture_.capture_output_used) {
    ...
    if (submodules_.gain_controller2) {
      submodules_.gain_controller2->NotifyAppliedInputVolume(
          capture_.applied_input_volume);
    ...
    if (capture_.recommended_input_volume.has_value()) {
      data_dumper_->DumpRaw("recommended_input_volume", 1,
...
void AudioProcessingImpl::set_stream_analog_level(int level) {
  ...
  capture_.applied_input_volume_changed =
      ...
      capture_.applied_input_volume != kUnspecifiedInputVolume;
  capture_.applied_input_volume = level;
...
AudioProcessingImpl::ApmCaptureState::ApmCaptureState()
    : was_stream_delay_set(false),
      ...
      applied_input_volume(kUnspecifiedInputVolume),
