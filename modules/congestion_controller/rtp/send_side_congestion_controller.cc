 ...
 public:
  ...
  bool Run() override {
    ...
    rtc::TaskQueue::Current()->PostDelayedTask(rtc::WrapUnique(this),
                                               period_ms_);
    // Returning false to tell TaskQueue to release this pointer rather than
    // desctructing this object..
    return false;
  }
...
void SendSideCongestionController::StartProcessPeriodicTasks() {
  task_queue_->PostTask(NewPeriodicTask(
      rtc::Bind(&SendSideCongestionController::UpdateControllerWithTimeInterval,
                this),
