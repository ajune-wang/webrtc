...
vars = {
  ...
  'chromium_revision': '5a64040dc63c39874d952905d188ba398464d62d',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '2612500cae37cf4631fb686338cbfef9f6e4824a',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'dc0f536bb9e2b76f981d3e6bc5708e87502d762f',
  'src/tools/gyp':
