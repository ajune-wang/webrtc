...
class CallStats : public Module, public RtcpRttStats {
 public:
  ...
  // TODO(tommi): No threading protection? Unclear on what thread this is
  // called. A pointer to this object seems to be cached in multiple places and
  // used from random threads.
  // This method returns |this|, so isn't really needed.
