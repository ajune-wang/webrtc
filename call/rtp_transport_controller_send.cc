...
RtpTransportControllerSend::RtpTransportControllerSend(
  ...
  // TODO(srte): When the task queue version of SendSideCongestionController is
  // validated, posting on the task queue should be done by
  // RtpTransportControllerSend directly.
  send_side_cc_ =
