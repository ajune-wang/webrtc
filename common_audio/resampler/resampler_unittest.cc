...
TEST_F(ResamplerTest, MultipleResets) {
  const int kNumChanges = 5;
  const std::array<int, kNumChanges> kInRates = {
      {8000, 44000, 44000, 32000, 32000}};
  const std::array<int, kNumChanges> kOutRates = {
      {16000, 48000, 48000, 16000, 16000}};
  const std::array<int, kNumChanges> kNumChannels = {{2, 2, 2, 2, 1}};
