...
void ReadParam(const Json::Value& root,
  ...
  if (rtc::GetValueFromJsonObject(root, param_name, &subsection)) {
    ...
    ReadParam(subsection, "excitation_limit", &param->excitation_limit);
