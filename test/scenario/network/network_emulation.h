...
// other to form different networks with different behavior. Behavior itself
// will be determined by concrete implementation of NetworkBehaviorInterface,
// that is used inside the node.
class EmulatedNetworkNode : public EmulatedNetworkReceiverInterface {
 public:
  // Creates node based on |network_behavior|. Also node will apply specified
