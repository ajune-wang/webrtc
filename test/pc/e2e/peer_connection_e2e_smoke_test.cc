...
TEST_F(PeerConnectionE2EQualityTestSmokeTest, MAYBE_Smoke) {
  ...
  RunTest(
      ...
      [](PeerConfigurer* bob) {
        ...
        TimeDelta slide_change_interval = TimeDelta::Seconds(2);
        TimeDelta scrolling_duration = TimeDelta::Millis(1800);
        TimeDelta pause_duration = slide_change_interval - scrolling_duration;
        auto screen_share_frame_generator =
            test::CreateScrollingInputFromYuvFilesFrameGenerator(
                ...
                scrolling_duration.ms(), pause_duration.ms());
