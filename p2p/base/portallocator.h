...
enum {
  ...
  // With this flag, these "any address" ports would not be pruned regardless of
  // the allocation results of the normal ports
  PORTALLOCATOR_DISABLE_PRUNE_ANY_ADDRESS_PORTS = 0x20000,

  // Exclude link-local network interfaces
  // from considertaion after adapter enumeration.
  PORTALLOCATOR_DISABLE_LINK_LOCAL_NETWORKS = 0x40000,
};
