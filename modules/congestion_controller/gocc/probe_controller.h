...
#ifndef MODULES_CONGESTION_CONTROLLER_GOCC_PROBE_CONTROLLER_H_
#define MODULES_CONGESTION_CONTROLLER_GOCC_PROBE_CONTROLLER_H_
...
class ProbeController {
 public:
  ProbeController(const Clock* clock, ProbeClusterConfig::Observer* observer);
  ~ProbeController();
...
#endif  // MODULES_CONGESTION_CONTROLLER_GOCC_PROBE_CONTROLLER_H_
