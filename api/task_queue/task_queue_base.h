...
class RTC_LOCKABLE RTC_EXPORT TaskQueueBase {
 public:
  ...
  // were posted to, whether they're executed or not. It means SequenceChecker
  // works during task destruction, a fact that can be used to guarantee object
  // deletion happening on a particular sequence.
