...
public class PeerConnection {
  ...
  @NativeMethods
  interface Natives {
    long getNativePeerConnection(long nativePeerConnection);
    SessionDescription getLocalDescription(long nativePeerConnection);
    SessionDescription getRemoteDescription(long nativePeerConnection);
    RtcCertificatePem getCertificate(long nativePeerConnection);
    DataChannel createDataChannel(long nativePeerConnection, String label, DataChannel.Init init);
    void createOffer(long nativePeerConnection, SdpObserver observer, MediaConstraints constraints);
    void createAnswer(
        long nativePeerConnection, SdpObserver observer, MediaConstraints constraints);
    void setLocalDescriptionAutomatically(long nativePeerConnection, SdpObserver observer);
    void setLocalDescription(
        long nativePeerConnection, SdpObserver observer, SessionDescription sdp);
    void setRemoteDescription(
        long nativePeerConnection, SdpObserver observer, SessionDescription sdp);
    void restartIce(long nativePeerConnection);
    void setAudioPlayout(long nativePeerConnection, boolean playout);
    void setAudioRecording(long nativePeerConnection, boolean recording);
    boolean setBitrate(long nativePeerConnection, Integer min, Integer current, Integer max);
    SignalingState signalingState(long nativePeerConnection);
    IceConnectionState iceConnectionState(long nativePeerConnection);
    PeerConnectionState connectionState(long nativePeerConnection);
    IceGatheringState iceGatheringState(long nativePeerConnection);
    void close(long nativePeerConnection);
    long createPeerConnectionObserver(Observer observer);
    void freeOwnedPeerConnection(long ownedPeerConnection);
    boolean setConfiguration(long nativePeerConnection, RTCConfiguration config);
    boolean addIceCandidate(
        long nativePeerConnection, String sdpMid, int sdpMLineIndex, String iceCandidateSdp);
    void addIceCandidateWithObserver(long nativePeerConnection, String sdpMid, int sdpMLineIndex,
        String iceCandidateSdp, AddIceObserver observer);
    boolean removeIceCandidates(long nativePeerConnection, final IceCandidate[] candidates);
    boolean addLocalStream(long nativePeerConnection, long stream);
    void removeLocalStream(long nativePeerConnection, long stream);
    boolean oldGetStats(long nativePeerConnection, StatsObserver observer, long nativeTrack);
    void newGetStats(long nativePeerConnection, RTCStatsCollectorCallback callback);
    void newGetStatsSender(
        long nativePeerConnection, long sender, RTCStatsCollectorCallback callback);
    void newGetStatsReceiver(
        long nativePeerConnection, long receiver, RTCStatsCollectorCallback callback);
    RtpSender createSender(long nativePeerConnection, String kind, String stream_id);
    List<RtpSender> getSenders(long nativePeerConnection);
    List<RtpReceiver> getReceivers(long nativePeerConnection);
    List<RtpTransceiver> getTransceivers() long nativePeerConnection;
    RtpSender addTrack(long nativePeerConnection, long track, List<String> streamIds);
    boolean removeTrack(long nativePeerConnection, long sender);
    RtpTransceiver addTransceiverWithTrack(
        long nativePeerConnection, long track, RtpTransceiver.RtpTransceiverInit init);
    RtpTransceiver addTransceiverOfType(long nativePeerConnection,
        MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit init);
    boolean startRtcEventLog(long nativePeerConnection, int file_descriptor, int max_size_bytes);
    void stopRtcEventLog(long nativePeerConnection);
  }
}
