...
class RTC_EXPORT RTCStats {
 public:
  ...
  RTCStats(std::string&& id, Timestamp timestamp)
      : id_(std::move(id)), timestamp_(timestamp) {}
  [[deprecated]] RTCStats(const std::string& id, int64_t timestamp_us)
      : id_(id), timestamp_(Timestamp::Micros(timestamp_us)) {}
  [[deprecated]] RTCStats(std::string&& id, int64_t timestamp_us)
      : id_(id), timestamp_(Timestamp::Micros(timestamp_us)) {}
  ...
  [[deprecated]] int64_t timestamp_us() const { return timestamp_.us(); }
