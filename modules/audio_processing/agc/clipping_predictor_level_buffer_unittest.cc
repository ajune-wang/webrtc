...
TEST(ClippingPredictorLevelBufferTest, CheckValueForFirstProcessing) {
  ...
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 0, /*num_items*/ 1),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 3,
                                                              .max = 6})));
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 1, /*num_items*/ 1),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 1,
                                                              .max = 2})));
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 0, /*num_items*/ 2),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 2,
                                                              .max = 6})));
}

TEST(ClippingPredictorLevelBufferTest, CheckValueForRepeatedProcessing) {
  ClippingPredictorLevelBuffer buffer(/*capacity*/ 2);
  buffer.Push({.average = 1, .max = 1});
  buffer.Push({.average = 3, .max = 6});
  ...
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 0, /*num_items*/ 1),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 6,
                                                              .max = 12})));
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 1, /*num_items*/ 1),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 7,
                                                              .max = 14})));
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 0, /*num_items*/ 2),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 6.5f,
                                                              .max = 14})));
}

TEST(ClippingPredictorLevelBufferTest, CheckTooFewItemsInProcessing) {
...
TEST(ClippingPredictorLevelBufferTest, CheckValueAfterReset) {
  ClippingPredictorLevelBuffer buffer(/*capacity*/ 2);
  buffer.Push({.average = 1, .max = 2});
  buffer.Reset();
  buffer.Push({.average = 5, .max = 10});
  ...
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 0, /*num_items*/ 2),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 6,
                                                              .max = 14})));
  EXPECT_THAT(buffer.ComputePartialMetrics(/*delay*/ 1, /*num_items*/ 1),
              Optional(Eq(ClippingPredictorLevelBuffer::Level{.average = 5,
                                                              .max = 10})));
}
