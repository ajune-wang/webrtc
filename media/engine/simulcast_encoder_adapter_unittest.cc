...
class TestSimulcastEncoderAdapterFake : public ::testing::Test,
 ...
 public:
  ...
  void set_use_fallback_factory_(bool use_fallback) {
    use_fallback_factory_ = use_fallback;
  }
...
TEST_F(TestSimulcastEncoderAdapterFake, SupportFallback) {
  // Enable support for fallback encoder factory and re-setup.
  set_use_fallback_factory_(true);
  SetUp();
