...
void ApplyEncoderBitrateLimitsIfSingleActiveStream(
  ...
  // still be mulitiple encodings congfigured (does not make sense). Sometimes
  // the only active/ encoding is not the first layer, in which case the check
  // following this one would fail. Always set the index to 0.
