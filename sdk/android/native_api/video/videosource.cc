...
// In Java API VideoSource object owns AndroidVideoTrackSource. In native API we
// want a C++ object to own VideoSource. This class doesn't extend
// AndroidVideoTrackSource because that would cause a diamond inheritance on
// VideoTrackSourceInterface. Instead, it delegates all calls.
