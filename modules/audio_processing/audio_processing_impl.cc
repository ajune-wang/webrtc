...
AudioProcessingImpl::AudioProcessingImpl(
    ...
    : env_(env),
      ...
      use_setup_specific_default_aec3_config_(
          UseSetupSpecificDefaultAec3Congfig(env_.field_trials())),
      ...
      constants_(!env_.field_trials().IsEnabled(
                     "WebRTC-ApmExperimentalMultiChannelRenderKillSwitch"),
                 !env_.field_trials().IsEnabled(
                     "WebRTC-ApmExperimentalMultiChannelCaptureKillSwitch"),
                 EnforceSplitBandHpf(env_.field_trials()),
                 MinimizeProcessingForUnusedOutput(env_.field_trials())),
      capture_(),
      capture_nonlocked_(),
