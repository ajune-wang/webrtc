...
class PeerConnection : public PeerConnectionInterface,
 ...
 public:
  ...
  virtual cricket::VoiceChannel* voice_channel() const {
    return static_cast<cricket::VoiceChannel*>(GetAudioTransceiver()->internal()->channel());
  }
  virtual cricket::VideoChannel* video_channel() const {
    return static_cast<cricket::VideoChannel*>(GetVideoTransceiver()->internal()->channel());
  }
 ...
 private:
  ...
  rtc::scoped_refptr<RtpTransceiverProxyWithInternal<RtpTransceiver>> GetAudioTransceiver() const;
  rtc::scoped_refptr<RtpTransceiverProxyWithInternal<RtpTransceiver>> GetVideoTransceiver() const;

  bool HasRtpSender(cricket::MediaType type) const;

  rtc::scoped_refptr<
      RtpSenderProxyWithInternal<RtpSenderInternal>>
