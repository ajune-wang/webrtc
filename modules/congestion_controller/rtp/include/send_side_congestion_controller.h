...
class SendSideCongestionController
 ...
 private:
  ...
  std::unique_ptr<NetworkControllerInterface> controller_
      RTC_GUARDED_BY(task_queue_);
  rtc::CriticalSection control_handler_ptr_critical_section_;
  send_side_cc_internal::ControlHandler* control_handler_ptr_
      RTC_GUARDED_BY(control_handler_ptr_critical_section_);
