...
vars = {
  ...
  'chromium_revision': '189da6fad12a79e3071b903ffc40840a6e348212',
...
deps = {
  ...
  'src/testing':
    'https://chromium.googlesource.com/chromium/src/testing@d772ef23c5391150a34b2f705c4a0021f7a1d191',
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@cae59049e3784bdf0fd68b077cc52970a4eb2bbf',
    ...
    'packages': [
      {
          ...
          'version': '6dUQJo3e3Ya4I6P2r0VGg5SlgUjqkpaDTEXI4VxFM6UC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
