...
RnnVadFeaturesExtractor::RnnVadFeaturesExtractor()
    : full_band_buf_(0.f),
      ...
      bands_indexes_(
          ComputeOpusBandBoundaries(kHalfSampleRate, kHalf20msFftLenght)),
...
void RnnVadFeaturesExtractor::ComputeFeatures(
  ...
  ComputeFftAndBandEnergies(kHalfPitchMaxPeriod, {frame_fft_ref_},
                            {band_energies_ref});
  ...
  ComputeFftAndBandEnergies(kHalfPitchMaxPeriod - pitch_info_.period / 4,
  ...
  ComputeBandCorrelations({frame_fft_ref_}, {band_energies_ref},
                          {frame_fft_lagged_}, {band_energies_lagged},
                          {bands_indexes_}, {band_corr_coeffs});
