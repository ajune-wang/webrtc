...
// details of WebRTC. There's a default implementation that uses field trials as
// the underlying mapping. Note that there's no guarantess that the meaning of a
