...
public class MediaStream {
  ...
  public boolean addTrack(AudioTrack track) {
    ...
    if (MediaStreamJni.get().addAudioTrackToNativeStream(
            nativeStream, track.getNativeAudioTrack())) {
  ...
  public boolean addTrack(VideoTrack track) {
    checkMediaStreamExists();
    if (MediaStreamJni.get().addVideoTrackToNativeStream(
            nativeStream, track.getNativeVideoTrack())) {
