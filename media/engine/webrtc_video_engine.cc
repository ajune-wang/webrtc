...
bool WebRtcVideoChannel::ApplyChangedParams(
  ...
  if (changed_params.negotiated_codecs || changed_params.max_bandwidth_bps) {
    ...
    if (changed_params.negotiated_codecs || changed_params.rtcp_mode) {
...
bool WebRtcVideoChannel::SetSend(bool send) {
  ...
  if (send && negotiated_codecs_.empty()) {
