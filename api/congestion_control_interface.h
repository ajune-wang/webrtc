...
// Defines congestion control feedback interface for media transport.
class CongestionControlInterface {
 public:
  CongestionControlInterface() = default;
  ...
  //
  // TODO(b/132163472): Looks like AddRttObserver and RemoveRttObserver were
