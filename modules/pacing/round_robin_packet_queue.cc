...
void RoundRobinPacketQueue::Push(RtpPacketToSend::Type type,
                                 uint32_t ssrc,
                                 uint16_t seq_number,
                                 int64_t capture_time_ms,
                                 int64_t enqueue_time_ms,
...
void RoundRobinPacketQueue::Push(int64_t enqueue_time_ms,
                                 uint64_t enqueue_order,
  ...
  Push(PacketInfo(*type, ssrc, sequence_number, capture_time_ms,
