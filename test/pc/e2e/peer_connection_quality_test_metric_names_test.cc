...
// Adds peer with some audio and video. Which are the particular audio and video
// parameters has to be not important for the caller.
void AddRandomVideoAudioPeer(
...
TEST(PeerConnectionE2EQualityTestMetricNamesTest,
  ...
  AddRandomVideoAudioPeer("alice", "alice_audio", "alice_video",
                          alice_network->network_dependencies(), fixture);
  AddRandomVideoAudioPeer("bob", "bob_audio", "bob_video",
