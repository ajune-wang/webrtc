...
public class PlatformSoftwareVideoDecoderFactory extends MediaCodecVideoDecoderFactory {
  /**
   * Default whitelist predicate.
   */
  private static final MediaCodecVideoDecoderFactory.Predicate<MediaCodecInfo> defaultWhitelist =
      new MediaCodecVideoDecoderFactory.Predicate<MediaCodecInfo>() {
  ...
  public PlatformSoftwareVideoDecoderFactory(@Nullable EglBase.Context sharedContext) {
    super(sharedContext, defaultWhitelist, null);
  }
}
