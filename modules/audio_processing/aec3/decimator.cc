...
const std::vector<CascadedBiQuadFilter::BiQuadParam> kLowPassFilterDS4 = {
    {{-0.08873842f, 0.99605496f}, {0.75916227f, 0.23841065f}, 0.26250696827},
    {{0.62273832f, 0.78243018f}, {0.74892112f, 0.5410152f}, 0.26250696827},
    {{0.71107693f, 0.70311421f}, {0.74895534f, 0.63924616f}, 0.26250696827}};
