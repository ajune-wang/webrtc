...
std::unique_ptr<FrameGeneratorInterface> CreateSquareGenerator(
    int width,
    int height,
...
std::unique_ptr<FrameGeneratorInterface> CreateFromYuvFile(
...
std::unique_ptr<FrameGeneratorInterface> CreateScrollingInputFromYuvFiles(
    Clock* clock,
