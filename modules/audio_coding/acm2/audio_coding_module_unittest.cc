...
void expect_checksum_eq(std::string ref, std::string result) {
...
class AcmSenderBitExactnessOldApi : public ::testing::Test,
 ...
 protected:
  ...
  void Run(const std::string& audio_checksum_ref,
    ...
    expect_checksum_eq(audio_checksum_ref, checksum_string);
    ...
    expect_checksum_eq(payload_checksum_ref, checksum_string);
...
namespace {
// Checksum depends on libopus being compiled with or withour SSE.
