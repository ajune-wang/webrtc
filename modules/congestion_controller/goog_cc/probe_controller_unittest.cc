...
TEST(ProbeControllerTest, LimitAlrProbeWhenLossBasedBweLimited) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "probe_if_bandwidth_is_loss_limited:true/");
  std::unique_ptr<ProbeController> probe_controller =
      fixture.CreateController();
  probe_controller->EnablePeriodicAlrProbing(true);
  auto probes = probe_controller->SetBitrates(
...
TEST(ProbeControllerTest,
  ...
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "network_state_interval:5s,probe_if_bandwidth_is_loss_limited:true/");
  std::unique_ptr<ProbeController> probe_controller =
      fixture.CreateController();
...
TEST(ProbeControllerTest, DISABLED_ProbeFurtherInAlrIfLossBasedIncreasing) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "probe_if_bandwidth_is_loss_limited:true/");
  std::unique_ptr<ProbeController> probe_controller =
  ...
  probes = probe_controller->SetEstimatedBitrate(
      ...
      fixture.CurrentTime());
  EXPECT_EQ(probes.size(), 1u);
  EXPECT_EQ(probes[0].target_data_rate, 2 * 1.5 * kStartBitrate);
}
...
TEST(ProbeControllerTest,
     DISABLED_ProbeFurtherBecauseOfHighLinkCapacityWhenLossBasedIncreases) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "network_state_interval:5s,probe_if_bandwidth_is_loss_limited:true/");
  std::unique_ptr<ProbeController> probe_controller =
  ...
  probes = probe_controller->SetEstimatedBitrate(
      ...
      fixture.CurrentTime());
  EXPECT_FALSE(probes.empty());
  EXPECT_EQ(probes[0].target_data_rate, 2.0 * probe_target_rate);
}

TEST(ProbeControllerTest,
     DISABLED_ProbeFurtherWhenLossBasedIsSameAsDelayBasedEstimate) {
  ProbeControllerFixture fixture(
      "WebRTC-Bwe-ProbingConfiguration/"
      "network_state_interval:5s,probe_if_bandwidth_is_loss_limited:true/");
  std::unique_ptr<ProbeController> probe_controller =
