...
TEST(PeerConnectionE2EQualityTestSmokeTest, RunWithEmulatedNetwork) {
  ...
  NetworkDescriptor alice_network =
      network_emulation_manager->CreateNetworkDescriptor({alice_endpoint});
  fixture->AddPeer(alice_network.network_thread, alice_network.network_manager,
  ...
  NetworkDescriptor bob_network =
      network_emulation_manager->CreateNetworkDescriptor({bob_endpoint});
  fixture->AddPeer(bob_network.network_thread, bob_network.network_manager,
                   [](PeerConfigurer* bob) {
