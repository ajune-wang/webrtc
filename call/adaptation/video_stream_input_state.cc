...
VideoStreamInputState::VideoStreamInputState()
    : has_input_(false),
      ...
      highest_active_stream_pixels_(0) {}
...
void VideoStreamInputState::set_highest_active_stream_pixels(
    int highest_active_stream_pixels) {
  highest_active_stream_pixels_ = highest_active_stream_pixels;
}
...
int VideoStreamInputState::highest_active_stream_pixels() const {
  return highest_active_stream_pixels_;
}
