...
// from audio input thread from AudioSender. Each methods are protected by
// RTC_DCHECK_RUN_ON by SequenceChecker.
//
...
class AudioEgress : public AudioSender, public AudioPacketizationCallback {
 ...
 private:
  ...
  // On mute_, app_thread_checker_ enforces sequential write while audio thread
