...
TEST(RtcpTransceiverImplTest, CallbacksOnSenderReport) {
  ...
  rtcp_transceiver.AddMediaReceiverCallbacks(kRemoteSsrc, &callback);
...
TEST(RtcpTransceiverImplTest, MultipleCallbacksOnSameSsrc) {
  ...
  RtcpTransceiverImpl rtcp_transceiver(DefaultTestConfig());
  rtcp_transceiver.AddMediaReceiverCallbacks(kRemoteSsrc, &callback1);
  rtcp_transceiver.AddMediaReceiverCallbacks(kRemoteSsrc, &callback2);
...
TEST(RtcpTransceiverImplTest, DoesntCallbackAfterRemoved) {
  ...
  rtcp_transceiver.RemoveMediaReceiverCallbacks(kRemoteSsrc, &callback1);
...
TEST(RtcpTransceiverImplTest, CallbacksBySenderSsrc) {
  ...
  StrictMock<MockMediaReceiverRtcpCallbacks> callback2;
  RtcpTransceiverImpl rtcp_transceiver(DefaultTestConfig());
  rtcp_transceiver.AddMediaReceiverCallbacks(kRemoteSsrc1, &callback1);
  rtcp_transceiver.AddMediaReceiverCallbacks(kRemoteSsrc2, &callback2);
