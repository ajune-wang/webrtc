...
vars = {
  ...
  'chromium_revision': '8a525c3da968aa903b5c27fa3a1c761941ddf235',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '23a3982262d2792db61d7aaaafdf7c76bd96c7a7',
...
deps_os = {
  ...
  'ios': {
    'src/ios':
      Var('chromium_git') + '/chromium/src/ios' + '@' + 'fe260a690e7c8efa471fe034587f0ff8571252e3',
  },
  'unix': {
    'src/third_party/lss':
