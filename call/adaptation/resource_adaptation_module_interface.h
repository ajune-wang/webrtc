...
//
// [UNDER CONSTRUCTION] This interface is work-in-progress. It needs to be able
// to handle all the necessary input and output for resource adaptation decision
// making.
//
