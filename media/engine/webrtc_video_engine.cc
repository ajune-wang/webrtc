...
WebRtcVideoChannel::WebRtcVideoReceiveStream::GetVideoReceiverInfo(
  ...
  if (use_standard_bytes_stats_) {
    ...
    info.bytes_rcvd = stats.rtp_stats.data.transmitted.payload_bytes +
                      stats.rtp_stats.data.transmitted.header_bytes +
                      stats.rtp_stats.data.transmitted.padding_bytes;
  }
  info.packets_rcvd = stats.rtp_stats.data.transmitted.packets;
  ...
  info.last_packet_received_timestamp_ms =
      stats.rtp_stats.data.last_packet_received_timestamp_ms;
