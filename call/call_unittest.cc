...
struct CallHelper {
  CallHelper() {
    ...
    webrtc::CallConfig config(&event_log_);
...
struct CallBitrateHelper {
  CallBitrateHelper() : CallBitrateHelper(CallConfig::BitrateConfig()) {}

  explicit CallBitrateHelper(const CallConfig::BitrateConfig& bitrate_config)
...
TEST(CallBitrateTest, BiggerMaskMinUsed) {
  CallBitrateHelper call;
  CallConfig::BitrateConfigMask mask;
...
TEST(CallBitrateTest, BiggerConfigMinUsed) {
  ...
  CallConfig::BitrateConfig config;
