 ...
 public:
  ...
  void DecrementFramerate(int reason) {
    if (fps_counters_[reason] == 0) {
      ...
      // 1. Down resolution (cpu):   res={quality:0,cpu:1},
      // fps={quality:0,cpu:0}
      // 2. Down fps (quality):      res={quality:0,cpu:1},
      // fps={quality:1,cpu:0}
      // 3. Up fps (cpu):            res={quality:1,cpu:0},
      // fps={quality:0,cpu:0}
      // 4. Up resolution (quality): res={quality:0,cpu:0},
      // fps={quality:0,cpu:0}
