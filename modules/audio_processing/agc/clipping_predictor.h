...
class ClippingPredictor {
 public:
  ...
  // Estimates the analog gain clipped level step. Returns absl::nullopt if
  // clipping is not predicted, otherwise returns the suggested decrease in the
  // analog gain level.
...
// Creates a ClippingPredictor based on crest factor-based cliping event
// prediction.
