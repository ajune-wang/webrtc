...
int32_t ChannelSend::SendMediaTransportAudio(
  ...
  // TODO(nisse): Considered connecting to the ssrc config, but that would
  // require wiring via SetLocalSSRC, which seems wrong. To support multiple
  // channels, introduce should have a MediaTransportSender object bound to a
  // specific channel id.
