...
- (void)testInitWithString {
  ...
  profileLevelId = [[RTC_OBJC_TYPE(RTCH264ProfileLevelId) alloc] initWithHexString:level31ConstrainedBaseline];
...
- (void)testInitWithProfileAndLevel {
  ...
  profileLevelId = [[RTC_OBJC_TYPE(RTCH264ProfileLevelId) alloc] initWithProfile:RTCH264ProfileConstrainedBaseline
                                                            level:RTCH264Level3_1];
