...
// iOS, from version 10.0, but not pthread_condattr_setclock.
#if defined(WEBRTC_MAC) || defined(WEBRTC_IOS)
#define USE_CLOCK_GETTIME 1
#define USE_PTHREAD_CONDATTR_SETCLOCK 0
...
#else
#define USE_CLOCK_GETTIME 1
#define USE_PTHREAD_CONDATTR_SETCLOCK 1
#define USE_PTHREAD_COND_TIMEDWAIT_MONOTONIC_NP 0
#endif
...
#if USE_CLOCK_GETTIME && USE_PTHREAD_CONDATTR_SETCLOCK && \
