...
class NetworkEmulationManager {
 public:
  ...
  struct SimulatedNetworkNode {
    ...
    class Builder {
     public:
      ...
      Builder& config(SimulatedNetworkInterface::Config config);
  ...
  // |ret_route| for feedback. The created route allows sending messages with a
  // specified size and a callback action to be triggered as the message has
  // been delivered. This can be used to emulate HTTP cross traffic and to
  // implement realistic reliable signaling over lossy networks.
  // TODO(srte): Handle clearingof the routes involved.
