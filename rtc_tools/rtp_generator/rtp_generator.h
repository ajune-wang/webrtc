...
class RtpGenerator final : public webrtc::Transport {
 public:
  ...
  // Generates a receiver configuration readable by video_replay based on the
  // |generator_config| passed in during construction.
  void GenerateReceiverConfig(const std::string& receiver_config_path);
  ...
  // TODO(benwright) - Add RTCP support.
