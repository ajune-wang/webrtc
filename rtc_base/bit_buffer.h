...
class BitBuffer {
 public:
  ...
  // Reads value in range [0, num_values - 1]. Returns false if there isn't
  // enough data left.
  // If num_values is 2^n, the helper is same as ReadBits(val, n)
  // Otherwise smaller values consume 1 less bit than larger values.
