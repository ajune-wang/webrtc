...
class AudioEgress : public AudioSender, public AudioPacketizationCallback {
 ...
 private:
  // Mute handling logic refactored used only for SendAudioData. This is to
  // accomodate better mute state testing. It's expected to run under
  // encoder_queue_ thread.
