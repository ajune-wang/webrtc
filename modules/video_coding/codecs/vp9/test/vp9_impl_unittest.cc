 ...
 protected:
  ...
  ColorSpace CreateTestColorSpace() const {
    ...
    ColorSpace color_space(
        ...
        ColorSpace::ChromaSitingVertical::kTopCollocated, &hdr_metadata);
    return color_space;
  }
};
...
TEST_F(TestVp9Impl, EncodeDecode) {
  ...
  EXPECT_EQ(ColorSpace::ChromaSitingHorizontal::kUnspecified,
            color_space.chroma_siting_horizontal());
  EXPECT_EQ(ColorSpace::ChromaSitingVertical::kUnspecified,
