...
uint64_t SignedBitWidth(int64_t input) {
  // TODO: !!!
  // if (input >= 0) {
  //   return UnsignedBitWidth(rtc::dchecked_cast<uint64_t>(input));
  // }

  // if (input == std::numeric_limits<int64_t>::min()) {
  //   return 64;
  // }

  // input = rtc::dchecked_cast<uint64_t>
  // }
  return 64;  // TODO: !!!
}
