...
vars = {
  ...
  'chromium_revision': 'a929f18ee1ef222e5c9029d9f4444c3624e1fd9f',
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@f036ad90ef24167874d62ba15efec8c9104cdbc0',
    ...
    'packages': [
      {
          ...
          'version': '3mHuid8po_2quFk8USfka6-cnP5vwWXIx75RMuV8ksIC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
