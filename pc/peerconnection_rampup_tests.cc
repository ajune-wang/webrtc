...
// the encoder can get a max throughput of around 1 Mbps using the
// FrameGeneratorCapturer (SquareGenerator) with the video configuration set for
// this test. Setting the network bandwidth to 500 Kbps allows the video's
// bitrate to push the network's limitations.
