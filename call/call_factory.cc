...
Call* CallFactory::CreateCall(const Call::Config& config) {
  ...
  transportConfig.bitrate_config = config.bitrate_config;
  transportConfig.event_log = config.event_log;
  transportConfig.network_controller_factory =
      config.network_controller_factory;
  transportConfig.network_state_predictor_factory =
      config.network_state_predictor_factory;
  transportConfig.task_queue_factory = config.task_queue_factory;
  transportConfig.trials = config.trials;
