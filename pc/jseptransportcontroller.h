...
class JsepTransportController : public sigslot::has_slots<>,
 ...
 public:
  ...
  sigslot::signal1<bool> SignalIceReceiving;
 ...
 private:
  ...
  bool ShouldEnableBundle(SdpType type,
                          const cricket::SessionDescription* description);
  ...
  const cricket::JsepTransport2* GetJsepTransport(
      const std::string& transport_name) const;
  cricket::JsepTransport2* GetJsepTransport(const std::string& transport_name);
  ...
  bool GetStats_n(const std::string& transport_name,
                  cricket::TransportStats* stats);
  void SetMetricsObserver_n(webrtc::MetricsObserverInterface* metrics_observer);

  RTCError SetLocalTransportDescription_n(
      const std::string& mid,
      const cricket::ContentInfo& content_info,
      const cricket::TransportInfo& transport_info,
      SdpType type,
      const std::vector<int> encrypted_extension_ids);
  RTCError SetRemoteTransportDescription_n(
      const std::string& mid,
      const cricket::ContentInfo& content_info,
      const cricket::TransportInfo& transport_info,
      SdpType type,
  ...
  void OnChannelGatheringState_n(cricket::IceTransportInternal* channel);
  void OnChannelCandidateGathered_n(cricket::IceTransportInternal* channel,
                                    const cricket::Candidate& candidate);
  void OnChannelCandidatesRemoved(const cricket::Candidates& candidates);
  void OnChannelCandidatesRemoved_n(cricket::IceTransportInternal* channel,
                                    const cricket::Candidates& candidates);
  void OnChannelRoleConflict_n(cricket::IceTransportInternal* channel);
  void OnChannelStateChanged_n(cricket::IceTransportInternal* channel);
