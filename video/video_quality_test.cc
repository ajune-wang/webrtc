...
// This class is used to hide shared ownership of passed simulations from
// underlying layers, that requires std::unique_ptr was passed. It is done
// because we can't add references on simulations in Params as unique pointers,
// because it will remove copy constructor and make it impossible to make
// backward compatible changes.
class NetworkSimulationWrapper final : public NetworkSimulationInterface {
 public:
