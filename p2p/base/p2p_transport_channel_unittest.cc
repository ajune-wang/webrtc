...
#include "rtc_base/mock_mdns_responder.h"
...
TEST_F(P2PTransportChannelTest,
  ...
  // socket in gathering.
  auto kOnlyLocalAndStunPorts = cricket::PORTALLOCATOR_DISABLE_RELAY |
                                cricket::PORTALLOCATOR_DISABLE_TCP |
  ...
  auto mock_mdns_responder = absl::make_unique<webrtc::MockMdnsResponder>();
