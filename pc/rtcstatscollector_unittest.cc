...
TEST_F(RTCStatsCollectorTest,
  ...
  voice_sender_info_ssrc1.echo_return_loss = rtc::Optional<int>(42);
  voice_sender_info_ssrc1.echo_return_loss_enhancement = rtc::Optional<int>(52);
  ...
  voice_sender_info_ssrc2.echo_return_loss = rtc::Optional<int>();
  voice_sender_info_ssrc2.echo_return_loss_enhancement = rtc::Optional<int>();
