...
AudioTrackJni::AudioTrackJni(const AudioParameters& audio_parameters,
                             const JavaRef<jobject>& j_audio_track)
    : j_audio_track_(AttachCurrentThreadIfNeeded(), j_audio_track),
  ...
  Java_WebRtcAudioTrack_setNativeAudioTrack(AttachCurrentThreadIfNeeded(),
                                            j_audio_track_,
