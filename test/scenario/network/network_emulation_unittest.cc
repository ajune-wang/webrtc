...
TEST(NetworkEmulationManagerTest, Run) {
  ...
  EmulatedNetworkController* nt1 =
      network_manager.CreateEmulatedNetworkController({alice_endpoint});
  EmulatedNetworkController* nt2 =
      network_manager.CreateEmulatedNetworkController({bob_endpoint});
