...
void RtpPayloadParams::Vp8ManageExplicitDependencies(
  ...
  // #if RTC_DCHECK_IS_ON
  //   if (is_keyframe) {
  //     // None referenced; all updated.
  //     RTC_DCHECK(!vp8_info.bufferReferencesLast);
  //     RTC_DCHECK(!vp8_info.bufferReferencesGolden);
  //     RTC_DCHECK(!vp8_info.bufferReferencesArf);
  //     RTC_DCHECK(vp8_info.bufferUpdatesLast);
  //     RTC_DCHECK(vp8_info.bufferUpdatesGolden);
  //     RTC_DCHECK(vp8_info.bufferUpdatesArf);
  //   } else {
  //     // At least one is referenced.
  //     RTC_DCHECK(vp8_info.bufferReferencesLast ||
  //                vp8_info.bufferReferencesGolden ||
  //                vp8_info.bufferReferencesArf);
  //   }
  // #endif

  for (size_t i = 0; i < CodecSpecificInfoVP8::Buffer::kCount; ++i) {
