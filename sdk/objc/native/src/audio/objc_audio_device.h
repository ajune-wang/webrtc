...
class ObjCAudioDevice final : public AudioDeviceGeneric {
 ...
 private:
  ...
  // Update audio output parameters to current audio device output
  // parameters and allocates new buffers given the new audio format.
  void SetupOutputAudioBuffersForAudioDevice();

  // Update audio input parameters to current audio device input
  // parameters and allocates new buffers given the new audio format.
  void SetupInputAudioBuffersForAudioDevice();
