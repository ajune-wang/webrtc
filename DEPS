...
vars = {
  ...
  'chromium_revision': '75622996bb6cbae10d346f0ecd43e4b0b0508899',
  ...
  # and whatever else without interference from each other.
  'chromium_third_party_revision': '8ff19f9fb60af98e0a0dc2dd5bb6e7fed809e2e4',
}
deps = {
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + 'b60d9e5731e96fcbb09b510140c389eb54e98f0e',
  'src/tools/gyp':
