...
class MockPacedSender : public PacedSender {
 public:
  ...
  MOCK_METHOD0(GetPacerConfigReceiver, network::PacerConfig::Receiver*());
  // MOCK_METHOD0(GetPacerStateReceiver, network::PacerState::Receiver*());
  MOCK_METHOD0(GetProbeClusterConfigReceiver,
               network::ProbeClusterConfig::Receiver*());
};
