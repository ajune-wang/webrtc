...
void OverrideQualityScalingSettingsIfNeeded(
  ...
  if (encoder_info->scaling_settings.thresholds.has_value() &&
    ...
    // Scaling settings are present but quality adaptation is disabled. We need
    // to remove scaling settings.
  ...
  // be aware of WebRTC quality scaling. Use default settings for known codecs.
...
void VideoStreamEncoder::SetSource(
  ...
  encoder_queue_.PostTask([this, degradation_preference] {
    ...
    if (encoder_) {
      ...
      OverrideQualityScalingSettingsIfNeeded(send_codec_, &encoder_info);
...
void VideoStreamEncoder::ReconfigureEncoder() {
  ...
  OverrideQualityScalingSettingsIfNeeded(send_codec_, &info);
