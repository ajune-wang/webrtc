...
class ResourceAdaptationProcessor : public ResourceAdaptationProcessorInterface,
 ...
 public:
  ...
  void AddProcessorListener(
      ResourceAdaptationProcessorListener* processor_listener) override;
 ...
 private:
  ...
  VideoStreamEncoderObserver* const encoder_stats_observer_
      RTC_GUARDED_BY(sequence_checker_);
  std::vector<ResourceAdaptationProcessorListener*> processor_listeners_
      RTC_GUARDED_BY(sequence_checker_);
  ...
  std::vector<AdaptationListener*> adaptation_listeners_
      RTC_GUARDED_BY(sequence_checker_);
  std::vector<AdaptationConstraint*> video_stream_encoder_resources_
      RTC_GUARDED_BY(sequence_checker_);
