...
class VideoReceiveStream : public webrtc::VideoReceiveStream,
 ...
 private:
  ...
  Clock* const cplayout_delay_lock_;
  ...
  int frame_minimum_playout_delay_ms_ RTC_GUARDED_BY(playout_delay_lock_) = 0;
  // Minimum delay as decided by the setLatency function in "webrtc/api".
  int base_minimum_playout_delay_ms_ RTC_GUARDED_BY(playout_delay_lock_) = 0;
  ...
  int frame_maximum_playout_delay_ms_ RTC_GUARDED_BY(playout_delay_lock_) = 0;
};
}  // namespace internal
}  // namespace webrtc
