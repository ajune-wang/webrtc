...
#ifndef MEDIA_ENGINE_WEB_RTC_VIDEO_DECODER_FACTORY_H_
#define MEDIA_ENGINE_WEB_RTC_VIDEO_DECODER_FACTORY_H_
...
#endif  // MEDIA_ENGINE_WEB_RTC_VIDEO_DECODER_FACTORY_H_
