...
#ifndef MEDIA_ENGINE_WEB_RTC_VIDEO_ENCODER_FACTORY_H_
#define MEDIA_ENGINE_WEB_RTC_VIDEO_ENCODER_FACTORY_H_
...
#endif  // MEDIA_ENGINE_WEB_RTC_VIDEO_ENCODER_FACTORY_H_
