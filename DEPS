...
vars = {
  ...
  'chromium_revision': 'a9d2e41689e31ea136a018af363809d8134263bb',
...
deps = {
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + '9a1398d6b9577bad72eb24c604bed2c4546841b5',
  ...
  'src/tools':
    Var('chromium_git') + '/chromium/src/tools' + '@' + '451e621083fc970805c9b0c1487c733e6a397fd2',
