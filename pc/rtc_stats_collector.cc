...
std::unique_ptr<RTCAudioPlayoutStats> CreateAudioPlayoutStats(
    const AudioDeviceInfo info, int64_t timestamp_us) {
...
void RTCStatsCollector::ProduceAudioRTPStreamStats_n(
  ...
  report->TryAddStats(CreateAudioPlayoutStats(stats.track_media_info_map.voice_media_info()->audio_device_info, timestamp_us));
}
