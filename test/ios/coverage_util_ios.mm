...
#import "test/webrtc_ios_enable_coverage.h"

#if !defined(NDEBUG) && BUILDFLAG(WEBRTC_IOS_ENABLE_COVERAGE)
...
#endif  // !defined(NDEBUG) && BUILDFLAG(WEBRTC_IOS_ENABLE_COVERAGE)
}
