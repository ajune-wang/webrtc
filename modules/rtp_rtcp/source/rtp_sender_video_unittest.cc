...
// Task queue which replicates external threads - no CurrentTaskQueue is set.
class ExternalTaskQueue : public TaskQueueBase {
 public:
  ExternalTaskQueue() = default;
...
TEST_F(RtpSenderVideoWithFrameTransformerTest,
  ...
  ExternalTaskQueue hw_encoder_queue;
