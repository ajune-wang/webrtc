...
TEST_F(TestVCMJitterEstimator, TestUpperBound) {
  ...
  test_cases[3].upper_bound = 100.0;
  test_cases[3].rtt_mult = 0;
  test_cases[3].jitter_est_cap_ms = absl::nullopt;
  // Small upper bound value, rtt_mult = 0, and nullopt for rtt_mult cap.
  test_cases[2].upper_bound = 3.5;
  test_cases[2].rtt_mult = 0;
  test_cases[2].jitter_est_cap_ms = absl::nullopt;
  // Large upper bound value, rtt_mult = 1, and large rtt_mult cap value.
  test_cases[0].upper_bound = 100;
  test_cases[0].rtt_mult = 1;
  test_cases[0].jitter_est_cap_ms = 100;
  // Large upper bound, rtt_mult = 1, and small rtt_mult cap value.
  test_cases[1].upper_bound = 100;
  test_cases[1].rtt_mult = 1;
  test_cases[1].jitter_est_cap_ms = 10;
