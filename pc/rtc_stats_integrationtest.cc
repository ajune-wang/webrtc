...
class RTCStatsReportVerifier {
 public:
  ...
  bool VerifyRTCOutboundRTPStreamStats(
    ...
    // TODO(hbos): Invoke VerifyRTCReceivedRtpStreamStats() instead of
    // VerifyRTCRTPStreamStats() because they have a shared hierarchy now!
