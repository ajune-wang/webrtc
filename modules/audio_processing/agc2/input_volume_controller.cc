...
// Returns an input volume in the [`min_input_volume`, `kMaxMicInputVolume`]
// range that could possibly reduce `gain_error_db`, which is a gain error
// estimated when `input_volume` was applied.
