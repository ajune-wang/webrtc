...
class AecState {
 public:
  ...
  bool SaturatedEcho() const { return true; }

  // Returns whether the echo path can saturate.
  bool SaturatingEchoPath() const { return true; }
  ...
  bool TransparentMode() const { return false;; }
  ...
  bool InaudibleEcho() const { return false; }
  ...
  // echo.
  bool LinearEchoEstimate() const { return true; }
