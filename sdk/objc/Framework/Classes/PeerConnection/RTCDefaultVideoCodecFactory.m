...
- (void)addFormat:(RTCVideoCodecInfo *)codecInfo withClass:(id)codecClass {
...
- (id)codecClassForFormat:(RTCVideoCodecInfo *)codecInfo {
...
- (id<RTCVideoEncoder>)createEncoder:(RTCVideoCodecInfo *)info {
  Class<RTCVideoEncoder> encoderClass = [_codecList codecClassForFormat:info];
...
- (id<RTCVideoDecoder>)createDecoder:(RTCVideoCodecInfo *)info {
  Class<RTCVideoDecoder> decoderClass = [_codecList codecClassForFormat:info];
