...
class AecDumpImpl : public AecDump {
 public:
  ...
  void AddCaptureStreamInput(const FloatAudioFrame<const float>& src) override;
  void AddCaptureStreamOutput(const FloatAudioFrame<const float>& src) override;
  ...
  void WriteRenderStreamMessage(
      const FloatAudioFrame<const float>& src) override;
