...
// SimulatedNetworkConfig represents a configuration for default network
// simulation that will be used by WebRTC if no NetworkSimulationInterface
...
class NetworkSimulationInterface {
 public:
  // DO NOT USE. Use SimulatedNetworkConfig directly. This reference should be
  // removed when all users will be switched on direct usage.
  using SimulatedNetworkConfig = SimulatedNetworkConfig;
