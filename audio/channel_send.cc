...
int32_t ChannelSend::SendMediaTransportAudio(
  ...
  if (!rtc_error.ok()) {
    // TODO(sukhanov): Add debug string.
  ...
  // TODO(sukhanov): We do not need to update bitrate on every frame.
  // const int bitrate_bps = sender_media_transport->GetBitrateBps();

  // TODO(sukhanov): Someone should limit / fix initial bitrate.
  // SetBitRate(bitrate_bps, /*probing_interval_ms=*/10);
