...
class RTC_EXPORT PeerConnectionInterface : public webrtc::RefCountInterface {
 public:
  ...
  struct RTC_EXPORT RTCConfiguration {
    ...
    bool stats_timestamp_with_no_epoch() const {
      return media_config.stats_timestamp_with_no_epoch;
    }
    void set_stats_timestamp_with_no_epoch(bool enable) {
      media_config.stats_timestamp_with_no_epoch = enable;
    }
