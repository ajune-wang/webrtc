...
int EncoderSimulcastProxy::InitEncode(const VideoCodec* inst,
  ...
  if (inst->numberOfSimulcastStreams <= 1 ||
    ...
    // TODO(https://crbug.com/webrtc/14884): Can we not always use
    // SimulcastEncoderAdapter and get rid of EncoderSimulcastProxy? The
    // SimulcastEncoderAdapter has a passthrough mode.
