...
namespace {
const size_t kBitrates[] = {50, 100, 200, 400, 800};
...
TEST_F(VideoProcessorIntegrationTestArmEval, LibvpxVP8_SingleLayer) {
  config_.SetCodecSettings(kVideoCodecVP8, 1, 1, 1, false /* denoising_on */,
                           false /* frame_dropper_on */,
                           false /* spatial_resize_on */,
                           false /* resilience_on */, 640, 360);

  std::map<size_t, std::vector<VideoStatistics>> rd_stats;
  for (size_t bitrate_kbps : kBitrates) {
...
TEST_F(VideoProcessorIntegrationTestArmEval, LibvpxVP9_SingleLayer) {
  config_.SetCodecSettings(kVideoCodecVP9, 1, 1, 1, false /* denoising_on */,
                           false /* frame_dropper_on */,
                           false /* spatial_resize_on */,
                           false /* resilience_on */, 640, 360);
...
TEST_F(VideoProcessorIntegrationTestArmEval, LibvpxVp8_Multires_2SL3TL) {
  config_.SetCodecSettings(kVideoCodecVP8, 2, 1, 3, false /* denoising_on */,
                           true /* frame_dropper_on */,
                           false /* spatial_resize_on */,
                           true /* resilience_on */, 640, 360);
...
TEST_F(VideoProcessorIntegrationTestArmEval, LibvpxVp9_Svc_2SL3TL) {
  config_.SetCodecSettings(kVideoCodecVP9, 1, 2, 3, false /* denoising_on */,
                           true /* frame_dropper_on */,
                           false /* spatial_resize_on */,
                           true /* resilience_on */, 640, 360);
