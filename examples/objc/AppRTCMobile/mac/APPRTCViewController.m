...
- (void)updateConstraints {
  NSParameterAssert(_roomField != nil && _scrollView != nil && _remoteVideoView != nil &&
                    _localVideoView != nil && _actionItemsView != nil && _connectButton != nil &&
                    _loopbackButton != nil);

  [self removeConstraints:[self constraints]];
  NSDictionary* viewsDictionary = NSDictionaryOfVariableBindings(_roomField,
                                                                 _scrollView,
                                                                 _remoteVideoView,
                                                                 _localVideoView,
                                                                 _actionItemsView,
...
- (void)startCall:(id)sender {
  ...
  [self.delegate appRTCMainView:self didEnterRoomId:roomString loopback:_loopbackButton.intValue];
...
@interface APPRTCViewController () <ARDAppClientDelegate, APPRTCMainViewDelegate>
...
- (void)displayUsageInstructions {
  [self.mainView displayLogMessage:@"To start call:\n"
