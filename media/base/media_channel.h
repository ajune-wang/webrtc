...
class MediaBaseChannel {
 public:
  virtual ~MediaBaseChannel() = default;
...
class MediaSendChannel : virtual public MediaBaseChannel {
 public:
  virtual ~MediaSendChannel() = default;
...
class MediaReceiveChannel : virtual public MediaBaseChannel {
 public:
  virtual ~MediaReceiveChannel() = default;
...
class MediaChannel : public MediaSendChannel, public MediaReceiveChannel {
 public:
