...
struct RTC_EXPORT VideoSinkWants {
  ...
  // resolution but this may not always be the case due to scaleResolutionDownBy
  // or turning off simulcast or SVC layers.
  //
  ...
  //
  // Note that the |encoder_resolutions| can change while frames are in flight
  // and should only be used as a hint when constructing the webrtc::VideoFrame.
