...
RTC_EXTERN NSString* RTCFieldTrialMedianSlopeFilterValue(size_t windowSize,
...
RTC_EXTERN NSString* RTCFieldTrialTrendlineFilterValue(size_t windowSize,
 ...
 * call into WebRTC. See: webrtc/system_wrappers/include/field_trial_default.h
 */
