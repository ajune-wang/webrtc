...
ModuleRtpRtcpImpl2::ModuleRtpRtcpImpl2(const Configuration& configuration)
  ...
  if (rtt_stats_ || (configuration.receiver_only &&
...
void ModuleRtpRtcpImpl2::SetRecvRttEnabled(bool enabled) {
  rtcp_sender_.SetRecvRttEnabled(enabled);
  rtcp_receiver_.SetRecvRttEnabled(enabled);
}
