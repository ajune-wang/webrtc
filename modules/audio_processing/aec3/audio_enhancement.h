...
#ifndef MODULES_AUDIO_PROCESSING_AEC3_AUDIO_ENHANCEMENT_H_
#define MODULES_AUDIO_PROCESSING_AEC3_AUDIO_ENHANCEMENT_H_
...
// Performs enhancement using a provided custom audio enhancement module. Does
// not take ownership of the audio enhancement module.
class AudioEnhancement {
 public:
  AudioEnhancement(size_t num_capture_channels,
                   size_t num_bands,
                   AudioEnhancer* enhancer);
  ~AudioEnhancement();
  AudioEnhancement(const AudioEnhancement&) = delete;
  AudioEnhancement& operator=(const AudioEnhancement&) = delete;
...
#endif  // MODULES_AUDIO_PROCESSING_AEC3_AUDIO_ENHANCEMENT_H_
