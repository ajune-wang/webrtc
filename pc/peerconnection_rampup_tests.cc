...
// This constant is taken from ramup_tests.cc: kExpectedHighVideoBitrateBps +
...
class PeerConnectionWrapperForRampUpTest : public PeerConnectionWrapper {
 public:
  ...
  void AddLocalVideoTrackWithFakeSource() {
  ...
  void AddLocalAudioTrackWithFakeSource() {
    ...
    auto track =
        pc_factory()->CreateAudioTrack(rtc::CreateRandomUuid(), source);
    AddTrack(track);
  }
...
class PeerConnectionRampUpTest : public ::testing::Test {
 public:
  ...
  void SetupOneToOneCall() {
    ...
    caller_->AddLocalVideoTrackWithFakeSource();
    caller_->AddLocalAudioTrackWithFakeSource();
    callee_->AddLocalVideoTrackWithFakeSource();
    callee_->AddLocalAudioTrackWithFakeSource();
