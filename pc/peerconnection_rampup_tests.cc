...
// The max video bitrate is 1.7 mbps, and it's limit throughput is about 1 mbps.
// Setting the network bandwidth at 4/3 of 1 mbps allows the video's bitrate
// to push the network's limitations.
