 ...
 private:
  class PortData {
   public:
    ...
    // The following methods are used to manage the signaling any address ports
    // and their gathered candidates (using the default route that the OS
    // assigns). See the comments before
