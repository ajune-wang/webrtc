...
TEST_F(RtcpSenderTest, DoesntSchedulesInitalReportWhenSsrcSetOnConstruction) {
  rtcp_sender_->SetRTCPStatus(RtcpMode::kReducedSize);
...
TEST_F(RtcpSenderTest, DoesntSchedulesInitalReportOnFirstSetSsrc) {
  // Set up without first SSRC not set at construciton
  RtpRtcp::Configuration configuration = GetDefaultConfig();
