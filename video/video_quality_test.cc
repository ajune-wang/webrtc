...
std::unique_ptr<VideoEncoder> VideoQualityTest::CreateVideoEncoder(
  ...
  if (!params_.logging.encoded_frame_base_path.empty()) {
    ...
    std::vector<FileWrapper> files;
    files.emplace_back(FileWrapper::OpenWriteOnly(prefix + "1.ivf"));
    files.emplace_back(FileWrapper::OpenWriteOnly(prefix + "2.ivf"));
    files.emplace_back(FileWrapper::OpenWriteOnly(prefix + "3.ivf"));
