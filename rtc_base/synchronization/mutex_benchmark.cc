...
CPU Caches:
  ...
  L2 Unified 1024 KiB (x6)
  L3 Unified 8448 KiB (x1)
Load Average: 0.33, 0.30, 0.43
----------------------------------------------------------------------
Benchmark                            Time             CPU   Iterations
----------------------------------------------------------------------
BM_LockWithMutex/threads:1        14.4 ns         14.4 ns     48604563
BM_LockWithMutex/threads:2        44.1 ns         88.3 ns      7266048
BM_LockWithMutex/threads:4        53.2 ns          202 ns      2973804
BM_LockWithMutex/threads:12       87.7 ns          989 ns       727908
