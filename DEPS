...
vars = {
  ...
  'chromium_revision': '6dc2a467a661f76a8c60352c2e9bb21b0c4f0920',
...
deps = {
  ...
  'src/base':
    Var('chromium_git') + '/chromium/src/base' + '@' + 'd169facbaf644bdb1a3179b90e8c756ff76b1da8',
  'src/build':
  ...
  'src/third_party':
    Var('chromium_git') + '/chromium/src/third_party' + '@' + 'facdb1662fd86735df7dfc16793a8ed4e995101c',
