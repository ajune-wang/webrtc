...
void DefaultVideoQualityAnalyzer::ReportResults(
  ...
  ReportResult("psnr", test_case_name, stats.psnr, "dB",
               webrtc::test::ImproveDirection::kBiggerIsBetter);
  ...
  ReportResult("receive_to_render_time", test_case_name,
               ...
               webrtc::test::ImproveDirection::kSmallerIsBetter);
  test::PrintResult(
      "dropped_frames", "", test_case_name, frame_counters.dropped, "count",
      /*important=*/false, webrtc::test::ImproveDirection::kSmallerIsBetter);
  ...
  ReportResult("max_skipped", test_case_name, stats.skipped_between_rendered,
               "count", webrtc::test::ImproveDirection::kSmallerIsBetter);
}
