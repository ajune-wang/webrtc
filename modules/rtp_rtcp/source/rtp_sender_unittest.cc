...
TEST_P(RtpSenderVideoTest, PopulateGenericFrameDescriptor) {
  ...
  ASSERT_EQ(2U, descriptor_wire.FrameDependenciesDiffs().size());
  EXPECT_EQ(1, descriptor_wire.FrameDependenciesDiffs()[0]);
  EXPECT_EQ(500, descriptor_wire.FrameDependenciesDiffs()[1]);
  uint8_t spatial_bitmask = 0b00010100;
