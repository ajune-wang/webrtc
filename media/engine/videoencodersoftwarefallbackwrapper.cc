...
void GetForcedFallbackParamsFromFieldTrialGroup(int* param_max_pixels) {
...
VideoEncoderSoftwareFallbackWrapper::VideoEncoderSoftwareFallbackWrapper(
  ...
  if (forced_fallback_possible_) {
    GetForcedFallbackParamsFromFieldTrialGroup(&forced_fallback_.max_pixels_);
  }
}
...
bool VideoEncoderSoftwareFallbackWrapper::TryInitForcedFallbackEncoder() {
  ...
  if (fallback_encoder_) {// || forced_fallback_.active_) {
    return false;
  }
  // Fallback not active.
