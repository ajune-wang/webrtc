...
RTC_OBJC_EXPORT
@protocol RTC_OBJC_TYPE(RTCPeerConnectionDelegate) <NSObject>
...
- (void)peerConnection:(RTC_OBJC_TYPE(RTCPeerConnection) *)peerConnection didAddStream:(RTC_OBJC_TYPE(RTCMediaStream) *)stream;

/** Called when a remote peer closes a stream.
 *  This is not called when RTCSdpSemanticsUnifiedPlan is specified.
 */
- (void)peerConnection:(RTC_OBJC_TYPE(RTCPeerConnection) *)peerConnection didRemoveStream:(RTC_OBJC_TYPE(RTCMediaStream) *)stream;
 ...
 *  Note: reading this property returns different instances of RTC_OBJC_TYPE(RTCRtpSender).
 *  Use isEqual: instead of == to compare RTC_OBJC_TYPE(RTCRtpSender) instances.
 */
 ...
 *  Note: reading this property returns different instances of RTC_OBJC_TYPE(RTCRtpReceiver).
 *  Use isEqual: instead of == to compare RTC_OBJC_TYPE(RTCRtpReceiver) instances.
 */
 ...
 *  RTC_OBJC_TYPE(RTCRtpTransceiver). Use isEqual: instead of == to compare RTC_OBJC_TYPE(RTCRtpTransceiver)
 *  instances.
 ...
 *  the newly created RTC_OBJC_TYPE(RTCRtpSender). The RTC_OBJC_TYPE(RTCRtpSender) will be associated with
 ...
 */
- (RTC_OBJC_TYPE(RTCRtpSender) *)addTrack:(RTC_OBJC_TYPE(RTCMediaStreamTrack) *)track streamIds:(NSArray<NSString *> *)streamIds;

/** With PlanB semantics, removes an RTC_OBJC_TYPE(RTCRtpSender) from this peer connection.
 *
 *  With UnifiedPlan semantics, sets sender's track to null and removes the
 *  send component from the associated RTC_OBJC_TYPE(RTCRtpTransceiver)'s direction.
 *
 *  Returns YES on success.
 */
- (BOOL)removeTrack:(RTC_OBJC_TYPE(RTCRtpSender) *)sender;

/** addTransceiver creates a new RTC_OBJC_TYPE(RTCRtpTransceiver) and adds it to the set of
 ...
 *  the track.
 */
- (RTC_OBJC_TYPE(RTCRtpTransceiver) *)addTransceiverWithTrack:(RTC_OBJC_TYPE(RTCMediaStreamTrack) *)track;
- (RTC_OBJC_TYPE(RTCRtpTransceiver) *)addTransceiverWithTrack:(RTC_OBJC_TYPE(RTCMediaStreamTrack) *)track
...
/** Apply the supplied RTC_OBJC_TYPE(RTCSessionDescription) as the local description. */
- (void)setLocalDescription:(RTC_OBJC_TYPE(RTCSessionDescription) *)sdp
          completionHandler:(nullable void (^)(NSError *_Nullable error))completionHandler;

/** Apply the supplied RTC_OBJC_TYPE(RTCSessionDescription) as the remote description. */
...
@interface RTC_OBJC_TYPE(RTCPeerConnection) (Media)

/** Create an RTC_OBJC_TYPE(RTCRtpSender) with the specified kind and media stream ID.
...
@interface RTC_OBJC_TYPE(RTCPeerConnection) (DataChannel)

/** Create a new data channel with the given label and configuration. */
- (nullable RTC_OBJC_TYPE(RTCDataChannel) *)dataChannelForLabel:(NSString *)label
                                   configuration:(RTC_OBJC_TYPE(RTCDataChannelConfiguration) *)configuration;

@end

typedef void (^RTCStatisticsCompletionHandler)(RTCStatisticsReport *);

@interface RTC_OBJC_TYPE(RTCPeerConnection) (Stats)

/** Gather stats for the given RTC_OBJC_TYPE(RTCMediaStreamTrack). If |mediaStreamTrack| is nil
 *  statistics are gathered for all tracks.
 */
- (void)statsForTrack:(nullable RTC_OBJC_TYPE(RTCMediaStreamTrack) *)mediaStreamTrack
     statsOutputLevel:(RTCStatsOutputLevel)statsOutputLevel
    completionHandler:(nullable void (^)(NSArray<RTC_OBJC_TYPE(RTCLegacyStatsReport) *> *stats))completionHandler;
