...
class TransformableFrameInterface {
 public:
  ...
  // Returns a pointer to the owned frame payload data. Does not change data
  // ownership. The pointer is valid until the next non-const method call.
...
class TransformableVideoFrameInterface : public TransformableFrameInterface {
 public:
  ...
  virtual const RTPVideoHeader& GetHeader() const = 0;
  ...
  virtual rtc::ArrayView<const uint8_t> GetAdditionalData() const = 0;
};
