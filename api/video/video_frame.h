...
class RTC_EXPORT VideoFrame {
 public:
  ...
  class ReceivedEncodedFrame : public rtc::RefCountInterface {
   public:
  ...
  class RTC_EXPORT Builder {
   ...
   private:
    ...
    rtc::scoped_refptr<ReceivedEncodedFrame> encoded_frame_;
  };
  ...
  rtc::scoped_refptr<ReceivedEncodedFrame> encoded_frame() const;
