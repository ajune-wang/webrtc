...
XdgDesktopPortalBase* XdgDesktopPortalBase::instance_ = nullptr;
std::once_flag XdgDesktopPortalBase::once_flag_;
...
ConnectionData::~ConnectionData() {
  ...
  // This should get deleted automatically as it's owned
  // by the GDBusProxy above
  connection_ = nullptr;
...
// static
XdgDesktopPortalBase& XdgDesktopPortalBase::GetInstance() {
  std::call_once(once_flag_, [] { instance_ = new XdgDesktopPortalBase(); });
  return *instance_;
}

// static
void XdgDesktopPortalBase::DestroyInstance() {
...
void XdgDesktopPortalBase::InitPortal(
  ...
  connection_data->cancellable_ = g_cancellable_new();
  ...
  g_dbus_proxy_new_for_bus(
      ...
      GetConnectionData(id)->cancellable_,
...
void XdgDesktopPortalBase::OnProxyRequested(GObject* /*object*/,
  ...
  auto connection_data =
      XdgDesktopPortalBase::GetInstance().GetConnectionData(data->GetDataId());
  RTC_CHECK(connection_data);
  ...
  if (!proxy) {
    ...
    XdgDesktopPortalBase::GetInstance().CloseConnection(connection_data->id_);
    return;
  }
  connection_data->proxy_ = proxy;
  ...
  XdgDesktopPortalBase::GetInstance().SessionRequest(data);
}
...
void XdgDesktopPortalBase::SessionRequest(UserData* data) {
  ...
  g_dbus_proxy_call(connection_data->proxy_, "CreateSession",
                    ...
                    /*timeout=*/-1, connection_data->cancellable_,
                    reinterpret_cast<GAsyncReadyCallback>(OnSessionRequested),
                    data);
}

// static
void XdgDesktopPortalBase::OnSessionRequested(GDBusProxy* proxy,
                                              GAsyncResult* result,
                                              gpointer user_data) {
  UserData* data = static_cast<UserData*>(user_data);
  RTC_DCHECK(data);
  ...
  if (!handle) {
    ...
    if (connection_data->session_request_signal_id_) {
      g_dbus_connection_signal_unsubscribe(
          connection_data->connection_,
          connection_data->session_request_signal_id_);
...
void XdgDesktopPortalBase::OnSessionRequestResponseSignal(
  ...
  XdgDesktopPortalBase::GetInstance().SourcesRequest(data);
}
...
void XdgDesktopPortalBase::SourcesRequest(UserData* data) {
  ...
  g_dbus_proxy_call(
      ...
      G_DBUS_CALL_FLAGS_NONE, /*timeout=*/-1, connection_data->cancellable_,
      reinterpret_cast<GAsyncReadyCallback>(OnSourcesRequested), data);
}

// static
void XdgDesktopPortalBase::OnSourcesRequested(GDBusProxy* proxy,
                                              GAsyncResult* result,
                                              gpointer user_data) {
  UserData* data = static_cast<UserData*>(user_data);
  RTC_DCHECK(data);
  ...
  if (!handle) {
    ...
    if (connection_data->sources_request_signal_id_) {
      g_dbus_connection_signal_unsubscribe(
          connection_data->connection_,
          connection_data->sources_request_signal_id_);
...
void XdgDesktopPortalBase::OnSourcesRequestResponseSignal(
  ...
  XdgDesktopPortalBase::GetInstance().StartRequest(data);
}
...
// static
void XdgDesktopPortalBase::OnStartRequested(GDBusProxy* proxy,
                                            GAsyncResult* result,
                                            gpointer user_data) {
  UserData* data = static_cast<UserData*>(user_data);
  RTC_DCHECK(data);
  ...
  if (!handle) {
    ...
    if (connection_data->start_request_signal_id_) {
      g_dbus_connection_signal_unsubscribe(
          connection_data->connection_,
          connection_data->start_request_signal_id_);
...
void XdgDesktopPortalBase::OnStartRequestResponseSignal(
  ...
  XdgDesktopPortalBase::GetInstance().OpenPipeWireRemote(data);
}
...
void XdgDesktopPortalBase::OpenPipeWireRemote(UserData* data) {
  ...
  g_dbus_proxy_call_with_unix_fd_list(
      ...
      connection_data->cancellable_,
      reinterpret_cast<GAsyncReadyCallback>(OnOpenPipeWireRemoteRequested),
      data);
}

// static
void XdgDesktopPortalBase::OnOpenPipeWireRemoteRequested(GDBusProxy* proxy,
                                                         GAsyncResult* result,
                                                         gpointer user_data) {
  UserData* data = static_cast<UserData*>(user_data);
  RTC_DCHECK(data);
