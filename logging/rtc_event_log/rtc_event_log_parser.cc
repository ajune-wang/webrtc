...
bool ParsedRtcEventLog::ParseStream(
  ...
  for (const auto& incoming : incoming_rtcp_packets_) {
    ...
    StoreRtcpBlocks(timestamp_us, packet_begin, packet_end, &incoming_sr_,
                    &incoming_rr_, &incoming_xr_, &incoming_transport_feedback_,
                    &incoming_remb_, &incoming_nack_, &incoming_fir_,
                    &incoming_pli_, &incoming_loss_notification_);
  }
  ...
  for (const auto& outgoing : outgoing_rtcp_packets_) {
    ...
    StoreRtcpBlocks(timestamp_us, packet_begin, packet_end, &outgoing_sr_,
                    &outgoing_rr_, &outgoing_xr_, &outgoing_transport_feedback_,
                    &outgoing_remb_, &outgoing_nack_, &outgoing_fir_,
                    &outgoing_pli_, &outgoing_loss_notification_);
  }
