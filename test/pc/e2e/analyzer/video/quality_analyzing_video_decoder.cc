...
int32_t QualityAnalyzingVideoDecoder::Decode(
  ...
  if (out.discard) {
    ...
    // to prevent regressions on relevant streams. Because of it discarded image
    // will be always decoded as black frame and will be passed to callback
    // directly without reaching decoder and video quality analyzer.
