...
TEST_F(TraditionalReassemblyStreamsTest, NoStreamsCanBeHandedOver) {
  ...
  EXPECT_EQ(streams1.GetHandoverReadiness(), HandoverReadinessStatus::kReady);
...
TEST_F(TraditionalReassemblyStreamsTest,
  ...
  EXPECT_EQ(streams1.GetHandoverReadiness(),
            HandoverReadinessStatus::kOrderedStreamHasUnassembledChunks);
...
TEST_F(TraditionalReassemblyStreamsTest,
  ...
  EXPECT_EQ(streams1.GetHandoverReadiness(),
            HandoverReadinessStatus::kUnorderedStreamHasUnassembledChunks);
