...
vars = {
  ...
  'chromium_revision': 'cc28c46ef23a0e308937be85c60b131128e2a2c3',
}
...
deps = {
  ...
  'src/third_party':
    'https://chromium.googlesource.com/chromium/src/third_party@f35b3108b315171dce2dd21315db624f3749bc7d',
