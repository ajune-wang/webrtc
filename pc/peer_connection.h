...
class PeerConnection : public PeerConnectionInternal,
 ...
 private:
  ...
  // It is desired to remove this friendship, it is part of refactoring.
  // TODO(bugs.webrtc.org/11146): Remove friendship to DataChannelController
  friend class DataChannelController;
