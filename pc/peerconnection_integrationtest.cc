...
class PeerConnectionIntegrationBaseTest : public testing::Test {
 public:
  ...
  bool CreatePeerConnectionWrappersWithSdpSemantics(
    ...
    webrtc::PeerConnectionDependencies caller_dependencies(nullptr);
    ...
    webrtc::PeerConnectionDependencies callee_dependencies(nullptr);
  ...
  bool CreatePeerConnectionWrappersWithConstraints(
    ...
    webrtc::PeerConnectionDependencies caller_dependencies(nullptr);
    caller_ =
        CreatePeerConnectionWrapper("Caller", caller_constraints, nullptr,
                                    nullptr, std::move(caller_dependencies));
    webrtc::PeerConnectionDependencies callee_dependencies(nullptr);
    callee_ =
        CreatePeerConnectionWrapper("Callee", callee_constraints, nullptr,
                                    nullptr, std::move(callee_dependencies));
    return caller_ && callee_;
  }
  ...
  bool CreatePeerConnectionWrappersWithOptions(
    ...
    webrtc::PeerConnectionDependencies caller_dependencies(nullptr);
    caller_ =
        CreatePeerConnectionWrapper("Caller", nullptr, &caller_options, nullptr,
                                    std::move(caller_dependencies));
    webrtc::PeerConnectionDependencies callee_dependencies(nullptr);
    callee_ =
        CreatePeerConnectionWrapper("Callee", nullptr, &callee_options, nullptr,
                                    std::move(callee_dependencies));
    return caller_ && callee_;
  }
