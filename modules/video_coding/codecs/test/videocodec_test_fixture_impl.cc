...
SdpVideoFormat CreateSdpVideoFormat(
  ...
  if (config.codec_settings.codecType == kVideoCodecH264) {
    ...
    // Extra condition to fallback to the default creation of SdpVideoFormat.
    // This is needed for backwards compatibilty in downstream projects that
    // still uses the preliminary codec name AV1X.
