...
class PeerConnectionInterfaceBaseTest : public testing::Test {
 protected:
  ...
  void WaitAndVerifyOnAddTrack(const std::string& stream_label,
...
class PeerConnectionInterfaceTestUnifiedPlan
    : public PeerConnectionInterfaceBaseTest {
 protected:
  PeerConnectionInterfaceTestUnifiedPlan()
      : PeerConnectionInterfaceBaseTest(SdpSemantics::kUnifiedPlan) {}
};
...
TEST_P(PeerConnectionInterfaceTest, CreateOfferReceiveAnswer) {
  InitiateCall();
  WaitAndVerifyOnAddTrack(kStreamLabel1, 2);
...
TEST_P(PeerConnectionInterfaceTest, CreateOfferReceivePrAnswerAndAnswer) {
  ...
  WaitAndVerifyOnAddTrack(kStreamLabel1, 1);
}
...
// signaled.
TEST_F(PeerConnectionInterfaceTestPlanB, UpdateRemoteStreams) {
  FakeConstraints constraints;
  constraints.AddMandatory(webrtc::MediaConstraintsInterface::kEnableDtlsSrtp,
                           true);
  CreatePeerConnection(&constraints);
...
TEST_P(PeerConnectionInterfaceTest, DefaultTracksNotDestroyedAndRecreated) {
  FakeConstraints constraints;
  constraints.AddMandatory(webrtc::MediaConstraintsInterface::kEnableDtlsSrtp,
                           true);
  CreatePeerConnection(&constraints);
...
TEST_P(PeerConnectionInterfaceTest, SignalSameTracksInSeparateMediaStream) {
  FakeConstraints constraints;
  constraints.AddMandatory(webrtc::MediaConstraintsInterface::kEnableDtlsSrtp,
                           true);
  CreatePeerConnection(&constraints);
