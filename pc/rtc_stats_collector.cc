...
CreateInboundRTPStreamStatsFromVideoReceiverInfo(
  ...
  if (video_receiver_info.fec_packets_received.has_value()) {
    inbound_video->fec_packets_received =
        *video_receiver_info.fec_packets_received;
  }
  if (video_receiver_info.fec_packets_discarded.has_value()) {
    inbound_video->fec_packets_discarded =
        *video_receiver_info.fec_packets_discarded;
  }
  if (video_receiver_info.fec_bytes_received.has_value()) {
    inbound_video->fec_bytes_received = *video_receiver_info.fec_bytes_received;
  }
