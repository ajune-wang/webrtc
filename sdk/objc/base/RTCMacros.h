...
#define RTC_INTERNAL_CONCAT_HELPER_1(a, b) a##b
#define RTC_INTERNAL_CONCAT_HELPER_2(a, b) RTC_INTERNAL_CONCAT_HELPER_1(a, b)
...
#define RTC_OBJC_TYPE(type_name) RTC_INTERNAL_CONCAT_HELPER_2(RTC_OBJC_TYPE_PREFIX, type_name)
