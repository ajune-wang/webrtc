...
class RtcEventLogImpl final : public RtcEventLog {
 ...
 private:
  ...
  //
  // `WriteToOutput` is a blocking function.
  // - If logging not started, we won't output the events. It is safe to
  // allow logging on caller's thread with locking to avoid TaskQueue.
  // - If logging started, we would schedule `WriteToOutput` and block caller.
  // Let logging on TaskQueue and return intermediately.
